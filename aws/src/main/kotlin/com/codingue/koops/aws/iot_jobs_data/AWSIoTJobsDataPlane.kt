...
package com.codingue.koops.aws.iot_jobs_data
...
var com.codingue.koops.core.Environment.iot_jobs_data: AWSIoTJobsDataPlane
	get() {
...
fun AWSIoTJobsDataPlaneFunctions.describeJobExecution(init: (AWSIoTJobsDataPlaneDescribeJobExecutionCommand.() -> Unit)? = null): com.amazonaws.services.iotjobsdataplane.model.DescribeJobExecutionResult {
	return this.block.declare(AWSIoTJobsDataPlaneDescribeJobExecutionCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.iotjobsdataplane.model.DescribeJobExecutionResult
}
...
class AWSIoTJobsDataPlaneDescribeJobExecutionCommand() : AmazonWebServiceCommand<com.amazonaws.services.iotjobsdataplane.model.DescribeJobExecutionRequest, com.amazonaws.services.iotjobsdataplane.model.DescribeJobExecutionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.iotjobsdataplane.model.DescribeJobExecutionResult {
...
fun AWSIoTJobsDataPlaneFunctions.getPendingJobExecutions(init: (AWSIoTJobsDataPlaneGetPendingJobExecutionsCommand.() -> Unit)? = null): com.amazonaws.services.iotjobsdataplane.model.GetPendingJobExecutionsResult {
	return this.block.declare(AWSIoTJobsDataPlaneGetPendingJobExecutionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.iotjobsdataplane.model.GetPendingJobExecutionsResult
}
...
class AWSIoTJobsDataPlaneGetPendingJobExecutionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.iotjobsdataplane.model.GetPendingJobExecutionsRequest, com.amazonaws.services.iotjobsdataplane.model.GetPendingJobExecutionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.iotjobsdataplane.model.GetPendingJobExecutionsResult {
...
fun AWSIoTJobsDataPlaneFunctions.startNextPendingJobExecution(init: (AWSIoTJobsDataPlaneStartNextPendingJobExecutionCommand.() -> Unit)? = null): com.amazonaws.services.iotjobsdataplane.model.StartNextPendingJobExecutionResult {
	return this.block.declare(AWSIoTJobsDataPlaneStartNextPendingJobExecutionCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.iotjobsdataplane.model.StartNextPendingJobExecutionResult
}
...
class AWSIoTJobsDataPlaneStartNextPendingJobExecutionCommand() : AmazonWebServiceCommand<com.amazonaws.services.iotjobsdataplane.model.StartNextPendingJobExecutionRequest, com.amazonaws.services.iotjobsdataplane.model.StartNextPendingJobExecutionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.iotjobsdataplane.model.StartNextPendingJobExecutionResult {
...
fun AWSIoTJobsDataPlaneFunctions.updateJobExecution(init: (AWSIoTJobsDataPlaneUpdateJobExecutionCommand.() -> Unit)? = null): com.amazonaws.services.iotjobsdataplane.model.UpdateJobExecutionResult {
	return this.block.declare(AWSIoTJobsDataPlaneUpdateJobExecutionCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.iotjobsdataplane.model.UpdateJobExecutionResult
}
...
class AWSIoTJobsDataPlaneUpdateJobExecutionCommand() : AmazonWebServiceCommand<com.amazonaws.services.iotjobsdataplane.model.UpdateJobExecutionRequest, com.amazonaws.services.iotjobsdataplane.model.UpdateJobExecutionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.iotjobsdataplane.model.UpdateJobExecutionResult {
