...
package com.codingue.koops.aws.mq

import javax.annotation.Generated
import com.codingue.koops.common.*
import com.codingue.koops.core.*
import com.codingue.koops.aws.*
import com.amazonaws.services.mq.*
import com.amazonaws.services.mq.model.*

var com.codingue.koops.core.Environment.mq: AmazonMQ
	get() {
		var service = this.capabilities["aws-mq"]
		if (service == null) {
			service = AmazonMQClientBuilder.standard().build()
			this.capabilities["aws-mq"] = service
		}
		return service as AmazonMQ
	}
	set(mq) {
		this.capabilities["aws-mq"] = mq
	}
...
fun AmazonMQFunctions.createBroker(init: (AmazonMQCreateBrokerCommand.() -> Unit)? = null): com.amazonaws.services.mq.model.CreateBrokerResult {
	return this.block.declare(AmazonMQCreateBrokerCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mq.model.CreateBrokerResult
}
...
class AmazonMQCreateBrokerCommand() : AmazonWebServiceCommand<com.amazonaws.services.mq.model.CreateBrokerRequest, com.amazonaws.services.mq.model.CreateBrokerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mq.model.CreateBrokerResult {
...
fun AmazonMQFunctions.createConfiguration(init: (AmazonMQCreateConfigurationCommand.() -> Unit)? = null): com.amazonaws.services.mq.model.CreateConfigurationResult {
	return this.block.declare(AmazonMQCreateConfigurationCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mq.model.CreateConfigurationResult
}
...
class AmazonMQCreateConfigurationCommand() : AmazonWebServiceCommand<com.amazonaws.services.mq.model.CreateConfigurationRequest, com.amazonaws.services.mq.model.CreateConfigurationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mq.model.CreateConfigurationResult {
...
fun AmazonMQFunctions.createUser(brokerId: String, username: String, init: (AmazonMQCreateUserCommand.() -> Unit)? = null): com.amazonaws.services.mq.model.CreateUserResult {
	return this.block.declare(AmazonMQCreateUserCommand(brokerId, username).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mq.model.CreateUserResult
}
...
class AmazonMQCreateUserCommand(val brokerId: String, val username: String) : AmazonWebServiceCommand<com.amazonaws.services.mq.model.CreateUserRequest, com.amazonaws.services.mq.model.CreateUserResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mq.model.CreateUserResult {
...
fun AmazonMQFunctions.deleteBroker(brokerId: String, init: (AmazonMQDeleteBrokerCommand.() -> Unit)? = null): com.amazonaws.services.mq.model.DeleteBrokerResult {
	return this.block.declare(AmazonMQDeleteBrokerCommand(brokerId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mq.model.DeleteBrokerResult
}
...
class AmazonMQDeleteBrokerCommand(val brokerId: String) : AmazonWebServiceCommand<com.amazonaws.services.mq.model.DeleteBrokerRequest, com.amazonaws.services.mq.model.DeleteBrokerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mq.model.DeleteBrokerResult {
...
fun AmazonMQFunctions.deleteUser(brokerId: String, username: String, init: (AmazonMQDeleteUserCommand.() -> Unit)? = null): com.amazonaws.services.mq.model.DeleteUserResult {
	return this.block.declare(AmazonMQDeleteUserCommand(brokerId, username).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mq.model.DeleteUserResult
}
...
class AmazonMQDeleteUserCommand(val brokerId: String, val username: String) : AmazonWebServiceCommand<com.amazonaws.services.mq.model.DeleteUserRequest, com.amazonaws.services.mq.model.DeleteUserResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mq.model.DeleteUserResult {
...
fun AmazonMQFunctions.describeBroker(brokerId: String, init: (AmazonMQDescribeBrokerCommand.() -> Unit)? = null): com.amazonaws.services.mq.model.DescribeBrokerResult {
	return this.block.declare(AmazonMQDescribeBrokerCommand(brokerId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mq.model.DescribeBrokerResult
}
...
class AmazonMQDescribeBrokerCommand(val brokerId: String) : AmazonWebServiceCommand<com.amazonaws.services.mq.model.DescribeBrokerRequest, com.amazonaws.services.mq.model.DescribeBrokerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mq.model.DescribeBrokerResult {
...
fun AmazonMQFunctions.describeConfiguration(configurationId: String, init: (AmazonMQDescribeConfigurationCommand.() -> Unit)? = null): com.amazonaws.services.mq.model.DescribeConfigurationResult {
	return this.block.declare(AmazonMQDescribeConfigurationCommand(configurationId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mq.model.DescribeConfigurationResult
}
...
class AmazonMQDescribeConfigurationCommand(val configurationId: String) : AmazonWebServiceCommand<com.amazonaws.services.mq.model.DescribeConfigurationRequest, com.amazonaws.services.mq.model.DescribeConfigurationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mq.model.DescribeConfigurationResult {
...
fun AmazonMQFunctions.describeConfigurationRevision(configurationId: String, configurationRevision: String, init: (AmazonMQDescribeConfigurationRevisionCommand.() -> Unit)? = null): com.amazonaws.services.mq.model.DescribeConfigurationRevisionResult {
	return this.block.declare(AmazonMQDescribeConfigurationRevisionCommand(configurationId, configurationRevision).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mq.model.DescribeConfigurationRevisionResult
}
...
class AmazonMQDescribeConfigurationRevisionCommand(val configurationId: String, val configurationRevision: String) : AmazonWebServiceCommand<com.amazonaws.services.mq.model.DescribeConfigurationRevisionRequest, com.amazonaws.services.mq.model.DescribeConfigurationRevisionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mq.model.DescribeConfigurationRevisionResult {
...
fun AmazonMQFunctions.describeUser(brokerId: String, username: String, init: (AmazonMQDescribeUserCommand.() -> Unit)? = null): com.amazonaws.services.mq.model.DescribeUserResult {
	return this.block.declare(AmazonMQDescribeUserCommand(brokerId, username).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mq.model.DescribeUserResult
}
...
class AmazonMQDescribeUserCommand(val brokerId: String, val username: String) : AmazonWebServiceCommand<com.amazonaws.services.mq.model.DescribeUserRequest, com.amazonaws.services.mq.model.DescribeUserResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mq.model.DescribeUserResult {
...
fun AmazonMQFunctions.listBrokers(init: (AmazonMQListBrokersCommand.() -> Unit)? = null): com.amazonaws.services.mq.model.ListBrokersResult {
	return this.block.declare(AmazonMQListBrokersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mq.model.ListBrokersResult
}
...
class AmazonMQListBrokersCommand() : AmazonWebServiceCommand<com.amazonaws.services.mq.model.ListBrokersRequest, com.amazonaws.services.mq.model.ListBrokersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mq.model.ListBrokersResult {
...
fun AmazonMQFunctions.listConfigurationRevisions(configurationId: String, init: (AmazonMQListConfigurationRevisionsCommand.() -> Unit)? = null): com.amazonaws.services.mq.model.ListConfigurationRevisionsResult {
	return this.block.declare(AmazonMQListConfigurationRevisionsCommand(configurationId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mq.model.ListConfigurationRevisionsResult
}
...
class AmazonMQListConfigurationRevisionsCommand(val configurationId: String) : AmazonWebServiceCommand<com.amazonaws.services.mq.model.ListConfigurationRevisionsRequest, com.amazonaws.services.mq.model.ListConfigurationRevisionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mq.model.ListConfigurationRevisionsResult {
...
fun AmazonMQFunctions.listConfigurations(init: (AmazonMQListConfigurationsCommand.() -> Unit)? = null): com.amazonaws.services.mq.model.ListConfigurationsResult {
	return this.block.declare(AmazonMQListConfigurationsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mq.model.ListConfigurationsResult
}
...
class AmazonMQListConfigurationsCommand() : AmazonWebServiceCommand<com.amazonaws.services.mq.model.ListConfigurationsRequest, com.amazonaws.services.mq.model.ListConfigurationsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mq.model.ListConfigurationsResult {
...
fun AmazonMQFunctions.listUsers(brokerId: String, init: (AmazonMQListUsersCommand.() -> Unit)? = null): com.amazonaws.services.mq.model.ListUsersResult {
	return this.block.declare(AmazonMQListUsersCommand(brokerId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mq.model.ListUsersResult
}
...
class AmazonMQListUsersCommand(val brokerId: String) : AmazonWebServiceCommand<com.amazonaws.services.mq.model.ListUsersRequest, com.amazonaws.services.mq.model.ListUsersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mq.model.ListUsersResult {
...
fun AmazonMQFunctions.rebootBroker(brokerId: String, init: (AmazonMQRebootBrokerCommand.() -> Unit)? = null): com.amazonaws.services.mq.model.RebootBrokerResult {
	return this.block.declare(AmazonMQRebootBrokerCommand(brokerId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mq.model.RebootBrokerResult
}
...
class AmazonMQRebootBrokerCommand(val brokerId: String) : AmazonWebServiceCommand<com.amazonaws.services.mq.model.RebootBrokerRequest, com.amazonaws.services.mq.model.RebootBrokerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mq.model.RebootBrokerResult {
...
fun AmazonMQFunctions.updateBroker(brokerId: String, init: (AmazonMQUpdateBrokerCommand.() -> Unit)? = null): com.amazonaws.services.mq.model.UpdateBrokerResult {
	return this.block.declare(AmazonMQUpdateBrokerCommand(brokerId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mq.model.UpdateBrokerResult
}
...
class AmazonMQUpdateBrokerCommand(val brokerId: String) : AmazonWebServiceCommand<com.amazonaws.services.mq.model.UpdateBrokerRequest, com.amazonaws.services.mq.model.UpdateBrokerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mq.model.UpdateBrokerResult {
...
fun AmazonMQFunctions.updateConfiguration(configurationId: String, init: (AmazonMQUpdateConfigurationCommand.() -> Unit)? = null): com.amazonaws.services.mq.model.UpdateConfigurationResult {
	return this.block.declare(AmazonMQUpdateConfigurationCommand(configurationId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mq.model.UpdateConfigurationResult
}
...
class AmazonMQUpdateConfigurationCommand(val configurationId: String) : AmazonWebServiceCommand<com.amazonaws.services.mq.model.UpdateConfigurationRequest, com.amazonaws.services.mq.model.UpdateConfigurationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mq.model.UpdateConfigurationResult {
...
fun AmazonMQFunctions.updateUser(brokerId: String, username: String, init: (AmazonMQUpdateUserCommand.() -> Unit)? = null): com.amazonaws.services.mq.model.UpdateUserResult {
	return this.block.declare(AmazonMQUpdateUserCommand(brokerId, username).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mq.model.UpdateUserResult
}
...
class AmazonMQUpdateUserCommand(val brokerId: String, val username: String) : AmazonWebServiceCommand<com.amazonaws.services.mq.model.UpdateUserRequest, com.amazonaws.services.mq.model.UpdateUserResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mq.model.UpdateUserResult {
