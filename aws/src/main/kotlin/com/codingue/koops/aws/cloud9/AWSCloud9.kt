...
package com.codingue.koops.aws.cloud9
...
var com.codingue.koops.core.Environment.cloud9: AWSCloud9
	get() {
...
fun AWSCloud9Functions.createEnvironmentEC2(init: (AWSCloud9CreateEnvironmentEC2Command.() -> Unit)? = null): com.amazonaws.services.cloud9.model.CreateEnvironmentEC2Result {
	return this.block.declare(AWSCloud9CreateEnvironmentEC2Command().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloud9.model.CreateEnvironmentEC2Result
}
...
class AWSCloud9CreateEnvironmentEC2Command() : AmazonWebServiceCommand<com.amazonaws.services.cloud9.model.CreateEnvironmentEC2Request, com.amazonaws.services.cloud9.model.CreateEnvironmentEC2Result> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloud9.model.CreateEnvironmentEC2Result {
...
fun AWSCloud9Functions.createEnvironmentMembership(init: (AWSCloud9CreateEnvironmentMembershipCommand.() -> Unit)? = null): com.amazonaws.services.cloud9.model.CreateEnvironmentMembershipResult {
	return this.block.declare(AWSCloud9CreateEnvironmentMembershipCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloud9.model.CreateEnvironmentMembershipResult
}
...
class AWSCloud9CreateEnvironmentMembershipCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloud9.model.CreateEnvironmentMembershipRequest, com.amazonaws.services.cloud9.model.CreateEnvironmentMembershipResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloud9.model.CreateEnvironmentMembershipResult {
...
fun AWSCloud9Functions.deleteEnvironment(init: (AWSCloud9DeleteEnvironmentCommand.() -> Unit)? = null): com.amazonaws.services.cloud9.model.DeleteEnvironmentResult {
	return this.block.declare(AWSCloud9DeleteEnvironmentCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloud9.model.DeleteEnvironmentResult
}
...
class AWSCloud9DeleteEnvironmentCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloud9.model.DeleteEnvironmentRequest, com.amazonaws.services.cloud9.model.DeleteEnvironmentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloud9.model.DeleteEnvironmentResult {
...
fun AWSCloud9Functions.deleteEnvironmentMembership(init: (AWSCloud9DeleteEnvironmentMembershipCommand.() -> Unit)? = null): com.amazonaws.services.cloud9.model.DeleteEnvironmentMembershipResult {
	return this.block.declare(AWSCloud9DeleteEnvironmentMembershipCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloud9.model.DeleteEnvironmentMembershipResult
}
...
class AWSCloud9DeleteEnvironmentMembershipCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloud9.model.DeleteEnvironmentMembershipRequest, com.amazonaws.services.cloud9.model.DeleteEnvironmentMembershipResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloud9.model.DeleteEnvironmentMembershipResult {
...
fun AWSCloud9Functions.describeEnvironmentMemberships(init: (AWSCloud9DescribeEnvironmentMembershipsCommand.() -> Unit)? = null): com.amazonaws.services.cloud9.model.DescribeEnvironmentMembershipsResult {
	return this.block.declare(AWSCloud9DescribeEnvironmentMembershipsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloud9.model.DescribeEnvironmentMembershipsResult
}
...
class AWSCloud9DescribeEnvironmentMembershipsCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloud9.model.DescribeEnvironmentMembershipsRequest, com.amazonaws.services.cloud9.model.DescribeEnvironmentMembershipsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloud9.model.DescribeEnvironmentMembershipsResult {
...
fun AWSCloud9Functions.describeEnvironmentStatus(init: (AWSCloud9DescribeEnvironmentStatusCommand.() -> Unit)? = null): com.amazonaws.services.cloud9.model.DescribeEnvironmentStatusResult {
	return this.block.declare(AWSCloud9DescribeEnvironmentStatusCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloud9.model.DescribeEnvironmentStatusResult
}
...
class AWSCloud9DescribeEnvironmentStatusCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloud9.model.DescribeEnvironmentStatusRequest, com.amazonaws.services.cloud9.model.DescribeEnvironmentStatusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloud9.model.DescribeEnvironmentStatusResult {
...
fun AWSCloud9Functions.describeEnvironments(init: (AWSCloud9DescribeEnvironmentsCommand.() -> Unit)? = null): com.amazonaws.services.cloud9.model.DescribeEnvironmentsResult {
	return this.block.declare(AWSCloud9DescribeEnvironmentsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloud9.model.DescribeEnvironmentsResult
}
...
class AWSCloud9DescribeEnvironmentsCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloud9.model.DescribeEnvironmentsRequest, com.amazonaws.services.cloud9.model.DescribeEnvironmentsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloud9.model.DescribeEnvironmentsResult {
...
fun AWSCloud9Functions.listEnvironments(init: (AWSCloud9ListEnvironmentsCommand.() -> Unit)? = null): com.amazonaws.services.cloud9.model.ListEnvironmentsResult {
	return this.block.declare(AWSCloud9ListEnvironmentsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloud9.model.ListEnvironmentsResult
}
...
class AWSCloud9ListEnvironmentsCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloud9.model.ListEnvironmentsRequest, com.amazonaws.services.cloud9.model.ListEnvironmentsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloud9.model.ListEnvironmentsResult {
...
fun AWSCloud9Functions.updateEnvironment(init: (AWSCloud9UpdateEnvironmentCommand.() -> Unit)? = null): com.amazonaws.services.cloud9.model.UpdateEnvironmentResult {
	return this.block.declare(AWSCloud9UpdateEnvironmentCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloud9.model.UpdateEnvironmentResult
}
...
class AWSCloud9UpdateEnvironmentCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloud9.model.UpdateEnvironmentRequest, com.amazonaws.services.cloud9.model.UpdateEnvironmentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloud9.model.UpdateEnvironmentResult {
...
fun AWSCloud9Functions.updateEnvironmentMembership(init: (AWSCloud9UpdateEnvironmentMembershipCommand.() -> Unit)? = null): com.amazonaws.services.cloud9.model.UpdateEnvironmentMembershipResult {
	return this.block.declare(AWSCloud9UpdateEnvironmentMembershipCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloud9.model.UpdateEnvironmentMembershipResult
}
...
class AWSCloud9UpdateEnvironmentMembershipCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloud9.model.UpdateEnvironmentMembershipRequest, com.amazonaws.services.cloud9.model.UpdateEnvironmentMembershipResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloud9.model.UpdateEnvironmentMembershipResult {
