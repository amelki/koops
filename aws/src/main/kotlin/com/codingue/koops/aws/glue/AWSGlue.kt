...
package com.codingue.koops.aws.glue
...
var com.codingue.koops.core.Environment.glue: AWSGlue
	get() {
...
fun AWSGlueFunctions.batchCreatePartition(databaseName: String, tableName: String, partitionInputList: List<com.amazonaws.services.glue.model.PartitionInput>, init: (AWSGlueBatchCreatePartitionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.BatchCreatePartitionResult {
	return this.block.declare(AWSGlueBatchCreatePartitionCommand(databaseName, tableName, partitionInputList).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.BatchCreatePartitionResult
}
...
class AWSGlueBatchCreatePartitionCommand(val databaseName: String, val tableName: String, val partitionInputList: List<com.amazonaws.services.glue.model.PartitionInput>) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.BatchCreatePartitionRequest, com.amazonaws.services.glue.model.BatchCreatePartitionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.BatchCreatePartitionResult {
...
fun AWSGlueFunctions.batchDeleteConnection(connectionNameList: List<String>, init: (AWSGlueBatchDeleteConnectionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.BatchDeleteConnectionResult {
	return this.block.declare(AWSGlueBatchDeleteConnectionCommand(connectionNameList).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.BatchDeleteConnectionResult
}
...
class AWSGlueBatchDeleteConnectionCommand(val connectionNameList: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.BatchDeleteConnectionRequest, com.amazonaws.services.glue.model.BatchDeleteConnectionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.BatchDeleteConnectionResult {
...
fun AWSGlueFunctions.batchDeletePartition(databaseName: String, tableName: String, partitionsToDelete: List<com.amazonaws.services.glue.model.PartitionValueList>, init: (AWSGlueBatchDeletePartitionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.BatchDeletePartitionResult {
	return this.block.declare(AWSGlueBatchDeletePartitionCommand(databaseName, tableName, partitionsToDelete).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.BatchDeletePartitionResult
}
...
class AWSGlueBatchDeletePartitionCommand(val databaseName: String, val tableName: String, val partitionsToDelete: List<com.amazonaws.services.glue.model.PartitionValueList>) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.BatchDeletePartitionRequest, com.amazonaws.services.glue.model.BatchDeletePartitionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.BatchDeletePartitionResult {
...
fun AWSGlueFunctions.batchDeleteTable(databaseName: String, tablesToDelete: List<String>, init: (AWSGlueBatchDeleteTableCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.BatchDeleteTableResult {
	return this.block.declare(AWSGlueBatchDeleteTableCommand(databaseName, tablesToDelete).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.BatchDeleteTableResult
}
...
class AWSGlueBatchDeleteTableCommand(val databaseName: String, val tablesToDelete: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.BatchDeleteTableRequest, com.amazonaws.services.glue.model.BatchDeleteTableResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.BatchDeleteTableResult {
...
fun AWSGlueFunctions.batchDeleteTableVersion(databaseName: String, tableName: String, versionIds: List<String>, init: (AWSGlueBatchDeleteTableVersionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.BatchDeleteTableVersionResult {
	return this.block.declare(AWSGlueBatchDeleteTableVersionCommand(databaseName, tableName, versionIds).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.BatchDeleteTableVersionResult
}
...
class AWSGlueBatchDeleteTableVersionCommand(val databaseName: String, val tableName: String, val versionIds: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.BatchDeleteTableVersionRequest, com.amazonaws.services.glue.model.BatchDeleteTableVersionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.BatchDeleteTableVersionResult {
...
fun AWSGlueFunctions.batchGetPartition(databaseName: String, tableName: String, partitionsToGet: List<com.amazonaws.services.glue.model.PartitionValueList>, init: (AWSGlueBatchGetPartitionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.BatchGetPartitionResult {
	return this.block.declare(AWSGlueBatchGetPartitionCommand(databaseName, tableName, partitionsToGet).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.BatchGetPartitionResult
}
...
class AWSGlueBatchGetPartitionCommand(val databaseName: String, val tableName: String, val partitionsToGet: List<com.amazonaws.services.glue.model.PartitionValueList>) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.BatchGetPartitionRequest, com.amazonaws.services.glue.model.BatchGetPartitionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.BatchGetPartitionResult {
...
fun AWSGlueFunctions.batchStopJobRun(jobName: String, jobRunIds: List<String>, init: (AWSGlueBatchStopJobRunCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.BatchStopJobRunResult {
	return this.block.declare(AWSGlueBatchStopJobRunCommand(jobName, jobRunIds).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.BatchStopJobRunResult
}
...
class AWSGlueBatchStopJobRunCommand(val jobName: String, val jobRunIds: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.BatchStopJobRunRequest, com.amazonaws.services.glue.model.BatchStopJobRunResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.BatchStopJobRunResult {
...
fun AWSGlueFunctions.createClassifier(init: (AWSGlueCreateClassifierCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.CreateClassifierResult {
	return this.block.declare(AWSGlueCreateClassifierCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.CreateClassifierResult
}
...
class AWSGlueCreateClassifierCommand() : AmazonWebServiceCommand<com.amazonaws.services.glue.model.CreateClassifierRequest, com.amazonaws.services.glue.model.CreateClassifierResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.CreateClassifierResult {
...
fun AWSGlueFunctions.createConnection(connectionInput: com.amazonaws.services.glue.model.ConnectionInput, init: (AWSGlueCreateConnectionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.CreateConnectionResult {
	return this.block.declare(AWSGlueCreateConnectionCommand(connectionInput).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.CreateConnectionResult
}
...
class AWSGlueCreateConnectionCommand(val connectionInput: com.amazonaws.services.glue.model.ConnectionInput) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.CreateConnectionRequest, com.amazonaws.services.glue.model.CreateConnectionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.CreateConnectionResult {
...
fun AWSGlueFunctions.createCrawler(name: String, role: String, databaseName: String, targets: com.amazonaws.services.glue.model.CrawlerTargets, init: (AWSGlueCreateCrawlerCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.CreateCrawlerResult {
	return this.block.declare(AWSGlueCreateCrawlerCommand(name, role, databaseName, targets).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.CreateCrawlerResult
}
...
class AWSGlueCreateCrawlerCommand(val name: String, val role: String, val databaseName: String, val targets: com.amazonaws.services.glue.model.CrawlerTargets) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.CreateCrawlerRequest, com.amazonaws.services.glue.model.CreateCrawlerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.CreateCrawlerResult {
...
fun AWSGlueFunctions.createDatabase(databaseInput: com.amazonaws.services.glue.model.DatabaseInput, init: (AWSGlueCreateDatabaseCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.CreateDatabaseResult {
	return this.block.declare(AWSGlueCreateDatabaseCommand(databaseInput).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.CreateDatabaseResult
}
...
class AWSGlueCreateDatabaseCommand(val databaseInput: com.amazonaws.services.glue.model.DatabaseInput) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.CreateDatabaseRequest, com.amazonaws.services.glue.model.CreateDatabaseResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.CreateDatabaseResult {
...
fun AWSGlueFunctions.createDevEndpoint(endpointName: String, roleArn: String, init: (AWSGlueCreateDevEndpointCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.CreateDevEndpointResult {
	return this.block.declare(AWSGlueCreateDevEndpointCommand(endpointName, roleArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.CreateDevEndpointResult
}
...
class AWSGlueCreateDevEndpointCommand(val endpointName: String, val roleArn: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.CreateDevEndpointRequest, com.amazonaws.services.glue.model.CreateDevEndpointResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.CreateDevEndpointResult {
...
fun AWSGlueFunctions.createJob(name: String, role: String, command: com.amazonaws.services.glue.model.JobCommand, init: (AWSGlueCreateJobCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.CreateJobResult {
	return this.block.declare(AWSGlueCreateJobCommand(name, role, command).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.CreateJobResult
}
...
class AWSGlueCreateJobCommand(val name: String, val role: String, val command: com.amazonaws.services.glue.model.JobCommand) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.CreateJobRequest, com.amazonaws.services.glue.model.CreateJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.CreateJobResult {
...
fun AWSGlueFunctions.createPartition(databaseName: String, tableName: String, partitionInput: com.amazonaws.services.glue.model.PartitionInput, init: (AWSGlueCreatePartitionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.CreatePartitionResult {
	return this.block.declare(AWSGlueCreatePartitionCommand(databaseName, tableName, partitionInput).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.CreatePartitionResult
}
...
class AWSGlueCreatePartitionCommand(val databaseName: String, val tableName: String, val partitionInput: com.amazonaws.services.glue.model.PartitionInput) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.CreatePartitionRequest, com.amazonaws.services.glue.model.CreatePartitionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.CreatePartitionResult {
...
fun AWSGlueFunctions.createScript(init: (AWSGlueCreateScriptCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.CreateScriptResult {
	return this.block.declare(AWSGlueCreateScriptCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.CreateScriptResult
}
...
class AWSGlueCreateScriptCommand() : AmazonWebServiceCommand<com.amazonaws.services.glue.model.CreateScriptRequest, com.amazonaws.services.glue.model.CreateScriptResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.CreateScriptResult {
...
fun AWSGlueFunctions.createTable(databaseName: String, tableInput: com.amazonaws.services.glue.model.TableInput, init: (AWSGlueCreateTableCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.CreateTableResult {
	return this.block.declare(AWSGlueCreateTableCommand(databaseName, tableInput).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.CreateTableResult
}
...
class AWSGlueCreateTableCommand(val databaseName: String, val tableInput: com.amazonaws.services.glue.model.TableInput) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.CreateTableRequest, com.amazonaws.services.glue.model.CreateTableResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.CreateTableResult {
...
fun AWSGlueFunctions.createTrigger(name: String, type: TriggerType, actions: List<com.amazonaws.services.glue.model.Action>, init: (AWSGlueCreateTriggerCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.CreateTriggerResult {
	return this.block.declare(AWSGlueCreateTriggerCommand(name, type, actions).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.CreateTriggerResult
}
...
class AWSGlueCreateTriggerCommand(val name: String, val type: TriggerType, val actions: List<com.amazonaws.services.glue.model.Action>) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.CreateTriggerRequest, com.amazonaws.services.glue.model.CreateTriggerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.CreateTriggerResult {
...
fun AWSGlueFunctions.createUserDefinedFunction(databaseName: String, functionInput: com.amazonaws.services.glue.model.UserDefinedFunctionInput, init: (AWSGlueCreateUserDefinedFunctionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.CreateUserDefinedFunctionResult {
	return this.block.declare(AWSGlueCreateUserDefinedFunctionCommand(databaseName, functionInput).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.CreateUserDefinedFunctionResult
}
...
class AWSGlueCreateUserDefinedFunctionCommand(val databaseName: String, val functionInput: com.amazonaws.services.glue.model.UserDefinedFunctionInput) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.CreateUserDefinedFunctionRequest, com.amazonaws.services.glue.model.CreateUserDefinedFunctionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.CreateUserDefinedFunctionResult {
...
fun AWSGlueFunctions.deleteClassifier(name: String, init: (AWSGlueDeleteClassifierCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.DeleteClassifierResult {
	return this.block.declare(AWSGlueDeleteClassifierCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.DeleteClassifierResult
}
...
class AWSGlueDeleteClassifierCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.DeleteClassifierRequest, com.amazonaws.services.glue.model.DeleteClassifierResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.DeleteClassifierResult {
...
fun AWSGlueFunctions.deleteConnection(connectionName: String, init: (AWSGlueDeleteConnectionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.DeleteConnectionResult {
	return this.block.declare(AWSGlueDeleteConnectionCommand(connectionName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.DeleteConnectionResult
}
...
class AWSGlueDeleteConnectionCommand(val connectionName: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.DeleteConnectionRequest, com.amazonaws.services.glue.model.DeleteConnectionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.DeleteConnectionResult {
...
fun AWSGlueFunctions.deleteCrawler(name: String, init: (AWSGlueDeleteCrawlerCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.DeleteCrawlerResult {
	return this.block.declare(AWSGlueDeleteCrawlerCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.DeleteCrawlerResult
}
...
class AWSGlueDeleteCrawlerCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.DeleteCrawlerRequest, com.amazonaws.services.glue.model.DeleteCrawlerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.DeleteCrawlerResult {
...
fun AWSGlueFunctions.deleteDatabase(name: String, init: (AWSGlueDeleteDatabaseCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.DeleteDatabaseResult {
	return this.block.declare(AWSGlueDeleteDatabaseCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.DeleteDatabaseResult
}
...
class AWSGlueDeleteDatabaseCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.DeleteDatabaseRequest, com.amazonaws.services.glue.model.DeleteDatabaseResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.DeleteDatabaseResult {
...
fun AWSGlueFunctions.deleteDevEndpoint(endpointName: String, init: (AWSGlueDeleteDevEndpointCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.DeleteDevEndpointResult {
	return this.block.declare(AWSGlueDeleteDevEndpointCommand(endpointName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.DeleteDevEndpointResult
}
...
class AWSGlueDeleteDevEndpointCommand(val endpointName: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.DeleteDevEndpointRequest, com.amazonaws.services.glue.model.DeleteDevEndpointResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.DeleteDevEndpointResult {
...
fun AWSGlueFunctions.deleteJob(jobName: String, init: (AWSGlueDeleteJobCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.DeleteJobResult {
	return this.block.declare(AWSGlueDeleteJobCommand(jobName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.DeleteJobResult
}
...
class AWSGlueDeleteJobCommand(val jobName: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.DeleteJobRequest, com.amazonaws.services.glue.model.DeleteJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.DeleteJobResult {
...
fun AWSGlueFunctions.deletePartition(databaseName: String, tableName: String, partitionValues: List<String>, init: (AWSGlueDeletePartitionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.DeletePartitionResult {
	return this.block.declare(AWSGlueDeletePartitionCommand(databaseName, tableName, partitionValues).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.DeletePartitionResult
}
...
class AWSGlueDeletePartitionCommand(val databaseName: String, val tableName: String, val partitionValues: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.DeletePartitionRequest, com.amazonaws.services.glue.model.DeletePartitionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.DeletePartitionResult {
...
fun AWSGlueFunctions.deleteTable(databaseName: String, name: String, init: (AWSGlueDeleteTableCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.DeleteTableResult {
	return this.block.declare(AWSGlueDeleteTableCommand(databaseName, name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.DeleteTableResult
}
...
class AWSGlueDeleteTableCommand(val databaseName: String, val name: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.DeleteTableRequest, com.amazonaws.services.glue.model.DeleteTableResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.DeleteTableResult {
...
fun AWSGlueFunctions.deleteTableVersion(databaseName: String, tableName: String, versionId: String, init: (AWSGlueDeleteTableVersionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.DeleteTableVersionResult {
	return this.block.declare(AWSGlueDeleteTableVersionCommand(databaseName, tableName, versionId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.DeleteTableVersionResult
}
...
class AWSGlueDeleteTableVersionCommand(val databaseName: String, val tableName: String, val versionId: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.DeleteTableVersionRequest, com.amazonaws.services.glue.model.DeleteTableVersionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.DeleteTableVersionResult {
...
fun AWSGlueFunctions.deleteTrigger(name: String, init: (AWSGlueDeleteTriggerCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.DeleteTriggerResult {
	return this.block.declare(AWSGlueDeleteTriggerCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.DeleteTriggerResult
}
...
class AWSGlueDeleteTriggerCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.DeleteTriggerRequest, com.amazonaws.services.glue.model.DeleteTriggerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.DeleteTriggerResult {
...
fun AWSGlueFunctions.deleteUserDefinedFunction(databaseName: String, functionName: String, init: (AWSGlueDeleteUserDefinedFunctionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.DeleteUserDefinedFunctionResult {
	return this.block.declare(AWSGlueDeleteUserDefinedFunctionCommand(databaseName, functionName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.DeleteUserDefinedFunctionResult
}
...
class AWSGlueDeleteUserDefinedFunctionCommand(val databaseName: String, val functionName: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.DeleteUserDefinedFunctionRequest, com.amazonaws.services.glue.model.DeleteUserDefinedFunctionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.DeleteUserDefinedFunctionResult {
...
fun AWSGlueFunctions.getCatalogImportStatus(init: (AWSGlueGetCatalogImportStatusCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetCatalogImportStatusResult {
	return this.block.declare(AWSGlueGetCatalogImportStatusCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetCatalogImportStatusResult
}
...
class AWSGlueGetCatalogImportStatusCommand() : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetCatalogImportStatusRequest, com.amazonaws.services.glue.model.GetCatalogImportStatusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetCatalogImportStatusResult {
...
fun AWSGlueFunctions.getClassifier(name: String, init: (AWSGlueGetClassifierCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetClassifierResult {
	return this.block.declare(AWSGlueGetClassifierCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetClassifierResult
}
...
class AWSGlueGetClassifierCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetClassifierRequest, com.amazonaws.services.glue.model.GetClassifierResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetClassifierResult {
...
fun AWSGlueFunctions.getClassifiers(init: (AWSGlueGetClassifiersCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetClassifiersResult {
	return this.block.declare(AWSGlueGetClassifiersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetClassifiersResult
}
...
class AWSGlueGetClassifiersCommand() : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetClassifiersRequest, com.amazonaws.services.glue.model.GetClassifiersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetClassifiersResult {
...
fun AWSGlueFunctions.getConnection(name: String, init: (AWSGlueGetConnectionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetConnectionResult {
	return this.block.declare(AWSGlueGetConnectionCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetConnectionResult
}
...
class AWSGlueGetConnectionCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetConnectionRequest, com.amazonaws.services.glue.model.GetConnectionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetConnectionResult {
...
fun AWSGlueFunctions.getConnections(init: (AWSGlueGetConnectionsCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetConnectionsResult {
	return this.block.declare(AWSGlueGetConnectionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetConnectionsResult
}
...
class AWSGlueGetConnectionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetConnectionsRequest, com.amazonaws.services.glue.model.GetConnectionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetConnectionsResult {
...
fun AWSGlueFunctions.getCrawler(name: String, init: (AWSGlueGetCrawlerCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetCrawlerResult {
	return this.block.declare(AWSGlueGetCrawlerCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetCrawlerResult
}
...
class AWSGlueGetCrawlerCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetCrawlerRequest, com.amazonaws.services.glue.model.GetCrawlerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetCrawlerResult {
...
fun AWSGlueFunctions.getCrawlerMetrics(init: (AWSGlueGetCrawlerMetricsCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetCrawlerMetricsResult {
	return this.block.declare(AWSGlueGetCrawlerMetricsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetCrawlerMetricsResult
}
...
class AWSGlueGetCrawlerMetricsCommand() : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetCrawlerMetricsRequest, com.amazonaws.services.glue.model.GetCrawlerMetricsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetCrawlerMetricsResult {
...
fun AWSGlueFunctions.getCrawlers(init: (AWSGlueGetCrawlersCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetCrawlersResult {
	return this.block.declare(AWSGlueGetCrawlersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetCrawlersResult
}
...
class AWSGlueGetCrawlersCommand() : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetCrawlersRequest, com.amazonaws.services.glue.model.GetCrawlersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetCrawlersResult {
...
fun AWSGlueFunctions.getDatabase(name: String, init: (AWSGlueGetDatabaseCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetDatabaseResult {
	return this.block.declare(AWSGlueGetDatabaseCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetDatabaseResult
}
...
class AWSGlueGetDatabaseCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetDatabaseRequest, com.amazonaws.services.glue.model.GetDatabaseResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetDatabaseResult {
...
fun AWSGlueFunctions.getDatabases(init: (AWSGlueGetDatabasesCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetDatabasesResult {
	return this.block.declare(AWSGlueGetDatabasesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetDatabasesResult
}
...
class AWSGlueGetDatabasesCommand() : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetDatabasesRequest, com.amazonaws.services.glue.model.GetDatabasesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetDatabasesResult {
...
fun AWSGlueFunctions.getDataflowGraph(init: (AWSGlueGetDataflowGraphCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetDataflowGraphResult {
	return this.block.declare(AWSGlueGetDataflowGraphCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetDataflowGraphResult
}
...
class AWSGlueGetDataflowGraphCommand() : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetDataflowGraphRequest, com.amazonaws.services.glue.model.GetDataflowGraphResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetDataflowGraphResult {
...
fun AWSGlueFunctions.getDevEndpoint(endpointName: String, init: (AWSGlueGetDevEndpointCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetDevEndpointResult {
	return this.block.declare(AWSGlueGetDevEndpointCommand(endpointName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetDevEndpointResult
}
...
class AWSGlueGetDevEndpointCommand(val endpointName: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetDevEndpointRequest, com.amazonaws.services.glue.model.GetDevEndpointResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetDevEndpointResult {
...
fun AWSGlueFunctions.getDevEndpoints(init: (AWSGlueGetDevEndpointsCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetDevEndpointsResult {
	return this.block.declare(AWSGlueGetDevEndpointsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetDevEndpointsResult
}
...
class AWSGlueGetDevEndpointsCommand() : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetDevEndpointsRequest, com.amazonaws.services.glue.model.GetDevEndpointsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetDevEndpointsResult {
...
fun AWSGlueFunctions.getJob(jobName: String, init: (AWSGlueGetJobCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetJobResult {
	return this.block.declare(AWSGlueGetJobCommand(jobName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetJobResult
}
...
class AWSGlueGetJobCommand(val jobName: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetJobRequest, com.amazonaws.services.glue.model.GetJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetJobResult {
...
fun AWSGlueFunctions.getJobRun(jobName: String, runId: String, init: (AWSGlueGetJobRunCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetJobRunResult {
	return this.block.declare(AWSGlueGetJobRunCommand(jobName, runId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetJobRunResult
}
...
class AWSGlueGetJobRunCommand(val jobName: String, val runId: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetJobRunRequest, com.amazonaws.services.glue.model.GetJobRunResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetJobRunResult {
...
fun AWSGlueFunctions.getJobRuns(jobName: String, init: (AWSGlueGetJobRunsCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetJobRunsResult {
	return this.block.declare(AWSGlueGetJobRunsCommand(jobName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetJobRunsResult
}
...
class AWSGlueGetJobRunsCommand(val jobName: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetJobRunsRequest, com.amazonaws.services.glue.model.GetJobRunsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetJobRunsResult {
...
fun AWSGlueFunctions.getJobs(init: (AWSGlueGetJobsCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetJobsResult {
	return this.block.declare(AWSGlueGetJobsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetJobsResult
}
...
class AWSGlueGetJobsCommand() : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetJobsRequest, com.amazonaws.services.glue.model.GetJobsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetJobsResult {
...
fun AWSGlueFunctions.getMapping(source: com.amazonaws.services.glue.model.CatalogEntry, init: (AWSGlueGetMappingCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetMappingResult {
	return this.block.declare(AWSGlueGetMappingCommand(source).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetMappingResult
}
...
class AWSGlueGetMappingCommand(val source: com.amazonaws.services.glue.model.CatalogEntry) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetMappingRequest, com.amazonaws.services.glue.model.GetMappingResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetMappingResult {
...
fun AWSGlueFunctions.getPartition(databaseName: String, tableName: String, partitionValues: List<String>, init: (AWSGlueGetPartitionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetPartitionResult {
	return this.block.declare(AWSGlueGetPartitionCommand(databaseName, tableName, partitionValues).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetPartitionResult
}
...
class AWSGlueGetPartitionCommand(val databaseName: String, val tableName: String, val partitionValues: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetPartitionRequest, com.amazonaws.services.glue.model.GetPartitionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetPartitionResult {
...
fun AWSGlueFunctions.getPartitions(databaseName: String, tableName: String, init: (AWSGlueGetPartitionsCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetPartitionsResult {
	return this.block.declare(AWSGlueGetPartitionsCommand(databaseName, tableName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetPartitionsResult
}
...
class AWSGlueGetPartitionsCommand(val databaseName: String, val tableName: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetPartitionsRequest, com.amazonaws.services.glue.model.GetPartitionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetPartitionsResult {
...
fun AWSGlueFunctions.getPlan(mapping: List<com.amazonaws.services.glue.model.MappingEntry>, source: com.amazonaws.services.glue.model.CatalogEntry, init: (AWSGlueGetPlanCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetPlanResult {
	return this.block.declare(AWSGlueGetPlanCommand(mapping, source).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetPlanResult
}
...
class AWSGlueGetPlanCommand(val mapping: List<com.amazonaws.services.glue.model.MappingEntry>, val source: com.amazonaws.services.glue.model.CatalogEntry) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetPlanRequest, com.amazonaws.services.glue.model.GetPlanResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetPlanResult {
...
fun AWSGlueFunctions.getTable(databaseName: String, name: String, init: (AWSGlueGetTableCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetTableResult {
	return this.block.declare(AWSGlueGetTableCommand(databaseName, name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetTableResult
}
...
class AWSGlueGetTableCommand(val databaseName: String, val name: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetTableRequest, com.amazonaws.services.glue.model.GetTableResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetTableResult {
...
fun AWSGlueFunctions.getTableVersion(databaseName: String, tableName: String, init: (AWSGlueGetTableVersionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetTableVersionResult {
	return this.block.declare(AWSGlueGetTableVersionCommand(databaseName, tableName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetTableVersionResult
}
...
class AWSGlueGetTableVersionCommand(val databaseName: String, val tableName: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetTableVersionRequest, com.amazonaws.services.glue.model.GetTableVersionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetTableVersionResult {
...
fun AWSGlueFunctions.getTableVersions(databaseName: String, tableName: String, init: (AWSGlueGetTableVersionsCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetTableVersionsResult {
	return this.block.declare(AWSGlueGetTableVersionsCommand(databaseName, tableName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetTableVersionsResult
}
...
class AWSGlueGetTableVersionsCommand(val databaseName: String, val tableName: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetTableVersionsRequest, com.amazonaws.services.glue.model.GetTableVersionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetTableVersionsResult {
...
fun AWSGlueFunctions.getTables(databaseName: String, init: (AWSGlueGetTablesCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetTablesResult {
	return this.block.declare(AWSGlueGetTablesCommand(databaseName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetTablesResult
}
...
class AWSGlueGetTablesCommand(val databaseName: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetTablesRequest, com.amazonaws.services.glue.model.GetTablesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetTablesResult {
...
fun AWSGlueFunctions.getTrigger(name: String, init: (AWSGlueGetTriggerCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetTriggerResult {
	return this.block.declare(AWSGlueGetTriggerCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetTriggerResult
}
...
class AWSGlueGetTriggerCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetTriggerRequest, com.amazonaws.services.glue.model.GetTriggerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetTriggerResult {
...
fun AWSGlueFunctions.getTriggers(init: (AWSGlueGetTriggersCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetTriggersResult {
	return this.block.declare(AWSGlueGetTriggersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetTriggersResult
}
...
class AWSGlueGetTriggersCommand() : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetTriggersRequest, com.amazonaws.services.glue.model.GetTriggersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetTriggersResult {
...
fun AWSGlueFunctions.getUserDefinedFunction(databaseName: String, functionName: String, init: (AWSGlueGetUserDefinedFunctionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetUserDefinedFunctionResult {
	return this.block.declare(AWSGlueGetUserDefinedFunctionCommand(databaseName, functionName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetUserDefinedFunctionResult
}
...
class AWSGlueGetUserDefinedFunctionCommand(val databaseName: String, val functionName: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetUserDefinedFunctionRequest, com.amazonaws.services.glue.model.GetUserDefinedFunctionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetUserDefinedFunctionResult {
...
fun AWSGlueFunctions.getUserDefinedFunctions(databaseName: String, pattern: String, init: (AWSGlueGetUserDefinedFunctionsCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.GetUserDefinedFunctionsResult {
	return this.block.declare(AWSGlueGetUserDefinedFunctionsCommand(databaseName, pattern).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.GetUserDefinedFunctionsResult
}
...
class AWSGlueGetUserDefinedFunctionsCommand(val databaseName: String, val pattern: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.GetUserDefinedFunctionsRequest, com.amazonaws.services.glue.model.GetUserDefinedFunctionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.GetUserDefinedFunctionsResult {
...
fun AWSGlueFunctions.importCatalogToGlue(init: (AWSGlueImportCatalogToGlueCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.ImportCatalogToGlueResult {
	return this.block.declare(AWSGlueImportCatalogToGlueCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.ImportCatalogToGlueResult
}
...
class AWSGlueImportCatalogToGlueCommand() : AmazonWebServiceCommand<com.amazonaws.services.glue.model.ImportCatalogToGlueRequest, com.amazonaws.services.glue.model.ImportCatalogToGlueResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.ImportCatalogToGlueResult {
...
fun AWSGlueFunctions.resetJobBookmark(jobName: String, init: (AWSGlueResetJobBookmarkCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.ResetJobBookmarkResult {
	return this.block.declare(AWSGlueResetJobBookmarkCommand(jobName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.ResetJobBookmarkResult
}
...
class AWSGlueResetJobBookmarkCommand(val jobName: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.ResetJobBookmarkRequest, com.amazonaws.services.glue.model.ResetJobBookmarkResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.ResetJobBookmarkResult {
...
fun AWSGlueFunctions.startCrawler(name: String, init: (AWSGlueStartCrawlerCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.StartCrawlerResult {
	return this.block.declare(AWSGlueStartCrawlerCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.StartCrawlerResult
}
...
class AWSGlueStartCrawlerCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.StartCrawlerRequest, com.amazonaws.services.glue.model.StartCrawlerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.StartCrawlerResult {
...
fun AWSGlueFunctions.startCrawlerSchedule(crawlerName: String, init: (AWSGlueStartCrawlerScheduleCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.StartCrawlerScheduleResult {
	return this.block.declare(AWSGlueStartCrawlerScheduleCommand(crawlerName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.StartCrawlerScheduleResult
}
...
class AWSGlueStartCrawlerScheduleCommand(val crawlerName: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.StartCrawlerScheduleRequest, com.amazonaws.services.glue.model.StartCrawlerScheduleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.StartCrawlerScheduleResult {
...
fun AWSGlueFunctions.startJobRun(jobName: String, init: (AWSGlueStartJobRunCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.StartJobRunResult {
	return this.block.declare(AWSGlueStartJobRunCommand(jobName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.StartJobRunResult
}
...
class AWSGlueStartJobRunCommand(val jobName: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.StartJobRunRequest, com.amazonaws.services.glue.model.StartJobRunResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.StartJobRunResult {
...
fun AWSGlueFunctions.startTrigger(name: String, init: (AWSGlueStartTriggerCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.StartTriggerResult {
	return this.block.declare(AWSGlueStartTriggerCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.StartTriggerResult
}
...
class AWSGlueStartTriggerCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.StartTriggerRequest, com.amazonaws.services.glue.model.StartTriggerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.StartTriggerResult {
...
fun AWSGlueFunctions.stopCrawler(name: String, init: (AWSGlueStopCrawlerCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.StopCrawlerResult {
	return this.block.declare(AWSGlueStopCrawlerCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.StopCrawlerResult
}
...
class AWSGlueStopCrawlerCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.StopCrawlerRequest, com.amazonaws.services.glue.model.StopCrawlerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.StopCrawlerResult {
...
fun AWSGlueFunctions.stopCrawlerSchedule(crawlerName: String, init: (AWSGlueStopCrawlerScheduleCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.StopCrawlerScheduleResult {
	return this.block.declare(AWSGlueStopCrawlerScheduleCommand(crawlerName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.StopCrawlerScheduleResult
}
...
class AWSGlueStopCrawlerScheduleCommand(val crawlerName: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.StopCrawlerScheduleRequest, com.amazonaws.services.glue.model.StopCrawlerScheduleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.StopCrawlerScheduleResult {
...
fun AWSGlueFunctions.stopTrigger(name: String, init: (AWSGlueStopTriggerCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.StopTriggerResult {
	return this.block.declare(AWSGlueStopTriggerCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.StopTriggerResult
}
...
class AWSGlueStopTriggerCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.StopTriggerRequest, com.amazonaws.services.glue.model.StopTriggerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.StopTriggerResult {
...
fun AWSGlueFunctions.updateClassifier(init: (AWSGlueUpdateClassifierCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.UpdateClassifierResult {
	return this.block.declare(AWSGlueUpdateClassifierCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.UpdateClassifierResult
}
...
class AWSGlueUpdateClassifierCommand() : AmazonWebServiceCommand<com.amazonaws.services.glue.model.UpdateClassifierRequest, com.amazonaws.services.glue.model.UpdateClassifierResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.UpdateClassifierResult {
...
fun AWSGlueFunctions.updateConnection(name: String, connectionInput: com.amazonaws.services.glue.model.ConnectionInput, init: (AWSGlueUpdateConnectionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.UpdateConnectionResult {
	return this.block.declare(AWSGlueUpdateConnectionCommand(name, connectionInput).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.UpdateConnectionResult
}
...
class AWSGlueUpdateConnectionCommand(val name: String, val connectionInput: com.amazonaws.services.glue.model.ConnectionInput) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.UpdateConnectionRequest, com.amazonaws.services.glue.model.UpdateConnectionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.UpdateConnectionResult {
...
fun AWSGlueFunctions.updateCrawler(name: String, init: (AWSGlueUpdateCrawlerCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.UpdateCrawlerResult {
	return this.block.declare(AWSGlueUpdateCrawlerCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.UpdateCrawlerResult
}
...
class AWSGlueUpdateCrawlerCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.UpdateCrawlerRequest, com.amazonaws.services.glue.model.UpdateCrawlerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.UpdateCrawlerResult {
...
fun AWSGlueFunctions.updateCrawlerSchedule(crawlerName: String, init: (AWSGlueUpdateCrawlerScheduleCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.UpdateCrawlerScheduleResult {
	return this.block.declare(AWSGlueUpdateCrawlerScheduleCommand(crawlerName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.UpdateCrawlerScheduleResult
}
...
class AWSGlueUpdateCrawlerScheduleCommand(val crawlerName: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.UpdateCrawlerScheduleRequest, com.amazonaws.services.glue.model.UpdateCrawlerScheduleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.UpdateCrawlerScheduleResult {
...
fun AWSGlueFunctions.updateDatabase(name: String, databaseInput: com.amazonaws.services.glue.model.DatabaseInput, init: (AWSGlueUpdateDatabaseCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.UpdateDatabaseResult {
	return this.block.declare(AWSGlueUpdateDatabaseCommand(name, databaseInput).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.UpdateDatabaseResult
}
...
class AWSGlueUpdateDatabaseCommand(val name: String, val databaseInput: com.amazonaws.services.glue.model.DatabaseInput) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.UpdateDatabaseRequest, com.amazonaws.services.glue.model.UpdateDatabaseResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.UpdateDatabaseResult {
...
fun AWSGlueFunctions.updateDevEndpoint(endpointName: String, init: (AWSGlueUpdateDevEndpointCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.UpdateDevEndpointResult {
	return this.block.declare(AWSGlueUpdateDevEndpointCommand(endpointName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.UpdateDevEndpointResult
}
...
class AWSGlueUpdateDevEndpointCommand(val endpointName: String) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.UpdateDevEndpointRequest, com.amazonaws.services.glue.model.UpdateDevEndpointResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.UpdateDevEndpointResult {
...
fun AWSGlueFunctions.updateJob(jobName: String, jobUpdate: com.amazonaws.services.glue.model.JobUpdate, init: (AWSGlueUpdateJobCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.UpdateJobResult {
	return this.block.declare(AWSGlueUpdateJobCommand(jobName, jobUpdate).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.UpdateJobResult
}
...
class AWSGlueUpdateJobCommand(val jobName: String, val jobUpdate: com.amazonaws.services.glue.model.JobUpdate) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.UpdateJobRequest, com.amazonaws.services.glue.model.UpdateJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.UpdateJobResult {
...
fun AWSGlueFunctions.updatePartition(databaseName: String, tableName: String, partitionValueList: List<String>, partitionInput: com.amazonaws.services.glue.model.PartitionInput, init: (AWSGlueUpdatePartitionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.UpdatePartitionResult {
	return this.block.declare(AWSGlueUpdatePartitionCommand(databaseName, tableName, partitionValueList, partitionInput).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.UpdatePartitionResult
}
...
class AWSGlueUpdatePartitionCommand(val databaseName: String, val tableName: String, val partitionValueList: List<String>, val partitionInput: com.amazonaws.services.glue.model.PartitionInput) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.UpdatePartitionRequest, com.amazonaws.services.glue.model.UpdatePartitionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.UpdatePartitionResult {
...
fun AWSGlueFunctions.updateTable(databaseName: String, tableInput: com.amazonaws.services.glue.model.TableInput, init: (AWSGlueUpdateTableCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.UpdateTableResult {
	return this.block.declare(AWSGlueUpdateTableCommand(databaseName, tableInput).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.UpdateTableResult
}
...
class AWSGlueUpdateTableCommand(val databaseName: String, val tableInput: com.amazonaws.services.glue.model.TableInput) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.UpdateTableRequest, com.amazonaws.services.glue.model.UpdateTableResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.UpdateTableResult {
...
fun AWSGlueFunctions.updateTrigger(name: String, triggerUpdate: com.amazonaws.services.glue.model.TriggerUpdate, init: (AWSGlueUpdateTriggerCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.UpdateTriggerResult {
	return this.block.declare(AWSGlueUpdateTriggerCommand(name, triggerUpdate).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.UpdateTriggerResult
}
...
class AWSGlueUpdateTriggerCommand(val name: String, val triggerUpdate: com.amazonaws.services.glue.model.TriggerUpdate) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.UpdateTriggerRequest, com.amazonaws.services.glue.model.UpdateTriggerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.UpdateTriggerResult {
...
fun AWSGlueFunctions.updateUserDefinedFunction(databaseName: String, functionName: String, functionInput: com.amazonaws.services.glue.model.UserDefinedFunctionInput, init: (AWSGlueUpdateUserDefinedFunctionCommand.() -> Unit)? = null): com.amazonaws.services.glue.model.UpdateUserDefinedFunctionResult {
	return this.block.declare(AWSGlueUpdateUserDefinedFunctionCommand(databaseName, functionName, functionInput).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.glue.model.UpdateUserDefinedFunctionResult
}
...
class AWSGlueUpdateUserDefinedFunctionCommand(val databaseName: String, val functionName: String, val functionInput: com.amazonaws.services.glue.model.UserDefinedFunctionInput) : AmazonWebServiceCommand<com.amazonaws.services.glue.model.UpdateUserDefinedFunctionRequest, com.amazonaws.services.glue.model.UpdateUserDefinedFunctionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.glue.model.UpdateUserDefinedFunctionResult {
