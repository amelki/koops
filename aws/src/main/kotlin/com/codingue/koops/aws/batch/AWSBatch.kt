...
package com.codingue.koops.aws.batch
...
var com.codingue.koops.core.Environment.batch: AWSBatch
	get() {
		var service = this.capabilities["aws-batch"]
		if (service == null) {
			service = AWSBatchClientBuilder.standard().build()
			this.capabilities["aws-batch"] = service
		}
		return service as AWSBatch
	}
	set(batch) {
		this.capabilities["aws-batch"] = batch
	}
...
fun AWSBatchFunctions.cancelJob(init: (AWSBatchCancelJobCommand.() -> Unit)? = null): com.amazonaws.services.batch.model.CancelJobResult {
	return this.block.declare(AWSBatchCancelJobCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.batch.model.CancelJobResult
}
...
class AWSBatchCancelJobCommand() : AmazonWebServiceCommand<com.amazonaws.services.batch.model.CancelJobRequest, com.amazonaws.services.batch.model.CancelJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.batch.model.CancelJobResult {
...
fun AWSBatchFunctions.createComputeEnvironment(init: (AWSBatchCreateComputeEnvironmentCommand.() -> Unit)? = null): com.amazonaws.services.batch.model.CreateComputeEnvironmentResult {
	return this.block.declare(AWSBatchCreateComputeEnvironmentCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.batch.model.CreateComputeEnvironmentResult
}
...
class AWSBatchCreateComputeEnvironmentCommand() : AmazonWebServiceCommand<com.amazonaws.services.batch.model.CreateComputeEnvironmentRequest, com.amazonaws.services.batch.model.CreateComputeEnvironmentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.batch.model.CreateComputeEnvironmentResult {
...
fun AWSBatchFunctions.createJobQueue(init: (AWSBatchCreateJobQueueCommand.() -> Unit)? = null): com.amazonaws.services.batch.model.CreateJobQueueResult {
	return this.block.declare(AWSBatchCreateJobQueueCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.batch.model.CreateJobQueueResult
}
...
class AWSBatchCreateJobQueueCommand() : AmazonWebServiceCommand<com.amazonaws.services.batch.model.CreateJobQueueRequest, com.amazonaws.services.batch.model.CreateJobQueueResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.batch.model.CreateJobQueueResult {
...
fun AWSBatchFunctions.deleteComputeEnvironment(init: (AWSBatchDeleteComputeEnvironmentCommand.() -> Unit)? = null): com.amazonaws.services.batch.model.DeleteComputeEnvironmentResult {
	return this.block.declare(AWSBatchDeleteComputeEnvironmentCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.batch.model.DeleteComputeEnvironmentResult
}
...
class AWSBatchDeleteComputeEnvironmentCommand() : AmazonWebServiceCommand<com.amazonaws.services.batch.model.DeleteComputeEnvironmentRequest, com.amazonaws.services.batch.model.DeleteComputeEnvironmentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.batch.model.DeleteComputeEnvironmentResult {
...
fun AWSBatchFunctions.deleteJobQueue(init: (AWSBatchDeleteJobQueueCommand.() -> Unit)? = null): com.amazonaws.services.batch.model.DeleteJobQueueResult {
	return this.block.declare(AWSBatchDeleteJobQueueCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.batch.model.DeleteJobQueueResult
}
...
class AWSBatchDeleteJobQueueCommand() : AmazonWebServiceCommand<com.amazonaws.services.batch.model.DeleteJobQueueRequest, com.amazonaws.services.batch.model.DeleteJobQueueResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.batch.model.DeleteJobQueueResult {
...
fun AWSBatchFunctions.deregisterJobDefinition(init: (AWSBatchDeregisterJobDefinitionCommand.() -> Unit)? = null): com.amazonaws.services.batch.model.DeregisterJobDefinitionResult {
	return this.block.declare(AWSBatchDeregisterJobDefinitionCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.batch.model.DeregisterJobDefinitionResult
}
...
class AWSBatchDeregisterJobDefinitionCommand() : AmazonWebServiceCommand<com.amazonaws.services.batch.model.DeregisterJobDefinitionRequest, com.amazonaws.services.batch.model.DeregisterJobDefinitionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.batch.model.DeregisterJobDefinitionResult {
...
fun AWSBatchFunctions.describeComputeEnvironments(init: (AWSBatchDescribeComputeEnvironmentsCommand.() -> Unit)? = null): com.amazonaws.services.batch.model.DescribeComputeEnvironmentsResult {
	return this.block.declare(AWSBatchDescribeComputeEnvironmentsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.batch.model.DescribeComputeEnvironmentsResult
}
...
class AWSBatchDescribeComputeEnvironmentsCommand() : AmazonWebServiceCommand<com.amazonaws.services.batch.model.DescribeComputeEnvironmentsRequest, com.amazonaws.services.batch.model.DescribeComputeEnvironmentsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.batch.model.DescribeComputeEnvironmentsResult {
...
fun AWSBatchFunctions.describeJobDefinitions(init: (AWSBatchDescribeJobDefinitionsCommand.() -> Unit)? = null): com.amazonaws.services.batch.model.DescribeJobDefinitionsResult {
	return this.block.declare(AWSBatchDescribeJobDefinitionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.batch.model.DescribeJobDefinitionsResult
}
...
class AWSBatchDescribeJobDefinitionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.batch.model.DescribeJobDefinitionsRequest, com.amazonaws.services.batch.model.DescribeJobDefinitionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.batch.model.DescribeJobDefinitionsResult {
...
fun AWSBatchFunctions.describeJobQueues(init: (AWSBatchDescribeJobQueuesCommand.() -> Unit)? = null): com.amazonaws.services.batch.model.DescribeJobQueuesResult {
	return this.block.declare(AWSBatchDescribeJobQueuesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.batch.model.DescribeJobQueuesResult
}
...
class AWSBatchDescribeJobQueuesCommand() : AmazonWebServiceCommand<com.amazonaws.services.batch.model.DescribeJobQueuesRequest, com.amazonaws.services.batch.model.DescribeJobQueuesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.batch.model.DescribeJobQueuesResult {
...
fun AWSBatchFunctions.describeJobs(init: (AWSBatchDescribeJobsCommand.() -> Unit)? = null): com.amazonaws.services.batch.model.DescribeJobsResult {
	return this.block.declare(AWSBatchDescribeJobsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.batch.model.DescribeJobsResult
}
...
class AWSBatchDescribeJobsCommand() : AmazonWebServiceCommand<com.amazonaws.services.batch.model.DescribeJobsRequest, com.amazonaws.services.batch.model.DescribeJobsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.batch.model.DescribeJobsResult {
...
fun AWSBatchFunctions.listJobs(init: (AWSBatchListJobsCommand.() -> Unit)? = null): com.amazonaws.services.batch.model.ListJobsResult {
	return this.block.declare(AWSBatchListJobsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.batch.model.ListJobsResult
}
...
class AWSBatchListJobsCommand() : AmazonWebServiceCommand<com.amazonaws.services.batch.model.ListJobsRequest, com.amazonaws.services.batch.model.ListJobsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.batch.model.ListJobsResult {
...
fun AWSBatchFunctions.registerJobDefinition(init: (AWSBatchRegisterJobDefinitionCommand.() -> Unit)? = null): com.amazonaws.services.batch.model.RegisterJobDefinitionResult {
	return this.block.declare(AWSBatchRegisterJobDefinitionCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.batch.model.RegisterJobDefinitionResult
}
...
class AWSBatchRegisterJobDefinitionCommand() : AmazonWebServiceCommand<com.amazonaws.services.batch.model.RegisterJobDefinitionRequest, com.amazonaws.services.batch.model.RegisterJobDefinitionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.batch.model.RegisterJobDefinitionResult {
...
fun AWSBatchFunctions.submitJob(init: (AWSBatchSubmitJobCommand.() -> Unit)? = null): com.amazonaws.services.batch.model.SubmitJobResult {
	return this.block.declare(AWSBatchSubmitJobCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.batch.model.SubmitJobResult
}
...
class AWSBatchSubmitJobCommand() : AmazonWebServiceCommand<com.amazonaws.services.batch.model.SubmitJobRequest, com.amazonaws.services.batch.model.SubmitJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.batch.model.SubmitJobResult {
...
fun AWSBatchFunctions.terminateJob(init: (AWSBatchTerminateJobCommand.() -> Unit)? = null): com.amazonaws.services.batch.model.TerminateJobResult {
	return this.block.declare(AWSBatchTerminateJobCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.batch.model.TerminateJobResult
}
...
class AWSBatchTerminateJobCommand() : AmazonWebServiceCommand<com.amazonaws.services.batch.model.TerminateJobRequest, com.amazonaws.services.batch.model.TerminateJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.batch.model.TerminateJobResult {
...
fun AWSBatchFunctions.updateComputeEnvironment(init: (AWSBatchUpdateComputeEnvironmentCommand.() -> Unit)? = null): com.amazonaws.services.batch.model.UpdateComputeEnvironmentResult {
	return this.block.declare(AWSBatchUpdateComputeEnvironmentCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.batch.model.UpdateComputeEnvironmentResult
}
...
class AWSBatchUpdateComputeEnvironmentCommand() : AmazonWebServiceCommand<com.amazonaws.services.batch.model.UpdateComputeEnvironmentRequest, com.amazonaws.services.batch.model.UpdateComputeEnvironmentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.batch.model.UpdateComputeEnvironmentResult {
...
fun AWSBatchFunctions.updateJobQueue(init: (AWSBatchUpdateJobQueueCommand.() -> Unit)? = null): com.amazonaws.services.batch.model.UpdateJobQueueResult {
	return this.block.declare(AWSBatchUpdateJobQueueCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.batch.model.UpdateJobQueueResult
}
...
class AWSBatchUpdateJobQueueCommand() : AmazonWebServiceCommand<com.amazonaws.services.batch.model.UpdateJobQueueRequest, com.amazonaws.services.batch.model.UpdateJobQueueResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.batch.model.UpdateJobQueueResult {
