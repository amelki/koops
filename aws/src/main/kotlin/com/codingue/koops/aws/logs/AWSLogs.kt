...
package com.codingue.koops.aws.logs
...
var com.codingue.koops.core.Environment.logs: AWSLogs
	get() {
...
fun AWSLogsFunctions.associateKmsKey(init: (AWSLogsAssociateKmsKeyCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.AssociateKmsKeyResult {
	return this.block.declare(AWSLogsAssociateKmsKeyCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.AssociateKmsKeyResult
}
...
class AWSLogsAssociateKmsKeyCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.AssociateKmsKeyRequest, com.amazonaws.services.logs.model.AssociateKmsKeyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.AssociateKmsKeyResult {
...
fun AWSLogsFunctions.cancelExportTask(init: (AWSLogsCancelExportTaskCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.CancelExportTaskResult {
	return this.block.declare(AWSLogsCancelExportTaskCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.CancelExportTaskResult
}
...
class AWSLogsCancelExportTaskCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.CancelExportTaskRequest, com.amazonaws.services.logs.model.CancelExportTaskResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.CancelExportTaskResult {
...
fun AWSLogsFunctions.createExportTask(init: (AWSLogsCreateExportTaskCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.CreateExportTaskResult {
	return this.block.declare(AWSLogsCreateExportTaskCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.CreateExportTaskResult
}
...
class AWSLogsCreateExportTaskCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.CreateExportTaskRequest, com.amazonaws.services.logs.model.CreateExportTaskResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.CreateExportTaskResult {
...
fun AWSLogsFunctions.createLogGroup(init: (AWSLogsCreateLogGroupCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.CreateLogGroupResult {
	return this.block.declare(AWSLogsCreateLogGroupCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.CreateLogGroupResult
}
...
class AWSLogsCreateLogGroupCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.CreateLogGroupRequest, com.amazonaws.services.logs.model.CreateLogGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.CreateLogGroupResult {
...
fun AWSLogsFunctions.createLogStream(init: (AWSLogsCreateLogStreamCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.CreateLogStreamResult {
	return this.block.declare(AWSLogsCreateLogStreamCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.CreateLogStreamResult
}
...
class AWSLogsCreateLogStreamCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.CreateLogStreamRequest, com.amazonaws.services.logs.model.CreateLogStreamResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.CreateLogStreamResult {
...
fun AWSLogsFunctions.deleteDestination(init: (AWSLogsDeleteDestinationCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.DeleteDestinationResult {
	return this.block.declare(AWSLogsDeleteDestinationCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.DeleteDestinationResult
}
...
class AWSLogsDeleteDestinationCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.DeleteDestinationRequest, com.amazonaws.services.logs.model.DeleteDestinationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.DeleteDestinationResult {
...
fun AWSLogsFunctions.deleteLogGroup(init: (AWSLogsDeleteLogGroupCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.DeleteLogGroupResult {
	return this.block.declare(AWSLogsDeleteLogGroupCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.DeleteLogGroupResult
}
...
class AWSLogsDeleteLogGroupCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.DeleteLogGroupRequest, com.amazonaws.services.logs.model.DeleteLogGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.DeleteLogGroupResult {
...
fun AWSLogsFunctions.deleteLogStream(init: (AWSLogsDeleteLogStreamCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.DeleteLogStreamResult {
	return this.block.declare(AWSLogsDeleteLogStreamCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.DeleteLogStreamResult
}
...
class AWSLogsDeleteLogStreamCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.DeleteLogStreamRequest, com.amazonaws.services.logs.model.DeleteLogStreamResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.DeleteLogStreamResult {
...
fun AWSLogsFunctions.deleteMetricFilter(init: (AWSLogsDeleteMetricFilterCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.DeleteMetricFilterResult {
	return this.block.declare(AWSLogsDeleteMetricFilterCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.DeleteMetricFilterResult
}
...
class AWSLogsDeleteMetricFilterCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.DeleteMetricFilterRequest, com.amazonaws.services.logs.model.DeleteMetricFilterResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.DeleteMetricFilterResult {
...
fun AWSLogsFunctions.deleteResourcePolicy(init: (AWSLogsDeleteResourcePolicyCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.DeleteResourcePolicyResult {
	return this.block.declare(AWSLogsDeleteResourcePolicyCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.DeleteResourcePolicyResult
}
...
class AWSLogsDeleteResourcePolicyCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.DeleteResourcePolicyRequest, com.amazonaws.services.logs.model.DeleteResourcePolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.DeleteResourcePolicyResult {
...
fun AWSLogsFunctions.deleteRetentionPolicy(init: (AWSLogsDeleteRetentionPolicyCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.DeleteRetentionPolicyResult {
	return this.block.declare(AWSLogsDeleteRetentionPolicyCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.DeleteRetentionPolicyResult
}
...
class AWSLogsDeleteRetentionPolicyCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.DeleteRetentionPolicyRequest, com.amazonaws.services.logs.model.DeleteRetentionPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.DeleteRetentionPolicyResult {
...
fun AWSLogsFunctions.deleteSubscriptionFilter(init: (AWSLogsDeleteSubscriptionFilterCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.DeleteSubscriptionFilterResult {
	return this.block.declare(AWSLogsDeleteSubscriptionFilterCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.DeleteSubscriptionFilterResult
}
...
class AWSLogsDeleteSubscriptionFilterCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.DeleteSubscriptionFilterRequest, com.amazonaws.services.logs.model.DeleteSubscriptionFilterResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.DeleteSubscriptionFilterResult {
...
fun AWSLogsFunctions.describeDestinations(init: (AWSLogsDescribeDestinationsCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.DescribeDestinationsResult {
	return this.block.declare(AWSLogsDescribeDestinationsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.DescribeDestinationsResult
}
...
class AWSLogsDescribeDestinationsCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.DescribeDestinationsRequest, com.amazonaws.services.logs.model.DescribeDestinationsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.DescribeDestinationsResult {
...
fun AWSLogsFunctions.describeExportTasks(init: (AWSLogsDescribeExportTasksCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.DescribeExportTasksResult {
	return this.block.declare(AWSLogsDescribeExportTasksCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.DescribeExportTasksResult
}
...
class AWSLogsDescribeExportTasksCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.DescribeExportTasksRequest, com.amazonaws.services.logs.model.DescribeExportTasksResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.DescribeExportTasksResult {
...
fun AWSLogsFunctions.describeLogGroups(init: (AWSLogsDescribeLogGroupsCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.DescribeLogGroupsResult {
	return this.block.declare(AWSLogsDescribeLogGroupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.DescribeLogGroupsResult
}
...
class AWSLogsDescribeLogGroupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.DescribeLogGroupsRequest, com.amazonaws.services.logs.model.DescribeLogGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.DescribeLogGroupsResult {
...
fun AWSLogsFunctions.describeLogStreams(init: (AWSLogsDescribeLogStreamsCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.DescribeLogStreamsResult {
	return this.block.declare(AWSLogsDescribeLogStreamsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.DescribeLogStreamsResult
}
...
class AWSLogsDescribeLogStreamsCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.DescribeLogStreamsRequest, com.amazonaws.services.logs.model.DescribeLogStreamsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.DescribeLogStreamsResult {
...
fun AWSLogsFunctions.describeMetricFilters(init: (AWSLogsDescribeMetricFiltersCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.DescribeMetricFiltersResult {
	return this.block.declare(AWSLogsDescribeMetricFiltersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.DescribeMetricFiltersResult
}
...
class AWSLogsDescribeMetricFiltersCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.DescribeMetricFiltersRequest, com.amazonaws.services.logs.model.DescribeMetricFiltersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.DescribeMetricFiltersResult {
...
fun AWSLogsFunctions.describeResourcePolicies(init: (AWSLogsDescribeResourcePoliciesCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.DescribeResourcePoliciesResult {
	return this.block.declare(AWSLogsDescribeResourcePoliciesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.DescribeResourcePoliciesResult
}
...
class AWSLogsDescribeResourcePoliciesCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.DescribeResourcePoliciesRequest, com.amazonaws.services.logs.model.DescribeResourcePoliciesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.DescribeResourcePoliciesResult {
...
fun AWSLogsFunctions.describeSubscriptionFilters(init: (AWSLogsDescribeSubscriptionFiltersCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.DescribeSubscriptionFiltersResult {
	return this.block.declare(AWSLogsDescribeSubscriptionFiltersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.DescribeSubscriptionFiltersResult
}
...
class AWSLogsDescribeSubscriptionFiltersCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.DescribeSubscriptionFiltersRequest, com.amazonaws.services.logs.model.DescribeSubscriptionFiltersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.DescribeSubscriptionFiltersResult {
...
fun AWSLogsFunctions.disassociateKmsKey(init: (AWSLogsDisassociateKmsKeyCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.DisassociateKmsKeyResult {
	return this.block.declare(AWSLogsDisassociateKmsKeyCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.DisassociateKmsKeyResult
}
...
class AWSLogsDisassociateKmsKeyCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.DisassociateKmsKeyRequest, com.amazonaws.services.logs.model.DisassociateKmsKeyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.DisassociateKmsKeyResult {
...
fun AWSLogsFunctions.filterLogEvents(init: (AWSLogsFilterLogEventsCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.FilterLogEventsResult {
	return this.block.declare(AWSLogsFilterLogEventsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.FilterLogEventsResult
}
...
class AWSLogsFilterLogEventsCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.FilterLogEventsRequest, com.amazonaws.services.logs.model.FilterLogEventsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.FilterLogEventsResult {
...
fun AWSLogsFunctions.getLogEvents(init: (AWSLogsGetLogEventsCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.GetLogEventsResult {
	return this.block.declare(AWSLogsGetLogEventsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.GetLogEventsResult
}
...
class AWSLogsGetLogEventsCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.GetLogEventsRequest, com.amazonaws.services.logs.model.GetLogEventsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.GetLogEventsResult {
...
fun AWSLogsFunctions.listTagsLogGroup(init: (AWSLogsListTagsLogGroupCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.ListTagsLogGroupResult {
	return this.block.declare(AWSLogsListTagsLogGroupCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.ListTagsLogGroupResult
}
...
class AWSLogsListTagsLogGroupCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.ListTagsLogGroupRequest, com.amazonaws.services.logs.model.ListTagsLogGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.ListTagsLogGroupResult {
...
fun AWSLogsFunctions.putDestination(init: (AWSLogsPutDestinationCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.PutDestinationResult {
	return this.block.declare(AWSLogsPutDestinationCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.PutDestinationResult
}
...
class AWSLogsPutDestinationCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.PutDestinationRequest, com.amazonaws.services.logs.model.PutDestinationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.PutDestinationResult {
...
fun AWSLogsFunctions.putDestinationPolicy(init: (AWSLogsPutDestinationPolicyCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.PutDestinationPolicyResult {
	return this.block.declare(AWSLogsPutDestinationPolicyCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.PutDestinationPolicyResult
}
...
class AWSLogsPutDestinationPolicyCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.PutDestinationPolicyRequest, com.amazonaws.services.logs.model.PutDestinationPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.PutDestinationPolicyResult {
...
fun AWSLogsFunctions.putLogEvents(init: (AWSLogsPutLogEventsCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.PutLogEventsResult {
	return this.block.declare(AWSLogsPutLogEventsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.PutLogEventsResult
}
...
class AWSLogsPutLogEventsCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.PutLogEventsRequest, com.amazonaws.services.logs.model.PutLogEventsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.PutLogEventsResult {
...
fun AWSLogsFunctions.putMetricFilter(init: (AWSLogsPutMetricFilterCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.PutMetricFilterResult {
	return this.block.declare(AWSLogsPutMetricFilterCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.PutMetricFilterResult
}
...
class AWSLogsPutMetricFilterCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.PutMetricFilterRequest, com.amazonaws.services.logs.model.PutMetricFilterResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.PutMetricFilterResult {
...
fun AWSLogsFunctions.putResourcePolicy(init: (AWSLogsPutResourcePolicyCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.PutResourcePolicyResult {
	return this.block.declare(AWSLogsPutResourcePolicyCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.PutResourcePolicyResult
}
...
class AWSLogsPutResourcePolicyCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.PutResourcePolicyRequest, com.amazonaws.services.logs.model.PutResourcePolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.PutResourcePolicyResult {
...
fun AWSLogsFunctions.putRetentionPolicy(init: (AWSLogsPutRetentionPolicyCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.PutRetentionPolicyResult {
	return this.block.declare(AWSLogsPutRetentionPolicyCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.PutRetentionPolicyResult
}
...
class AWSLogsPutRetentionPolicyCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.PutRetentionPolicyRequest, com.amazonaws.services.logs.model.PutRetentionPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.PutRetentionPolicyResult {
...
fun AWSLogsFunctions.putSubscriptionFilter(init: (AWSLogsPutSubscriptionFilterCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.PutSubscriptionFilterResult {
	return this.block.declare(AWSLogsPutSubscriptionFilterCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.PutSubscriptionFilterResult
}
...
class AWSLogsPutSubscriptionFilterCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.PutSubscriptionFilterRequest, com.amazonaws.services.logs.model.PutSubscriptionFilterResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.PutSubscriptionFilterResult {
...
fun AWSLogsFunctions.tagLogGroup(init: (AWSLogsTagLogGroupCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.TagLogGroupResult {
	return this.block.declare(AWSLogsTagLogGroupCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.TagLogGroupResult
}
...
class AWSLogsTagLogGroupCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.TagLogGroupRequest, com.amazonaws.services.logs.model.TagLogGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.TagLogGroupResult {
...
fun AWSLogsFunctions.testMetricFilter(init: (AWSLogsTestMetricFilterCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.TestMetricFilterResult {
	return this.block.declare(AWSLogsTestMetricFilterCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.TestMetricFilterResult
}
...
class AWSLogsTestMetricFilterCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.TestMetricFilterRequest, com.amazonaws.services.logs.model.TestMetricFilterResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.TestMetricFilterResult {
...
fun AWSLogsFunctions.untagLogGroup(init: (AWSLogsUntagLogGroupCommand.() -> Unit)? = null): com.amazonaws.services.logs.model.UntagLogGroupResult {
	return this.block.declare(AWSLogsUntagLogGroupCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.logs.model.UntagLogGroupResult
}
...
class AWSLogsUntagLogGroupCommand() : AmazonWebServiceCommand<com.amazonaws.services.logs.model.UntagLogGroupRequest, com.amazonaws.services.logs.model.UntagLogGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.logs.model.UntagLogGroupResult {
