...
package com.codingue.koops.aws.snowball

import javax.annotation.Generated
import com.codingue.koops.common.*
import com.codingue.koops.core.*
import com.codingue.koops.aws.*
import com.amazonaws.services.snowball.*
import com.amazonaws.services.snowball.model.*

var com.codingue.koops.core.Environment.snowball: AmazonSnowball
	get() {
		var service = this.capabilities["aws-snowball"]
		if (service == null) {
			service = AmazonSnowballClientBuilder.standard().build()
			this.capabilities["aws-snowball"] = service
		}
		return service as AmazonSnowball
	}
	set(snowball) {
		this.capabilities["aws-snowball"] = snowball
	}
...
fun AmazonSnowballFunctions.cancelCluster(clusterId: String, init: (AmazonSnowballCancelClusterCommand.() -> Unit)? = null): com.amazonaws.services.snowball.model.CancelClusterResult {
	return this.block.declare(AmazonSnowballCancelClusterCommand(clusterId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.snowball.model.CancelClusterResult
}
...
class AmazonSnowballCancelClusterCommand(val clusterId: String) : AmazonWebServiceCommand<com.amazonaws.services.snowball.model.CancelClusterRequest, com.amazonaws.services.snowball.model.CancelClusterResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.snowball.model.CancelClusterResult {
...
fun AmazonSnowballFunctions.cancelJob(jobId: String, init: (AmazonSnowballCancelJobCommand.() -> Unit)? = null): com.amazonaws.services.snowball.model.CancelJobResult {
	return this.block.declare(AmazonSnowballCancelJobCommand(jobId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.snowball.model.CancelJobResult
}
...
class AmazonSnowballCancelJobCommand(val jobId: String) : AmazonWebServiceCommand<com.amazonaws.services.snowball.model.CancelJobRequest, com.amazonaws.services.snowball.model.CancelJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.snowball.model.CancelJobResult {
...
fun AmazonSnowballFunctions.createAddress(address: com.amazonaws.services.snowball.model.Address, init: (AmazonSnowballCreateAddressCommand.() -> Unit)? = null): com.amazonaws.services.snowball.model.CreateAddressResult {
	return this.block.declare(AmazonSnowballCreateAddressCommand(address).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.snowball.model.CreateAddressResult
}
...
class AmazonSnowballCreateAddressCommand(val address: com.amazonaws.services.snowball.model.Address) : AmazonWebServiceCommand<com.amazonaws.services.snowball.model.CreateAddressRequest, com.amazonaws.services.snowball.model.CreateAddressResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.snowball.model.CreateAddressResult {
...
fun AmazonSnowballFunctions.createCluster(jobType: JobType, resources: com.amazonaws.services.snowball.model.JobResource, addressId: String, roleARN: String, shippingOption: ShippingOption, init: (AmazonSnowballCreateClusterCommand.() -> Unit)? = null): com.amazonaws.services.snowball.model.CreateClusterResult {
	return this.block.declare(AmazonSnowballCreateClusterCommand(jobType, resources, addressId, roleARN, shippingOption).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.snowball.model.CreateClusterResult
}
...
class AmazonSnowballCreateClusterCommand(val jobType: JobType, val resources: com.amazonaws.services.snowball.model.JobResource, val addressId: String, val roleARN: String, val shippingOption: ShippingOption) : AmazonWebServiceCommand<com.amazonaws.services.snowball.model.CreateClusterRequest, com.amazonaws.services.snowball.model.CreateClusterResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.snowball.model.CreateClusterResult {
...
fun AmazonSnowballFunctions.createJob(init: (AmazonSnowballCreateJobCommand.() -> Unit)? = null): com.amazonaws.services.snowball.model.CreateJobResult {
	return this.block.declare(AmazonSnowballCreateJobCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.snowball.model.CreateJobResult
}
...
class AmazonSnowballCreateJobCommand() : AmazonWebServiceCommand<com.amazonaws.services.snowball.model.CreateJobRequest, com.amazonaws.services.snowball.model.CreateJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.snowball.model.CreateJobResult {
...
fun AmazonSnowballFunctions.describeAddress(addressId: String, init: (AmazonSnowballDescribeAddressCommand.() -> Unit)? = null): com.amazonaws.services.snowball.model.DescribeAddressResult {
	return this.block.declare(AmazonSnowballDescribeAddressCommand(addressId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.snowball.model.DescribeAddressResult
}
...
class AmazonSnowballDescribeAddressCommand(val addressId: String) : AmazonWebServiceCommand<com.amazonaws.services.snowball.model.DescribeAddressRequest, com.amazonaws.services.snowball.model.DescribeAddressResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.snowball.model.DescribeAddressResult {
...
fun AmazonSnowballFunctions.describeAddresses(init: (AmazonSnowballDescribeAddressesCommand.() -> Unit)? = null): com.amazonaws.services.snowball.model.DescribeAddressesResult {
	return this.block.declare(AmazonSnowballDescribeAddressesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.snowball.model.DescribeAddressesResult
}
...
class AmazonSnowballDescribeAddressesCommand() : AmazonWebServiceCommand<com.amazonaws.services.snowball.model.DescribeAddressesRequest, com.amazonaws.services.snowball.model.DescribeAddressesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.snowball.model.DescribeAddressesResult {
...
fun AmazonSnowballFunctions.describeCluster(clusterId: String, init: (AmazonSnowballDescribeClusterCommand.() -> Unit)? = null): com.amazonaws.services.snowball.model.DescribeClusterResult {
	return this.block.declare(AmazonSnowballDescribeClusterCommand(clusterId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.snowball.model.DescribeClusterResult
}
...
class AmazonSnowballDescribeClusterCommand(val clusterId: String) : AmazonWebServiceCommand<com.amazonaws.services.snowball.model.DescribeClusterRequest, com.amazonaws.services.snowball.model.DescribeClusterResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.snowball.model.DescribeClusterResult {
...
fun AmazonSnowballFunctions.describeJob(jobId: String, init: (AmazonSnowballDescribeJobCommand.() -> Unit)? = null): com.amazonaws.services.snowball.model.DescribeJobResult {
	return this.block.declare(AmazonSnowballDescribeJobCommand(jobId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.snowball.model.DescribeJobResult
}
...
class AmazonSnowballDescribeJobCommand(val jobId: String) : AmazonWebServiceCommand<com.amazonaws.services.snowball.model.DescribeJobRequest, com.amazonaws.services.snowball.model.DescribeJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.snowball.model.DescribeJobResult {
...
fun AmazonSnowballFunctions.getJobManifest(jobId: String, init: (AmazonSnowballGetJobManifestCommand.() -> Unit)? = null): com.amazonaws.services.snowball.model.GetJobManifestResult {
	return this.block.declare(AmazonSnowballGetJobManifestCommand(jobId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.snowball.model.GetJobManifestResult
}
...
class AmazonSnowballGetJobManifestCommand(val jobId: String) : AmazonWebServiceCommand<com.amazonaws.services.snowball.model.GetJobManifestRequest, com.amazonaws.services.snowball.model.GetJobManifestResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.snowball.model.GetJobManifestResult {
...
fun AmazonSnowballFunctions.getJobUnlockCode(jobId: String, init: (AmazonSnowballGetJobUnlockCodeCommand.() -> Unit)? = null): com.amazonaws.services.snowball.model.GetJobUnlockCodeResult {
	return this.block.declare(AmazonSnowballGetJobUnlockCodeCommand(jobId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.snowball.model.GetJobUnlockCodeResult
}
...
class AmazonSnowballGetJobUnlockCodeCommand(val jobId: String) : AmazonWebServiceCommand<com.amazonaws.services.snowball.model.GetJobUnlockCodeRequest, com.amazonaws.services.snowball.model.GetJobUnlockCodeResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.snowball.model.GetJobUnlockCodeResult {
...
fun AmazonSnowballFunctions.getSnowballUsage(init: (AmazonSnowballGetSnowballUsageCommand.() -> Unit)? = null): com.amazonaws.services.snowball.model.GetSnowballUsageResult {
	return this.block.declare(AmazonSnowballGetSnowballUsageCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.snowball.model.GetSnowballUsageResult
}
...
class AmazonSnowballGetSnowballUsageCommand() : AmazonWebServiceCommand<com.amazonaws.services.snowball.model.GetSnowballUsageRequest, com.amazonaws.services.snowball.model.GetSnowballUsageResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.snowball.model.GetSnowballUsageResult {
...
fun AmazonSnowballFunctions.listClusterJobs(clusterId: String, init: (AmazonSnowballListClusterJobsCommand.() -> Unit)? = null): com.amazonaws.services.snowball.model.ListClusterJobsResult {
	return this.block.declare(AmazonSnowballListClusterJobsCommand(clusterId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.snowball.model.ListClusterJobsResult
}
...
class AmazonSnowballListClusterJobsCommand(val clusterId: String) : AmazonWebServiceCommand<com.amazonaws.services.snowball.model.ListClusterJobsRequest, com.amazonaws.services.snowball.model.ListClusterJobsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.snowball.model.ListClusterJobsResult {
...
fun AmazonSnowballFunctions.listClusters(init: (AmazonSnowballListClustersCommand.() -> Unit)? = null): com.amazonaws.services.snowball.model.ListClustersResult {
	return this.block.declare(AmazonSnowballListClustersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.snowball.model.ListClustersResult
}
...
class AmazonSnowballListClustersCommand() : AmazonWebServiceCommand<com.amazonaws.services.snowball.model.ListClustersRequest, com.amazonaws.services.snowball.model.ListClustersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.snowball.model.ListClustersResult {
...
fun AmazonSnowballFunctions.listJobs(init: (AmazonSnowballListJobsCommand.() -> Unit)? = null): com.amazonaws.services.snowball.model.ListJobsResult {
	return this.block.declare(AmazonSnowballListJobsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.snowball.model.ListJobsResult
}
...
class AmazonSnowballListJobsCommand() : AmazonWebServiceCommand<com.amazonaws.services.snowball.model.ListJobsRequest, com.amazonaws.services.snowball.model.ListJobsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.snowball.model.ListJobsResult {
...
fun AmazonSnowballFunctions.updateCluster(clusterId: String, init: (AmazonSnowballUpdateClusterCommand.() -> Unit)? = null): com.amazonaws.services.snowball.model.UpdateClusterResult {
	return this.block.declare(AmazonSnowballUpdateClusterCommand(clusterId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.snowball.model.UpdateClusterResult
}
...
class AmazonSnowballUpdateClusterCommand(val clusterId: String) : AmazonWebServiceCommand<com.amazonaws.services.snowball.model.UpdateClusterRequest, com.amazonaws.services.snowball.model.UpdateClusterResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.snowball.model.UpdateClusterResult {
...
fun AmazonSnowballFunctions.updateJob(jobId: String, init: (AmazonSnowballUpdateJobCommand.() -> Unit)? = null): com.amazonaws.services.snowball.model.UpdateJobResult {
	return this.block.declare(AmazonSnowballUpdateJobCommand(jobId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.snowball.model.UpdateJobResult
}
...
class AmazonSnowballUpdateJobCommand(val jobId: String) : AmazonWebServiceCommand<com.amazonaws.services.snowball.model.UpdateJobRequest, com.amazonaws.services.snowball.model.UpdateJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.snowball.model.UpdateJobResult {
