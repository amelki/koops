...
package com.codingue.koops.aws.kinesis
...
var com.codingue.koops.core.Environment.kinesis: AmazonKinesis
	get() {
		var service = this.capabilities["aws-kinesis"]
		if (service == null) {
			service = AmazonKinesisClientBuilder.standard().build()
			this.capabilities["aws-kinesis"] = service
		}
		return service as AmazonKinesis
	}
	set(kinesis) {
		this.capabilities["aws-kinesis"] = kinesis
	}
...
fun AmazonKinesisFunctions.addTagsToStream(streamName: String, tags: Map<String, String>, init: (AmazonKinesisAddTagsToStreamCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.AddTagsToStreamResult {
	return this.block.declare(AmazonKinesisAddTagsToStreamCommand(streamName, tags).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.AddTagsToStreamResult
}
...
class AmazonKinesisAddTagsToStreamCommand(val streamName: String, val tags: Map<String, String>) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.AddTagsToStreamRequest, com.amazonaws.services.kinesis.model.AddTagsToStreamResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.AddTagsToStreamResult {
...
fun AmazonKinesisFunctions.createStream(streamName: String, shardCount: Int, init: (AmazonKinesisCreateStreamCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.CreateStreamResult {
	return this.block.declare(AmazonKinesisCreateStreamCommand(streamName, shardCount).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.CreateStreamResult
}
...
class AmazonKinesisCreateStreamCommand(val streamName: String, val shardCount: Int) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.CreateStreamRequest, com.amazonaws.services.kinesis.model.CreateStreamResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.CreateStreamResult {
...
fun AmazonKinesisFunctions.decreaseStreamRetentionPeriod(streamName: String, retentionPeriodHours: Int, init: (AmazonKinesisDecreaseStreamRetentionPeriodCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.DecreaseStreamRetentionPeriodResult {
	return this.block.declare(AmazonKinesisDecreaseStreamRetentionPeriodCommand(streamName, retentionPeriodHours).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.DecreaseStreamRetentionPeriodResult
}
...
class AmazonKinesisDecreaseStreamRetentionPeriodCommand(val streamName: String, val retentionPeriodHours: Int) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.DecreaseStreamRetentionPeriodRequest, com.amazonaws.services.kinesis.model.DecreaseStreamRetentionPeriodResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.DecreaseStreamRetentionPeriodResult {
...
fun AmazonKinesisFunctions.deleteStream(streamName: String, init: (AmazonKinesisDeleteStreamCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.DeleteStreamResult {
	return this.block.declare(AmazonKinesisDeleteStreamCommand(streamName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.DeleteStreamResult
}
...
class AmazonKinesisDeleteStreamCommand(val streamName: String) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.DeleteStreamRequest, com.amazonaws.services.kinesis.model.DeleteStreamResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.DeleteStreamResult {
...
fun AmazonKinesisFunctions.describeLimits(init: (AmazonKinesisDescribeLimitsCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.DescribeLimitsResult {
	return this.block.declare(AmazonKinesisDescribeLimitsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.DescribeLimitsResult
}
...
class AmazonKinesisDescribeLimitsCommand() : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.DescribeLimitsRequest, com.amazonaws.services.kinesis.model.DescribeLimitsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.DescribeLimitsResult {
...
fun AmazonKinesisFunctions.describeStream(streamName: String, init: (AmazonKinesisDescribeStreamCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.DescribeStreamResult {
	return this.block.declare(AmazonKinesisDescribeStreamCommand(streamName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.DescribeStreamResult
}
...
class AmazonKinesisDescribeStreamCommand(val streamName: String) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.DescribeStreamRequest, com.amazonaws.services.kinesis.model.DescribeStreamResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.DescribeStreamResult {
...
fun AmazonKinesisFunctions.describeStreamSummary(streamName: String, init: (AmazonKinesisDescribeStreamSummaryCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.DescribeStreamSummaryResult {
	return this.block.declare(AmazonKinesisDescribeStreamSummaryCommand(streamName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.DescribeStreamSummaryResult
}
...
class AmazonKinesisDescribeStreamSummaryCommand(val streamName: String) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.DescribeStreamSummaryRequest, com.amazonaws.services.kinesis.model.DescribeStreamSummaryResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.DescribeStreamSummaryResult {
...
fun AmazonKinesisFunctions.disableEnhancedMonitoring(streamName: String, shardLevelMetrics: List<MetricsName>, init: (AmazonKinesisDisableEnhancedMonitoringCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.DisableEnhancedMonitoringResult {
	return this.block.declare(AmazonKinesisDisableEnhancedMonitoringCommand(streamName, shardLevelMetrics).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.DisableEnhancedMonitoringResult
}
...
class AmazonKinesisDisableEnhancedMonitoringCommand(val streamName: String, val shardLevelMetrics: List<MetricsName>) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.DisableEnhancedMonitoringRequest, com.amazonaws.services.kinesis.model.DisableEnhancedMonitoringResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.DisableEnhancedMonitoringResult {
...
fun AmazonKinesisFunctions.enableEnhancedMonitoring(streamName: String, shardLevelMetrics: List<MetricsName>, init: (AmazonKinesisEnableEnhancedMonitoringCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.EnableEnhancedMonitoringResult {
	return this.block.declare(AmazonKinesisEnableEnhancedMonitoringCommand(streamName, shardLevelMetrics).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.EnableEnhancedMonitoringResult
}
...
class AmazonKinesisEnableEnhancedMonitoringCommand(val streamName: String, val shardLevelMetrics: List<MetricsName>) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.EnableEnhancedMonitoringRequest, com.amazonaws.services.kinesis.model.EnableEnhancedMonitoringResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.EnableEnhancedMonitoringResult {
...
fun AmazonKinesisFunctions.getRecords(shardIterator: String, init: (AmazonKinesisGetRecordsCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.GetRecordsResult {
	return this.block.declare(AmazonKinesisGetRecordsCommand(shardIterator).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.GetRecordsResult
}
...
class AmazonKinesisGetRecordsCommand(val shardIterator: String) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.GetRecordsRequest, com.amazonaws.services.kinesis.model.GetRecordsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.GetRecordsResult {
...
fun AmazonKinesisFunctions.getShardIterator(streamName: String, shardId: String, shardIteratorType: ShardIteratorType, init: (AmazonKinesisGetShardIteratorCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.GetShardIteratorResult {
	return this.block.declare(AmazonKinesisGetShardIteratorCommand(streamName, shardId, shardIteratorType).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.GetShardIteratorResult
}
...
class AmazonKinesisGetShardIteratorCommand(val streamName: String, val shardId: String, val shardIteratorType: ShardIteratorType) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.GetShardIteratorRequest, com.amazonaws.services.kinesis.model.GetShardIteratorResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.GetShardIteratorResult {
...
fun AmazonKinesisFunctions.increaseStreamRetentionPeriod(streamName: String, retentionPeriodHours: Int, init: (AmazonKinesisIncreaseStreamRetentionPeriodCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.IncreaseStreamRetentionPeriodResult {
	return this.block.declare(AmazonKinesisIncreaseStreamRetentionPeriodCommand(streamName, retentionPeriodHours).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.IncreaseStreamRetentionPeriodResult
}
...
class AmazonKinesisIncreaseStreamRetentionPeriodCommand(val streamName: String, val retentionPeriodHours: Int) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.IncreaseStreamRetentionPeriodRequest, com.amazonaws.services.kinesis.model.IncreaseStreamRetentionPeriodResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.IncreaseStreamRetentionPeriodResult {
...
fun AmazonKinesisFunctions.listShards(init: (AmazonKinesisListShardsCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.ListShardsResult {
	return this.block.declare(AmazonKinesisListShardsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.ListShardsResult
}
...
class AmazonKinesisListShardsCommand() : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.ListShardsRequest, com.amazonaws.services.kinesis.model.ListShardsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.ListShardsResult {
...
fun AmazonKinesisFunctions.listStreams(init: (AmazonKinesisListStreamsCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.ListStreamsResult {
	return this.block.declare(AmazonKinesisListStreamsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.ListStreamsResult
}
...
class AmazonKinesisListStreamsCommand() : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.ListStreamsRequest, com.amazonaws.services.kinesis.model.ListStreamsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.ListStreamsResult {
...
fun AmazonKinesisFunctions.listTagsForStream(streamName: String, init: (AmazonKinesisListTagsForStreamCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.ListTagsForStreamResult {
	return this.block.declare(AmazonKinesisListTagsForStreamCommand(streamName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.ListTagsForStreamResult
}
...
class AmazonKinesisListTagsForStreamCommand(val streamName: String) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.ListTagsForStreamRequest, com.amazonaws.services.kinesis.model.ListTagsForStreamResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.ListTagsForStreamResult {
...
fun AmazonKinesisFunctions.mergeShards(streamName: String, shardToMerge: String, adjacentShardToMerge: String, init: (AmazonKinesisMergeShardsCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.MergeShardsResult {
	return this.block.declare(AmazonKinesisMergeShardsCommand(streamName, shardToMerge, adjacentShardToMerge).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.MergeShardsResult
}
...
class AmazonKinesisMergeShardsCommand(val streamName: String, val shardToMerge: String, val adjacentShardToMerge: String) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.MergeShardsRequest, com.amazonaws.services.kinesis.model.MergeShardsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.MergeShardsResult {
...
fun AmazonKinesisFunctions.putRecord(streamName: String, data: java.nio.ByteBuffer, partitionKey: String, init: (AmazonKinesisPutRecordCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.PutRecordResult {
	return this.block.declare(AmazonKinesisPutRecordCommand(streamName, data, partitionKey).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.PutRecordResult
}
...
class AmazonKinesisPutRecordCommand(val streamName: String, val data: java.nio.ByteBuffer, val partitionKey: String) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.PutRecordRequest, com.amazonaws.services.kinesis.model.PutRecordResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.PutRecordResult {
...
fun AmazonKinesisFunctions.putRecords(records: List<com.amazonaws.services.kinesis.model.PutRecordsRequestEntry>, streamName: String, init: (AmazonKinesisPutRecordsCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.PutRecordsResult {
	return this.block.declare(AmazonKinesisPutRecordsCommand(records, streamName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.PutRecordsResult
}
...
class AmazonKinesisPutRecordsCommand(val records: List<com.amazonaws.services.kinesis.model.PutRecordsRequestEntry>, val streamName: String) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.PutRecordsRequest, com.amazonaws.services.kinesis.model.PutRecordsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.PutRecordsResult {
...
fun AmazonKinesisFunctions.removeTagsFromStream(streamName: String, tagKeys: List<String>, init: (AmazonKinesisRemoveTagsFromStreamCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.RemoveTagsFromStreamResult {
	return this.block.declare(AmazonKinesisRemoveTagsFromStreamCommand(streamName, tagKeys).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.RemoveTagsFromStreamResult
}
...
class AmazonKinesisRemoveTagsFromStreamCommand(val streamName: String, val tagKeys: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.RemoveTagsFromStreamRequest, com.amazonaws.services.kinesis.model.RemoveTagsFromStreamResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.RemoveTagsFromStreamResult {
...
fun AmazonKinesisFunctions.splitShard(streamName: String, shardToSplit: String, newStartingHashKey: String, init: (AmazonKinesisSplitShardCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.SplitShardResult {
	return this.block.declare(AmazonKinesisSplitShardCommand(streamName, shardToSplit, newStartingHashKey).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.SplitShardResult
}
...
class AmazonKinesisSplitShardCommand(val streamName: String, val shardToSplit: String, val newStartingHashKey: String) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.SplitShardRequest, com.amazonaws.services.kinesis.model.SplitShardResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.SplitShardResult {
...
fun AmazonKinesisFunctions.startStreamEncryption(streamName: String, encryptionType: EncryptionType, keyId: String, init: (AmazonKinesisStartStreamEncryptionCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.StartStreamEncryptionResult {
	return this.block.declare(AmazonKinesisStartStreamEncryptionCommand(streamName, encryptionType, keyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.StartStreamEncryptionResult
}
...
class AmazonKinesisStartStreamEncryptionCommand(val streamName: String, val encryptionType: EncryptionType, val keyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.StartStreamEncryptionRequest, com.amazonaws.services.kinesis.model.StartStreamEncryptionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.StartStreamEncryptionResult {
...
fun AmazonKinesisFunctions.stopStreamEncryption(streamName: String, encryptionType: EncryptionType, keyId: String, init: (AmazonKinesisStopStreamEncryptionCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.StopStreamEncryptionResult {
	return this.block.declare(AmazonKinesisStopStreamEncryptionCommand(streamName, encryptionType, keyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.StopStreamEncryptionResult
}
...
class AmazonKinesisStopStreamEncryptionCommand(val streamName: String, val encryptionType: EncryptionType, val keyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.StopStreamEncryptionRequest, com.amazonaws.services.kinesis.model.StopStreamEncryptionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.StopStreamEncryptionResult {
...
fun AmazonKinesisFunctions.updateShardCount(streamName: String, targetShardCount: Int, scalingType: ScalingType, init: (AmazonKinesisUpdateShardCountCommand.() -> Unit)? = null): com.amazonaws.services.kinesis.model.UpdateShardCountResult {
	return this.block.declare(AmazonKinesisUpdateShardCountCommand(streamName, targetShardCount, scalingType).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesis.model.UpdateShardCountResult
}
...
class AmazonKinesisUpdateShardCountCommand(val streamName: String, val targetShardCount: Int, val scalingType: ScalingType) : AmazonWebServiceCommand<com.amazonaws.services.kinesis.model.UpdateShardCountRequest, com.amazonaws.services.kinesis.model.UpdateShardCountResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesis.model.UpdateShardCountResult {
