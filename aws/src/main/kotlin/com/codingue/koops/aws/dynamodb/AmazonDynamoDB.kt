...
package com.codingue.koops.aws.dynamodb
...
var com.codingue.koops.core.Environment.dynamodb: AmazonDynamoDB
	get() {
...
fun AmazonDynamoDBFunctions.batchGetItem(requestItems: Map<String, com.amazonaws.services.dynamodbv2.model.KeysAndAttributes>, init: (AmazonDynamoDBBatchGetItemCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.BatchGetItemResult {
	return this.block.declare(AmazonDynamoDBBatchGetItemCommand(requestItems).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.BatchGetItemResult
}
...
class AmazonDynamoDBBatchGetItemCommand(val requestItems: Map<String, com.amazonaws.services.dynamodbv2.model.KeysAndAttributes>) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.BatchGetItemRequest, com.amazonaws.services.dynamodbv2.model.BatchGetItemResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.BatchGetItemResult {
...
fun AmazonDynamoDBFunctions.batchWriteItem(requestItems: Map<String, List<com.amazonaws.services.dynamodbv2.model.WriteRequest>>, init: (AmazonDynamoDBBatchWriteItemCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.BatchWriteItemResult {
	return this.block.declare(AmazonDynamoDBBatchWriteItemCommand(requestItems).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.BatchWriteItemResult
}
...
class AmazonDynamoDBBatchWriteItemCommand(val requestItems: Map<String, List<com.amazonaws.services.dynamodbv2.model.WriteRequest>>) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.BatchWriteItemRequest, com.amazonaws.services.dynamodbv2.model.BatchWriteItemResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.BatchWriteItemResult {
...
fun AmazonDynamoDBFunctions.createBackup(tableName: String, backupName: String, init: (AmazonDynamoDBCreateBackupCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.CreateBackupResult {
	return this.block.declare(AmazonDynamoDBCreateBackupCommand(tableName, backupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.CreateBackupResult
}
...
class AmazonDynamoDBCreateBackupCommand(val tableName: String, val backupName: String) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.CreateBackupRequest, com.amazonaws.services.dynamodbv2.model.CreateBackupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.CreateBackupResult {
...
fun AmazonDynamoDBFunctions.createGlobalTable(globalTableName: String, replicationGroup: List<com.amazonaws.services.dynamodbv2.model.Replica>, init: (AmazonDynamoDBCreateGlobalTableCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.CreateGlobalTableResult {
	return this.block.declare(AmazonDynamoDBCreateGlobalTableCommand(globalTableName, replicationGroup).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.CreateGlobalTableResult
}
...
class AmazonDynamoDBCreateGlobalTableCommand(val globalTableName: String, val replicationGroup: List<com.amazonaws.services.dynamodbv2.model.Replica>) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.CreateGlobalTableRequest, com.amazonaws.services.dynamodbv2.model.CreateGlobalTableResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.CreateGlobalTableResult {
...
fun AmazonDynamoDBFunctions.createTable(attributeDefinitions: List<com.amazonaws.services.dynamodbv2.model.AttributeDefinition>, tableName: String, keySchema: List<com.amazonaws.services.dynamodbv2.model.KeySchemaElement>, provisionedThroughput: com.amazonaws.services.dynamodbv2.model.ProvisionedThroughput, init: (AmazonDynamoDBCreateTableCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.CreateTableResult {
	return this.block.declare(AmazonDynamoDBCreateTableCommand(attributeDefinitions, tableName, keySchema, provisionedThroughput).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.CreateTableResult
}
...
class AmazonDynamoDBCreateTableCommand(val attributeDefinitions: List<com.amazonaws.services.dynamodbv2.model.AttributeDefinition>, val tableName: String, val keySchema: List<com.amazonaws.services.dynamodbv2.model.KeySchemaElement>, val provisionedThroughput: com.amazonaws.services.dynamodbv2.model.ProvisionedThroughput) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.CreateTableRequest, com.amazonaws.services.dynamodbv2.model.CreateTableResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.CreateTableResult {
...
fun AmazonDynamoDBFunctions.deleteBackup(backupArn: String, init: (AmazonDynamoDBDeleteBackupCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.DeleteBackupResult {
	return this.block.declare(AmazonDynamoDBDeleteBackupCommand(backupArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.DeleteBackupResult
}
...
class AmazonDynamoDBDeleteBackupCommand(val backupArn: String) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.DeleteBackupRequest, com.amazonaws.services.dynamodbv2.model.DeleteBackupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.DeleteBackupResult {
...
fun AmazonDynamoDBFunctions.deleteItem(tableName: String, key: Map<String, com.amazonaws.services.dynamodbv2.model.AttributeValue>, init: (AmazonDynamoDBDeleteItemCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.DeleteItemResult {
	return this.block.declare(AmazonDynamoDBDeleteItemCommand(tableName, key).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.DeleteItemResult
}
...
class AmazonDynamoDBDeleteItemCommand(val tableName: String, val key: Map<String, com.amazonaws.services.dynamodbv2.model.AttributeValue>) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.DeleteItemRequest, com.amazonaws.services.dynamodbv2.model.DeleteItemResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.DeleteItemResult {
...
fun AmazonDynamoDBFunctions.deleteTable(tableName: String, init: (AmazonDynamoDBDeleteTableCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.DeleteTableResult {
	return this.block.declare(AmazonDynamoDBDeleteTableCommand(tableName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.DeleteTableResult
}
...
class AmazonDynamoDBDeleteTableCommand(val tableName: String) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.DeleteTableRequest, com.amazonaws.services.dynamodbv2.model.DeleteTableResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.DeleteTableResult {
...
fun AmazonDynamoDBFunctions.describeBackup(backupArn: String, init: (AmazonDynamoDBDescribeBackupCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.DescribeBackupResult {
	return this.block.declare(AmazonDynamoDBDescribeBackupCommand(backupArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.DescribeBackupResult
}
...
class AmazonDynamoDBDescribeBackupCommand(val backupArn: String) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.DescribeBackupRequest, com.amazonaws.services.dynamodbv2.model.DescribeBackupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.DescribeBackupResult {
...
fun AmazonDynamoDBFunctions.describeContinuousBackups(tableName: String, init: (AmazonDynamoDBDescribeContinuousBackupsCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.DescribeContinuousBackupsResult {
	return this.block.declare(AmazonDynamoDBDescribeContinuousBackupsCommand(tableName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.DescribeContinuousBackupsResult
}
...
class AmazonDynamoDBDescribeContinuousBackupsCommand(val tableName: String) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.DescribeContinuousBackupsRequest, com.amazonaws.services.dynamodbv2.model.DescribeContinuousBackupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.DescribeContinuousBackupsResult {
...
fun AmazonDynamoDBFunctions.describeGlobalTable(globalTableName: String, init: (AmazonDynamoDBDescribeGlobalTableCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.DescribeGlobalTableResult {
	return this.block.declare(AmazonDynamoDBDescribeGlobalTableCommand(globalTableName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.DescribeGlobalTableResult
}
...
class AmazonDynamoDBDescribeGlobalTableCommand(val globalTableName: String) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.DescribeGlobalTableRequest, com.amazonaws.services.dynamodbv2.model.DescribeGlobalTableResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.DescribeGlobalTableResult {
...
fun AmazonDynamoDBFunctions.describeLimits(init: (AmazonDynamoDBDescribeLimitsCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.DescribeLimitsResult {
	return this.block.declare(AmazonDynamoDBDescribeLimitsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.DescribeLimitsResult
}
...
class AmazonDynamoDBDescribeLimitsCommand() : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.DescribeLimitsRequest, com.amazonaws.services.dynamodbv2.model.DescribeLimitsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.DescribeLimitsResult {
...
fun AmazonDynamoDBFunctions.describeTable(tableName: String, init: (AmazonDynamoDBDescribeTableCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.DescribeTableResult {
	return this.block.declare(AmazonDynamoDBDescribeTableCommand(tableName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.DescribeTableResult
}
...
class AmazonDynamoDBDescribeTableCommand(val tableName: String) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.DescribeTableRequest, com.amazonaws.services.dynamodbv2.model.DescribeTableResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.DescribeTableResult {
...
fun AmazonDynamoDBFunctions.describeTimeToLive(tableName: String, init: (AmazonDynamoDBDescribeTimeToLiveCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.DescribeTimeToLiveResult {
	return this.block.declare(AmazonDynamoDBDescribeTimeToLiveCommand(tableName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.DescribeTimeToLiveResult
}
...
class AmazonDynamoDBDescribeTimeToLiveCommand(val tableName: String) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.DescribeTimeToLiveRequest, com.amazonaws.services.dynamodbv2.model.DescribeTimeToLiveResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.DescribeTimeToLiveResult {
...
fun AmazonDynamoDBFunctions.getItem(tableName: String, key: Map<String, com.amazonaws.services.dynamodbv2.model.AttributeValue>, init: (AmazonDynamoDBGetItemCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.GetItemResult {
	return this.block.declare(AmazonDynamoDBGetItemCommand(tableName, key).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.GetItemResult
}
...
class AmazonDynamoDBGetItemCommand(val tableName: String, val key: Map<String, com.amazonaws.services.dynamodbv2.model.AttributeValue>) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.GetItemRequest, com.amazonaws.services.dynamodbv2.model.GetItemResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.GetItemResult {
...
fun AmazonDynamoDBFunctions.listBackups(init: (AmazonDynamoDBListBackupsCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.ListBackupsResult {
	return this.block.declare(AmazonDynamoDBListBackupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.ListBackupsResult
}
...
class AmazonDynamoDBListBackupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.ListBackupsRequest, com.amazonaws.services.dynamodbv2.model.ListBackupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.ListBackupsResult {
...
fun AmazonDynamoDBFunctions.listGlobalTables(init: (AmazonDynamoDBListGlobalTablesCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.ListGlobalTablesResult {
	return this.block.declare(AmazonDynamoDBListGlobalTablesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.ListGlobalTablesResult
}
...
class AmazonDynamoDBListGlobalTablesCommand() : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.ListGlobalTablesRequest, com.amazonaws.services.dynamodbv2.model.ListGlobalTablesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.ListGlobalTablesResult {
...
fun AmazonDynamoDBFunctions.listTables(init: (AmazonDynamoDBListTablesCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.ListTablesResult {
	return this.block.declare(AmazonDynamoDBListTablesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.ListTablesResult
}
...
class AmazonDynamoDBListTablesCommand() : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.ListTablesRequest, com.amazonaws.services.dynamodbv2.model.ListTablesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.ListTablesResult {
...
fun AmazonDynamoDBFunctions.listTagsOfResource(resourceArn: String, init: (AmazonDynamoDBListTagsOfResourceCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.ListTagsOfResourceResult {
	return this.block.declare(AmazonDynamoDBListTagsOfResourceCommand(resourceArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.ListTagsOfResourceResult
}
...
class AmazonDynamoDBListTagsOfResourceCommand(val resourceArn: String) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.ListTagsOfResourceRequest, com.amazonaws.services.dynamodbv2.model.ListTagsOfResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.ListTagsOfResourceResult {
...
fun AmazonDynamoDBFunctions.putItem(tableName: String, item: Map<String, com.amazonaws.services.dynamodbv2.model.AttributeValue>, init: (AmazonDynamoDBPutItemCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.PutItemResult {
	return this.block.declare(AmazonDynamoDBPutItemCommand(tableName, item).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.PutItemResult
}
...
class AmazonDynamoDBPutItemCommand(val tableName: String, val item: Map<String, com.amazonaws.services.dynamodbv2.model.AttributeValue>) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.PutItemRequest, com.amazonaws.services.dynamodbv2.model.PutItemResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.PutItemResult {
...
fun AmazonDynamoDBFunctions.query(tableName: String, init: (AmazonDynamoDBQueryCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.QueryResult {
	return this.block.declare(AmazonDynamoDBQueryCommand(tableName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.QueryResult
}
...
class AmazonDynamoDBQueryCommand(val tableName: String) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.QueryRequest, com.amazonaws.services.dynamodbv2.model.QueryResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.QueryResult {
...
fun AmazonDynamoDBFunctions.restoreTableFromBackup(targetTableName: String, backupArn: String, init: (AmazonDynamoDBRestoreTableFromBackupCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.RestoreTableFromBackupResult {
	return this.block.declare(AmazonDynamoDBRestoreTableFromBackupCommand(targetTableName, backupArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.RestoreTableFromBackupResult
}
...
class AmazonDynamoDBRestoreTableFromBackupCommand(val targetTableName: String, val backupArn: String) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.RestoreTableFromBackupRequest, com.amazonaws.services.dynamodbv2.model.RestoreTableFromBackupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.RestoreTableFromBackupResult {
...
fun AmazonDynamoDBFunctions.restoreTableToPointInTime(sourceTableName: String, targetTableName: String, init: (AmazonDynamoDBRestoreTableToPointInTimeCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.RestoreTableToPointInTimeResult {
	return this.block.declare(AmazonDynamoDBRestoreTableToPointInTimeCommand(sourceTableName, targetTableName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.RestoreTableToPointInTimeResult
}
...
class AmazonDynamoDBRestoreTableToPointInTimeCommand(val sourceTableName: String, val targetTableName: String) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.RestoreTableToPointInTimeRequest, com.amazonaws.services.dynamodbv2.model.RestoreTableToPointInTimeResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.RestoreTableToPointInTimeResult {
...
fun AmazonDynamoDBFunctions.scan(tableName: String, init: (AmazonDynamoDBScanCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.ScanResult {
	return this.block.declare(AmazonDynamoDBScanCommand(tableName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.ScanResult
}
...
class AmazonDynamoDBScanCommand(val tableName: String) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.ScanRequest, com.amazonaws.services.dynamodbv2.model.ScanResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.ScanResult {
...
fun AmazonDynamoDBFunctions.tagResource(resourceArn: String, tags: List<com.amazonaws.services.dynamodbv2.model.Tag>, init: (AmazonDynamoDBTagResourceCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.TagResourceResult {
	return this.block.declare(AmazonDynamoDBTagResourceCommand(resourceArn, tags).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.TagResourceResult
}
...
class AmazonDynamoDBTagResourceCommand(val resourceArn: String, val tags: List<com.amazonaws.services.dynamodbv2.model.Tag>) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.TagResourceRequest, com.amazonaws.services.dynamodbv2.model.TagResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.TagResourceResult {
...
fun AmazonDynamoDBFunctions.untagResource(resourceArn: String, tagKeys: List<String>, init: (AmazonDynamoDBUntagResourceCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.UntagResourceResult {
	return this.block.declare(AmazonDynamoDBUntagResourceCommand(resourceArn, tagKeys).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.UntagResourceResult
}
...
class AmazonDynamoDBUntagResourceCommand(val resourceArn: String, val tagKeys: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.UntagResourceRequest, com.amazonaws.services.dynamodbv2.model.UntagResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.UntagResourceResult {
...
fun AmazonDynamoDBFunctions.updateContinuousBackups(tableName: String, pointInTimeRecoverySpecification: com.amazonaws.services.dynamodbv2.model.PointInTimeRecoverySpecification, init: (AmazonDynamoDBUpdateContinuousBackupsCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.UpdateContinuousBackupsResult {
	return this.block.declare(AmazonDynamoDBUpdateContinuousBackupsCommand(tableName, pointInTimeRecoverySpecification).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.UpdateContinuousBackupsResult
}
...
class AmazonDynamoDBUpdateContinuousBackupsCommand(val tableName: String, val pointInTimeRecoverySpecification: com.amazonaws.services.dynamodbv2.model.PointInTimeRecoverySpecification) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.UpdateContinuousBackupsRequest, com.amazonaws.services.dynamodbv2.model.UpdateContinuousBackupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.UpdateContinuousBackupsResult {
...
fun AmazonDynamoDBFunctions.updateGlobalTable(globalTableName: String, replicaUpdates: List<com.amazonaws.services.dynamodbv2.model.ReplicaUpdate>, init: (AmazonDynamoDBUpdateGlobalTableCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.UpdateGlobalTableResult {
	return this.block.declare(AmazonDynamoDBUpdateGlobalTableCommand(globalTableName, replicaUpdates).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.UpdateGlobalTableResult
}
...
class AmazonDynamoDBUpdateGlobalTableCommand(val globalTableName: String, val replicaUpdates: List<com.amazonaws.services.dynamodbv2.model.ReplicaUpdate>) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.UpdateGlobalTableRequest, com.amazonaws.services.dynamodbv2.model.UpdateGlobalTableResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.UpdateGlobalTableResult {
...
fun AmazonDynamoDBFunctions.updateItem(tableName: String, key: Map<String, com.amazonaws.services.dynamodbv2.model.AttributeValue>, init: (AmazonDynamoDBUpdateItemCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.UpdateItemResult {
	return this.block.declare(AmazonDynamoDBUpdateItemCommand(tableName, key).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.UpdateItemResult
}
...
class AmazonDynamoDBUpdateItemCommand(val tableName: String, val key: Map<String, com.amazonaws.services.dynamodbv2.model.AttributeValue>) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.UpdateItemRequest, com.amazonaws.services.dynamodbv2.model.UpdateItemResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.UpdateItemResult {
...
fun AmazonDynamoDBFunctions.updateTable(tableName: String, init: (AmazonDynamoDBUpdateTableCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.UpdateTableResult {
	return this.block.declare(AmazonDynamoDBUpdateTableCommand(tableName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.UpdateTableResult
}
...
class AmazonDynamoDBUpdateTableCommand(val tableName: String) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.UpdateTableRequest, com.amazonaws.services.dynamodbv2.model.UpdateTableResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.UpdateTableResult {
...
fun AmazonDynamoDBFunctions.updateTimeToLive(tableName: String, timeToLiveSpecification: com.amazonaws.services.dynamodbv2.model.TimeToLiveSpecification, init: (AmazonDynamoDBUpdateTimeToLiveCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.UpdateTimeToLiveResult {
	return this.block.declare(AmazonDynamoDBUpdateTimeToLiveCommand(tableName, timeToLiveSpecification).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.UpdateTimeToLiveResult
}
...
class AmazonDynamoDBUpdateTimeToLiveCommand(val tableName: String, val timeToLiveSpecification: com.amazonaws.services.dynamodbv2.model.TimeToLiveSpecification) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.UpdateTimeToLiveRequest, com.amazonaws.services.dynamodbv2.model.UpdateTimeToLiveResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.UpdateTimeToLiveResult {
