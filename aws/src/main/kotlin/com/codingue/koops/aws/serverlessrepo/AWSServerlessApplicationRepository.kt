...
package com.codingue.koops.aws.serverlessrepo
...
fun AWSServerlessApplicationRepositoryFunctions.createApplication(init: (AWSServerlessApplicationRepositoryCreateApplicationCommand.() -> Unit)? = null): com.amazonaws.services.serverlessapplicationrepository.model.CreateApplicationResult {
	return this.block.declare(AWSServerlessApplicationRepositoryCreateApplicationCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.serverlessapplicationrepository.model.CreateApplicationResult
}
...
class AWSServerlessApplicationRepositoryCreateApplicationCommand() : AmazonWebServiceCommand<com.amazonaws.services.serverlessapplicationrepository.model.CreateApplicationRequest, com.amazonaws.services.serverlessapplicationrepository.model.CreateApplicationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.serverlessapplicationrepository.model.CreateApplicationResult {
...
fun AWSServerlessApplicationRepositoryFunctions.createApplicationVersion(applicationId: String, semanticVersion: String, init: (AWSServerlessApplicationRepositoryCreateApplicationVersionCommand.() -> Unit)? = null): com.amazonaws.services.serverlessapplicationrepository.model.CreateApplicationVersionResult {
	return this.block.declare(AWSServerlessApplicationRepositoryCreateApplicationVersionCommand(applicationId, semanticVersion).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.serverlessapplicationrepository.model.CreateApplicationVersionResult
}
...
class AWSServerlessApplicationRepositoryCreateApplicationVersionCommand(val applicationId: String, val semanticVersion: String) : AmazonWebServiceCommand<com.amazonaws.services.serverlessapplicationrepository.model.CreateApplicationVersionRequest, com.amazonaws.services.serverlessapplicationrepository.model.CreateApplicationVersionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.serverlessapplicationrepository.model.CreateApplicationVersionResult {
...
fun AWSServerlessApplicationRepositoryFunctions.createCloudFormationChangeSet(applicationId: String, init: (AWSServerlessApplicationRepositoryCreateCloudFormationChangeSetCommand.() -> Unit)? = null): com.amazonaws.services.serverlessapplicationrepository.model.CreateCloudFormationChangeSetResult {
	return this.block.declare(AWSServerlessApplicationRepositoryCreateCloudFormationChangeSetCommand(applicationId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.serverlessapplicationrepository.model.CreateCloudFormationChangeSetResult
}
...
class AWSServerlessApplicationRepositoryCreateCloudFormationChangeSetCommand(val applicationId: String) : AmazonWebServiceCommand<com.amazonaws.services.serverlessapplicationrepository.model.CreateCloudFormationChangeSetRequest, com.amazonaws.services.serverlessapplicationrepository.model.CreateCloudFormationChangeSetResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.serverlessapplicationrepository.model.CreateCloudFormationChangeSetResult {
...
fun AWSServerlessApplicationRepositoryFunctions.deleteApplication(applicationId: String, init: (AWSServerlessApplicationRepositoryDeleteApplicationCommand.() -> Unit)? = null): com.amazonaws.services.serverlessapplicationrepository.model.DeleteApplicationResult {
	return this.block.declare(AWSServerlessApplicationRepositoryDeleteApplicationCommand(applicationId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.serverlessapplicationrepository.model.DeleteApplicationResult
}
...
class AWSServerlessApplicationRepositoryDeleteApplicationCommand(val applicationId: String) : AmazonWebServiceCommand<com.amazonaws.services.serverlessapplicationrepository.model.DeleteApplicationRequest, com.amazonaws.services.serverlessapplicationrepository.model.DeleteApplicationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.serverlessapplicationrepository.model.DeleteApplicationResult {
...
fun AWSServerlessApplicationRepositoryFunctions.getApplication(applicationId: String, init: (AWSServerlessApplicationRepositoryGetApplicationCommand.() -> Unit)? = null): com.amazonaws.services.serverlessapplicationrepository.model.GetApplicationResult {
	return this.block.declare(AWSServerlessApplicationRepositoryGetApplicationCommand(applicationId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.serverlessapplicationrepository.model.GetApplicationResult
}
...
class AWSServerlessApplicationRepositoryGetApplicationCommand(val applicationId: String) : AmazonWebServiceCommand<com.amazonaws.services.serverlessapplicationrepository.model.GetApplicationRequest, com.amazonaws.services.serverlessapplicationrepository.model.GetApplicationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.serverlessapplicationrepository.model.GetApplicationResult {
...
fun AWSServerlessApplicationRepositoryFunctions.getApplicationPolicy(applicationId: String, init: (AWSServerlessApplicationRepositoryGetApplicationPolicyCommand.() -> Unit)? = null): com.amazonaws.services.serverlessapplicationrepository.model.GetApplicationPolicyResult {
	return this.block.declare(AWSServerlessApplicationRepositoryGetApplicationPolicyCommand(applicationId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.serverlessapplicationrepository.model.GetApplicationPolicyResult
}
...
class AWSServerlessApplicationRepositoryGetApplicationPolicyCommand(val applicationId: String) : AmazonWebServiceCommand<com.amazonaws.services.serverlessapplicationrepository.model.GetApplicationPolicyRequest, com.amazonaws.services.serverlessapplicationrepository.model.GetApplicationPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.serverlessapplicationrepository.model.GetApplicationPolicyResult {
...
fun AWSServerlessApplicationRepositoryFunctions.listApplicationVersions(applicationId: String, init: (AWSServerlessApplicationRepositoryListApplicationVersionsCommand.() -> Unit)? = null): com.amazonaws.services.serverlessapplicationrepository.model.ListApplicationVersionsResult {
	return this.block.declare(AWSServerlessApplicationRepositoryListApplicationVersionsCommand(applicationId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.serverlessapplicationrepository.model.ListApplicationVersionsResult
}
...
class AWSServerlessApplicationRepositoryListApplicationVersionsCommand(val applicationId: String) : AmazonWebServiceCommand<com.amazonaws.services.serverlessapplicationrepository.model.ListApplicationVersionsRequest, com.amazonaws.services.serverlessapplicationrepository.model.ListApplicationVersionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.serverlessapplicationrepository.model.ListApplicationVersionsResult {
...
fun AWSServerlessApplicationRepositoryFunctions.listApplications(init: (AWSServerlessApplicationRepositoryListApplicationsCommand.() -> Unit)? = null): com.amazonaws.services.serverlessapplicationrepository.model.ListApplicationsResult {
	return this.block.declare(AWSServerlessApplicationRepositoryListApplicationsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.serverlessapplicationrepository.model.ListApplicationsResult
}
...
class AWSServerlessApplicationRepositoryListApplicationsCommand() : AmazonWebServiceCommand<com.amazonaws.services.serverlessapplicationrepository.model.ListApplicationsRequest, com.amazonaws.services.serverlessapplicationrepository.model.ListApplicationsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.serverlessapplicationrepository.model.ListApplicationsResult {
...
fun AWSServerlessApplicationRepositoryFunctions.putApplicationPolicy(applicationId: String, init: (AWSServerlessApplicationRepositoryPutApplicationPolicyCommand.() -> Unit)? = null): com.amazonaws.services.serverlessapplicationrepository.model.PutApplicationPolicyResult {
	return this.block.declare(AWSServerlessApplicationRepositoryPutApplicationPolicyCommand(applicationId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.serverlessapplicationrepository.model.PutApplicationPolicyResult
}
...
class AWSServerlessApplicationRepositoryPutApplicationPolicyCommand(val applicationId: String) : AmazonWebServiceCommand<com.amazonaws.services.serverlessapplicationrepository.model.PutApplicationPolicyRequest, com.amazonaws.services.serverlessapplicationrepository.model.PutApplicationPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.serverlessapplicationrepository.model.PutApplicationPolicyResult {
...
fun AWSServerlessApplicationRepositoryFunctions.updateApplication(applicationId: String, init: (AWSServerlessApplicationRepositoryUpdateApplicationCommand.() -> Unit)? = null): com.amazonaws.services.serverlessapplicationrepository.model.UpdateApplicationResult {
	return this.block.declare(AWSServerlessApplicationRepositoryUpdateApplicationCommand(applicationId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.serverlessapplicationrepository.model.UpdateApplicationResult
}
...
class AWSServerlessApplicationRepositoryUpdateApplicationCommand(val applicationId: String) : AmazonWebServiceCommand<com.amazonaws.services.serverlessapplicationrepository.model.UpdateApplicationRequest, com.amazonaws.services.serverlessapplicationrepository.model.UpdateApplicationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.serverlessapplicationrepository.model.UpdateApplicationResult {
