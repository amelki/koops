...
package com.codingue.koops.aws.cognito_sync
...
var com.codingue.koops.core.Environment.cognito_sync: AmazonCognitoSync
	get() {
...
fun AmazonCognitoSyncFunctions.bulkPublish(identityPoolId: String, init: (AmazonCognitoSyncBulkPublishCommand.() -> Unit)? = null): com.amazonaws.services.cognitosync.model.BulkPublishResult {
	return this.block.declare(AmazonCognitoSyncBulkPublishCommand(identityPoolId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitosync.model.BulkPublishResult
}
...
class AmazonCognitoSyncBulkPublishCommand(val identityPoolId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitosync.model.BulkPublishRequest, com.amazonaws.services.cognitosync.model.BulkPublishResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitosync.model.BulkPublishResult {
...
fun AmazonCognitoSyncFunctions.deleteDataset(identityPoolId: String, identityId: String, datasetName: String, init: (AmazonCognitoSyncDeleteDatasetCommand.() -> Unit)? = null): com.amazonaws.services.cognitosync.model.DeleteDatasetResult {
	return this.block.declare(AmazonCognitoSyncDeleteDatasetCommand(identityPoolId, identityId, datasetName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitosync.model.DeleteDatasetResult
}
...
class AmazonCognitoSyncDeleteDatasetCommand(val identityPoolId: String, val identityId: String, val datasetName: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitosync.model.DeleteDatasetRequest, com.amazonaws.services.cognitosync.model.DeleteDatasetResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitosync.model.DeleteDatasetResult {
...
fun AmazonCognitoSyncFunctions.describeDataset(identityPoolId: String, identityId: String, datasetName: String, init: (AmazonCognitoSyncDescribeDatasetCommand.() -> Unit)? = null): com.amazonaws.services.cognitosync.model.DescribeDatasetResult {
	return this.block.declare(AmazonCognitoSyncDescribeDatasetCommand(identityPoolId, identityId, datasetName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitosync.model.DescribeDatasetResult
}
...
class AmazonCognitoSyncDescribeDatasetCommand(val identityPoolId: String, val identityId: String, val datasetName: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitosync.model.DescribeDatasetRequest, com.amazonaws.services.cognitosync.model.DescribeDatasetResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitosync.model.DescribeDatasetResult {
...
fun AmazonCognitoSyncFunctions.describeIdentityPoolUsage(identityPoolId: String, init: (AmazonCognitoSyncDescribeIdentityPoolUsageCommand.() -> Unit)? = null): com.amazonaws.services.cognitosync.model.DescribeIdentityPoolUsageResult {
	return this.block.declare(AmazonCognitoSyncDescribeIdentityPoolUsageCommand(identityPoolId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitosync.model.DescribeIdentityPoolUsageResult
}
...
class AmazonCognitoSyncDescribeIdentityPoolUsageCommand(val identityPoolId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitosync.model.DescribeIdentityPoolUsageRequest, com.amazonaws.services.cognitosync.model.DescribeIdentityPoolUsageResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitosync.model.DescribeIdentityPoolUsageResult {
...
fun AmazonCognitoSyncFunctions.describeIdentityUsage(identityPoolId: String, identityId: String, init: (AmazonCognitoSyncDescribeIdentityUsageCommand.() -> Unit)? = null): com.amazonaws.services.cognitosync.model.DescribeIdentityUsageResult {
	return this.block.declare(AmazonCognitoSyncDescribeIdentityUsageCommand(identityPoolId, identityId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitosync.model.DescribeIdentityUsageResult
}
...
class AmazonCognitoSyncDescribeIdentityUsageCommand(val identityPoolId: String, val identityId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitosync.model.DescribeIdentityUsageRequest, com.amazonaws.services.cognitosync.model.DescribeIdentityUsageResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitosync.model.DescribeIdentityUsageResult {
...
fun AmazonCognitoSyncFunctions.getBulkPublishDetails(identityPoolId: String, init: (AmazonCognitoSyncGetBulkPublishDetailsCommand.() -> Unit)? = null): com.amazonaws.services.cognitosync.model.GetBulkPublishDetailsResult {
	return this.block.declare(AmazonCognitoSyncGetBulkPublishDetailsCommand(identityPoolId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitosync.model.GetBulkPublishDetailsResult
}
...
class AmazonCognitoSyncGetBulkPublishDetailsCommand(val identityPoolId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitosync.model.GetBulkPublishDetailsRequest, com.amazonaws.services.cognitosync.model.GetBulkPublishDetailsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitosync.model.GetBulkPublishDetailsResult {
...
fun AmazonCognitoSyncFunctions.getCognitoEvents(identityPoolId: String, init: (AmazonCognitoSyncGetCognitoEventsCommand.() -> Unit)? = null): com.amazonaws.services.cognitosync.model.GetCognitoEventsResult {
	return this.block.declare(AmazonCognitoSyncGetCognitoEventsCommand(identityPoolId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitosync.model.GetCognitoEventsResult
}
...
class AmazonCognitoSyncGetCognitoEventsCommand(val identityPoolId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitosync.model.GetCognitoEventsRequest, com.amazonaws.services.cognitosync.model.GetCognitoEventsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitosync.model.GetCognitoEventsResult {
...
fun AmazonCognitoSyncFunctions.getIdentityPoolConfiguration(identityPoolId: String, init: (AmazonCognitoSyncGetIdentityPoolConfigurationCommand.() -> Unit)? = null): com.amazonaws.services.cognitosync.model.GetIdentityPoolConfigurationResult {
	return this.block.declare(AmazonCognitoSyncGetIdentityPoolConfigurationCommand(identityPoolId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitosync.model.GetIdentityPoolConfigurationResult
}
...
class AmazonCognitoSyncGetIdentityPoolConfigurationCommand(val identityPoolId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitosync.model.GetIdentityPoolConfigurationRequest, com.amazonaws.services.cognitosync.model.GetIdentityPoolConfigurationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitosync.model.GetIdentityPoolConfigurationResult {
...
fun AmazonCognitoSyncFunctions.listDatasets(identityPoolId: String, identityId: String, init: (AmazonCognitoSyncListDatasetsCommand.() -> Unit)? = null): com.amazonaws.services.cognitosync.model.ListDatasetsResult {
	return this.block.declare(AmazonCognitoSyncListDatasetsCommand(identityPoolId, identityId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitosync.model.ListDatasetsResult
}
...
class AmazonCognitoSyncListDatasetsCommand(val identityPoolId: String, val identityId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitosync.model.ListDatasetsRequest, com.amazonaws.services.cognitosync.model.ListDatasetsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitosync.model.ListDatasetsResult {
...
fun AmazonCognitoSyncFunctions.listIdentityPoolUsage(init: (AmazonCognitoSyncListIdentityPoolUsageCommand.() -> Unit)? = null): com.amazonaws.services.cognitosync.model.ListIdentityPoolUsageResult {
	return this.block.declare(AmazonCognitoSyncListIdentityPoolUsageCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitosync.model.ListIdentityPoolUsageResult
}
...
class AmazonCognitoSyncListIdentityPoolUsageCommand() : AmazonWebServiceCommand<com.amazonaws.services.cognitosync.model.ListIdentityPoolUsageRequest, com.amazonaws.services.cognitosync.model.ListIdentityPoolUsageResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitosync.model.ListIdentityPoolUsageResult {
...
fun AmazonCognitoSyncFunctions.listRecords(identityPoolId: String, identityId: String, datasetName: String, init: (AmazonCognitoSyncListRecordsCommand.() -> Unit)? = null): com.amazonaws.services.cognitosync.model.ListRecordsResult {
	return this.block.declare(AmazonCognitoSyncListRecordsCommand(identityPoolId, identityId, datasetName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitosync.model.ListRecordsResult
}
...
class AmazonCognitoSyncListRecordsCommand(val identityPoolId: String, val identityId: String, val datasetName: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitosync.model.ListRecordsRequest, com.amazonaws.services.cognitosync.model.ListRecordsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitosync.model.ListRecordsResult {
...
fun AmazonCognitoSyncFunctions.registerDevice(identityPoolId: String, identityId: String, platform: Platform, token: String, init: (AmazonCognitoSyncRegisterDeviceCommand.() -> Unit)? = null): com.amazonaws.services.cognitosync.model.RegisterDeviceResult {
	return this.block.declare(AmazonCognitoSyncRegisterDeviceCommand(identityPoolId, identityId, platform, token).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitosync.model.RegisterDeviceResult
}
...
class AmazonCognitoSyncRegisterDeviceCommand(val identityPoolId: String, val identityId: String, val platform: Platform, val token: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitosync.model.RegisterDeviceRequest, com.amazonaws.services.cognitosync.model.RegisterDeviceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitosync.model.RegisterDeviceResult {
...
fun AmazonCognitoSyncFunctions.setCognitoEvents(identityPoolId: String, events: Map<String, String>, init: (AmazonCognitoSyncSetCognitoEventsCommand.() -> Unit)? = null): com.amazonaws.services.cognitosync.model.SetCognitoEventsResult {
	return this.block.declare(AmazonCognitoSyncSetCognitoEventsCommand(identityPoolId, events).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitosync.model.SetCognitoEventsResult
}
...
class AmazonCognitoSyncSetCognitoEventsCommand(val identityPoolId: String, val events: Map<String, String>) : AmazonWebServiceCommand<com.amazonaws.services.cognitosync.model.SetCognitoEventsRequest, com.amazonaws.services.cognitosync.model.SetCognitoEventsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitosync.model.SetCognitoEventsResult {
...
fun AmazonCognitoSyncFunctions.setIdentityPoolConfiguration(identityPoolId: String, init: (AmazonCognitoSyncSetIdentityPoolConfigurationCommand.() -> Unit)? = null): com.amazonaws.services.cognitosync.model.SetIdentityPoolConfigurationResult {
	return this.block.declare(AmazonCognitoSyncSetIdentityPoolConfigurationCommand(identityPoolId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitosync.model.SetIdentityPoolConfigurationResult
}
...
class AmazonCognitoSyncSetIdentityPoolConfigurationCommand(val identityPoolId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitosync.model.SetIdentityPoolConfigurationRequest, com.amazonaws.services.cognitosync.model.SetIdentityPoolConfigurationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitosync.model.SetIdentityPoolConfigurationResult {
...
fun AmazonCognitoSyncFunctions.subscribeToDataset(identityPoolId: String, identityId: String, datasetName: String, deviceId: String, init: (AmazonCognitoSyncSubscribeToDatasetCommand.() -> Unit)? = null): com.amazonaws.services.cognitosync.model.SubscribeToDatasetResult {
	return this.block.declare(AmazonCognitoSyncSubscribeToDatasetCommand(identityPoolId, identityId, datasetName, deviceId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitosync.model.SubscribeToDatasetResult
}
...
class AmazonCognitoSyncSubscribeToDatasetCommand(val identityPoolId: String, val identityId: String, val datasetName: String, val deviceId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitosync.model.SubscribeToDatasetRequest, com.amazonaws.services.cognitosync.model.SubscribeToDatasetResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitosync.model.SubscribeToDatasetResult {
...
fun AmazonCognitoSyncFunctions.unsubscribeFromDataset(identityPoolId: String, identityId: String, datasetName: String, deviceId: String, init: (AmazonCognitoSyncUnsubscribeFromDatasetCommand.() -> Unit)? = null): com.amazonaws.services.cognitosync.model.UnsubscribeFromDatasetResult {
	return this.block.declare(AmazonCognitoSyncUnsubscribeFromDatasetCommand(identityPoolId, identityId, datasetName, deviceId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitosync.model.UnsubscribeFromDatasetResult
}
...
class AmazonCognitoSyncUnsubscribeFromDatasetCommand(val identityPoolId: String, val identityId: String, val datasetName: String, val deviceId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitosync.model.UnsubscribeFromDatasetRequest, com.amazonaws.services.cognitosync.model.UnsubscribeFromDatasetResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitosync.model.UnsubscribeFromDatasetResult {
...
fun AmazonCognitoSyncFunctions.updateRecords(identityPoolId: String, identityId: String, datasetName: String, syncSessionToken: String, init: (AmazonCognitoSyncUpdateRecordsCommand.() -> Unit)? = null): com.amazonaws.services.cognitosync.model.UpdateRecordsResult {
	return this.block.declare(AmazonCognitoSyncUpdateRecordsCommand(identityPoolId, identityId, datasetName, syncSessionToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitosync.model.UpdateRecordsResult
}
...
class AmazonCognitoSyncUpdateRecordsCommand(val identityPoolId: String, val identityId: String, val datasetName: String, val syncSessionToken: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitosync.model.UpdateRecordsRequest, com.amazonaws.services.cognitosync.model.UpdateRecordsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitosync.model.UpdateRecordsResult {
