...
package com.codingue.koops.aws.ds
...
var com.codingue.koops.core.Environment.ds: AWSDirectoryService
	get() {
		var service = this.capabilities["aws-ds"]
		if (service == null) {
			service = AWSDirectoryServiceClientBuilder.standard().build()
			this.capabilities["aws-ds"] = service
		}
		return service as AWSDirectoryService
	}
	set(ds) {
		this.capabilities["aws-ds"] = ds
	}
...
fun AWSDirectoryServiceFunctions.addIpRoutes(directoryId: String, ipRoutes: List<com.amazonaws.services.directory.model.IpRoute>, init: (AWSDirectoryServiceAddIpRoutesCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.AddIpRoutesResult {
	return this.block.declare(AWSDirectoryServiceAddIpRoutesCommand(directoryId, ipRoutes).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.AddIpRoutesResult
}
...
class AWSDirectoryServiceAddIpRoutesCommand(val directoryId: String, val ipRoutes: List<com.amazonaws.services.directory.model.IpRoute>) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.AddIpRoutesRequest, com.amazonaws.services.directory.model.AddIpRoutesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.AddIpRoutesResult {
...
fun AWSDirectoryServiceFunctions.addTagsToResource(resourceId: String, tags: List<com.amazonaws.services.directory.model.Tag>, init: (AWSDirectoryServiceAddTagsToResourceCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.AddTagsToResourceResult {
	return this.block.declare(AWSDirectoryServiceAddTagsToResourceCommand(resourceId, tags).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.AddTagsToResourceResult
}
...
class AWSDirectoryServiceAddTagsToResourceCommand(val resourceId: String, val tags: List<com.amazonaws.services.directory.model.Tag>) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.AddTagsToResourceRequest, com.amazonaws.services.directory.model.AddTagsToResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.AddTagsToResourceResult {
...
fun AWSDirectoryServiceFunctions.cancelSchemaExtension(directoryId: String, schemaExtensionId: String, init: (AWSDirectoryServiceCancelSchemaExtensionCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.CancelSchemaExtensionResult {
	return this.block.declare(AWSDirectoryServiceCancelSchemaExtensionCommand(directoryId, schemaExtensionId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.CancelSchemaExtensionResult
}
...
class AWSDirectoryServiceCancelSchemaExtensionCommand(val directoryId: String, val schemaExtensionId: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.CancelSchemaExtensionRequest, com.amazonaws.services.directory.model.CancelSchemaExtensionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.CancelSchemaExtensionResult {
...
fun AWSDirectoryServiceFunctions.connectDirectory(name: String, password: String, size: DirectorySize, connectSettings: com.amazonaws.services.directory.model.DirectoryConnectSettings, init: (AWSDirectoryServiceConnectDirectoryCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.ConnectDirectoryResult {
	return this.block.declare(AWSDirectoryServiceConnectDirectoryCommand(name, password, size, connectSettings).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.ConnectDirectoryResult
}
...
class AWSDirectoryServiceConnectDirectoryCommand(val name: String, val password: String, val size: DirectorySize, val connectSettings: com.amazonaws.services.directory.model.DirectoryConnectSettings) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.ConnectDirectoryRequest, com.amazonaws.services.directory.model.ConnectDirectoryResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.ConnectDirectoryResult {
...
fun AWSDirectoryServiceFunctions.createAlias(directoryId: String, alias: String, init: (AWSDirectoryServiceCreateAliasCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.CreateAliasResult {
	return this.block.declare(AWSDirectoryServiceCreateAliasCommand(directoryId, alias).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.CreateAliasResult
}
...
class AWSDirectoryServiceCreateAliasCommand(val directoryId: String, val alias: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.CreateAliasRequest, com.amazonaws.services.directory.model.CreateAliasResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.CreateAliasResult {
...
fun AWSDirectoryServiceFunctions.createComputer(directoryId: String, computerName: String, password: String, init: (AWSDirectoryServiceCreateComputerCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.CreateComputerResult {
	return this.block.declare(AWSDirectoryServiceCreateComputerCommand(directoryId, computerName, password).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.CreateComputerResult
}
...
class AWSDirectoryServiceCreateComputerCommand(val directoryId: String, val computerName: String, val password: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.CreateComputerRequest, com.amazonaws.services.directory.model.CreateComputerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.CreateComputerResult {
...
fun AWSDirectoryServiceFunctions.createConditionalForwarder(directoryId: String, remoteDomainName: String, dnsIpAddrs: List<String>, init: (AWSDirectoryServiceCreateConditionalForwarderCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.CreateConditionalForwarderResult {
	return this.block.declare(AWSDirectoryServiceCreateConditionalForwarderCommand(directoryId, remoteDomainName, dnsIpAddrs).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.CreateConditionalForwarderResult
}
...
class AWSDirectoryServiceCreateConditionalForwarderCommand(val directoryId: String, val remoteDomainName: String, val dnsIpAddrs: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.CreateConditionalForwarderRequest, com.amazonaws.services.directory.model.CreateConditionalForwarderResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.CreateConditionalForwarderResult {
...
fun AWSDirectoryServiceFunctions.createDirectory(name: String, password: String, size: DirectorySize, init: (AWSDirectoryServiceCreateDirectoryCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.CreateDirectoryResult {
	return this.block.declare(AWSDirectoryServiceCreateDirectoryCommand(name, password, size).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.CreateDirectoryResult
}
...
class AWSDirectoryServiceCreateDirectoryCommand(val name: String, val password: String, val size: DirectorySize) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.CreateDirectoryRequest, com.amazonaws.services.directory.model.CreateDirectoryResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.CreateDirectoryResult {
...
fun AWSDirectoryServiceFunctions.createMicrosoftAD(name: String, password: String, vpcSettings: com.amazonaws.services.directory.model.DirectoryVpcSettings, init: (AWSDirectoryServiceCreateMicrosoftADCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.CreateMicrosoftADResult {
	return this.block.declare(AWSDirectoryServiceCreateMicrosoftADCommand(name, password, vpcSettings).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.CreateMicrosoftADResult
}
...
class AWSDirectoryServiceCreateMicrosoftADCommand(val name: String, val password: String, val vpcSettings: com.amazonaws.services.directory.model.DirectoryVpcSettings) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.CreateMicrosoftADRequest, com.amazonaws.services.directory.model.CreateMicrosoftADResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.CreateMicrosoftADResult {
...
fun AWSDirectoryServiceFunctions.createSnapshot(directoryId: String, init: (AWSDirectoryServiceCreateSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.CreateSnapshotResult {
	return this.block.declare(AWSDirectoryServiceCreateSnapshotCommand(directoryId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.CreateSnapshotResult
}
...
class AWSDirectoryServiceCreateSnapshotCommand(val directoryId: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.CreateSnapshotRequest, com.amazonaws.services.directory.model.CreateSnapshotResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.CreateSnapshotResult {
...
fun AWSDirectoryServiceFunctions.createTrust(directoryId: String, remoteDomainName: String, trustPassword: String, trustDirection: TrustDirection, init: (AWSDirectoryServiceCreateTrustCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.CreateTrustResult {
	return this.block.declare(AWSDirectoryServiceCreateTrustCommand(directoryId, remoteDomainName, trustPassword, trustDirection).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.CreateTrustResult
}
...
class AWSDirectoryServiceCreateTrustCommand(val directoryId: String, val remoteDomainName: String, val trustPassword: String, val trustDirection: TrustDirection) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.CreateTrustRequest, com.amazonaws.services.directory.model.CreateTrustResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.CreateTrustResult {
...
fun AWSDirectoryServiceFunctions.deleteConditionalForwarder(directoryId: String, remoteDomainName: String, init: (AWSDirectoryServiceDeleteConditionalForwarderCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.DeleteConditionalForwarderResult {
	return this.block.declare(AWSDirectoryServiceDeleteConditionalForwarderCommand(directoryId, remoteDomainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.DeleteConditionalForwarderResult
}
...
class AWSDirectoryServiceDeleteConditionalForwarderCommand(val directoryId: String, val remoteDomainName: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.DeleteConditionalForwarderRequest, com.amazonaws.services.directory.model.DeleteConditionalForwarderResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.DeleteConditionalForwarderResult {
...
fun AWSDirectoryServiceFunctions.deleteDirectory(directoryId: String, init: (AWSDirectoryServiceDeleteDirectoryCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.DeleteDirectoryResult {
	return this.block.declare(AWSDirectoryServiceDeleteDirectoryCommand(directoryId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.DeleteDirectoryResult
}
...
class AWSDirectoryServiceDeleteDirectoryCommand(val directoryId: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.DeleteDirectoryRequest, com.amazonaws.services.directory.model.DeleteDirectoryResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.DeleteDirectoryResult {
...
fun AWSDirectoryServiceFunctions.deleteSnapshot(snapshotId: String, init: (AWSDirectoryServiceDeleteSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.DeleteSnapshotResult {
	return this.block.declare(AWSDirectoryServiceDeleteSnapshotCommand(snapshotId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.DeleteSnapshotResult
}
...
class AWSDirectoryServiceDeleteSnapshotCommand(val snapshotId: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.DeleteSnapshotRequest, com.amazonaws.services.directory.model.DeleteSnapshotResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.DeleteSnapshotResult {
...
fun AWSDirectoryServiceFunctions.deleteTrust(trustId: String, init: (AWSDirectoryServiceDeleteTrustCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.DeleteTrustResult {
	return this.block.declare(AWSDirectoryServiceDeleteTrustCommand(trustId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.DeleteTrustResult
}
...
class AWSDirectoryServiceDeleteTrustCommand(val trustId: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.DeleteTrustRequest, com.amazonaws.services.directory.model.DeleteTrustResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.DeleteTrustResult {
...
fun AWSDirectoryServiceFunctions.deregisterEventTopic(directoryId: String, topicName: String, init: (AWSDirectoryServiceDeregisterEventTopicCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.DeregisterEventTopicResult {
	return this.block.declare(AWSDirectoryServiceDeregisterEventTopicCommand(directoryId, topicName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.DeregisterEventTopicResult
}
...
class AWSDirectoryServiceDeregisterEventTopicCommand(val directoryId: String, val topicName: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.DeregisterEventTopicRequest, com.amazonaws.services.directory.model.DeregisterEventTopicResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.DeregisterEventTopicResult {
...
fun AWSDirectoryServiceFunctions.describeConditionalForwarders(directoryId: String, init: (AWSDirectoryServiceDescribeConditionalForwardersCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.DescribeConditionalForwardersResult {
	return this.block.declare(AWSDirectoryServiceDescribeConditionalForwardersCommand(directoryId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.DescribeConditionalForwardersResult
}
...
class AWSDirectoryServiceDescribeConditionalForwardersCommand(val directoryId: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.DescribeConditionalForwardersRequest, com.amazonaws.services.directory.model.DescribeConditionalForwardersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.DescribeConditionalForwardersResult {
...
fun AWSDirectoryServiceFunctions.describeDirectories(init: (AWSDirectoryServiceDescribeDirectoriesCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.DescribeDirectoriesResult {
	return this.block.declare(AWSDirectoryServiceDescribeDirectoriesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.DescribeDirectoriesResult
}
...
class AWSDirectoryServiceDescribeDirectoriesCommand() : AmazonWebServiceCommand<com.amazonaws.services.directory.model.DescribeDirectoriesRequest, com.amazonaws.services.directory.model.DescribeDirectoriesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.DescribeDirectoriesResult {
...
fun AWSDirectoryServiceFunctions.describeDomainControllers(directoryId: String, init: (AWSDirectoryServiceDescribeDomainControllersCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.DescribeDomainControllersResult {
	return this.block.declare(AWSDirectoryServiceDescribeDomainControllersCommand(directoryId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.DescribeDomainControllersResult
}
...
class AWSDirectoryServiceDescribeDomainControllersCommand(val directoryId: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.DescribeDomainControllersRequest, com.amazonaws.services.directory.model.DescribeDomainControllersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.DescribeDomainControllersResult {
...
fun AWSDirectoryServiceFunctions.describeEventTopics(init: (AWSDirectoryServiceDescribeEventTopicsCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.DescribeEventTopicsResult {
	return this.block.declare(AWSDirectoryServiceDescribeEventTopicsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.DescribeEventTopicsResult
}
...
class AWSDirectoryServiceDescribeEventTopicsCommand() : AmazonWebServiceCommand<com.amazonaws.services.directory.model.DescribeEventTopicsRequest, com.amazonaws.services.directory.model.DescribeEventTopicsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.DescribeEventTopicsResult {
...
fun AWSDirectoryServiceFunctions.describeSnapshots(init: (AWSDirectoryServiceDescribeSnapshotsCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.DescribeSnapshotsResult {
	return this.block.declare(AWSDirectoryServiceDescribeSnapshotsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.DescribeSnapshotsResult
}
...
class AWSDirectoryServiceDescribeSnapshotsCommand() : AmazonWebServiceCommand<com.amazonaws.services.directory.model.DescribeSnapshotsRequest, com.amazonaws.services.directory.model.DescribeSnapshotsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.DescribeSnapshotsResult {
...
fun AWSDirectoryServiceFunctions.describeTrusts(init: (AWSDirectoryServiceDescribeTrustsCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.DescribeTrustsResult {
	return this.block.declare(AWSDirectoryServiceDescribeTrustsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.DescribeTrustsResult
}
...
class AWSDirectoryServiceDescribeTrustsCommand() : AmazonWebServiceCommand<com.amazonaws.services.directory.model.DescribeTrustsRequest, com.amazonaws.services.directory.model.DescribeTrustsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.DescribeTrustsResult {
...
fun AWSDirectoryServiceFunctions.disableRadius(directoryId: String, init: (AWSDirectoryServiceDisableRadiusCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.DisableRadiusResult {
	return this.block.declare(AWSDirectoryServiceDisableRadiusCommand(directoryId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.DisableRadiusResult
}
...
class AWSDirectoryServiceDisableRadiusCommand(val directoryId: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.DisableRadiusRequest, com.amazonaws.services.directory.model.DisableRadiusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.DisableRadiusResult {
...
fun AWSDirectoryServiceFunctions.disableSso(directoryId: String, init: (AWSDirectoryServiceDisableSsoCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.DisableSsoResult {
	return this.block.declare(AWSDirectoryServiceDisableSsoCommand(directoryId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.DisableSsoResult
}
...
class AWSDirectoryServiceDisableSsoCommand(val directoryId: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.DisableSsoRequest, com.amazonaws.services.directory.model.DisableSsoResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.DisableSsoResult {
...
fun AWSDirectoryServiceFunctions.enableRadius(directoryId: String, radiusSettings: com.amazonaws.services.directory.model.RadiusSettings, init: (AWSDirectoryServiceEnableRadiusCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.EnableRadiusResult {
	return this.block.declare(AWSDirectoryServiceEnableRadiusCommand(directoryId, radiusSettings).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.EnableRadiusResult
}
...
class AWSDirectoryServiceEnableRadiusCommand(val directoryId: String, val radiusSettings: com.amazonaws.services.directory.model.RadiusSettings) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.EnableRadiusRequest, com.amazonaws.services.directory.model.EnableRadiusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.EnableRadiusResult {
...
fun AWSDirectoryServiceFunctions.enableSso(directoryId: String, init: (AWSDirectoryServiceEnableSsoCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.EnableSsoResult {
	return this.block.declare(AWSDirectoryServiceEnableSsoCommand(directoryId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.EnableSsoResult
}
...
class AWSDirectoryServiceEnableSsoCommand(val directoryId: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.EnableSsoRequest, com.amazonaws.services.directory.model.EnableSsoResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.EnableSsoResult {
...
fun AWSDirectoryServiceFunctions.getDirectoryLimits(init: (AWSDirectoryServiceGetDirectoryLimitsCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.GetDirectoryLimitsResult {
	return this.block.declare(AWSDirectoryServiceGetDirectoryLimitsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.GetDirectoryLimitsResult
}
...
class AWSDirectoryServiceGetDirectoryLimitsCommand() : AmazonWebServiceCommand<com.amazonaws.services.directory.model.GetDirectoryLimitsRequest, com.amazonaws.services.directory.model.GetDirectoryLimitsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.GetDirectoryLimitsResult {
...
fun AWSDirectoryServiceFunctions.getSnapshotLimits(directoryId: String, init: (AWSDirectoryServiceGetSnapshotLimitsCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.GetSnapshotLimitsResult {
	return this.block.declare(AWSDirectoryServiceGetSnapshotLimitsCommand(directoryId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.GetSnapshotLimitsResult
}
...
class AWSDirectoryServiceGetSnapshotLimitsCommand(val directoryId: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.GetSnapshotLimitsRequest, com.amazonaws.services.directory.model.GetSnapshotLimitsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.GetSnapshotLimitsResult {
...
fun AWSDirectoryServiceFunctions.listIpRoutes(directoryId: String, init: (AWSDirectoryServiceListIpRoutesCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.ListIpRoutesResult {
	return this.block.declare(AWSDirectoryServiceListIpRoutesCommand(directoryId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.ListIpRoutesResult
}
...
class AWSDirectoryServiceListIpRoutesCommand(val directoryId: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.ListIpRoutesRequest, com.amazonaws.services.directory.model.ListIpRoutesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.ListIpRoutesResult {
...
fun AWSDirectoryServiceFunctions.listSchemaExtensions(directoryId: String, init: (AWSDirectoryServiceListSchemaExtensionsCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.ListSchemaExtensionsResult {
	return this.block.declare(AWSDirectoryServiceListSchemaExtensionsCommand(directoryId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.ListSchemaExtensionsResult
}
...
class AWSDirectoryServiceListSchemaExtensionsCommand(val directoryId: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.ListSchemaExtensionsRequest, com.amazonaws.services.directory.model.ListSchemaExtensionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.ListSchemaExtensionsResult {
...
fun AWSDirectoryServiceFunctions.listTagsForResource(resourceId: String, init: (AWSDirectoryServiceListTagsForResourceCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.ListTagsForResourceResult {
	return this.block.declare(AWSDirectoryServiceListTagsForResourceCommand(resourceId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.ListTagsForResourceResult
}
...
class AWSDirectoryServiceListTagsForResourceCommand(val resourceId: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.ListTagsForResourceRequest, com.amazonaws.services.directory.model.ListTagsForResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.ListTagsForResourceResult {
...
fun AWSDirectoryServiceFunctions.registerEventTopic(directoryId: String, topicName: String, init: (AWSDirectoryServiceRegisterEventTopicCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.RegisterEventTopicResult {
	return this.block.declare(AWSDirectoryServiceRegisterEventTopicCommand(directoryId, topicName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.RegisterEventTopicResult
}
...
class AWSDirectoryServiceRegisterEventTopicCommand(val directoryId: String, val topicName: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.RegisterEventTopicRequest, com.amazonaws.services.directory.model.RegisterEventTopicResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.RegisterEventTopicResult {
...
fun AWSDirectoryServiceFunctions.removeIpRoutes(directoryId: String, cidrIps: List<String>, init: (AWSDirectoryServiceRemoveIpRoutesCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.RemoveIpRoutesResult {
	return this.block.declare(AWSDirectoryServiceRemoveIpRoutesCommand(directoryId, cidrIps).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.RemoveIpRoutesResult
}
...
class AWSDirectoryServiceRemoveIpRoutesCommand(val directoryId: String, val cidrIps: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.RemoveIpRoutesRequest, com.amazonaws.services.directory.model.RemoveIpRoutesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.RemoveIpRoutesResult {
...
fun AWSDirectoryServiceFunctions.removeTagsFromResource(resourceId: String, tagKeys: List<String>, init: (AWSDirectoryServiceRemoveTagsFromResourceCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.RemoveTagsFromResourceResult {
	return this.block.declare(AWSDirectoryServiceRemoveTagsFromResourceCommand(resourceId, tagKeys).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.RemoveTagsFromResourceResult
}
...
class AWSDirectoryServiceRemoveTagsFromResourceCommand(val resourceId: String, val tagKeys: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.RemoveTagsFromResourceRequest, com.amazonaws.services.directory.model.RemoveTagsFromResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.RemoveTagsFromResourceResult {
...
fun AWSDirectoryServiceFunctions.restoreFromSnapshot(snapshotId: String, init: (AWSDirectoryServiceRestoreFromSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.RestoreFromSnapshotResult {
	return this.block.declare(AWSDirectoryServiceRestoreFromSnapshotCommand(snapshotId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.RestoreFromSnapshotResult
}
...
class AWSDirectoryServiceRestoreFromSnapshotCommand(val snapshotId: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.RestoreFromSnapshotRequest, com.amazonaws.services.directory.model.RestoreFromSnapshotResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.RestoreFromSnapshotResult {
...
fun AWSDirectoryServiceFunctions.startSchemaExtension(directoryId: String, createSnapshotBeforeSchemaExtension: Boolean, ldifContent: String, description: String, init: (AWSDirectoryServiceStartSchemaExtensionCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.StartSchemaExtensionResult {
	return this.block.declare(AWSDirectoryServiceStartSchemaExtensionCommand(directoryId, createSnapshotBeforeSchemaExtension, ldifContent, description).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.StartSchemaExtensionResult
}
...
class AWSDirectoryServiceStartSchemaExtensionCommand(val directoryId: String, val createSnapshotBeforeSchemaExtension: Boolean, val ldifContent: String, val description: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.StartSchemaExtensionRequest, com.amazonaws.services.directory.model.StartSchemaExtensionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.StartSchemaExtensionResult {
...
fun AWSDirectoryServiceFunctions.updateConditionalForwarder(directoryId: String, remoteDomainName: String, dnsIpAddrs: List<String>, init: (AWSDirectoryServiceUpdateConditionalForwarderCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.UpdateConditionalForwarderResult {
	return this.block.declare(AWSDirectoryServiceUpdateConditionalForwarderCommand(directoryId, remoteDomainName, dnsIpAddrs).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.UpdateConditionalForwarderResult
}
...
class AWSDirectoryServiceUpdateConditionalForwarderCommand(val directoryId: String, val remoteDomainName: String, val dnsIpAddrs: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.UpdateConditionalForwarderRequest, com.amazonaws.services.directory.model.UpdateConditionalForwarderResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.UpdateConditionalForwarderResult {
...
fun AWSDirectoryServiceFunctions.updateNumberOfDomainControllers(directoryId: String, desiredNumber: Int, init: (AWSDirectoryServiceUpdateNumberOfDomainControllersCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.UpdateNumberOfDomainControllersResult {
	return this.block.declare(AWSDirectoryServiceUpdateNumberOfDomainControllersCommand(directoryId, desiredNumber).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.UpdateNumberOfDomainControllersResult
}
...
class AWSDirectoryServiceUpdateNumberOfDomainControllersCommand(val directoryId: String, val desiredNumber: Int) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.UpdateNumberOfDomainControllersRequest, com.amazonaws.services.directory.model.UpdateNumberOfDomainControllersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.UpdateNumberOfDomainControllersResult {
...
fun AWSDirectoryServiceFunctions.updateRadius(directoryId: String, radiusSettings: com.amazonaws.services.directory.model.RadiusSettings, init: (AWSDirectoryServiceUpdateRadiusCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.UpdateRadiusResult {
	return this.block.declare(AWSDirectoryServiceUpdateRadiusCommand(directoryId, radiusSettings).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.UpdateRadiusResult
}
...
class AWSDirectoryServiceUpdateRadiusCommand(val directoryId: String, val radiusSettings: com.amazonaws.services.directory.model.RadiusSettings) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.UpdateRadiusRequest, com.amazonaws.services.directory.model.UpdateRadiusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.UpdateRadiusResult {
...
fun AWSDirectoryServiceFunctions.verifyTrust(trustId: String, init: (AWSDirectoryServiceVerifyTrustCommand.() -> Unit)? = null): com.amazonaws.services.directory.model.VerifyTrustResult {
	return this.block.declare(AWSDirectoryServiceVerifyTrustCommand(trustId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.directory.model.VerifyTrustResult
}
...
class AWSDirectoryServiceVerifyTrustCommand(val trustId: String) : AmazonWebServiceCommand<com.amazonaws.services.directory.model.VerifyTrustRequest, com.amazonaws.services.directory.model.VerifyTrustResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.directory.model.VerifyTrustResult {
