...
package com.codingue.koops.aws.redshift
...
var com.codingue.koops.core.Environment.redshift: AmazonRedshift
	get() {
...
fun AmazonRedshiftFunctions.authorizeClusterSecurityGroupIngress(clusterSecurityGroupName: String, init: (AmazonRedshiftAuthorizeClusterSecurityGroupIngressCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.ClusterSecurityGroup {
	return this.block.declare(AmazonRedshiftAuthorizeClusterSecurityGroupIngressCommand(clusterSecurityGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.ClusterSecurityGroup
}
...
class AmazonRedshiftAuthorizeClusterSecurityGroupIngressCommand(val clusterSecurityGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.AuthorizeClusterSecurityGroupIngressRequest, com.amazonaws.services.redshift.model.ClusterSecurityGroup> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.ClusterSecurityGroup {
...
fun AmazonRedshiftFunctions.authorizeSnapshotAccess(snapshotIdentifier: String, accountWithRestoreAccess: String, init: (AmazonRedshiftAuthorizeSnapshotAccessCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.Snapshot {
	return this.block.declare(AmazonRedshiftAuthorizeSnapshotAccessCommand(snapshotIdentifier, accountWithRestoreAccess).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.Snapshot
}
...
class AmazonRedshiftAuthorizeSnapshotAccessCommand(val snapshotIdentifier: String, val accountWithRestoreAccess: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.AuthorizeSnapshotAccessRequest, com.amazonaws.services.redshift.model.Snapshot> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.Snapshot {
...
fun AmazonRedshiftFunctions.copyClusterSnapshot(sourceSnapshotIdentifier: String, targetSnapshotIdentifier: String, init: (AmazonRedshiftCopyClusterSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.Snapshot {
	return this.block.declare(AmazonRedshiftCopyClusterSnapshotCommand(sourceSnapshotIdentifier, targetSnapshotIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.Snapshot
}
...
fun AmazonRedshiftFunctions.createCluster(clusterIdentifier: String, nodeType: String, masterUsername: String, masterUserPassword: String, init: (AmazonRedshiftCreateClusterCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.Cluster {
	return this.block.declare(AmazonRedshiftCreateClusterCommand(clusterIdentifier, nodeType, masterUsername, masterUserPassword).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.Cluster
}
...
class AmazonRedshiftCreateClusterCommand(val clusterIdentifier: String, val nodeType: String, val masterUsername: String, val masterUserPassword: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.CreateClusterRequest, com.amazonaws.services.redshift.model.Cluster> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.Cluster {
...
fun AmazonRedshiftFunctions.createClusterParameterGroup(parameterGroupName: String, parameterGroupFamily: String, description: String, init: (AmazonRedshiftCreateClusterParameterGroupCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.ClusterParameterGroup {
	return this.block.declare(AmazonRedshiftCreateClusterParameterGroupCommand(parameterGroupName, parameterGroupFamily, description).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.ClusterParameterGroup
}
...
class AmazonRedshiftCreateClusterParameterGroupCommand(val parameterGroupName: String, val parameterGroupFamily: String, val description: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.CreateClusterParameterGroupRequest, com.amazonaws.services.redshift.model.ClusterParameterGroup> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.ClusterParameterGroup {
...
fun AmazonRedshiftFunctions.createClusterSecurityGroup(clusterSecurityGroupName: String, description: String, init: (AmazonRedshiftCreateClusterSecurityGroupCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.ClusterSecurityGroup {
	return this.block.declare(AmazonRedshiftCreateClusterSecurityGroupCommand(clusterSecurityGroupName, description).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.ClusterSecurityGroup
}
...
fun AmazonRedshiftFunctions.createClusterSnapshot(snapshotIdentifier: String, clusterIdentifier: String, init: (AmazonRedshiftCreateClusterSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.Snapshot {
	return this.block.declare(AmazonRedshiftCreateClusterSnapshotCommand(snapshotIdentifier, clusterIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.Snapshot
}
...
fun AmazonRedshiftFunctions.createClusterSubnetGroup(clusterSubnetGroupName: String, description: String, subnetIds: List<String>, init: (AmazonRedshiftCreateClusterSubnetGroupCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.ClusterSubnetGroup {
	return this.block.declare(AmazonRedshiftCreateClusterSubnetGroupCommand(clusterSubnetGroupName, description, subnetIds).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.ClusterSubnetGroup
}
...
class AmazonRedshiftCreateClusterSubnetGroupCommand(val clusterSubnetGroupName: String, val description: String, val subnetIds: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.CreateClusterSubnetGroupRequest, com.amazonaws.services.redshift.model.ClusterSubnetGroup> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.ClusterSubnetGroup {
...
fun AmazonRedshiftFunctions.createEventSubscription(subscriptionName: String, snsTopicArn: String, init: (AmazonRedshiftCreateEventSubscriptionCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.EventSubscription {
	return this.block.declare(AmazonRedshiftCreateEventSubscriptionCommand(subscriptionName, snsTopicArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.EventSubscription
}
...
class AmazonRedshiftCreateEventSubscriptionCommand(val subscriptionName: String, val snsTopicArn: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.CreateEventSubscriptionRequest, com.amazonaws.services.redshift.model.EventSubscription> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.EventSubscription {
...
fun AmazonRedshiftFunctions.createHsmClientCertificate(hsmClientCertificateIdentifier: String, init: (AmazonRedshiftCreateHsmClientCertificateCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.HsmClientCertificate {
	return this.block.declare(AmazonRedshiftCreateHsmClientCertificateCommand(hsmClientCertificateIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.HsmClientCertificate
}
...
class AmazonRedshiftCreateHsmClientCertificateCommand(val hsmClientCertificateIdentifier: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.CreateHsmClientCertificateRequest, com.amazonaws.services.redshift.model.HsmClientCertificate> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.HsmClientCertificate {
...
fun AmazonRedshiftFunctions.createHsmConfiguration(hsmConfigurationIdentifier: String, description: String, hsmIpAddress: String, hsmPartitionName: String, hsmPartitionPassword: String, hsmServerPublicCertificate: String, init: (AmazonRedshiftCreateHsmConfigurationCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.HsmConfiguration {
	return this.block.declare(AmazonRedshiftCreateHsmConfigurationCommand(hsmConfigurationIdentifier, description, hsmIpAddress, hsmPartitionName, hsmPartitionPassword, hsmServerPublicCertificate).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.HsmConfiguration
}
...
class AmazonRedshiftCreateHsmConfigurationCommand(val hsmConfigurationIdentifier: String, val description: String, val hsmIpAddress: String, val hsmPartitionName: String, val hsmPartitionPassword: String, val hsmServerPublicCertificate: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.CreateHsmConfigurationRequest, com.amazonaws.services.redshift.model.HsmConfiguration> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.HsmConfiguration {
...
fun AmazonRedshiftFunctions.createSnapshotCopyGrant(snapshotCopyGrantName: String, init: (AmazonRedshiftCreateSnapshotCopyGrantCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.SnapshotCopyGrant {
	return this.block.declare(AmazonRedshiftCreateSnapshotCopyGrantCommand(snapshotCopyGrantName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.SnapshotCopyGrant
}
...
class AmazonRedshiftCreateSnapshotCopyGrantCommand(val snapshotCopyGrantName: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.CreateSnapshotCopyGrantRequest, com.amazonaws.services.redshift.model.SnapshotCopyGrant> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.SnapshotCopyGrant {
...
fun AmazonRedshiftFunctions.createTags(resourceName: String, tags: List<com.amazonaws.services.redshift.model.Tag>, init: (AmazonRedshiftCreateTagsCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.CreateTagsResult {
	return this.block.declare(AmazonRedshiftCreateTagsCommand(resourceName, tags).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.CreateTagsResult
}
...
class AmazonRedshiftCreateTagsCommand(val resourceName: String, val tags: List<com.amazonaws.services.redshift.model.Tag>) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.CreateTagsRequest, com.amazonaws.services.redshift.model.CreateTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.CreateTagsResult {
...
fun AmazonRedshiftFunctions.deleteCluster(clusterIdentifier: String, init: (AmazonRedshiftDeleteClusterCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.Cluster {
	return this.block.declare(AmazonRedshiftDeleteClusterCommand(clusterIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.Cluster
}
...
fun AmazonRedshiftFunctions.deleteClusterParameterGroup(parameterGroupName: String, init: (AmazonRedshiftDeleteClusterParameterGroupCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DeleteClusterParameterGroupResult {
	return this.block.declare(AmazonRedshiftDeleteClusterParameterGroupCommand(parameterGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DeleteClusterParameterGroupResult
}
...
class AmazonRedshiftDeleteClusterParameterGroupCommand(val parameterGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DeleteClusterParameterGroupRequest, com.amazonaws.services.redshift.model.DeleteClusterParameterGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DeleteClusterParameterGroupResult {
...
fun AmazonRedshiftFunctions.deleteClusterSecurityGroup(clusterSecurityGroupName: String, init: (AmazonRedshiftDeleteClusterSecurityGroupCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DeleteClusterSecurityGroupResult {
	return this.block.declare(AmazonRedshiftDeleteClusterSecurityGroupCommand(clusterSecurityGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DeleteClusterSecurityGroupResult
}
...
class AmazonRedshiftDeleteClusterSecurityGroupCommand(val clusterSecurityGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DeleteClusterSecurityGroupRequest, com.amazonaws.services.redshift.model.DeleteClusterSecurityGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DeleteClusterSecurityGroupResult {
...
fun AmazonRedshiftFunctions.deleteClusterSnapshot(snapshotIdentifier: String, init: (AmazonRedshiftDeleteClusterSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.Snapshot {
	return this.block.declare(AmazonRedshiftDeleteClusterSnapshotCommand(snapshotIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.Snapshot
}
...
fun AmazonRedshiftFunctions.deleteClusterSubnetGroup(clusterSubnetGroupName: String, init: (AmazonRedshiftDeleteClusterSubnetGroupCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DeleteClusterSubnetGroupResult {
	return this.block.declare(AmazonRedshiftDeleteClusterSubnetGroupCommand(clusterSubnetGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DeleteClusterSubnetGroupResult
}
...
class AmazonRedshiftDeleteClusterSubnetGroupCommand(val clusterSubnetGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DeleteClusterSubnetGroupRequest, com.amazonaws.services.redshift.model.DeleteClusterSubnetGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DeleteClusterSubnetGroupResult {
...
fun AmazonRedshiftFunctions.deleteEventSubscription(subscriptionName: String, init: (AmazonRedshiftDeleteEventSubscriptionCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DeleteEventSubscriptionResult {
	return this.block.declare(AmazonRedshiftDeleteEventSubscriptionCommand(subscriptionName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DeleteEventSubscriptionResult
}
...
class AmazonRedshiftDeleteEventSubscriptionCommand(val subscriptionName: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DeleteEventSubscriptionRequest, com.amazonaws.services.redshift.model.DeleteEventSubscriptionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DeleteEventSubscriptionResult {
...
fun AmazonRedshiftFunctions.deleteHsmClientCertificate(hsmClientCertificateIdentifier: String, init: (AmazonRedshiftDeleteHsmClientCertificateCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DeleteHsmClientCertificateResult {
	return this.block.declare(AmazonRedshiftDeleteHsmClientCertificateCommand(hsmClientCertificateIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DeleteHsmClientCertificateResult
}
...
class AmazonRedshiftDeleteHsmClientCertificateCommand(val hsmClientCertificateIdentifier: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DeleteHsmClientCertificateRequest, com.amazonaws.services.redshift.model.DeleteHsmClientCertificateResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DeleteHsmClientCertificateResult {
...
fun AmazonRedshiftFunctions.deleteHsmConfiguration(hsmConfigurationIdentifier: String, init: (AmazonRedshiftDeleteHsmConfigurationCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DeleteHsmConfigurationResult {
	return this.block.declare(AmazonRedshiftDeleteHsmConfigurationCommand(hsmConfigurationIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DeleteHsmConfigurationResult
}
...
class AmazonRedshiftDeleteHsmConfigurationCommand(val hsmConfigurationIdentifier: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DeleteHsmConfigurationRequest, com.amazonaws.services.redshift.model.DeleteHsmConfigurationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DeleteHsmConfigurationResult {
...
fun AmazonRedshiftFunctions.deleteSnapshotCopyGrant(snapshotCopyGrantName: String, init: (AmazonRedshiftDeleteSnapshotCopyGrantCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DeleteSnapshotCopyGrantResult {
	return this.block.declare(AmazonRedshiftDeleteSnapshotCopyGrantCommand(snapshotCopyGrantName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DeleteSnapshotCopyGrantResult
}
...
class AmazonRedshiftDeleteSnapshotCopyGrantCommand(val snapshotCopyGrantName: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DeleteSnapshotCopyGrantRequest, com.amazonaws.services.redshift.model.DeleteSnapshotCopyGrantResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DeleteSnapshotCopyGrantResult {
...
fun AmazonRedshiftFunctions.deleteTags(resourceName: String, tagKeys: List<String>, init: (AmazonRedshiftDeleteTagsCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DeleteTagsResult {
	return this.block.declare(AmazonRedshiftDeleteTagsCommand(resourceName, tagKeys).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DeleteTagsResult
}
...
class AmazonRedshiftDeleteTagsCommand(val resourceName: String, val tagKeys: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DeleteTagsRequest, com.amazonaws.services.redshift.model.DeleteTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DeleteTagsResult {
...
fun AmazonRedshiftFunctions.describeClusterParameterGroups(init: (AmazonRedshiftDescribeClusterParameterGroupsCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeClusterParameterGroupsResult {
	return this.block.declare(AmazonRedshiftDescribeClusterParameterGroupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeClusterParameterGroupsResult
}
...
class AmazonRedshiftDescribeClusterParameterGroupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeClusterParameterGroupsRequest, com.amazonaws.services.redshift.model.DescribeClusterParameterGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeClusterParameterGroupsResult {
...
fun AmazonRedshiftFunctions.describeClusterParameters(parameterGroupName: String, init: (AmazonRedshiftDescribeClusterParametersCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeClusterParametersResult {
	return this.block.declare(AmazonRedshiftDescribeClusterParametersCommand(parameterGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeClusterParametersResult
}
...
class AmazonRedshiftDescribeClusterParametersCommand(val parameterGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeClusterParametersRequest, com.amazonaws.services.redshift.model.DescribeClusterParametersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeClusterParametersResult {
...
fun AmazonRedshiftFunctions.describeClusterSecurityGroups(init: (AmazonRedshiftDescribeClusterSecurityGroupsCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeClusterSecurityGroupsResult {
	return this.block.declare(AmazonRedshiftDescribeClusterSecurityGroupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeClusterSecurityGroupsResult
}
...
class AmazonRedshiftDescribeClusterSecurityGroupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeClusterSecurityGroupsRequest, com.amazonaws.services.redshift.model.DescribeClusterSecurityGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeClusterSecurityGroupsResult {
...
fun AmazonRedshiftFunctions.describeClusterSnapshots(init: (AmazonRedshiftDescribeClusterSnapshotsCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeClusterSnapshotsResult {
	return this.block.declare(AmazonRedshiftDescribeClusterSnapshotsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeClusterSnapshotsResult
}
...
class AmazonRedshiftDescribeClusterSnapshotsCommand() : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeClusterSnapshotsRequest, com.amazonaws.services.redshift.model.DescribeClusterSnapshotsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeClusterSnapshotsResult {
...
fun AmazonRedshiftFunctions.describeClusterSubnetGroups(init: (AmazonRedshiftDescribeClusterSubnetGroupsCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeClusterSubnetGroupsResult {
	return this.block.declare(AmazonRedshiftDescribeClusterSubnetGroupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeClusterSubnetGroupsResult
}
...
class AmazonRedshiftDescribeClusterSubnetGroupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeClusterSubnetGroupsRequest, com.amazonaws.services.redshift.model.DescribeClusterSubnetGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeClusterSubnetGroupsResult {
...
fun AmazonRedshiftFunctions.describeClusterVersions(init: (AmazonRedshiftDescribeClusterVersionsCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeClusterVersionsResult {
	return this.block.declare(AmazonRedshiftDescribeClusterVersionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeClusterVersionsResult
}
...
class AmazonRedshiftDescribeClusterVersionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeClusterVersionsRequest, com.amazonaws.services.redshift.model.DescribeClusterVersionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeClusterVersionsResult {
...
fun AmazonRedshiftFunctions.describeClusters(init: (AmazonRedshiftDescribeClustersCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeClustersResult {
	return this.block.declare(AmazonRedshiftDescribeClustersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeClustersResult
}
...
class AmazonRedshiftDescribeClustersCommand() : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeClustersRequest, com.amazonaws.services.redshift.model.DescribeClustersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeClustersResult {
...
fun AmazonRedshiftFunctions.describeDefaultClusterParameters(parameterGroupFamily: String, init: (AmazonRedshiftDescribeDefaultClusterParametersCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DefaultClusterParameters {
	return this.block.declare(AmazonRedshiftDescribeDefaultClusterParametersCommand(parameterGroupFamily).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DefaultClusterParameters
}
...
class AmazonRedshiftDescribeDefaultClusterParametersCommand(val parameterGroupFamily: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeDefaultClusterParametersRequest, com.amazonaws.services.redshift.model.DefaultClusterParameters> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DefaultClusterParameters {
...
fun AmazonRedshiftFunctions.describeEventCategories(init: (AmazonRedshiftDescribeEventCategoriesCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeEventCategoriesResult {
	return this.block.declare(AmazonRedshiftDescribeEventCategoriesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeEventCategoriesResult
}
...
class AmazonRedshiftDescribeEventCategoriesCommand() : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeEventCategoriesRequest, com.amazonaws.services.redshift.model.DescribeEventCategoriesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeEventCategoriesResult {
...
fun AmazonRedshiftFunctions.describeEventSubscriptions(init: (AmazonRedshiftDescribeEventSubscriptionsCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeEventSubscriptionsResult {
	return this.block.declare(AmazonRedshiftDescribeEventSubscriptionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeEventSubscriptionsResult
}
...
class AmazonRedshiftDescribeEventSubscriptionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeEventSubscriptionsRequest, com.amazonaws.services.redshift.model.DescribeEventSubscriptionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeEventSubscriptionsResult {
...
fun AmazonRedshiftFunctions.describeEvents(init: (AmazonRedshiftDescribeEventsCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeEventsResult {
	return this.block.declare(AmazonRedshiftDescribeEventsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeEventsResult
}
...
class AmazonRedshiftDescribeEventsCommand() : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeEventsRequest, com.amazonaws.services.redshift.model.DescribeEventsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeEventsResult {
...
fun AmazonRedshiftFunctions.describeHsmClientCertificates(init: (AmazonRedshiftDescribeHsmClientCertificatesCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeHsmClientCertificatesResult {
	return this.block.declare(AmazonRedshiftDescribeHsmClientCertificatesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeHsmClientCertificatesResult
}
...
class AmazonRedshiftDescribeHsmClientCertificatesCommand() : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeHsmClientCertificatesRequest, com.amazonaws.services.redshift.model.DescribeHsmClientCertificatesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeHsmClientCertificatesResult {
...
fun AmazonRedshiftFunctions.describeHsmConfigurations(init: (AmazonRedshiftDescribeHsmConfigurationsCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeHsmConfigurationsResult {
	return this.block.declare(AmazonRedshiftDescribeHsmConfigurationsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeHsmConfigurationsResult
}
...
class AmazonRedshiftDescribeHsmConfigurationsCommand() : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeHsmConfigurationsRequest, com.amazonaws.services.redshift.model.DescribeHsmConfigurationsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeHsmConfigurationsResult {
...
fun AmazonRedshiftFunctions.describeLoggingStatus(clusterIdentifier: String, init: (AmazonRedshiftDescribeLoggingStatusCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeLoggingStatusResult {
	return this.block.declare(AmazonRedshiftDescribeLoggingStatusCommand(clusterIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeLoggingStatusResult
}
...
class AmazonRedshiftDescribeLoggingStatusCommand(val clusterIdentifier: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeLoggingStatusRequest, com.amazonaws.services.redshift.model.DescribeLoggingStatusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeLoggingStatusResult {
...
fun AmazonRedshiftFunctions.describeOrderableClusterOptions(init: (AmazonRedshiftDescribeOrderableClusterOptionsCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeOrderableClusterOptionsResult {
	return this.block.declare(AmazonRedshiftDescribeOrderableClusterOptionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeOrderableClusterOptionsResult
}
...
class AmazonRedshiftDescribeOrderableClusterOptionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeOrderableClusterOptionsRequest, com.amazonaws.services.redshift.model.DescribeOrderableClusterOptionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeOrderableClusterOptionsResult {
...
fun AmazonRedshiftFunctions.describeReservedNodeOfferings(init: (AmazonRedshiftDescribeReservedNodeOfferingsCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeReservedNodeOfferingsResult {
	return this.block.declare(AmazonRedshiftDescribeReservedNodeOfferingsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeReservedNodeOfferingsResult
}
...
class AmazonRedshiftDescribeReservedNodeOfferingsCommand() : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeReservedNodeOfferingsRequest, com.amazonaws.services.redshift.model.DescribeReservedNodeOfferingsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeReservedNodeOfferingsResult {
...
fun AmazonRedshiftFunctions.describeReservedNodes(init: (AmazonRedshiftDescribeReservedNodesCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeReservedNodesResult {
	return this.block.declare(AmazonRedshiftDescribeReservedNodesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeReservedNodesResult
}
...
class AmazonRedshiftDescribeReservedNodesCommand() : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeReservedNodesRequest, com.amazonaws.services.redshift.model.DescribeReservedNodesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeReservedNodesResult {
...
fun AmazonRedshiftFunctions.describeResize(clusterIdentifier: String, init: (AmazonRedshiftDescribeResizeCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeResizeResult {
	return this.block.declare(AmazonRedshiftDescribeResizeCommand(clusterIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeResizeResult
}
...
class AmazonRedshiftDescribeResizeCommand(val clusterIdentifier: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeResizeRequest, com.amazonaws.services.redshift.model.DescribeResizeResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeResizeResult {
...
fun AmazonRedshiftFunctions.describeSnapshotCopyGrants(init: (AmazonRedshiftDescribeSnapshotCopyGrantsCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeSnapshotCopyGrantsResult {
	return this.block.declare(AmazonRedshiftDescribeSnapshotCopyGrantsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeSnapshotCopyGrantsResult
}
...
class AmazonRedshiftDescribeSnapshotCopyGrantsCommand() : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeSnapshotCopyGrantsRequest, com.amazonaws.services.redshift.model.DescribeSnapshotCopyGrantsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeSnapshotCopyGrantsResult {
...
fun AmazonRedshiftFunctions.describeTableRestoreStatus(init: (AmazonRedshiftDescribeTableRestoreStatusCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeTableRestoreStatusResult {
	return this.block.declare(AmazonRedshiftDescribeTableRestoreStatusCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeTableRestoreStatusResult
}
...
class AmazonRedshiftDescribeTableRestoreStatusCommand() : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeTableRestoreStatusRequest, com.amazonaws.services.redshift.model.DescribeTableRestoreStatusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeTableRestoreStatusResult {
...
fun AmazonRedshiftFunctions.describeTags(init: (AmazonRedshiftDescribeTagsCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DescribeTagsResult {
	return this.block.declare(AmazonRedshiftDescribeTagsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DescribeTagsResult
}
...
class AmazonRedshiftDescribeTagsCommand() : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DescribeTagsRequest, com.amazonaws.services.redshift.model.DescribeTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DescribeTagsResult {
...
fun AmazonRedshiftFunctions.disableLogging(clusterIdentifier: String, init: (AmazonRedshiftDisableLoggingCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.DisableLoggingResult {
	return this.block.declare(AmazonRedshiftDisableLoggingCommand(clusterIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.DisableLoggingResult
}
...
class AmazonRedshiftDisableLoggingCommand(val clusterIdentifier: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.DisableLoggingRequest, com.amazonaws.services.redshift.model.DisableLoggingResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.DisableLoggingResult {
...
fun AmazonRedshiftFunctions.disableSnapshotCopy(clusterIdentifier: String, init: (AmazonRedshiftDisableSnapshotCopyCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.Cluster {
	return this.block.declare(AmazonRedshiftDisableSnapshotCopyCommand(clusterIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.Cluster
}
...
fun AmazonRedshiftFunctions.enableLogging(clusterIdentifier: String, bucketName: String, init: (AmazonRedshiftEnableLoggingCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.EnableLoggingResult {
	return this.block.declare(AmazonRedshiftEnableLoggingCommand(clusterIdentifier, bucketName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.EnableLoggingResult
}
...
class AmazonRedshiftEnableLoggingCommand(val clusterIdentifier: String, val bucketName: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.EnableLoggingRequest, com.amazonaws.services.redshift.model.EnableLoggingResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.EnableLoggingResult {
...
fun AmazonRedshiftFunctions.enableSnapshotCopy(clusterIdentifier: String, destinationRegion: String, init: (AmazonRedshiftEnableSnapshotCopyCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.Cluster {
	return this.block.declare(AmazonRedshiftEnableSnapshotCopyCommand(clusterIdentifier, destinationRegion).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.Cluster
}
...
fun AmazonRedshiftFunctions.getClusterCredentials(dbUser: String, clusterIdentifier: String, init: (AmazonRedshiftGetClusterCredentialsCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.GetClusterCredentialsResult {
	return this.block.declare(AmazonRedshiftGetClusterCredentialsCommand(dbUser, clusterIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.GetClusterCredentialsResult
}
...
class AmazonRedshiftGetClusterCredentialsCommand(val dbUser: String, val clusterIdentifier: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.GetClusterCredentialsRequest, com.amazonaws.services.redshift.model.GetClusterCredentialsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.GetClusterCredentialsResult {
...
fun AmazonRedshiftFunctions.modifyCluster(clusterIdentifier: String, init: (AmazonRedshiftModifyClusterCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.Cluster {
	return this.block.declare(AmazonRedshiftModifyClusterCommand(clusterIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.Cluster
}
...
fun AmazonRedshiftFunctions.modifyClusterIamRoles(clusterIdentifier: String, init: (AmazonRedshiftModifyClusterIamRolesCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.Cluster {
	return this.block.declare(AmazonRedshiftModifyClusterIamRolesCommand(clusterIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.Cluster
}
...
fun AmazonRedshiftFunctions.modifyClusterParameterGroup(parameterGroupName: String, parameters: List<com.amazonaws.services.redshift.model.Parameter>, init: (AmazonRedshiftModifyClusterParameterGroupCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.ModifyClusterParameterGroupResult {
	return this.block.declare(AmazonRedshiftModifyClusterParameterGroupCommand(parameterGroupName, parameters).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.ModifyClusterParameterGroupResult
}
...
class AmazonRedshiftModifyClusterParameterGroupCommand(val parameterGroupName: String, val parameters: List<com.amazonaws.services.redshift.model.Parameter>) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.ModifyClusterParameterGroupRequest, com.amazonaws.services.redshift.model.ModifyClusterParameterGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.ModifyClusterParameterGroupResult {
...
fun AmazonRedshiftFunctions.modifyClusterSubnetGroup(clusterSubnetGroupName: String, subnetIds: List<String>, init: (AmazonRedshiftModifyClusterSubnetGroupCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.ClusterSubnetGroup {
	return this.block.declare(AmazonRedshiftModifyClusterSubnetGroupCommand(clusterSubnetGroupName, subnetIds).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.ClusterSubnetGroup
}
...
fun AmazonRedshiftFunctions.modifyEventSubscription(subscriptionName: String, init: (AmazonRedshiftModifyEventSubscriptionCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.EventSubscription {
	return this.block.declare(AmazonRedshiftModifyEventSubscriptionCommand(subscriptionName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.EventSubscription
}
...
fun AmazonRedshiftFunctions.modifySnapshotCopyRetentionPeriod(clusterIdentifier: String, retentionPeriod: Int, init: (AmazonRedshiftModifySnapshotCopyRetentionPeriodCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.Cluster {
	return this.block.declare(AmazonRedshiftModifySnapshotCopyRetentionPeriodCommand(clusterIdentifier, retentionPeriod).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.Cluster
}
...
fun AmazonRedshiftFunctions.purchaseReservedNodeOffering(reservedNodeOfferingId: String, init: (AmazonRedshiftPurchaseReservedNodeOfferingCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.ReservedNode {
	return this.block.declare(AmazonRedshiftPurchaseReservedNodeOfferingCommand(reservedNodeOfferingId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.ReservedNode
}
...
class AmazonRedshiftPurchaseReservedNodeOfferingCommand(val reservedNodeOfferingId: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.PurchaseReservedNodeOfferingRequest, com.amazonaws.services.redshift.model.ReservedNode> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.ReservedNode {
...
fun AmazonRedshiftFunctions.rebootCluster(clusterIdentifier: String, init: (AmazonRedshiftRebootClusterCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.Cluster {
	return this.block.declare(AmazonRedshiftRebootClusterCommand(clusterIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.Cluster
}
...
fun AmazonRedshiftFunctions.resetClusterParameterGroup(parameterGroupName: String, init: (AmazonRedshiftResetClusterParameterGroupCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.ResetClusterParameterGroupResult {
	return this.block.declare(AmazonRedshiftResetClusterParameterGroupCommand(parameterGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.ResetClusterParameterGroupResult
}
...
class AmazonRedshiftResetClusterParameterGroupCommand(val parameterGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.ResetClusterParameterGroupRequest, com.amazonaws.services.redshift.model.ResetClusterParameterGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.ResetClusterParameterGroupResult {
...
fun AmazonRedshiftFunctions.restoreFromClusterSnapshot(clusterIdentifier: String, snapshotIdentifier: String, init: (AmazonRedshiftRestoreFromClusterSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.Cluster {
	return this.block.declare(AmazonRedshiftRestoreFromClusterSnapshotCommand(clusterIdentifier, snapshotIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.Cluster
}
...
fun AmazonRedshiftFunctions.restoreTableFromClusterSnapshot(clusterIdentifier: String, snapshotIdentifier: String, sourceDatabaseName: String, sourceTableName: String, newTableName: String, init: (AmazonRedshiftRestoreTableFromClusterSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.TableRestoreStatus {
	return this.block.declare(AmazonRedshiftRestoreTableFromClusterSnapshotCommand(clusterIdentifier, snapshotIdentifier, sourceDatabaseName, sourceTableName, newTableName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.TableRestoreStatus
}
...
class AmazonRedshiftRestoreTableFromClusterSnapshotCommand(val clusterIdentifier: String, val snapshotIdentifier: String, val sourceDatabaseName: String, val sourceTableName: String, val newTableName: String) : AmazonWebServiceCommand<com.amazonaws.services.redshift.model.RestoreTableFromClusterSnapshotRequest, com.amazonaws.services.redshift.model.TableRestoreStatus> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.redshift.model.TableRestoreStatus {
...
fun AmazonRedshiftFunctions.revokeClusterSecurityGroupIngress(clusterSecurityGroupName: String, init: (AmazonRedshiftRevokeClusterSecurityGroupIngressCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.ClusterSecurityGroup {
	return this.block.declare(AmazonRedshiftRevokeClusterSecurityGroupIngressCommand(clusterSecurityGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.ClusterSecurityGroup
}
...
fun AmazonRedshiftFunctions.revokeSnapshotAccess(snapshotIdentifier: String, accountWithRestoreAccess: String, init: (AmazonRedshiftRevokeSnapshotAccessCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.Snapshot {
	return this.block.declare(AmazonRedshiftRevokeSnapshotAccessCommand(snapshotIdentifier, accountWithRestoreAccess).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.Snapshot
}
...
fun AmazonRedshiftFunctions.rotateEncryptionKey(clusterIdentifier: String, init: (AmazonRedshiftRotateEncryptionKeyCommand.() -> Unit)? = null): com.amazonaws.services.redshift.model.Cluster {
	return this.block.declare(AmazonRedshiftRotateEncryptionKeyCommand(clusterIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.redshift.model.Cluster
}
