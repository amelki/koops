...
package com.codingue.koops.aws.elasticache
...
var com.codingue.koops.core.Environment.elasticache: AmazonElastiCache
	get() {
		var service = this.capabilities["aws-elasticache"]
		if (service == null) {
			service = AmazonElastiCacheClientBuilder.standard().build()
			this.capabilities["aws-elasticache"] = service
		}
		return service as AmazonElastiCache
	}
	set(elasticache) {
		this.capabilities["aws-elasticache"] = elasticache
	}
...
fun AmazonElastiCacheFunctions.addTagsToResource(resourceName: String, tags: List<com.amazonaws.services.elasticache.model.Tag>, init: (AmazonElastiCacheAddTagsToResourceCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.AddTagsToResourceResult {
	return this.block.declare(AmazonElastiCacheAddTagsToResourceCommand(resourceName, tags).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.AddTagsToResourceResult
}
...
class AmazonElastiCacheAddTagsToResourceCommand(val resourceName: String, val tags: List<com.amazonaws.services.elasticache.model.Tag>) : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.AddTagsToResourceRequest, com.amazonaws.services.elasticache.model.AddTagsToResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.AddTagsToResourceResult {
...
fun AmazonElastiCacheFunctions.authorizeCacheSecurityGroupIngress(cacheSecurityGroupName: String, eC2SecurityGroupName: String, eC2SecurityGroupOwnerId: String, init: (AmazonElastiCacheAuthorizeCacheSecurityGroupIngressCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.CacheSecurityGroup {
	return this.block.declare(AmazonElastiCacheAuthorizeCacheSecurityGroupIngressCommand(cacheSecurityGroupName, eC2SecurityGroupName, eC2SecurityGroupOwnerId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.CacheSecurityGroup
}
...
class AmazonElastiCacheAuthorizeCacheSecurityGroupIngressCommand(val cacheSecurityGroupName: String, val eC2SecurityGroupName: String, val eC2SecurityGroupOwnerId: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.AuthorizeCacheSecurityGroupIngressRequest, com.amazonaws.services.elasticache.model.CacheSecurityGroup> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.CacheSecurityGroup {
...
fun AmazonElastiCacheFunctions.copySnapshot(sourceSnapshotName: String, targetSnapshotName: String, init: (AmazonElastiCacheCopySnapshotCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.Snapshot {
	return this.block.declare(AmazonElastiCacheCopySnapshotCommand(sourceSnapshotName, targetSnapshotName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.Snapshot
}
...
class AmazonElastiCacheCopySnapshotCommand(val sourceSnapshotName: String, val targetSnapshotName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.CopySnapshotRequest, com.amazonaws.services.elasticache.model.Snapshot> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.Snapshot {
...
fun AmazonElastiCacheFunctions.createCacheCluster(cacheClusterId: String, init: (AmazonElastiCacheCreateCacheClusterCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.CacheCluster {
	return this.block.declare(AmazonElastiCacheCreateCacheClusterCommand(cacheClusterId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.CacheCluster
}
...
class AmazonElastiCacheCreateCacheClusterCommand(val cacheClusterId: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.CreateCacheClusterRequest, com.amazonaws.services.elasticache.model.CacheCluster> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.CacheCluster {
...
fun AmazonElastiCacheFunctions.createCacheParameterGroup(cacheParameterGroupName: String, cacheParameterGroupFamily: String, description: String, init: (AmazonElastiCacheCreateCacheParameterGroupCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.CacheParameterGroup {
	return this.block.declare(AmazonElastiCacheCreateCacheParameterGroupCommand(cacheParameterGroupName, cacheParameterGroupFamily, description).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.CacheParameterGroup
}
...
class AmazonElastiCacheCreateCacheParameterGroupCommand(val cacheParameterGroupName: String, val cacheParameterGroupFamily: String, val description: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.CreateCacheParameterGroupRequest, com.amazonaws.services.elasticache.model.CacheParameterGroup> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.CacheParameterGroup {
...
fun AmazonElastiCacheFunctions.createCacheSecurityGroup(cacheSecurityGroupName: String, description: String, init: (AmazonElastiCacheCreateCacheSecurityGroupCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.CacheSecurityGroup {
	return this.block.declare(AmazonElastiCacheCreateCacheSecurityGroupCommand(cacheSecurityGroupName, description).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.CacheSecurityGroup
}
...
fun AmazonElastiCacheFunctions.createCacheSubnetGroup(cacheSubnetGroupName: String, cacheSubnetGroupDescription: String, subnetIds: List<String>, init: (AmazonElastiCacheCreateCacheSubnetGroupCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.CacheSubnetGroup {
	return this.block.declare(AmazonElastiCacheCreateCacheSubnetGroupCommand(cacheSubnetGroupName, cacheSubnetGroupDescription, subnetIds).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.CacheSubnetGroup
}
...
class AmazonElastiCacheCreateCacheSubnetGroupCommand(val cacheSubnetGroupName: String, val cacheSubnetGroupDescription: String, val subnetIds: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.CreateCacheSubnetGroupRequest, com.amazonaws.services.elasticache.model.CacheSubnetGroup> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.CacheSubnetGroup {
...
fun AmazonElastiCacheFunctions.createReplicationGroup(replicationGroupId: String, replicationGroupDescription: String, init: (AmazonElastiCacheCreateReplicationGroupCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.ReplicationGroup {
	return this.block.declare(AmazonElastiCacheCreateReplicationGroupCommand(replicationGroupId, replicationGroupDescription).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.ReplicationGroup
}
...
class AmazonElastiCacheCreateReplicationGroupCommand(val replicationGroupId: String, val replicationGroupDescription: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.CreateReplicationGroupRequest, com.amazonaws.services.elasticache.model.ReplicationGroup> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.ReplicationGroup {
...
fun AmazonElastiCacheFunctions.createSnapshot(snapshotName: String, init: (AmazonElastiCacheCreateSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.Snapshot {
	return this.block.declare(AmazonElastiCacheCreateSnapshotCommand(snapshotName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.Snapshot
}
...
fun AmazonElastiCacheFunctions.deleteCacheCluster(cacheClusterId: String, init: (AmazonElastiCacheDeleteCacheClusterCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.CacheCluster {
	return this.block.declare(AmazonElastiCacheDeleteCacheClusterCommand(cacheClusterId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.CacheCluster
}
...
fun AmazonElastiCacheFunctions.deleteCacheParameterGroup(cacheParameterGroupName: String, init: (AmazonElastiCacheDeleteCacheParameterGroupCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.DeleteCacheParameterGroupResult {
	return this.block.declare(AmazonElastiCacheDeleteCacheParameterGroupCommand(cacheParameterGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.DeleteCacheParameterGroupResult
}
...
class AmazonElastiCacheDeleteCacheParameterGroupCommand(val cacheParameterGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.DeleteCacheParameterGroupRequest, com.amazonaws.services.elasticache.model.DeleteCacheParameterGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.DeleteCacheParameterGroupResult {
...
fun AmazonElastiCacheFunctions.deleteCacheSecurityGroup(cacheSecurityGroupName: String, init: (AmazonElastiCacheDeleteCacheSecurityGroupCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.DeleteCacheSecurityGroupResult {
	return this.block.declare(AmazonElastiCacheDeleteCacheSecurityGroupCommand(cacheSecurityGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.DeleteCacheSecurityGroupResult
}
...
class AmazonElastiCacheDeleteCacheSecurityGroupCommand(val cacheSecurityGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.DeleteCacheSecurityGroupRequest, com.amazonaws.services.elasticache.model.DeleteCacheSecurityGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.DeleteCacheSecurityGroupResult {
...
fun AmazonElastiCacheFunctions.deleteCacheSubnetGroup(cacheSubnetGroupName: String, init: (AmazonElastiCacheDeleteCacheSubnetGroupCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.DeleteCacheSubnetGroupResult {
	return this.block.declare(AmazonElastiCacheDeleteCacheSubnetGroupCommand(cacheSubnetGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.DeleteCacheSubnetGroupResult
}
...
class AmazonElastiCacheDeleteCacheSubnetGroupCommand(val cacheSubnetGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.DeleteCacheSubnetGroupRequest, com.amazonaws.services.elasticache.model.DeleteCacheSubnetGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.DeleteCacheSubnetGroupResult {
...
fun AmazonElastiCacheFunctions.deleteReplicationGroup(replicationGroupId: String, init: (AmazonElastiCacheDeleteReplicationGroupCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.ReplicationGroup {
	return this.block.declare(AmazonElastiCacheDeleteReplicationGroupCommand(replicationGroupId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.ReplicationGroup
}
...
fun AmazonElastiCacheFunctions.deleteSnapshot(snapshotName: String, init: (AmazonElastiCacheDeleteSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.Snapshot {
	return this.block.declare(AmazonElastiCacheDeleteSnapshotCommand(snapshotName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.Snapshot
}
...
fun AmazonElastiCacheFunctions.describeCacheClusters(init: (AmazonElastiCacheDescribeCacheClustersCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.DescribeCacheClustersResult {
	return this.block.declare(AmazonElastiCacheDescribeCacheClustersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.DescribeCacheClustersResult
}
...
class AmazonElastiCacheDescribeCacheClustersCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.DescribeCacheClustersRequest, com.amazonaws.services.elasticache.model.DescribeCacheClustersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.DescribeCacheClustersResult {
...
fun AmazonElastiCacheFunctions.describeCacheEngineVersions(init: (AmazonElastiCacheDescribeCacheEngineVersionsCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.DescribeCacheEngineVersionsResult {
	return this.block.declare(AmazonElastiCacheDescribeCacheEngineVersionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.DescribeCacheEngineVersionsResult
}
...
class AmazonElastiCacheDescribeCacheEngineVersionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.DescribeCacheEngineVersionsRequest, com.amazonaws.services.elasticache.model.DescribeCacheEngineVersionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.DescribeCacheEngineVersionsResult {
...
fun AmazonElastiCacheFunctions.describeCacheParameterGroups(init: (AmazonElastiCacheDescribeCacheParameterGroupsCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.DescribeCacheParameterGroupsResult {
	return this.block.declare(AmazonElastiCacheDescribeCacheParameterGroupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.DescribeCacheParameterGroupsResult
}
...
class AmazonElastiCacheDescribeCacheParameterGroupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.DescribeCacheParameterGroupsRequest, com.amazonaws.services.elasticache.model.DescribeCacheParameterGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.DescribeCacheParameterGroupsResult {
...
fun AmazonElastiCacheFunctions.describeCacheParameters(cacheParameterGroupName: String, init: (AmazonElastiCacheDescribeCacheParametersCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.DescribeCacheParametersResult {
	return this.block.declare(AmazonElastiCacheDescribeCacheParametersCommand(cacheParameterGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.DescribeCacheParametersResult
}
...
class AmazonElastiCacheDescribeCacheParametersCommand(val cacheParameterGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.DescribeCacheParametersRequest, com.amazonaws.services.elasticache.model.DescribeCacheParametersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.DescribeCacheParametersResult {
...
fun AmazonElastiCacheFunctions.describeCacheSecurityGroups(init: (AmazonElastiCacheDescribeCacheSecurityGroupsCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.DescribeCacheSecurityGroupsResult {
	return this.block.declare(AmazonElastiCacheDescribeCacheSecurityGroupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.DescribeCacheSecurityGroupsResult
}
...
class AmazonElastiCacheDescribeCacheSecurityGroupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.DescribeCacheSecurityGroupsRequest, com.amazonaws.services.elasticache.model.DescribeCacheSecurityGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.DescribeCacheSecurityGroupsResult {
...
fun AmazonElastiCacheFunctions.describeCacheSubnetGroups(init: (AmazonElastiCacheDescribeCacheSubnetGroupsCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.DescribeCacheSubnetGroupsResult {
	return this.block.declare(AmazonElastiCacheDescribeCacheSubnetGroupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.DescribeCacheSubnetGroupsResult
}
...
class AmazonElastiCacheDescribeCacheSubnetGroupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.DescribeCacheSubnetGroupsRequest, com.amazonaws.services.elasticache.model.DescribeCacheSubnetGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.DescribeCacheSubnetGroupsResult {
...
fun AmazonElastiCacheFunctions.describeEngineDefaultParameters(cacheParameterGroupFamily: String, init: (AmazonElastiCacheDescribeEngineDefaultParametersCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.EngineDefaults {
	return this.block.declare(AmazonElastiCacheDescribeEngineDefaultParametersCommand(cacheParameterGroupFamily).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.EngineDefaults
}
...
class AmazonElastiCacheDescribeEngineDefaultParametersCommand(val cacheParameterGroupFamily: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.DescribeEngineDefaultParametersRequest, com.amazonaws.services.elasticache.model.EngineDefaults> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.EngineDefaults {
...
fun AmazonElastiCacheFunctions.describeEvents(init: (AmazonElastiCacheDescribeEventsCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.DescribeEventsResult {
	return this.block.declare(AmazonElastiCacheDescribeEventsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.DescribeEventsResult
}
...
class AmazonElastiCacheDescribeEventsCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.DescribeEventsRequest, com.amazonaws.services.elasticache.model.DescribeEventsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.DescribeEventsResult {
...
fun AmazonElastiCacheFunctions.describeReplicationGroups(init: (AmazonElastiCacheDescribeReplicationGroupsCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.DescribeReplicationGroupsResult {
	return this.block.declare(AmazonElastiCacheDescribeReplicationGroupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.DescribeReplicationGroupsResult
}
...
class AmazonElastiCacheDescribeReplicationGroupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.DescribeReplicationGroupsRequest, com.amazonaws.services.elasticache.model.DescribeReplicationGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.DescribeReplicationGroupsResult {
...
fun AmazonElastiCacheFunctions.describeReservedCacheNodes(init: (AmazonElastiCacheDescribeReservedCacheNodesCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.DescribeReservedCacheNodesResult {
	return this.block.declare(AmazonElastiCacheDescribeReservedCacheNodesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.DescribeReservedCacheNodesResult
}
...
class AmazonElastiCacheDescribeReservedCacheNodesCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.DescribeReservedCacheNodesRequest, com.amazonaws.services.elasticache.model.DescribeReservedCacheNodesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.DescribeReservedCacheNodesResult {
...
fun AmazonElastiCacheFunctions.describeReservedCacheNodesOfferings(init: (AmazonElastiCacheDescribeReservedCacheNodesOfferingsCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.DescribeReservedCacheNodesOfferingsResult {
	return this.block.declare(AmazonElastiCacheDescribeReservedCacheNodesOfferingsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.DescribeReservedCacheNodesOfferingsResult
}
...
class AmazonElastiCacheDescribeReservedCacheNodesOfferingsCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.DescribeReservedCacheNodesOfferingsRequest, com.amazonaws.services.elasticache.model.DescribeReservedCacheNodesOfferingsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.DescribeReservedCacheNodesOfferingsResult {
...
fun AmazonElastiCacheFunctions.describeSnapshots(init: (AmazonElastiCacheDescribeSnapshotsCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.DescribeSnapshotsResult {
	return this.block.declare(AmazonElastiCacheDescribeSnapshotsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.DescribeSnapshotsResult
}
...
class AmazonElastiCacheDescribeSnapshotsCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.DescribeSnapshotsRequest, com.amazonaws.services.elasticache.model.DescribeSnapshotsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.DescribeSnapshotsResult {
...
fun AmazonElastiCacheFunctions.listAllowedNodeTypeModifications(init: (AmazonElastiCacheListAllowedNodeTypeModificationsCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.ListAllowedNodeTypeModificationsResult {
	return this.block.declare(AmazonElastiCacheListAllowedNodeTypeModificationsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.ListAllowedNodeTypeModificationsResult
}
...
class AmazonElastiCacheListAllowedNodeTypeModificationsCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.ListAllowedNodeTypeModificationsRequest, com.amazonaws.services.elasticache.model.ListAllowedNodeTypeModificationsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.ListAllowedNodeTypeModificationsResult {
...
fun AmazonElastiCacheFunctions.listTagsForResource(resourceName: String, init: (AmazonElastiCacheListTagsForResourceCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.ListTagsForResourceResult {
	return this.block.declare(AmazonElastiCacheListTagsForResourceCommand(resourceName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.ListTagsForResourceResult
}
...
class AmazonElastiCacheListTagsForResourceCommand(val resourceName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.ListTagsForResourceRequest, com.amazonaws.services.elasticache.model.ListTagsForResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.ListTagsForResourceResult {
...
fun AmazonElastiCacheFunctions.modifyCacheCluster(cacheClusterId: String, init: (AmazonElastiCacheModifyCacheClusterCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.CacheCluster {
	return this.block.declare(AmazonElastiCacheModifyCacheClusterCommand(cacheClusterId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.CacheCluster
}
...
fun AmazonElastiCacheFunctions.modifyCacheParameterGroup(cacheParameterGroupName: String, parameterNameValues: List<com.amazonaws.services.elasticache.model.ParameterNameValue>, init: (AmazonElastiCacheModifyCacheParameterGroupCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.ModifyCacheParameterGroupResult {
	return this.block.declare(AmazonElastiCacheModifyCacheParameterGroupCommand(cacheParameterGroupName, parameterNameValues).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.ModifyCacheParameterGroupResult
}
...
class AmazonElastiCacheModifyCacheParameterGroupCommand(val cacheParameterGroupName: String, val parameterNameValues: List<com.amazonaws.services.elasticache.model.ParameterNameValue>) : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.ModifyCacheParameterGroupRequest, com.amazonaws.services.elasticache.model.ModifyCacheParameterGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.ModifyCacheParameterGroupResult {
...
fun AmazonElastiCacheFunctions.modifyCacheSubnetGroup(cacheSubnetGroupName: String, init: (AmazonElastiCacheModifyCacheSubnetGroupCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.CacheSubnetGroup {
	return this.block.declare(AmazonElastiCacheModifyCacheSubnetGroupCommand(cacheSubnetGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.CacheSubnetGroup
}
...
fun AmazonElastiCacheFunctions.modifyReplicationGroup(replicationGroupId: String, init: (AmazonElastiCacheModifyReplicationGroupCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.ReplicationGroup {
	return this.block.declare(AmazonElastiCacheModifyReplicationGroupCommand(replicationGroupId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.ReplicationGroup
}
...
fun AmazonElastiCacheFunctions.modifyReplicationGroupShardConfiguration(replicationGroupId: String, nodeGroupCount: Int, applyImmediately: Boolean, init: (AmazonElastiCacheModifyReplicationGroupShardConfigurationCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.ReplicationGroup {
	return this.block.declare(AmazonElastiCacheModifyReplicationGroupShardConfigurationCommand(replicationGroupId, nodeGroupCount, applyImmediately).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.ReplicationGroup
}
...
fun AmazonElastiCacheFunctions.purchaseReservedCacheNodesOffering(reservedCacheNodesOfferingId: String, init: (AmazonElastiCachePurchaseReservedCacheNodesOfferingCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.ReservedCacheNode {
	return this.block.declare(AmazonElastiCachePurchaseReservedCacheNodesOfferingCommand(reservedCacheNodesOfferingId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.ReservedCacheNode
}
...
class AmazonElastiCachePurchaseReservedCacheNodesOfferingCommand(val reservedCacheNodesOfferingId: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.PurchaseReservedCacheNodesOfferingRequest, com.amazonaws.services.elasticache.model.ReservedCacheNode> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.ReservedCacheNode {
...
fun AmazonElastiCacheFunctions.rebootCacheCluster(cacheClusterId: String, cacheNodeIdsToReboot: List<String>, init: (AmazonElastiCacheRebootCacheClusterCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.CacheCluster {
	return this.block.declare(AmazonElastiCacheRebootCacheClusterCommand(cacheClusterId, cacheNodeIdsToReboot).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.CacheCluster
}
...
fun AmazonElastiCacheFunctions.removeTagsFromResource(resourceName: String, tagKeys: List<String>, init: (AmazonElastiCacheRemoveTagsFromResourceCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.RemoveTagsFromResourceResult {
	return this.block.declare(AmazonElastiCacheRemoveTagsFromResourceCommand(resourceName, tagKeys).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.RemoveTagsFromResourceResult
}
...
class AmazonElastiCacheRemoveTagsFromResourceCommand(val resourceName: String, val tagKeys: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.RemoveTagsFromResourceRequest, com.amazonaws.services.elasticache.model.RemoveTagsFromResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.RemoveTagsFromResourceResult {
...
fun AmazonElastiCacheFunctions.resetCacheParameterGroup(cacheParameterGroupName: String, init: (AmazonElastiCacheResetCacheParameterGroupCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.ResetCacheParameterGroupResult {
	return this.block.declare(AmazonElastiCacheResetCacheParameterGroupCommand(cacheParameterGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.ResetCacheParameterGroupResult
}
...
class AmazonElastiCacheResetCacheParameterGroupCommand(val cacheParameterGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticache.model.ResetCacheParameterGroupRequest, com.amazonaws.services.elasticache.model.ResetCacheParameterGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticache.model.ResetCacheParameterGroupResult {
...
fun AmazonElastiCacheFunctions.revokeCacheSecurityGroupIngress(cacheSecurityGroupName: String, eC2SecurityGroupName: String, eC2SecurityGroupOwnerId: String, init: (AmazonElastiCacheRevokeCacheSecurityGroupIngressCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.CacheSecurityGroup {
	return this.block.declare(AmazonElastiCacheRevokeCacheSecurityGroupIngressCommand(cacheSecurityGroupName, eC2SecurityGroupName, eC2SecurityGroupOwnerId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.CacheSecurityGroup
}
...
fun AmazonElastiCacheFunctions.testFailover(replicationGroupId: String, nodeGroupId: String, init: (AmazonElastiCacheTestFailoverCommand.() -> Unit)? = null): com.amazonaws.services.elasticache.model.ReplicationGroup {
	return this.block.declare(AmazonElastiCacheTestFailoverCommand(replicationGroupId, nodeGroupId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticache.model.ReplicationGroup
}
