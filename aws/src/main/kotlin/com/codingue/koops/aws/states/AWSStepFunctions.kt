...
package com.codingue.koops.aws.states
...
var com.codingue.koops.core.Environment.states: AWSStepFunctions
	get() {
...
fun AWSStepFunctionsFunctions.createActivity(init: (AWSStepFunctionsCreateActivityCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.CreateActivityResult {
	return this.block.declare(AWSStepFunctionsCreateActivityCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.CreateActivityResult
}
...
class AWSStepFunctionsCreateActivityCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.CreateActivityRequest, com.amazonaws.services.stepfunctions.model.CreateActivityResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.CreateActivityResult {
...
fun AWSStepFunctionsFunctions.createStateMachine(init: (AWSStepFunctionsCreateStateMachineCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.CreateStateMachineResult {
	return this.block.declare(AWSStepFunctionsCreateStateMachineCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.CreateStateMachineResult
}
...
class AWSStepFunctionsCreateStateMachineCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.CreateStateMachineRequest, com.amazonaws.services.stepfunctions.model.CreateStateMachineResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.CreateStateMachineResult {
...
fun AWSStepFunctionsFunctions.deleteActivity(init: (AWSStepFunctionsDeleteActivityCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.DeleteActivityResult {
	return this.block.declare(AWSStepFunctionsDeleteActivityCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.DeleteActivityResult
}
...
class AWSStepFunctionsDeleteActivityCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.DeleteActivityRequest, com.amazonaws.services.stepfunctions.model.DeleteActivityResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.DeleteActivityResult {
...
fun AWSStepFunctionsFunctions.deleteStateMachine(init: (AWSStepFunctionsDeleteStateMachineCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.DeleteStateMachineResult {
	return this.block.declare(AWSStepFunctionsDeleteStateMachineCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.DeleteStateMachineResult
}
...
class AWSStepFunctionsDeleteStateMachineCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.DeleteStateMachineRequest, com.amazonaws.services.stepfunctions.model.DeleteStateMachineResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.DeleteStateMachineResult {
...
fun AWSStepFunctionsFunctions.describeActivity(init: (AWSStepFunctionsDescribeActivityCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.DescribeActivityResult {
	return this.block.declare(AWSStepFunctionsDescribeActivityCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.DescribeActivityResult
}
...
class AWSStepFunctionsDescribeActivityCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.DescribeActivityRequest, com.amazonaws.services.stepfunctions.model.DescribeActivityResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.DescribeActivityResult {
...
fun AWSStepFunctionsFunctions.describeExecution(init: (AWSStepFunctionsDescribeExecutionCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.DescribeExecutionResult {
	return this.block.declare(AWSStepFunctionsDescribeExecutionCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.DescribeExecutionResult
}
...
class AWSStepFunctionsDescribeExecutionCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.DescribeExecutionRequest, com.amazonaws.services.stepfunctions.model.DescribeExecutionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.DescribeExecutionResult {
...
fun AWSStepFunctionsFunctions.describeStateMachine(init: (AWSStepFunctionsDescribeStateMachineCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.DescribeStateMachineResult {
	return this.block.declare(AWSStepFunctionsDescribeStateMachineCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.DescribeStateMachineResult
}
...
class AWSStepFunctionsDescribeStateMachineCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.DescribeStateMachineRequest, com.amazonaws.services.stepfunctions.model.DescribeStateMachineResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.DescribeStateMachineResult {
...
fun AWSStepFunctionsFunctions.describeStateMachineForExecution(init: (AWSStepFunctionsDescribeStateMachineForExecutionCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.DescribeStateMachineForExecutionResult {
	return this.block.declare(AWSStepFunctionsDescribeStateMachineForExecutionCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.DescribeStateMachineForExecutionResult
}
...
class AWSStepFunctionsDescribeStateMachineForExecutionCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.DescribeStateMachineForExecutionRequest, com.amazonaws.services.stepfunctions.model.DescribeStateMachineForExecutionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.DescribeStateMachineForExecutionResult {
...
fun AWSStepFunctionsFunctions.getActivityTask(init: (AWSStepFunctionsGetActivityTaskCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.GetActivityTaskResult {
	return this.block.declare(AWSStepFunctionsGetActivityTaskCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.GetActivityTaskResult
}
...
class AWSStepFunctionsGetActivityTaskCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.GetActivityTaskRequest, com.amazonaws.services.stepfunctions.model.GetActivityTaskResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.GetActivityTaskResult {
...
fun AWSStepFunctionsFunctions.getExecutionHistory(init: (AWSStepFunctionsGetExecutionHistoryCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.GetExecutionHistoryResult {
	return this.block.declare(AWSStepFunctionsGetExecutionHistoryCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.GetExecutionHistoryResult
}
...
class AWSStepFunctionsGetExecutionHistoryCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.GetExecutionHistoryRequest, com.amazonaws.services.stepfunctions.model.GetExecutionHistoryResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.GetExecutionHistoryResult {
...
fun AWSStepFunctionsFunctions.listActivities(init: (AWSStepFunctionsListActivitiesCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.ListActivitiesResult {
	return this.block.declare(AWSStepFunctionsListActivitiesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.ListActivitiesResult
}
...
class AWSStepFunctionsListActivitiesCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.ListActivitiesRequest, com.amazonaws.services.stepfunctions.model.ListActivitiesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.ListActivitiesResult {
...
fun AWSStepFunctionsFunctions.listExecutions(init: (AWSStepFunctionsListExecutionsCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.ListExecutionsResult {
	return this.block.declare(AWSStepFunctionsListExecutionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.ListExecutionsResult
}
...
class AWSStepFunctionsListExecutionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.ListExecutionsRequest, com.amazonaws.services.stepfunctions.model.ListExecutionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.ListExecutionsResult {
...
fun AWSStepFunctionsFunctions.listStateMachines(init: (AWSStepFunctionsListStateMachinesCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.ListStateMachinesResult {
	return this.block.declare(AWSStepFunctionsListStateMachinesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.ListStateMachinesResult
}
...
class AWSStepFunctionsListStateMachinesCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.ListStateMachinesRequest, com.amazonaws.services.stepfunctions.model.ListStateMachinesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.ListStateMachinesResult {
...
fun AWSStepFunctionsFunctions.sendTaskFailure(init: (AWSStepFunctionsSendTaskFailureCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.SendTaskFailureResult {
	return this.block.declare(AWSStepFunctionsSendTaskFailureCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.SendTaskFailureResult
}
...
class AWSStepFunctionsSendTaskFailureCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.SendTaskFailureRequest, com.amazonaws.services.stepfunctions.model.SendTaskFailureResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.SendTaskFailureResult {
...
fun AWSStepFunctionsFunctions.sendTaskHeartbeat(init: (AWSStepFunctionsSendTaskHeartbeatCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.SendTaskHeartbeatResult {
	return this.block.declare(AWSStepFunctionsSendTaskHeartbeatCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.SendTaskHeartbeatResult
}
...
class AWSStepFunctionsSendTaskHeartbeatCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.SendTaskHeartbeatRequest, com.amazonaws.services.stepfunctions.model.SendTaskHeartbeatResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.SendTaskHeartbeatResult {
...
fun AWSStepFunctionsFunctions.sendTaskSuccess(init: (AWSStepFunctionsSendTaskSuccessCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.SendTaskSuccessResult {
	return this.block.declare(AWSStepFunctionsSendTaskSuccessCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.SendTaskSuccessResult
}
...
class AWSStepFunctionsSendTaskSuccessCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.SendTaskSuccessRequest, com.amazonaws.services.stepfunctions.model.SendTaskSuccessResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.SendTaskSuccessResult {
...
fun AWSStepFunctionsFunctions.startExecution(init: (AWSStepFunctionsStartExecutionCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.StartExecutionResult {
	return this.block.declare(AWSStepFunctionsStartExecutionCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.StartExecutionResult
}
...
class AWSStepFunctionsStartExecutionCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.StartExecutionRequest, com.amazonaws.services.stepfunctions.model.StartExecutionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.StartExecutionResult {
...
fun AWSStepFunctionsFunctions.stopExecution(init: (AWSStepFunctionsStopExecutionCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.StopExecutionResult {
	return this.block.declare(AWSStepFunctionsStopExecutionCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.StopExecutionResult
}
...
class AWSStepFunctionsStopExecutionCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.StopExecutionRequest, com.amazonaws.services.stepfunctions.model.StopExecutionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.StopExecutionResult {
...
fun AWSStepFunctionsFunctions.updateStateMachine(init: (AWSStepFunctionsUpdateStateMachineCommand.() -> Unit)? = null): com.amazonaws.services.stepfunctions.model.UpdateStateMachineResult {
	return this.block.declare(AWSStepFunctionsUpdateStateMachineCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.stepfunctions.model.UpdateStateMachineResult
}
...
class AWSStepFunctionsUpdateStateMachineCommand() : AmazonWebServiceCommand<com.amazonaws.services.stepfunctions.model.UpdateStateMachineRequest, com.amazonaws.services.stepfunctions.model.UpdateStateMachineResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.stepfunctions.model.UpdateStateMachineResult {
