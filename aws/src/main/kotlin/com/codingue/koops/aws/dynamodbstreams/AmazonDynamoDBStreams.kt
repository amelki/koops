...
package com.codingue.koops.aws.dynamodbstreams
...
var com.codingue.koops.core.Environment.dynamodbstreams: AmazonDynamoDBStreams
	get() {
...
@Generated
class AmazonDynamoDBStreamsFunctions(val block: Script)
...
fun AmazonDynamoDBStreamsFunctions.describeStream(streamArn: String, init: (AmazonDynamoDBStreamsDescribeStreamCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.DescribeStreamResult {
	return this.block.declare(AmazonDynamoDBStreamsDescribeStreamCommand(streamArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.DescribeStreamResult
}
...
class AmazonDynamoDBStreamsDescribeStreamCommand(val streamArn: String) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.DescribeStreamRequest, com.amazonaws.services.dynamodbv2.model.DescribeStreamResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.DescribeStreamResult {
...
fun AmazonDynamoDBStreamsFunctions.getRecords(shardIterator: String, init: (AmazonDynamoDBStreamsGetRecordsCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.GetRecordsResult {
	return this.block.declare(AmazonDynamoDBStreamsGetRecordsCommand(shardIterator).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.GetRecordsResult
}
...
class AmazonDynamoDBStreamsGetRecordsCommand(val shardIterator: String) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.GetRecordsRequest, com.amazonaws.services.dynamodbv2.model.GetRecordsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.GetRecordsResult {
...
fun AmazonDynamoDBStreamsFunctions.getShardIterator(streamArn: String, shardId: String, shardIteratorType: ShardIteratorType, init: (AmazonDynamoDBStreamsGetShardIteratorCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.GetShardIteratorResult {
	return this.block.declare(AmazonDynamoDBStreamsGetShardIteratorCommand(streamArn, shardId, shardIteratorType).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.GetShardIteratorResult
}
...
class AmazonDynamoDBStreamsGetShardIteratorCommand(val streamArn: String, val shardId: String, val shardIteratorType: ShardIteratorType) : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.GetShardIteratorRequest, com.amazonaws.services.dynamodbv2.model.GetShardIteratorResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.GetShardIteratorResult {
...
fun AmazonDynamoDBStreamsFunctions.listStreams(init: (AmazonDynamoDBStreamsListStreamsCommand.() -> Unit)? = null): com.amazonaws.services.dynamodbv2.model.ListStreamsResult {
	return this.block.declare(AmazonDynamoDBStreamsListStreamsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.dynamodbv2.model.ListStreamsResult
}
...
class AmazonDynamoDBStreamsListStreamsCommand() : AmazonWebServiceCommand<com.amazonaws.services.dynamodbv2.model.ListStreamsRequest, com.amazonaws.services.dynamodbv2.model.ListStreamsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.dynamodbv2.model.ListStreamsResult {
