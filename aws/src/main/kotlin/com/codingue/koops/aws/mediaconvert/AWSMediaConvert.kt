...
package com.codingue.koops.aws.mediaconvert
...
var com.codingue.koops.core.Environment.mediaconvert: AWSMediaConvert
	get() {
		var service = this.capabilities["aws-mediaconvert"]
		if (service == null) {
			service = AWSMediaConvertClientBuilder.standard().build()
			this.capabilities["aws-mediaconvert"] = service
		}
		return service as AWSMediaConvert
	}
	set(mediaconvert) {
		this.capabilities["aws-mediaconvert"] = mediaconvert
	}
...
fun AWSMediaConvertFunctions.cancelJob(id: String, init: (AWSMediaConvertCancelJobCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.CancelJobResult {
	return this.block.declare(AWSMediaConvertCancelJobCommand(id).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.CancelJobResult
}
...
class AWSMediaConvertCancelJobCommand(val id: String) : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.CancelJobRequest, com.amazonaws.services.mediaconvert.model.CancelJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.CancelJobResult {
...
fun AWSMediaConvertFunctions.createJob(init: (AWSMediaConvertCreateJobCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.CreateJobResult {
	return this.block.declare(AWSMediaConvertCreateJobCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.CreateJobResult
}
...
class AWSMediaConvertCreateJobCommand() : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.CreateJobRequest, com.amazonaws.services.mediaconvert.model.CreateJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.CreateJobResult {
...
fun AWSMediaConvertFunctions.createJobTemplate(init: (AWSMediaConvertCreateJobTemplateCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.CreateJobTemplateResult {
	return this.block.declare(AWSMediaConvertCreateJobTemplateCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.CreateJobTemplateResult
}
...
class AWSMediaConvertCreateJobTemplateCommand() : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.CreateJobTemplateRequest, com.amazonaws.services.mediaconvert.model.CreateJobTemplateResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.CreateJobTemplateResult {
...
fun AWSMediaConvertFunctions.createPreset(init: (AWSMediaConvertCreatePresetCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.CreatePresetResult {
	return this.block.declare(AWSMediaConvertCreatePresetCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.CreatePresetResult
}
...
class AWSMediaConvertCreatePresetCommand() : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.CreatePresetRequest, com.amazonaws.services.mediaconvert.model.CreatePresetResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.CreatePresetResult {
...
fun AWSMediaConvertFunctions.createQueue(init: (AWSMediaConvertCreateQueueCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.CreateQueueResult {
	return this.block.declare(AWSMediaConvertCreateQueueCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.CreateQueueResult
}
...
class AWSMediaConvertCreateQueueCommand() : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.CreateQueueRequest, com.amazonaws.services.mediaconvert.model.CreateQueueResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.CreateQueueResult {
...
fun AWSMediaConvertFunctions.deleteJobTemplate(name: String, init: (AWSMediaConvertDeleteJobTemplateCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.DeleteJobTemplateResult {
	return this.block.declare(AWSMediaConvertDeleteJobTemplateCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.DeleteJobTemplateResult
}
...
class AWSMediaConvertDeleteJobTemplateCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.DeleteJobTemplateRequest, com.amazonaws.services.mediaconvert.model.DeleteJobTemplateResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.DeleteJobTemplateResult {
...
fun AWSMediaConvertFunctions.deletePreset(name: String, init: (AWSMediaConvertDeletePresetCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.DeletePresetResult {
	return this.block.declare(AWSMediaConvertDeletePresetCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.DeletePresetResult
}
...
class AWSMediaConvertDeletePresetCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.DeletePresetRequest, com.amazonaws.services.mediaconvert.model.DeletePresetResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.DeletePresetResult {
...
fun AWSMediaConvertFunctions.deleteQueue(name: String, init: (AWSMediaConvertDeleteQueueCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.DeleteQueueResult {
	return this.block.declare(AWSMediaConvertDeleteQueueCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.DeleteQueueResult
}
...
class AWSMediaConvertDeleteQueueCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.DeleteQueueRequest, com.amazonaws.services.mediaconvert.model.DeleteQueueResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.DeleteQueueResult {
...
fun AWSMediaConvertFunctions.describeEndpoints(init: (AWSMediaConvertDescribeEndpointsCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.DescribeEndpointsResult {
	return this.block.declare(AWSMediaConvertDescribeEndpointsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.DescribeEndpointsResult
}
...
class AWSMediaConvertDescribeEndpointsCommand() : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.DescribeEndpointsRequest, com.amazonaws.services.mediaconvert.model.DescribeEndpointsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.DescribeEndpointsResult {
...
fun AWSMediaConvertFunctions.getJob(id: String, init: (AWSMediaConvertGetJobCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.GetJobResult {
	return this.block.declare(AWSMediaConvertGetJobCommand(id).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.GetJobResult
}
...
class AWSMediaConvertGetJobCommand(val id: String) : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.GetJobRequest, com.amazonaws.services.mediaconvert.model.GetJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.GetJobResult {
...
fun AWSMediaConvertFunctions.getJobTemplate(name: String, init: (AWSMediaConvertGetJobTemplateCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.GetJobTemplateResult {
	return this.block.declare(AWSMediaConvertGetJobTemplateCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.GetJobTemplateResult
}
...
class AWSMediaConvertGetJobTemplateCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.GetJobTemplateRequest, com.amazonaws.services.mediaconvert.model.GetJobTemplateResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.GetJobTemplateResult {
...
fun AWSMediaConvertFunctions.getPreset(name: String, init: (AWSMediaConvertGetPresetCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.GetPresetResult {
	return this.block.declare(AWSMediaConvertGetPresetCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.GetPresetResult
}
...
class AWSMediaConvertGetPresetCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.GetPresetRequest, com.amazonaws.services.mediaconvert.model.GetPresetResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.GetPresetResult {
...
fun AWSMediaConvertFunctions.getQueue(name: String, init: (AWSMediaConvertGetQueueCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.GetQueueResult {
	return this.block.declare(AWSMediaConvertGetQueueCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.GetQueueResult
}
...
class AWSMediaConvertGetQueueCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.GetQueueRequest, com.amazonaws.services.mediaconvert.model.GetQueueResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.GetQueueResult {
...
fun AWSMediaConvertFunctions.listJobTemplates(init: (AWSMediaConvertListJobTemplatesCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.ListJobTemplatesResult {
	return this.block.declare(AWSMediaConvertListJobTemplatesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.ListJobTemplatesResult
}
...
class AWSMediaConvertListJobTemplatesCommand() : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.ListJobTemplatesRequest, com.amazonaws.services.mediaconvert.model.ListJobTemplatesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.ListJobTemplatesResult {
...
fun AWSMediaConvertFunctions.listJobs(init: (AWSMediaConvertListJobsCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.ListJobsResult {
	return this.block.declare(AWSMediaConvertListJobsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.ListJobsResult
}
...
class AWSMediaConvertListJobsCommand() : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.ListJobsRequest, com.amazonaws.services.mediaconvert.model.ListJobsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.ListJobsResult {
...
fun AWSMediaConvertFunctions.listPresets(init: (AWSMediaConvertListPresetsCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.ListPresetsResult {
	return this.block.declare(AWSMediaConvertListPresetsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.ListPresetsResult
}
...
class AWSMediaConvertListPresetsCommand() : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.ListPresetsRequest, com.amazonaws.services.mediaconvert.model.ListPresetsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.ListPresetsResult {
...
fun AWSMediaConvertFunctions.listQueues(init: (AWSMediaConvertListQueuesCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.ListQueuesResult {
	return this.block.declare(AWSMediaConvertListQueuesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.ListQueuesResult
}
...
class AWSMediaConvertListQueuesCommand() : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.ListQueuesRequest, com.amazonaws.services.mediaconvert.model.ListQueuesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.ListQueuesResult {
...
fun AWSMediaConvertFunctions.updateJobTemplate(name: String, init: (AWSMediaConvertUpdateJobTemplateCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.UpdateJobTemplateResult {
	return this.block.declare(AWSMediaConvertUpdateJobTemplateCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.UpdateJobTemplateResult
}
...
class AWSMediaConvertUpdateJobTemplateCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.UpdateJobTemplateRequest, com.amazonaws.services.mediaconvert.model.UpdateJobTemplateResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.UpdateJobTemplateResult {
...
fun AWSMediaConvertFunctions.updatePreset(name: String, init: (AWSMediaConvertUpdatePresetCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.UpdatePresetResult {
	return this.block.declare(AWSMediaConvertUpdatePresetCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.UpdatePresetResult
}
...
class AWSMediaConvertUpdatePresetCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.UpdatePresetRequest, com.amazonaws.services.mediaconvert.model.UpdatePresetResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.UpdatePresetResult {
...
fun AWSMediaConvertFunctions.updateQueue(name: String, init: (AWSMediaConvertUpdateQueueCommand.() -> Unit)? = null): com.amazonaws.services.mediaconvert.model.UpdateQueueResult {
	return this.block.declare(AWSMediaConvertUpdateQueueCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediaconvert.model.UpdateQueueResult
}
...
class AWSMediaConvertUpdateQueueCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.mediaconvert.model.UpdateQueueRequest, com.amazonaws.services.mediaconvert.model.UpdateQueueResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediaconvert.model.UpdateQueueResult {
