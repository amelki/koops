...
package com.codingue.koops.aws.sts
...
fun AWSSecurityTokenServiceFunctions.assumeRole(roleArn: String, roleSessionName: String, init: (AWSSecurityTokenServiceAssumeRoleCommand.() -> Unit)? = null): com.amazonaws.services.securitytoken.model.AssumeRoleResult {
	return this.block.declare(AWSSecurityTokenServiceAssumeRoleCommand(roleArn, roleSessionName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.securitytoken.model.AssumeRoleResult
}
...
class AWSSecurityTokenServiceAssumeRoleCommand(val roleArn: String, val roleSessionName: String) : AmazonWebServiceCommand<com.amazonaws.services.securitytoken.model.AssumeRoleRequest, com.amazonaws.services.securitytoken.model.AssumeRoleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.securitytoken.model.AssumeRoleResult {
...
fun AWSSecurityTokenServiceFunctions.assumeRoleWithSAML(roleArn: String, principalArn: String, sAMLAssertion: String, init: (AWSSecurityTokenServiceAssumeRoleWithSAMLCommand.() -> Unit)? = null): com.amazonaws.services.securitytoken.model.AssumeRoleWithSAMLResult {
	return this.block.declare(AWSSecurityTokenServiceAssumeRoleWithSAMLCommand(roleArn, principalArn, sAMLAssertion).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.securitytoken.model.AssumeRoleWithSAMLResult
}
...
class AWSSecurityTokenServiceAssumeRoleWithSAMLCommand(val roleArn: String, val principalArn: String, val sAMLAssertion: String) : AmazonWebServiceCommand<com.amazonaws.services.securitytoken.model.AssumeRoleWithSAMLRequest, com.amazonaws.services.securitytoken.model.AssumeRoleWithSAMLResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.securitytoken.model.AssumeRoleWithSAMLResult {
...
fun AWSSecurityTokenServiceFunctions.assumeRoleWithWebIdentity(roleArn: String, roleSessionName: String, webIdentityToken: String, init: (AWSSecurityTokenServiceAssumeRoleWithWebIdentityCommand.() -> Unit)? = null): com.amazonaws.services.securitytoken.model.AssumeRoleWithWebIdentityResult {
	return this.block.declare(AWSSecurityTokenServiceAssumeRoleWithWebIdentityCommand(roleArn, roleSessionName, webIdentityToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.securitytoken.model.AssumeRoleWithWebIdentityResult
}
...
class AWSSecurityTokenServiceAssumeRoleWithWebIdentityCommand(val roleArn: String, val roleSessionName: String, val webIdentityToken: String) : AmazonWebServiceCommand<com.amazonaws.services.securitytoken.model.AssumeRoleWithWebIdentityRequest, com.amazonaws.services.securitytoken.model.AssumeRoleWithWebIdentityResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.securitytoken.model.AssumeRoleWithWebIdentityResult {
...
fun AWSSecurityTokenServiceFunctions.decodeAuthorizationMessage(encodedMessage: String, init: (AWSSecurityTokenServiceDecodeAuthorizationMessageCommand.() -> Unit)? = null): com.amazonaws.services.securitytoken.model.DecodeAuthorizationMessageResult {
	return this.block.declare(AWSSecurityTokenServiceDecodeAuthorizationMessageCommand(encodedMessage).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.securitytoken.model.DecodeAuthorizationMessageResult
}
...
class AWSSecurityTokenServiceDecodeAuthorizationMessageCommand(val encodedMessage: String) : AmazonWebServiceCommand<com.amazonaws.services.securitytoken.model.DecodeAuthorizationMessageRequest, com.amazonaws.services.securitytoken.model.DecodeAuthorizationMessageResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.securitytoken.model.DecodeAuthorizationMessageResult {
...
fun AWSSecurityTokenServiceFunctions.getCallerIdentity(init: (AWSSecurityTokenServiceGetCallerIdentityCommand.() -> Unit)? = null): com.amazonaws.services.securitytoken.model.GetCallerIdentityResult {
	return this.block.declare(AWSSecurityTokenServiceGetCallerIdentityCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.securitytoken.model.GetCallerIdentityResult
}
...
class AWSSecurityTokenServiceGetCallerIdentityCommand() : AmazonWebServiceCommand<com.amazonaws.services.securitytoken.model.GetCallerIdentityRequest, com.amazonaws.services.securitytoken.model.GetCallerIdentityResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.securitytoken.model.GetCallerIdentityResult {
...
fun AWSSecurityTokenServiceFunctions.getFederationToken(name: String, init: (AWSSecurityTokenServiceGetFederationTokenCommand.() -> Unit)? = null): com.amazonaws.services.securitytoken.model.GetFederationTokenResult {
	return this.block.declare(AWSSecurityTokenServiceGetFederationTokenCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.securitytoken.model.GetFederationTokenResult
}
...
class AWSSecurityTokenServiceGetFederationTokenCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.securitytoken.model.GetFederationTokenRequest, com.amazonaws.services.securitytoken.model.GetFederationTokenResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.securitytoken.model.GetFederationTokenResult {
...
fun AWSSecurityTokenServiceFunctions.getSessionToken(init: (AWSSecurityTokenServiceGetSessionTokenCommand.() -> Unit)? = null): com.amazonaws.services.securitytoken.model.GetSessionTokenResult {
	return this.block.declare(AWSSecurityTokenServiceGetSessionTokenCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.securitytoken.model.GetSessionTokenResult
}
...
class AWSSecurityTokenServiceGetSessionTokenCommand() : AmazonWebServiceCommand<com.amazonaws.services.securitytoken.model.GetSessionTokenRequest, com.amazonaws.services.securitytoken.model.GetSessionTokenResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.securitytoken.model.GetSessionTokenResult {
