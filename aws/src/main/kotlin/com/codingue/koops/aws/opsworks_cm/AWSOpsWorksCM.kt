...
package com.codingue.koops.aws.opsworks_cm
...
var com.codingue.koops.core.Environment.opsworks_cm: AWSOpsWorksCM
	get() {
		var service = this.capabilities["aws-opsworks_cm"]
		if (service == null) {
			service = AWSOpsWorksCMClientBuilder.standard().build()
			this.capabilities["aws-opsworks_cm"] = service
		}
		return service as AWSOpsWorksCM
	}
	set(opsworks_cm) {
		this.capabilities["aws-opsworks_cm"] = opsworks_cm
	}
...
fun AWSOpsWorksCMFunctions.associateNode(serverName: String, nodeName: String, engineAttributes: List<com.amazonaws.services.opsworkscm.model.EngineAttribute>, init: (AWSOpsWorksCMAssociateNodeCommand.() -> Unit)? = null): com.amazonaws.services.opsworkscm.model.AssociateNodeResult {
	return this.block.declare(AWSOpsWorksCMAssociateNodeCommand(serverName, nodeName, engineAttributes).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.opsworkscm.model.AssociateNodeResult
}
...
class AWSOpsWorksCMAssociateNodeCommand(val serverName: String, val nodeName: String, val engineAttributes: List<com.amazonaws.services.opsworkscm.model.EngineAttribute>) : AmazonWebServiceCommand<com.amazonaws.services.opsworkscm.model.AssociateNodeRequest, com.amazonaws.services.opsworkscm.model.AssociateNodeResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.opsworkscm.model.AssociateNodeResult {
...
fun AWSOpsWorksCMFunctions.createBackup(serverName: String, init: (AWSOpsWorksCMCreateBackupCommand.() -> Unit)? = null): com.amazonaws.services.opsworkscm.model.CreateBackupResult {
	return this.block.declare(AWSOpsWorksCMCreateBackupCommand(serverName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.opsworkscm.model.CreateBackupResult
}
...
class AWSOpsWorksCMCreateBackupCommand(val serverName: String) : AmazonWebServiceCommand<com.amazonaws.services.opsworkscm.model.CreateBackupRequest, com.amazonaws.services.opsworkscm.model.CreateBackupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.opsworkscm.model.CreateBackupResult {
...
fun AWSOpsWorksCMFunctions.createServer(serverName: String, instanceProfileArn: String, instanceType: String, serviceRoleArn: String, init: (AWSOpsWorksCMCreateServerCommand.() -> Unit)? = null): com.amazonaws.services.opsworkscm.model.CreateServerResult {
	return this.block.declare(AWSOpsWorksCMCreateServerCommand(serverName, instanceProfileArn, instanceType, serviceRoleArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.opsworkscm.model.CreateServerResult
}
...
class AWSOpsWorksCMCreateServerCommand(val serverName: String, val instanceProfileArn: String, val instanceType: String, val serviceRoleArn: String) : AmazonWebServiceCommand<com.amazonaws.services.opsworkscm.model.CreateServerRequest, com.amazonaws.services.opsworkscm.model.CreateServerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.opsworkscm.model.CreateServerResult {
...
fun AWSOpsWorksCMFunctions.deleteBackup(backupId: String, init: (AWSOpsWorksCMDeleteBackupCommand.() -> Unit)? = null): com.amazonaws.services.opsworkscm.model.DeleteBackupResult {
	return this.block.declare(AWSOpsWorksCMDeleteBackupCommand(backupId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.opsworkscm.model.DeleteBackupResult
}
...
class AWSOpsWorksCMDeleteBackupCommand(val backupId: String) : AmazonWebServiceCommand<com.amazonaws.services.opsworkscm.model.DeleteBackupRequest, com.amazonaws.services.opsworkscm.model.DeleteBackupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.opsworkscm.model.DeleteBackupResult {
...
fun AWSOpsWorksCMFunctions.deleteServer(serverName: String, init: (AWSOpsWorksCMDeleteServerCommand.() -> Unit)? = null): com.amazonaws.services.opsworkscm.model.DeleteServerResult {
	return this.block.declare(AWSOpsWorksCMDeleteServerCommand(serverName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.opsworkscm.model.DeleteServerResult
}
...
class AWSOpsWorksCMDeleteServerCommand(val serverName: String) : AmazonWebServiceCommand<com.amazonaws.services.opsworkscm.model.DeleteServerRequest, com.amazonaws.services.opsworkscm.model.DeleteServerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.opsworkscm.model.DeleteServerResult {
...
fun AWSOpsWorksCMFunctions.describeAccountAttributes(init: (AWSOpsWorksCMDescribeAccountAttributesCommand.() -> Unit)? = null): com.amazonaws.services.opsworkscm.model.DescribeAccountAttributesResult {
	return this.block.declare(AWSOpsWorksCMDescribeAccountAttributesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.opsworkscm.model.DescribeAccountAttributesResult
}
...
class AWSOpsWorksCMDescribeAccountAttributesCommand() : AmazonWebServiceCommand<com.amazonaws.services.opsworkscm.model.DescribeAccountAttributesRequest, com.amazonaws.services.opsworkscm.model.DescribeAccountAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.opsworkscm.model.DescribeAccountAttributesResult {
...
fun AWSOpsWorksCMFunctions.describeBackups(init: (AWSOpsWorksCMDescribeBackupsCommand.() -> Unit)? = null): com.amazonaws.services.opsworkscm.model.DescribeBackupsResult {
	return this.block.declare(AWSOpsWorksCMDescribeBackupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.opsworkscm.model.DescribeBackupsResult
}
...
class AWSOpsWorksCMDescribeBackupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.opsworkscm.model.DescribeBackupsRequest, com.amazonaws.services.opsworkscm.model.DescribeBackupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.opsworkscm.model.DescribeBackupsResult {
...
fun AWSOpsWorksCMFunctions.describeEvents(serverName: String, init: (AWSOpsWorksCMDescribeEventsCommand.() -> Unit)? = null): com.amazonaws.services.opsworkscm.model.DescribeEventsResult {
	return this.block.declare(AWSOpsWorksCMDescribeEventsCommand(serverName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.opsworkscm.model.DescribeEventsResult
}
...
class AWSOpsWorksCMDescribeEventsCommand(val serverName: String) : AmazonWebServiceCommand<com.amazonaws.services.opsworkscm.model.DescribeEventsRequest, com.amazonaws.services.opsworkscm.model.DescribeEventsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.opsworkscm.model.DescribeEventsResult {
...
fun AWSOpsWorksCMFunctions.describeNodeAssociationStatus(nodeAssociationStatusToken: String, serverName: String, init: (AWSOpsWorksCMDescribeNodeAssociationStatusCommand.() -> Unit)? = null): com.amazonaws.services.opsworkscm.model.DescribeNodeAssociationStatusResult {
	return this.block.declare(AWSOpsWorksCMDescribeNodeAssociationStatusCommand(nodeAssociationStatusToken, serverName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.opsworkscm.model.DescribeNodeAssociationStatusResult
}
...
class AWSOpsWorksCMDescribeNodeAssociationStatusCommand(val nodeAssociationStatusToken: String, val serverName: String) : AmazonWebServiceCommand<com.amazonaws.services.opsworkscm.model.DescribeNodeAssociationStatusRequest, com.amazonaws.services.opsworkscm.model.DescribeNodeAssociationStatusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.opsworkscm.model.DescribeNodeAssociationStatusResult {
...
fun AWSOpsWorksCMFunctions.describeServers(init: (AWSOpsWorksCMDescribeServersCommand.() -> Unit)? = null): com.amazonaws.services.opsworkscm.model.DescribeServersResult {
	return this.block.declare(AWSOpsWorksCMDescribeServersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.opsworkscm.model.DescribeServersResult
}
...
class AWSOpsWorksCMDescribeServersCommand() : AmazonWebServiceCommand<com.amazonaws.services.opsworkscm.model.DescribeServersRequest, com.amazonaws.services.opsworkscm.model.DescribeServersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.opsworkscm.model.DescribeServersResult {
...
fun AWSOpsWorksCMFunctions.disassociateNode(serverName: String, nodeName: String, init: (AWSOpsWorksCMDisassociateNodeCommand.() -> Unit)? = null): com.amazonaws.services.opsworkscm.model.DisassociateNodeResult {
	return this.block.declare(AWSOpsWorksCMDisassociateNodeCommand(serverName, nodeName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.opsworkscm.model.DisassociateNodeResult
}
...
class AWSOpsWorksCMDisassociateNodeCommand(val serverName: String, val nodeName: String) : AmazonWebServiceCommand<com.amazonaws.services.opsworkscm.model.DisassociateNodeRequest, com.amazonaws.services.opsworkscm.model.DisassociateNodeResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.opsworkscm.model.DisassociateNodeResult {
...
fun AWSOpsWorksCMFunctions.restoreServer(backupId: String, serverName: String, init: (AWSOpsWorksCMRestoreServerCommand.() -> Unit)? = null): com.amazonaws.services.opsworkscm.model.RestoreServerResult {
	return this.block.declare(AWSOpsWorksCMRestoreServerCommand(backupId, serverName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.opsworkscm.model.RestoreServerResult
}
...
class AWSOpsWorksCMRestoreServerCommand(val backupId: String, val serverName: String) : AmazonWebServiceCommand<com.amazonaws.services.opsworkscm.model.RestoreServerRequest, com.amazonaws.services.opsworkscm.model.RestoreServerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.opsworkscm.model.RestoreServerResult {
...
fun AWSOpsWorksCMFunctions.startMaintenance(serverName: String, init: (AWSOpsWorksCMStartMaintenanceCommand.() -> Unit)? = null): com.amazonaws.services.opsworkscm.model.StartMaintenanceResult {
	return this.block.declare(AWSOpsWorksCMStartMaintenanceCommand(serverName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.opsworkscm.model.StartMaintenanceResult
}
...
class AWSOpsWorksCMStartMaintenanceCommand(val serverName: String) : AmazonWebServiceCommand<com.amazonaws.services.opsworkscm.model.StartMaintenanceRequest, com.amazonaws.services.opsworkscm.model.StartMaintenanceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.opsworkscm.model.StartMaintenanceResult {
...
fun AWSOpsWorksCMFunctions.updateServer(serverName: String, init: (AWSOpsWorksCMUpdateServerCommand.() -> Unit)? = null): com.amazonaws.services.opsworkscm.model.UpdateServerResult {
	return this.block.declare(AWSOpsWorksCMUpdateServerCommand(serverName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.opsworkscm.model.UpdateServerResult
}
...
class AWSOpsWorksCMUpdateServerCommand(val serverName: String) : AmazonWebServiceCommand<com.amazonaws.services.opsworkscm.model.UpdateServerRequest, com.amazonaws.services.opsworkscm.model.UpdateServerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.opsworkscm.model.UpdateServerResult {
...
fun AWSOpsWorksCMFunctions.updateServerEngineAttributes(serverName: String, attributeName: String, init: (AWSOpsWorksCMUpdateServerEngineAttributesCommand.() -> Unit)? = null): com.amazonaws.services.opsworkscm.model.UpdateServerEngineAttributesResult {
	return this.block.declare(AWSOpsWorksCMUpdateServerEngineAttributesCommand(serverName, attributeName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.opsworkscm.model.UpdateServerEngineAttributesResult
}
...
class AWSOpsWorksCMUpdateServerEngineAttributesCommand(val serverName: String, val attributeName: String) : AmazonWebServiceCommand<com.amazonaws.services.opsworkscm.model.UpdateServerEngineAttributesRequest, com.amazonaws.services.opsworkscm.model.UpdateServerEngineAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.opsworkscm.model.UpdateServerEngineAttributesResult {
