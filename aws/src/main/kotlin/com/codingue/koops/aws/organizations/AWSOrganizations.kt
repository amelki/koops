...
package com.codingue.koops.aws.organizations
...
var com.codingue.koops.core.Environment.organizations: AWSOrganizations
	get() {
		var service = this.capabilities["aws-organizations"]
		if (service == null) {
			service = AWSOrganizationsClientBuilder.standard().build()
			this.capabilities["aws-organizations"] = service
		}
		return service as AWSOrganizations
	}
	set(organizations) {
		this.capabilities["aws-organizations"] = organizations
	}
...
fun AWSOrganizationsFunctions.acceptHandshake(handshakeId: String, init: (AWSOrganizationsAcceptHandshakeCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.AcceptHandshakeResult {
	return this.block.declare(AWSOrganizationsAcceptHandshakeCommand(handshakeId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.AcceptHandshakeResult
}
...
class AWSOrganizationsAcceptHandshakeCommand(val handshakeId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.AcceptHandshakeRequest, com.amazonaws.services.organizations.model.AcceptHandshakeResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.AcceptHandshakeResult {
...
fun AWSOrganizationsFunctions.attachPolicy(policyId: String, targetId: String, init: (AWSOrganizationsAttachPolicyCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.AttachPolicyResult {
	return this.block.declare(AWSOrganizationsAttachPolicyCommand(policyId, targetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.AttachPolicyResult
}
...
class AWSOrganizationsAttachPolicyCommand(val policyId: String, val targetId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.AttachPolicyRequest, com.amazonaws.services.organizations.model.AttachPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.AttachPolicyResult {
...
fun AWSOrganizationsFunctions.cancelHandshake(handshakeId: String, init: (AWSOrganizationsCancelHandshakeCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.CancelHandshakeResult {
	return this.block.declare(AWSOrganizationsCancelHandshakeCommand(handshakeId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.CancelHandshakeResult
}
...
class AWSOrganizationsCancelHandshakeCommand(val handshakeId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.CancelHandshakeRequest, com.amazonaws.services.organizations.model.CancelHandshakeResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.CancelHandshakeResult {
...
fun AWSOrganizationsFunctions.createAccount(email: String, accountName: String, init: (AWSOrganizationsCreateAccountCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.CreateAccountResult {
	return this.block.declare(AWSOrganizationsCreateAccountCommand(email, accountName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.CreateAccountResult
}
...
class AWSOrganizationsCreateAccountCommand(val email: String, val accountName: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.CreateAccountRequest, com.amazonaws.services.organizations.model.CreateAccountResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.CreateAccountResult {
...
fun AWSOrganizationsFunctions.createOrganization(init: (AWSOrganizationsCreateOrganizationCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.CreateOrganizationResult {
	return this.block.declare(AWSOrganizationsCreateOrganizationCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.CreateOrganizationResult
}
...
class AWSOrganizationsCreateOrganizationCommand() : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.CreateOrganizationRequest, com.amazonaws.services.organizations.model.CreateOrganizationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.CreateOrganizationResult {
...
fun AWSOrganizationsFunctions.createOrganizationalUnit(parentId: String, name: String, init: (AWSOrganizationsCreateOrganizationalUnitCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.CreateOrganizationalUnitResult {
	return this.block.declare(AWSOrganizationsCreateOrganizationalUnitCommand(parentId, name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.CreateOrganizationalUnitResult
}
...
class AWSOrganizationsCreateOrganizationalUnitCommand(val parentId: String, val name: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.CreateOrganizationalUnitRequest, com.amazonaws.services.organizations.model.CreateOrganizationalUnitResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.CreateOrganizationalUnitResult {
...
fun AWSOrganizationsFunctions.createPolicy(content: String, description: String, name: String, type: PolicyType, init: (AWSOrganizationsCreatePolicyCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.CreatePolicyResult {
	return this.block.declare(AWSOrganizationsCreatePolicyCommand(content, description, name, type).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.CreatePolicyResult
}
...
class AWSOrganizationsCreatePolicyCommand(val content: String, val description: String, val name: String, val type: PolicyType) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.CreatePolicyRequest, com.amazonaws.services.organizations.model.CreatePolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.CreatePolicyResult {
...
fun AWSOrganizationsFunctions.declineHandshake(handshakeId: String, init: (AWSOrganizationsDeclineHandshakeCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.DeclineHandshakeResult {
	return this.block.declare(AWSOrganizationsDeclineHandshakeCommand(handshakeId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.DeclineHandshakeResult
}
...
class AWSOrganizationsDeclineHandshakeCommand(val handshakeId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.DeclineHandshakeRequest, com.amazonaws.services.organizations.model.DeclineHandshakeResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.DeclineHandshakeResult {
...
fun AWSOrganizationsFunctions.deleteOrganization(init: (AWSOrganizationsDeleteOrganizationCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.DeleteOrganizationResult {
	return this.block.declare(AWSOrganizationsDeleteOrganizationCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.DeleteOrganizationResult
}
...
class AWSOrganizationsDeleteOrganizationCommand() : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.DeleteOrganizationRequest, com.amazonaws.services.organizations.model.DeleteOrganizationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.DeleteOrganizationResult {
...
fun AWSOrganizationsFunctions.deleteOrganizationalUnit(organizationalUnitId: String, init: (AWSOrganizationsDeleteOrganizationalUnitCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.DeleteOrganizationalUnitResult {
	return this.block.declare(AWSOrganizationsDeleteOrganizationalUnitCommand(organizationalUnitId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.DeleteOrganizationalUnitResult
}
...
class AWSOrganizationsDeleteOrganizationalUnitCommand(val organizationalUnitId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.DeleteOrganizationalUnitRequest, com.amazonaws.services.organizations.model.DeleteOrganizationalUnitResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.DeleteOrganizationalUnitResult {
...
fun AWSOrganizationsFunctions.deletePolicy(policyId: String, init: (AWSOrganizationsDeletePolicyCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.DeletePolicyResult {
	return this.block.declare(AWSOrganizationsDeletePolicyCommand(policyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.DeletePolicyResult
}
...
class AWSOrganizationsDeletePolicyCommand(val policyId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.DeletePolicyRequest, com.amazonaws.services.organizations.model.DeletePolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.DeletePolicyResult {
...
fun AWSOrganizationsFunctions.describeAccount(accountId: String, init: (AWSOrganizationsDescribeAccountCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.DescribeAccountResult {
	return this.block.declare(AWSOrganizationsDescribeAccountCommand(accountId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.DescribeAccountResult
}
...
class AWSOrganizationsDescribeAccountCommand(val accountId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.DescribeAccountRequest, com.amazonaws.services.organizations.model.DescribeAccountResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.DescribeAccountResult {
...
fun AWSOrganizationsFunctions.describeCreateAccountStatus(createAccountRequestId: String, init: (AWSOrganizationsDescribeCreateAccountStatusCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.DescribeCreateAccountStatusResult {
	return this.block.declare(AWSOrganizationsDescribeCreateAccountStatusCommand(createAccountRequestId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.DescribeCreateAccountStatusResult
}
...
class AWSOrganizationsDescribeCreateAccountStatusCommand(val createAccountRequestId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.DescribeCreateAccountStatusRequest, com.amazonaws.services.organizations.model.DescribeCreateAccountStatusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.DescribeCreateAccountStatusResult {
...
fun AWSOrganizationsFunctions.describeHandshake(handshakeId: String, init: (AWSOrganizationsDescribeHandshakeCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.DescribeHandshakeResult {
	return this.block.declare(AWSOrganizationsDescribeHandshakeCommand(handshakeId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.DescribeHandshakeResult
}
...
class AWSOrganizationsDescribeHandshakeCommand(val handshakeId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.DescribeHandshakeRequest, com.amazonaws.services.organizations.model.DescribeHandshakeResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.DescribeHandshakeResult {
...
fun AWSOrganizationsFunctions.describeOrganization(init: (AWSOrganizationsDescribeOrganizationCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.DescribeOrganizationResult {
	return this.block.declare(AWSOrganizationsDescribeOrganizationCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.DescribeOrganizationResult
}
...
class AWSOrganizationsDescribeOrganizationCommand() : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.DescribeOrganizationRequest, com.amazonaws.services.organizations.model.DescribeOrganizationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.DescribeOrganizationResult {
...
fun AWSOrganizationsFunctions.describeOrganizationalUnit(organizationalUnitId: String, init: (AWSOrganizationsDescribeOrganizationalUnitCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.DescribeOrganizationalUnitResult {
	return this.block.declare(AWSOrganizationsDescribeOrganizationalUnitCommand(organizationalUnitId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.DescribeOrganizationalUnitResult
}
...
class AWSOrganizationsDescribeOrganizationalUnitCommand(val organizationalUnitId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.DescribeOrganizationalUnitRequest, com.amazonaws.services.organizations.model.DescribeOrganizationalUnitResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.DescribeOrganizationalUnitResult {
...
fun AWSOrganizationsFunctions.describePolicy(policyId: String, init: (AWSOrganizationsDescribePolicyCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.DescribePolicyResult {
	return this.block.declare(AWSOrganizationsDescribePolicyCommand(policyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.DescribePolicyResult
}
...
class AWSOrganizationsDescribePolicyCommand(val policyId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.DescribePolicyRequest, com.amazonaws.services.organizations.model.DescribePolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.DescribePolicyResult {
...
fun AWSOrganizationsFunctions.detachPolicy(policyId: String, targetId: String, init: (AWSOrganizationsDetachPolicyCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.DetachPolicyResult {
	return this.block.declare(AWSOrganizationsDetachPolicyCommand(policyId, targetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.DetachPolicyResult
}
...
class AWSOrganizationsDetachPolicyCommand(val policyId: String, val targetId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.DetachPolicyRequest, com.amazonaws.services.organizations.model.DetachPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.DetachPolicyResult {
...
fun AWSOrganizationsFunctions.disableAWSServiceAccess(servicePrincipal: String, init: (AWSOrganizationsDisableAWSServiceAccessCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.DisableAWSServiceAccessResult {
	return this.block.declare(AWSOrganizationsDisableAWSServiceAccessCommand(servicePrincipal).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.DisableAWSServiceAccessResult
}
...
class AWSOrganizationsDisableAWSServiceAccessCommand(val servicePrincipal: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.DisableAWSServiceAccessRequest, com.amazonaws.services.organizations.model.DisableAWSServiceAccessResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.DisableAWSServiceAccessResult {
...
fun AWSOrganizationsFunctions.disablePolicyType(rootId: String, policyType: PolicyType, init: (AWSOrganizationsDisablePolicyTypeCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.DisablePolicyTypeResult {
	return this.block.declare(AWSOrganizationsDisablePolicyTypeCommand(rootId, policyType).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.DisablePolicyTypeResult
}
...
class AWSOrganizationsDisablePolicyTypeCommand(val rootId: String, val policyType: PolicyType) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.DisablePolicyTypeRequest, com.amazonaws.services.organizations.model.DisablePolicyTypeResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.DisablePolicyTypeResult {
...
fun AWSOrganizationsFunctions.enableAWSServiceAccess(servicePrincipal: String, init: (AWSOrganizationsEnableAWSServiceAccessCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.EnableAWSServiceAccessResult {
	return this.block.declare(AWSOrganizationsEnableAWSServiceAccessCommand(servicePrincipal).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.EnableAWSServiceAccessResult
}
...
class AWSOrganizationsEnableAWSServiceAccessCommand(val servicePrincipal: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.EnableAWSServiceAccessRequest, com.amazonaws.services.organizations.model.EnableAWSServiceAccessResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.EnableAWSServiceAccessResult {
...
fun AWSOrganizationsFunctions.enableAllFeatures(init: (AWSOrganizationsEnableAllFeaturesCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.EnableAllFeaturesResult {
	return this.block.declare(AWSOrganizationsEnableAllFeaturesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.EnableAllFeaturesResult
}
...
class AWSOrganizationsEnableAllFeaturesCommand() : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.EnableAllFeaturesRequest, com.amazonaws.services.organizations.model.EnableAllFeaturesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.EnableAllFeaturesResult {
...
fun AWSOrganizationsFunctions.enablePolicyType(rootId: String, policyType: PolicyType, init: (AWSOrganizationsEnablePolicyTypeCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.EnablePolicyTypeResult {
	return this.block.declare(AWSOrganizationsEnablePolicyTypeCommand(rootId, policyType).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.EnablePolicyTypeResult
}
...
class AWSOrganizationsEnablePolicyTypeCommand(val rootId: String, val policyType: PolicyType) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.EnablePolicyTypeRequest, com.amazonaws.services.organizations.model.EnablePolicyTypeResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.EnablePolicyTypeResult {
...
fun AWSOrganizationsFunctions.inviteAccountToOrganization(target: com.amazonaws.services.organizations.model.HandshakeParty, init: (AWSOrganizationsInviteAccountToOrganizationCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.InviteAccountToOrganizationResult {
	return this.block.declare(AWSOrganizationsInviteAccountToOrganizationCommand(target).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.InviteAccountToOrganizationResult
}
...
class AWSOrganizationsInviteAccountToOrganizationCommand(val target: com.amazonaws.services.organizations.model.HandshakeParty) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.InviteAccountToOrganizationRequest, com.amazonaws.services.organizations.model.InviteAccountToOrganizationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.InviteAccountToOrganizationResult {
...
fun AWSOrganizationsFunctions.leaveOrganization(init: (AWSOrganizationsLeaveOrganizationCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.LeaveOrganizationResult {
	return this.block.declare(AWSOrganizationsLeaveOrganizationCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.LeaveOrganizationResult
}
...
class AWSOrganizationsLeaveOrganizationCommand() : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.LeaveOrganizationRequest, com.amazonaws.services.organizations.model.LeaveOrganizationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.LeaveOrganizationResult {
...
fun AWSOrganizationsFunctions.listAWSServiceAccessForOrganization(init: (AWSOrganizationsListAWSServiceAccessForOrganizationCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.ListAWSServiceAccessForOrganizationResult {
	return this.block.declare(AWSOrganizationsListAWSServiceAccessForOrganizationCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.ListAWSServiceAccessForOrganizationResult
}
...
class AWSOrganizationsListAWSServiceAccessForOrganizationCommand() : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.ListAWSServiceAccessForOrganizationRequest, com.amazonaws.services.organizations.model.ListAWSServiceAccessForOrganizationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.ListAWSServiceAccessForOrganizationResult {
...
fun AWSOrganizationsFunctions.listAccounts(init: (AWSOrganizationsListAccountsCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.ListAccountsResult {
	return this.block.declare(AWSOrganizationsListAccountsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.ListAccountsResult
}
...
class AWSOrganizationsListAccountsCommand() : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.ListAccountsRequest, com.amazonaws.services.organizations.model.ListAccountsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.ListAccountsResult {
...
fun AWSOrganizationsFunctions.listAccountsForParent(parentId: String, init: (AWSOrganizationsListAccountsForParentCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.ListAccountsForParentResult {
	return this.block.declare(AWSOrganizationsListAccountsForParentCommand(parentId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.ListAccountsForParentResult
}
...
class AWSOrganizationsListAccountsForParentCommand(val parentId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.ListAccountsForParentRequest, com.amazonaws.services.organizations.model.ListAccountsForParentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.ListAccountsForParentResult {
...
fun AWSOrganizationsFunctions.listChildren(parentId: String, childType: ChildType, init: (AWSOrganizationsListChildrenCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.ListChildrenResult {
	return this.block.declare(AWSOrganizationsListChildrenCommand(parentId, childType).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.ListChildrenResult
}
...
class AWSOrganizationsListChildrenCommand(val parentId: String, val childType: ChildType) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.ListChildrenRequest, com.amazonaws.services.organizations.model.ListChildrenResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.ListChildrenResult {
...
fun AWSOrganizationsFunctions.listCreateAccountStatus(init: (AWSOrganizationsListCreateAccountStatusCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.ListCreateAccountStatusResult {
	return this.block.declare(AWSOrganizationsListCreateAccountStatusCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.ListCreateAccountStatusResult
}
...
class AWSOrganizationsListCreateAccountStatusCommand() : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.ListCreateAccountStatusRequest, com.amazonaws.services.organizations.model.ListCreateAccountStatusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.ListCreateAccountStatusResult {
...
fun AWSOrganizationsFunctions.listHandshakesForAccount(init: (AWSOrganizationsListHandshakesForAccountCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.ListHandshakesForAccountResult {
	return this.block.declare(AWSOrganizationsListHandshakesForAccountCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.ListHandshakesForAccountResult
}
...
class AWSOrganizationsListHandshakesForAccountCommand() : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.ListHandshakesForAccountRequest, com.amazonaws.services.organizations.model.ListHandshakesForAccountResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.ListHandshakesForAccountResult {
...
fun AWSOrganizationsFunctions.listHandshakesForOrganization(init: (AWSOrganizationsListHandshakesForOrganizationCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.ListHandshakesForOrganizationResult {
	return this.block.declare(AWSOrganizationsListHandshakesForOrganizationCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.ListHandshakesForOrganizationResult
}
...
class AWSOrganizationsListHandshakesForOrganizationCommand() : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.ListHandshakesForOrganizationRequest, com.amazonaws.services.organizations.model.ListHandshakesForOrganizationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.ListHandshakesForOrganizationResult {
...
fun AWSOrganizationsFunctions.listOrganizationalUnitsForParent(parentId: String, init: (AWSOrganizationsListOrganizationalUnitsForParentCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.ListOrganizationalUnitsForParentResult {
	return this.block.declare(AWSOrganizationsListOrganizationalUnitsForParentCommand(parentId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.ListOrganizationalUnitsForParentResult
}
...
class AWSOrganizationsListOrganizationalUnitsForParentCommand(val parentId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.ListOrganizationalUnitsForParentRequest, com.amazonaws.services.organizations.model.ListOrganizationalUnitsForParentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.ListOrganizationalUnitsForParentResult {
...
fun AWSOrganizationsFunctions.listParents(childId: String, init: (AWSOrganizationsListParentsCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.ListParentsResult {
	return this.block.declare(AWSOrganizationsListParentsCommand(childId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.ListParentsResult
}
...
class AWSOrganizationsListParentsCommand(val childId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.ListParentsRequest, com.amazonaws.services.organizations.model.ListParentsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.ListParentsResult {
...
fun AWSOrganizationsFunctions.listPolicies(filter: PolicyType, init: (AWSOrganizationsListPoliciesCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.ListPoliciesResult {
	return this.block.declare(AWSOrganizationsListPoliciesCommand(filter).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.ListPoliciesResult
}
...
class AWSOrganizationsListPoliciesCommand(val filter: PolicyType) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.ListPoliciesRequest, com.amazonaws.services.organizations.model.ListPoliciesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.ListPoliciesResult {
...
fun AWSOrganizationsFunctions.listPoliciesForTarget(targetId: String, filter: PolicyType, init: (AWSOrganizationsListPoliciesForTargetCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.ListPoliciesForTargetResult {
	return this.block.declare(AWSOrganizationsListPoliciesForTargetCommand(targetId, filter).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.ListPoliciesForTargetResult
}
...
class AWSOrganizationsListPoliciesForTargetCommand(val targetId: String, val filter: PolicyType) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.ListPoliciesForTargetRequest, com.amazonaws.services.organizations.model.ListPoliciesForTargetResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.ListPoliciesForTargetResult {
...
fun AWSOrganizationsFunctions.listRoots(init: (AWSOrganizationsListRootsCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.ListRootsResult {
	return this.block.declare(AWSOrganizationsListRootsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.ListRootsResult
}
...
class AWSOrganizationsListRootsCommand() : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.ListRootsRequest, com.amazonaws.services.organizations.model.ListRootsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.ListRootsResult {
...
fun AWSOrganizationsFunctions.listTargetsForPolicy(policyId: String, init: (AWSOrganizationsListTargetsForPolicyCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.ListTargetsForPolicyResult {
	return this.block.declare(AWSOrganizationsListTargetsForPolicyCommand(policyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.ListTargetsForPolicyResult
}
...
class AWSOrganizationsListTargetsForPolicyCommand(val policyId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.ListTargetsForPolicyRequest, com.amazonaws.services.organizations.model.ListTargetsForPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.ListTargetsForPolicyResult {
...
fun AWSOrganizationsFunctions.moveAccount(accountId: String, sourceParentId: String, destinationParentId: String, init: (AWSOrganizationsMoveAccountCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.MoveAccountResult {
	return this.block.declare(AWSOrganizationsMoveAccountCommand(accountId, sourceParentId, destinationParentId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.MoveAccountResult
}
...
class AWSOrganizationsMoveAccountCommand(val accountId: String, val sourceParentId: String, val destinationParentId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.MoveAccountRequest, com.amazonaws.services.organizations.model.MoveAccountResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.MoveAccountResult {
...
fun AWSOrganizationsFunctions.removeAccountFromOrganization(accountId: String, init: (AWSOrganizationsRemoveAccountFromOrganizationCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.RemoveAccountFromOrganizationResult {
	return this.block.declare(AWSOrganizationsRemoveAccountFromOrganizationCommand(accountId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.RemoveAccountFromOrganizationResult
}
...
class AWSOrganizationsRemoveAccountFromOrganizationCommand(val accountId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.RemoveAccountFromOrganizationRequest, com.amazonaws.services.organizations.model.RemoveAccountFromOrganizationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.RemoveAccountFromOrganizationResult {
...
fun AWSOrganizationsFunctions.updateOrganizationalUnit(organizationalUnitId: String, init: (AWSOrganizationsUpdateOrganizationalUnitCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.UpdateOrganizationalUnitResult {
	return this.block.declare(AWSOrganizationsUpdateOrganizationalUnitCommand(organizationalUnitId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.UpdateOrganizationalUnitResult
}
...
class AWSOrganizationsUpdateOrganizationalUnitCommand(val organizationalUnitId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.UpdateOrganizationalUnitRequest, com.amazonaws.services.organizations.model.UpdateOrganizationalUnitResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.UpdateOrganizationalUnitResult {
...
fun AWSOrganizationsFunctions.updatePolicy(policyId: String, init: (AWSOrganizationsUpdatePolicyCommand.() -> Unit)? = null): com.amazonaws.services.organizations.model.UpdatePolicyResult {
	return this.block.declare(AWSOrganizationsUpdatePolicyCommand(policyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.organizations.model.UpdatePolicyResult
}
...
class AWSOrganizationsUpdatePolicyCommand(val policyId: String) : AmazonWebServiceCommand<com.amazonaws.services.organizations.model.UpdatePolicyRequest, com.amazonaws.services.organizations.model.UpdatePolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.organizations.model.UpdatePolicyResult {
