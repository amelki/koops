...
package com.codingue.koops.aws.gamelift
...
var com.codingue.koops.core.Environment.gamelift: AmazonGameLift
	get() {
...
fun AmazonGameLiftFunctions.acceptMatch(ticketId: String, playerIds: List<String>, acceptanceType: AcceptanceType, init: (AmazonGameLiftAcceptMatchCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.AcceptMatchResult {
	return this.block.declare(AmazonGameLiftAcceptMatchCommand(ticketId, playerIds, acceptanceType).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.AcceptMatchResult
}
...
class AmazonGameLiftAcceptMatchCommand(val ticketId: String, val playerIds: List<String>, val acceptanceType: AcceptanceType) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.AcceptMatchRequest, com.amazonaws.services.gamelift.model.AcceptMatchResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.AcceptMatchResult {
...
fun AmazonGameLiftFunctions.createAlias(name: String, routingStrategy: com.amazonaws.services.gamelift.model.RoutingStrategy, init: (AmazonGameLiftCreateAliasCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.CreateAliasResult {
	return this.block.declare(AmazonGameLiftCreateAliasCommand(name, routingStrategy).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.CreateAliasResult
}
...
class AmazonGameLiftCreateAliasCommand(val name: String, val routingStrategy: com.amazonaws.services.gamelift.model.RoutingStrategy) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.CreateAliasRequest, com.amazonaws.services.gamelift.model.CreateAliasResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.CreateAliasResult {
...
fun AmazonGameLiftFunctions.createBuild(init: (AmazonGameLiftCreateBuildCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.CreateBuildResult {
	return this.block.declare(AmazonGameLiftCreateBuildCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.CreateBuildResult
}
...
class AmazonGameLiftCreateBuildCommand() : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.CreateBuildRequest, com.amazonaws.services.gamelift.model.CreateBuildResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.CreateBuildResult {
...
fun AmazonGameLiftFunctions.createFleet(name: String, buildId: String, eC2InstanceType: EC2InstanceType, init: (AmazonGameLiftCreateFleetCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.CreateFleetResult {
	return this.block.declare(AmazonGameLiftCreateFleetCommand(name, buildId, eC2InstanceType).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.CreateFleetResult
}
...
class AmazonGameLiftCreateFleetCommand(val name: String, val buildId: String, val eC2InstanceType: EC2InstanceType) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.CreateFleetRequest, com.amazonaws.services.gamelift.model.CreateFleetResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.CreateFleetResult {
...
fun AmazonGameLiftFunctions.createGameSession(maximumPlayerSessionCount: Int, init: (AmazonGameLiftCreateGameSessionCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.CreateGameSessionResult {
	return this.block.declare(AmazonGameLiftCreateGameSessionCommand(maximumPlayerSessionCount).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.CreateGameSessionResult
}
...
class AmazonGameLiftCreateGameSessionCommand(val maximumPlayerSessionCount: Int) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.CreateGameSessionRequest, com.amazonaws.services.gamelift.model.CreateGameSessionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.CreateGameSessionResult {
...
fun AmazonGameLiftFunctions.createGameSessionQueue(name: String, init: (AmazonGameLiftCreateGameSessionQueueCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.CreateGameSessionQueueResult {
	return this.block.declare(AmazonGameLiftCreateGameSessionQueueCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.CreateGameSessionQueueResult
}
...
class AmazonGameLiftCreateGameSessionQueueCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.CreateGameSessionQueueRequest, com.amazonaws.services.gamelift.model.CreateGameSessionQueueResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.CreateGameSessionQueueResult {
...
fun AmazonGameLiftFunctions.createMatchmakingConfiguration(name: String, gameSessionQueueArns: List<String>, requestTimeoutSeconds: Int, acceptanceRequired: Boolean, ruleSetName: String, init: (AmazonGameLiftCreateMatchmakingConfigurationCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.CreateMatchmakingConfigurationResult {
	return this.block.declare(AmazonGameLiftCreateMatchmakingConfigurationCommand(name, gameSessionQueueArns, requestTimeoutSeconds, acceptanceRequired, ruleSetName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.CreateMatchmakingConfigurationResult
}
...
class AmazonGameLiftCreateMatchmakingConfigurationCommand(val name: String, val gameSessionQueueArns: List<String>, val requestTimeoutSeconds: Int, val acceptanceRequired: Boolean, val ruleSetName: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.CreateMatchmakingConfigurationRequest, com.amazonaws.services.gamelift.model.CreateMatchmakingConfigurationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.CreateMatchmakingConfigurationResult {
...
fun AmazonGameLiftFunctions.createMatchmakingRuleSet(name: String, ruleSetBody: String, init: (AmazonGameLiftCreateMatchmakingRuleSetCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.CreateMatchmakingRuleSetResult {
	return this.block.declare(AmazonGameLiftCreateMatchmakingRuleSetCommand(name, ruleSetBody).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.CreateMatchmakingRuleSetResult
}
...
class AmazonGameLiftCreateMatchmakingRuleSetCommand(val name: String, val ruleSetBody: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.CreateMatchmakingRuleSetRequest, com.amazonaws.services.gamelift.model.CreateMatchmakingRuleSetResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.CreateMatchmakingRuleSetResult {
...
fun AmazonGameLiftFunctions.createPlayerSession(gameSessionId: String, playerId: String, init: (AmazonGameLiftCreatePlayerSessionCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.CreatePlayerSessionResult {
	return this.block.declare(AmazonGameLiftCreatePlayerSessionCommand(gameSessionId, playerId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.CreatePlayerSessionResult
}
...
class AmazonGameLiftCreatePlayerSessionCommand(val gameSessionId: String, val playerId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.CreatePlayerSessionRequest, com.amazonaws.services.gamelift.model.CreatePlayerSessionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.CreatePlayerSessionResult {
...
fun AmazonGameLiftFunctions.createPlayerSessions(gameSessionId: String, playerIds: List<String>, init: (AmazonGameLiftCreatePlayerSessionsCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.CreatePlayerSessionsResult {
	return this.block.declare(AmazonGameLiftCreatePlayerSessionsCommand(gameSessionId, playerIds).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.CreatePlayerSessionsResult
}
...
class AmazonGameLiftCreatePlayerSessionsCommand(val gameSessionId: String, val playerIds: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.CreatePlayerSessionsRequest, com.amazonaws.services.gamelift.model.CreatePlayerSessionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.CreatePlayerSessionsResult {
...
fun AmazonGameLiftFunctions.createVpcPeeringAuthorization(gameLiftAwsAccountId: String, peerVpcId: String, init: (AmazonGameLiftCreateVpcPeeringAuthorizationCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.CreateVpcPeeringAuthorizationResult {
	return this.block.declare(AmazonGameLiftCreateVpcPeeringAuthorizationCommand(gameLiftAwsAccountId, peerVpcId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.CreateVpcPeeringAuthorizationResult
}
...
class AmazonGameLiftCreateVpcPeeringAuthorizationCommand(val gameLiftAwsAccountId: String, val peerVpcId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.CreateVpcPeeringAuthorizationRequest, com.amazonaws.services.gamelift.model.CreateVpcPeeringAuthorizationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.CreateVpcPeeringAuthorizationResult {
...
fun AmazonGameLiftFunctions.createVpcPeeringConnection(fleetId: String, peerVpcAwsAccountId: String, peerVpcId: String, init: (AmazonGameLiftCreateVpcPeeringConnectionCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.CreateVpcPeeringConnectionResult {
	return this.block.declare(AmazonGameLiftCreateVpcPeeringConnectionCommand(fleetId, peerVpcAwsAccountId, peerVpcId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.CreateVpcPeeringConnectionResult
}
...
class AmazonGameLiftCreateVpcPeeringConnectionCommand(val fleetId: String, val peerVpcAwsAccountId: String, val peerVpcId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.CreateVpcPeeringConnectionRequest, com.amazonaws.services.gamelift.model.CreateVpcPeeringConnectionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.CreateVpcPeeringConnectionResult {
...
fun AmazonGameLiftFunctions.deleteAlias(aliasId: String, init: (AmazonGameLiftDeleteAliasCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DeleteAliasResult {
	return this.block.declare(AmazonGameLiftDeleteAliasCommand(aliasId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DeleteAliasResult
}
...
class AmazonGameLiftDeleteAliasCommand(val aliasId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DeleteAliasRequest, com.amazonaws.services.gamelift.model.DeleteAliasResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DeleteAliasResult {
...
fun AmazonGameLiftFunctions.deleteBuild(buildId: String, init: (AmazonGameLiftDeleteBuildCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DeleteBuildResult {
	return this.block.declare(AmazonGameLiftDeleteBuildCommand(buildId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DeleteBuildResult
}
...
class AmazonGameLiftDeleteBuildCommand(val buildId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DeleteBuildRequest, com.amazonaws.services.gamelift.model.DeleteBuildResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DeleteBuildResult {
...
fun AmazonGameLiftFunctions.deleteFleet(fleetId: String, init: (AmazonGameLiftDeleteFleetCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DeleteFleetResult {
	return this.block.declare(AmazonGameLiftDeleteFleetCommand(fleetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DeleteFleetResult
}
...
class AmazonGameLiftDeleteFleetCommand(val fleetId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DeleteFleetRequest, com.amazonaws.services.gamelift.model.DeleteFleetResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DeleteFleetResult {
...
fun AmazonGameLiftFunctions.deleteGameSessionQueue(name: String, init: (AmazonGameLiftDeleteGameSessionQueueCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DeleteGameSessionQueueResult {
	return this.block.declare(AmazonGameLiftDeleteGameSessionQueueCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DeleteGameSessionQueueResult
}
...
class AmazonGameLiftDeleteGameSessionQueueCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DeleteGameSessionQueueRequest, com.amazonaws.services.gamelift.model.DeleteGameSessionQueueResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DeleteGameSessionQueueResult {
...
fun AmazonGameLiftFunctions.deleteMatchmakingConfiguration(name: String, init: (AmazonGameLiftDeleteMatchmakingConfigurationCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DeleteMatchmakingConfigurationResult {
	return this.block.declare(AmazonGameLiftDeleteMatchmakingConfigurationCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DeleteMatchmakingConfigurationResult
}
...
class AmazonGameLiftDeleteMatchmakingConfigurationCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DeleteMatchmakingConfigurationRequest, com.amazonaws.services.gamelift.model.DeleteMatchmakingConfigurationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DeleteMatchmakingConfigurationResult {
...
fun AmazonGameLiftFunctions.deleteScalingPolicy(name: String, fleetId: String, init: (AmazonGameLiftDeleteScalingPolicyCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DeleteScalingPolicyResult {
	return this.block.declare(AmazonGameLiftDeleteScalingPolicyCommand(name, fleetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DeleteScalingPolicyResult
}
...
class AmazonGameLiftDeleteScalingPolicyCommand(val name: String, val fleetId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DeleteScalingPolicyRequest, com.amazonaws.services.gamelift.model.DeleteScalingPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DeleteScalingPolicyResult {
...
fun AmazonGameLiftFunctions.deleteVpcPeeringAuthorization(gameLiftAwsAccountId: String, peerVpcId: String, init: (AmazonGameLiftDeleteVpcPeeringAuthorizationCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DeleteVpcPeeringAuthorizationResult {
	return this.block.declare(AmazonGameLiftDeleteVpcPeeringAuthorizationCommand(gameLiftAwsAccountId, peerVpcId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DeleteVpcPeeringAuthorizationResult
}
...
class AmazonGameLiftDeleteVpcPeeringAuthorizationCommand(val gameLiftAwsAccountId: String, val peerVpcId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DeleteVpcPeeringAuthorizationRequest, com.amazonaws.services.gamelift.model.DeleteVpcPeeringAuthorizationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DeleteVpcPeeringAuthorizationResult {
...
fun AmazonGameLiftFunctions.deleteVpcPeeringConnection(fleetId: String, vpcPeeringConnectionId: String, init: (AmazonGameLiftDeleteVpcPeeringConnectionCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DeleteVpcPeeringConnectionResult {
	return this.block.declare(AmazonGameLiftDeleteVpcPeeringConnectionCommand(fleetId, vpcPeeringConnectionId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DeleteVpcPeeringConnectionResult
}
...
class AmazonGameLiftDeleteVpcPeeringConnectionCommand(val fleetId: String, val vpcPeeringConnectionId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DeleteVpcPeeringConnectionRequest, com.amazonaws.services.gamelift.model.DeleteVpcPeeringConnectionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DeleteVpcPeeringConnectionResult {
...
fun AmazonGameLiftFunctions.describeAlias(aliasId: String, init: (AmazonGameLiftDescribeAliasCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeAliasResult {
	return this.block.declare(AmazonGameLiftDescribeAliasCommand(aliasId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeAliasResult
}
...
class AmazonGameLiftDescribeAliasCommand(val aliasId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeAliasRequest, com.amazonaws.services.gamelift.model.DescribeAliasResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeAliasResult {
...
fun AmazonGameLiftFunctions.describeBuild(buildId: String, init: (AmazonGameLiftDescribeBuildCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeBuildResult {
	return this.block.declare(AmazonGameLiftDescribeBuildCommand(buildId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeBuildResult
}
...
class AmazonGameLiftDescribeBuildCommand(val buildId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeBuildRequest, com.amazonaws.services.gamelift.model.DescribeBuildResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeBuildResult {
...
fun AmazonGameLiftFunctions.describeEC2InstanceLimits(init: (AmazonGameLiftDescribeEC2InstanceLimitsCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeEC2InstanceLimitsResult {
	return this.block.declare(AmazonGameLiftDescribeEC2InstanceLimitsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeEC2InstanceLimitsResult
}
...
class AmazonGameLiftDescribeEC2InstanceLimitsCommand() : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeEC2InstanceLimitsRequest, com.amazonaws.services.gamelift.model.DescribeEC2InstanceLimitsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeEC2InstanceLimitsResult {
...
fun AmazonGameLiftFunctions.describeFleetAttributes(init: (AmazonGameLiftDescribeFleetAttributesCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeFleetAttributesResult {
	return this.block.declare(AmazonGameLiftDescribeFleetAttributesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeFleetAttributesResult
}
...
class AmazonGameLiftDescribeFleetAttributesCommand() : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeFleetAttributesRequest, com.amazonaws.services.gamelift.model.DescribeFleetAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeFleetAttributesResult {
...
fun AmazonGameLiftFunctions.describeFleetCapacity(init: (AmazonGameLiftDescribeFleetCapacityCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeFleetCapacityResult {
	return this.block.declare(AmazonGameLiftDescribeFleetCapacityCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeFleetCapacityResult
}
...
class AmazonGameLiftDescribeFleetCapacityCommand() : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeFleetCapacityRequest, com.amazonaws.services.gamelift.model.DescribeFleetCapacityResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeFleetCapacityResult {
...
fun AmazonGameLiftFunctions.describeFleetEvents(fleetId: String, init: (AmazonGameLiftDescribeFleetEventsCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeFleetEventsResult {
	return this.block.declare(AmazonGameLiftDescribeFleetEventsCommand(fleetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeFleetEventsResult
}
...
class AmazonGameLiftDescribeFleetEventsCommand(val fleetId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeFleetEventsRequest, com.amazonaws.services.gamelift.model.DescribeFleetEventsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeFleetEventsResult {
...
fun AmazonGameLiftFunctions.describeFleetPortSettings(fleetId: String, init: (AmazonGameLiftDescribeFleetPortSettingsCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeFleetPortSettingsResult {
	return this.block.declare(AmazonGameLiftDescribeFleetPortSettingsCommand(fleetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeFleetPortSettingsResult
}
...
class AmazonGameLiftDescribeFleetPortSettingsCommand(val fleetId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeFleetPortSettingsRequest, com.amazonaws.services.gamelift.model.DescribeFleetPortSettingsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeFleetPortSettingsResult {
...
fun AmazonGameLiftFunctions.describeFleetUtilization(init: (AmazonGameLiftDescribeFleetUtilizationCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeFleetUtilizationResult {
	return this.block.declare(AmazonGameLiftDescribeFleetUtilizationCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeFleetUtilizationResult
}
...
class AmazonGameLiftDescribeFleetUtilizationCommand() : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeFleetUtilizationRequest, com.amazonaws.services.gamelift.model.DescribeFleetUtilizationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeFleetUtilizationResult {
...
fun AmazonGameLiftFunctions.describeGameSessionDetails(init: (AmazonGameLiftDescribeGameSessionDetailsCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeGameSessionDetailsResult {
	return this.block.declare(AmazonGameLiftDescribeGameSessionDetailsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeGameSessionDetailsResult
}
...
class AmazonGameLiftDescribeGameSessionDetailsCommand() : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeGameSessionDetailsRequest, com.amazonaws.services.gamelift.model.DescribeGameSessionDetailsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeGameSessionDetailsResult {
...
fun AmazonGameLiftFunctions.describeGameSessionPlacement(placementId: String, init: (AmazonGameLiftDescribeGameSessionPlacementCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeGameSessionPlacementResult {
	return this.block.declare(AmazonGameLiftDescribeGameSessionPlacementCommand(placementId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeGameSessionPlacementResult
}
...
class AmazonGameLiftDescribeGameSessionPlacementCommand(val placementId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeGameSessionPlacementRequest, com.amazonaws.services.gamelift.model.DescribeGameSessionPlacementResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeGameSessionPlacementResult {
...
fun AmazonGameLiftFunctions.describeGameSessionQueues(init: (AmazonGameLiftDescribeGameSessionQueuesCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeGameSessionQueuesResult {
	return this.block.declare(AmazonGameLiftDescribeGameSessionQueuesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeGameSessionQueuesResult
}
...
class AmazonGameLiftDescribeGameSessionQueuesCommand() : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeGameSessionQueuesRequest, com.amazonaws.services.gamelift.model.DescribeGameSessionQueuesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeGameSessionQueuesResult {
...
fun AmazonGameLiftFunctions.describeGameSessions(init: (AmazonGameLiftDescribeGameSessionsCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeGameSessionsResult {
	return this.block.declare(AmazonGameLiftDescribeGameSessionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeGameSessionsResult
}
...
class AmazonGameLiftDescribeGameSessionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeGameSessionsRequest, com.amazonaws.services.gamelift.model.DescribeGameSessionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeGameSessionsResult {
...
fun AmazonGameLiftFunctions.describeInstances(fleetId: String, init: (AmazonGameLiftDescribeInstancesCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeInstancesResult {
	return this.block.declare(AmazonGameLiftDescribeInstancesCommand(fleetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeInstancesResult
}
...
class AmazonGameLiftDescribeInstancesCommand(val fleetId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeInstancesRequest, com.amazonaws.services.gamelift.model.DescribeInstancesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeInstancesResult {
...
fun AmazonGameLiftFunctions.describeMatchmaking(ticketIds: List<String>, init: (AmazonGameLiftDescribeMatchmakingCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeMatchmakingResult {
	return this.block.declare(AmazonGameLiftDescribeMatchmakingCommand(ticketIds).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeMatchmakingResult
}
...
class AmazonGameLiftDescribeMatchmakingCommand(val ticketIds: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeMatchmakingRequest, com.amazonaws.services.gamelift.model.DescribeMatchmakingResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeMatchmakingResult {
...
fun AmazonGameLiftFunctions.describeMatchmakingConfigurations(init: (AmazonGameLiftDescribeMatchmakingConfigurationsCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeMatchmakingConfigurationsResult {
	return this.block.declare(AmazonGameLiftDescribeMatchmakingConfigurationsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeMatchmakingConfigurationsResult
}
...
class AmazonGameLiftDescribeMatchmakingConfigurationsCommand() : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeMatchmakingConfigurationsRequest, com.amazonaws.services.gamelift.model.DescribeMatchmakingConfigurationsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeMatchmakingConfigurationsResult {
...
fun AmazonGameLiftFunctions.describeMatchmakingRuleSets(init: (AmazonGameLiftDescribeMatchmakingRuleSetsCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeMatchmakingRuleSetsResult {
	return this.block.declare(AmazonGameLiftDescribeMatchmakingRuleSetsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeMatchmakingRuleSetsResult
}
...
class AmazonGameLiftDescribeMatchmakingRuleSetsCommand() : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeMatchmakingRuleSetsRequest, com.amazonaws.services.gamelift.model.DescribeMatchmakingRuleSetsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeMatchmakingRuleSetsResult {
...
fun AmazonGameLiftFunctions.describePlayerSessions(init: (AmazonGameLiftDescribePlayerSessionsCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribePlayerSessionsResult {
	return this.block.declare(AmazonGameLiftDescribePlayerSessionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribePlayerSessionsResult
}
...
class AmazonGameLiftDescribePlayerSessionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribePlayerSessionsRequest, com.amazonaws.services.gamelift.model.DescribePlayerSessionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribePlayerSessionsResult {
...
fun AmazonGameLiftFunctions.describeRuntimeConfiguration(fleetId: String, init: (AmazonGameLiftDescribeRuntimeConfigurationCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeRuntimeConfigurationResult {
	return this.block.declare(AmazonGameLiftDescribeRuntimeConfigurationCommand(fleetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeRuntimeConfigurationResult
}
...
class AmazonGameLiftDescribeRuntimeConfigurationCommand(val fleetId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeRuntimeConfigurationRequest, com.amazonaws.services.gamelift.model.DescribeRuntimeConfigurationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeRuntimeConfigurationResult {
...
fun AmazonGameLiftFunctions.describeScalingPolicies(fleetId: String, init: (AmazonGameLiftDescribeScalingPoliciesCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeScalingPoliciesResult {
	return this.block.declare(AmazonGameLiftDescribeScalingPoliciesCommand(fleetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeScalingPoliciesResult
}
...
class AmazonGameLiftDescribeScalingPoliciesCommand(val fleetId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeScalingPoliciesRequest, com.amazonaws.services.gamelift.model.DescribeScalingPoliciesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeScalingPoliciesResult {
...
fun AmazonGameLiftFunctions.describeVpcPeeringAuthorizations(init: (AmazonGameLiftDescribeVpcPeeringAuthorizationsCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeVpcPeeringAuthorizationsResult {
	return this.block.declare(AmazonGameLiftDescribeVpcPeeringAuthorizationsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeVpcPeeringAuthorizationsResult
}
...
class AmazonGameLiftDescribeVpcPeeringAuthorizationsCommand() : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeVpcPeeringAuthorizationsRequest, com.amazonaws.services.gamelift.model.DescribeVpcPeeringAuthorizationsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeVpcPeeringAuthorizationsResult {
...
fun AmazonGameLiftFunctions.describeVpcPeeringConnections(init: (AmazonGameLiftDescribeVpcPeeringConnectionsCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.DescribeVpcPeeringConnectionsResult {
	return this.block.declare(AmazonGameLiftDescribeVpcPeeringConnectionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.DescribeVpcPeeringConnectionsResult
}
...
class AmazonGameLiftDescribeVpcPeeringConnectionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.DescribeVpcPeeringConnectionsRequest, com.amazonaws.services.gamelift.model.DescribeVpcPeeringConnectionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.DescribeVpcPeeringConnectionsResult {
...
fun AmazonGameLiftFunctions.getGameSessionLogUrl(gameSessionId: String, init: (AmazonGameLiftGetGameSessionLogUrlCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.GetGameSessionLogUrlResult {
	return this.block.declare(AmazonGameLiftGetGameSessionLogUrlCommand(gameSessionId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.GetGameSessionLogUrlResult
}
...
class AmazonGameLiftGetGameSessionLogUrlCommand(val gameSessionId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.GetGameSessionLogUrlRequest, com.amazonaws.services.gamelift.model.GetGameSessionLogUrlResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.GetGameSessionLogUrlResult {
...
fun AmazonGameLiftFunctions.getInstanceAccess(fleetId: String, instanceId: String, init: (AmazonGameLiftGetInstanceAccessCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.GetInstanceAccessResult {
	return this.block.declare(AmazonGameLiftGetInstanceAccessCommand(fleetId, instanceId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.GetInstanceAccessResult
}
...
class AmazonGameLiftGetInstanceAccessCommand(val fleetId: String, val instanceId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.GetInstanceAccessRequest, com.amazonaws.services.gamelift.model.GetInstanceAccessResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.GetInstanceAccessResult {
...
fun AmazonGameLiftFunctions.listAliases(init: (AmazonGameLiftListAliasesCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.ListAliasesResult {
	return this.block.declare(AmazonGameLiftListAliasesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.ListAliasesResult
}
...
class AmazonGameLiftListAliasesCommand() : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.ListAliasesRequest, com.amazonaws.services.gamelift.model.ListAliasesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.ListAliasesResult {
...
fun AmazonGameLiftFunctions.listBuilds(init: (AmazonGameLiftListBuildsCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.ListBuildsResult {
	return this.block.declare(AmazonGameLiftListBuildsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.ListBuildsResult
}
...
class AmazonGameLiftListBuildsCommand() : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.ListBuildsRequest, com.amazonaws.services.gamelift.model.ListBuildsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.ListBuildsResult {
...
fun AmazonGameLiftFunctions.listFleets(init: (AmazonGameLiftListFleetsCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.ListFleetsResult {
	return this.block.declare(AmazonGameLiftListFleetsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.ListFleetsResult
}
...
class AmazonGameLiftListFleetsCommand() : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.ListFleetsRequest, com.amazonaws.services.gamelift.model.ListFleetsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.ListFleetsResult {
...
fun AmazonGameLiftFunctions.putScalingPolicy(name: String, fleetId: String, scalingAdjustment: Int, scalingAdjustmentType: ScalingAdjustmentType, threshold: Double, comparisonOperator: ComparisonOperatorType, evaluationPeriods: Int, metricName: MetricName, init: (AmazonGameLiftPutScalingPolicyCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.PutScalingPolicyResult {
	return this.block.declare(AmazonGameLiftPutScalingPolicyCommand(name, fleetId, scalingAdjustment, scalingAdjustmentType, threshold, comparisonOperator, evaluationPeriods, metricName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.PutScalingPolicyResult
}
...
class AmazonGameLiftPutScalingPolicyCommand(val name: String, val fleetId: String, val scalingAdjustment: Int, val scalingAdjustmentType: ScalingAdjustmentType, val threshold: Double, val comparisonOperator: ComparisonOperatorType, val evaluationPeriods: Int, val metricName: MetricName) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.PutScalingPolicyRequest, com.amazonaws.services.gamelift.model.PutScalingPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.PutScalingPolicyResult {
...
fun AmazonGameLiftFunctions.requestUploadCredentials(buildId: String, init: (AmazonGameLiftRequestUploadCredentialsCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.RequestUploadCredentialsResult {
	return this.block.declare(AmazonGameLiftRequestUploadCredentialsCommand(buildId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.RequestUploadCredentialsResult
}
...
class AmazonGameLiftRequestUploadCredentialsCommand(val buildId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.RequestUploadCredentialsRequest, com.amazonaws.services.gamelift.model.RequestUploadCredentialsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.RequestUploadCredentialsResult {
...
fun AmazonGameLiftFunctions.resolveAlias(aliasId: String, init: (AmazonGameLiftResolveAliasCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.ResolveAliasResult {
	return this.block.declare(AmazonGameLiftResolveAliasCommand(aliasId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.ResolveAliasResult
}
...
class AmazonGameLiftResolveAliasCommand(val aliasId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.ResolveAliasRequest, com.amazonaws.services.gamelift.model.ResolveAliasResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.ResolveAliasResult {
...
fun AmazonGameLiftFunctions.searchGameSessions(init: (AmazonGameLiftSearchGameSessionsCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.SearchGameSessionsResult {
	return this.block.declare(AmazonGameLiftSearchGameSessionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.SearchGameSessionsResult
}
...
class AmazonGameLiftSearchGameSessionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.SearchGameSessionsRequest, com.amazonaws.services.gamelift.model.SearchGameSessionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.SearchGameSessionsResult {
...
fun AmazonGameLiftFunctions.startGameSessionPlacement(placementId: String, gameSessionQueueName: String, maximumPlayerSessionCount: Int, init: (AmazonGameLiftStartGameSessionPlacementCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.StartGameSessionPlacementResult {
	return this.block.declare(AmazonGameLiftStartGameSessionPlacementCommand(placementId, gameSessionQueueName, maximumPlayerSessionCount).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.StartGameSessionPlacementResult
}
...
class AmazonGameLiftStartGameSessionPlacementCommand(val placementId: String, val gameSessionQueueName: String, val maximumPlayerSessionCount: Int) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.StartGameSessionPlacementRequest, com.amazonaws.services.gamelift.model.StartGameSessionPlacementResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.StartGameSessionPlacementResult {
...
fun AmazonGameLiftFunctions.startMatchBackfill(configurationName: String, gameSessionArn: String, players: List<com.amazonaws.services.gamelift.model.Player>, init: (AmazonGameLiftStartMatchBackfillCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.StartMatchBackfillResult {
	return this.block.declare(AmazonGameLiftStartMatchBackfillCommand(configurationName, gameSessionArn, players).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.StartMatchBackfillResult
}
...
class AmazonGameLiftStartMatchBackfillCommand(val configurationName: String, val gameSessionArn: String, val players: List<com.amazonaws.services.gamelift.model.Player>) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.StartMatchBackfillRequest, com.amazonaws.services.gamelift.model.StartMatchBackfillResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.StartMatchBackfillResult {
...
fun AmazonGameLiftFunctions.startMatchmaking(configurationName: String, players: List<com.amazonaws.services.gamelift.model.Player>, init: (AmazonGameLiftStartMatchmakingCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.StartMatchmakingResult {
	return this.block.declare(AmazonGameLiftStartMatchmakingCommand(configurationName, players).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.StartMatchmakingResult
}
...
class AmazonGameLiftStartMatchmakingCommand(val configurationName: String, val players: List<com.amazonaws.services.gamelift.model.Player>) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.StartMatchmakingRequest, com.amazonaws.services.gamelift.model.StartMatchmakingResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.StartMatchmakingResult {
...
fun AmazonGameLiftFunctions.stopGameSessionPlacement(placementId: String, init: (AmazonGameLiftStopGameSessionPlacementCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.StopGameSessionPlacementResult {
	return this.block.declare(AmazonGameLiftStopGameSessionPlacementCommand(placementId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.StopGameSessionPlacementResult
}
...
class AmazonGameLiftStopGameSessionPlacementCommand(val placementId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.StopGameSessionPlacementRequest, com.amazonaws.services.gamelift.model.StopGameSessionPlacementResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.StopGameSessionPlacementResult {
...
fun AmazonGameLiftFunctions.stopMatchmaking(ticketId: String, init: (AmazonGameLiftStopMatchmakingCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.StopMatchmakingResult {
	return this.block.declare(AmazonGameLiftStopMatchmakingCommand(ticketId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.StopMatchmakingResult
}
...
class AmazonGameLiftStopMatchmakingCommand(val ticketId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.StopMatchmakingRequest, com.amazonaws.services.gamelift.model.StopMatchmakingResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.StopMatchmakingResult {
...
fun AmazonGameLiftFunctions.updateAlias(aliasId: String, init: (AmazonGameLiftUpdateAliasCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.UpdateAliasResult {
	return this.block.declare(AmazonGameLiftUpdateAliasCommand(aliasId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.UpdateAliasResult
}
...
class AmazonGameLiftUpdateAliasCommand(val aliasId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.UpdateAliasRequest, com.amazonaws.services.gamelift.model.UpdateAliasResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.UpdateAliasResult {
...
fun AmazonGameLiftFunctions.updateBuild(buildId: String, init: (AmazonGameLiftUpdateBuildCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.UpdateBuildResult {
	return this.block.declare(AmazonGameLiftUpdateBuildCommand(buildId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.UpdateBuildResult
}
...
class AmazonGameLiftUpdateBuildCommand(val buildId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.UpdateBuildRequest, com.amazonaws.services.gamelift.model.UpdateBuildResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.UpdateBuildResult {
...
fun AmazonGameLiftFunctions.updateFleetAttributes(fleetId: String, init: (AmazonGameLiftUpdateFleetAttributesCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.UpdateFleetAttributesResult {
	return this.block.declare(AmazonGameLiftUpdateFleetAttributesCommand(fleetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.UpdateFleetAttributesResult
}
...
class AmazonGameLiftUpdateFleetAttributesCommand(val fleetId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.UpdateFleetAttributesRequest, com.amazonaws.services.gamelift.model.UpdateFleetAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.UpdateFleetAttributesResult {
...
fun AmazonGameLiftFunctions.updateFleetCapacity(fleetId: String, init: (AmazonGameLiftUpdateFleetCapacityCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.UpdateFleetCapacityResult {
	return this.block.declare(AmazonGameLiftUpdateFleetCapacityCommand(fleetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.UpdateFleetCapacityResult
}
...
class AmazonGameLiftUpdateFleetCapacityCommand(val fleetId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.UpdateFleetCapacityRequest, com.amazonaws.services.gamelift.model.UpdateFleetCapacityResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.UpdateFleetCapacityResult {
...
fun AmazonGameLiftFunctions.updateFleetPortSettings(fleetId: String, init: (AmazonGameLiftUpdateFleetPortSettingsCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.UpdateFleetPortSettingsResult {
	return this.block.declare(AmazonGameLiftUpdateFleetPortSettingsCommand(fleetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.UpdateFleetPortSettingsResult
}
...
class AmazonGameLiftUpdateFleetPortSettingsCommand(val fleetId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.UpdateFleetPortSettingsRequest, com.amazonaws.services.gamelift.model.UpdateFleetPortSettingsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.UpdateFleetPortSettingsResult {
...
fun AmazonGameLiftFunctions.updateGameSession(gameSessionId: String, init: (AmazonGameLiftUpdateGameSessionCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.UpdateGameSessionResult {
	return this.block.declare(AmazonGameLiftUpdateGameSessionCommand(gameSessionId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.UpdateGameSessionResult
}
...
class AmazonGameLiftUpdateGameSessionCommand(val gameSessionId: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.UpdateGameSessionRequest, com.amazonaws.services.gamelift.model.UpdateGameSessionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.UpdateGameSessionResult {
...
fun AmazonGameLiftFunctions.updateGameSessionQueue(name: String, init: (AmazonGameLiftUpdateGameSessionQueueCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.UpdateGameSessionQueueResult {
	return this.block.declare(AmazonGameLiftUpdateGameSessionQueueCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.UpdateGameSessionQueueResult
}
...
class AmazonGameLiftUpdateGameSessionQueueCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.UpdateGameSessionQueueRequest, com.amazonaws.services.gamelift.model.UpdateGameSessionQueueResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.UpdateGameSessionQueueResult {
...
fun AmazonGameLiftFunctions.updateMatchmakingConfiguration(name: String, init: (AmazonGameLiftUpdateMatchmakingConfigurationCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.UpdateMatchmakingConfigurationResult {
	return this.block.declare(AmazonGameLiftUpdateMatchmakingConfigurationCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.UpdateMatchmakingConfigurationResult
}
...
class AmazonGameLiftUpdateMatchmakingConfigurationCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.UpdateMatchmakingConfigurationRequest, com.amazonaws.services.gamelift.model.UpdateMatchmakingConfigurationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.UpdateMatchmakingConfigurationResult {
...
fun AmazonGameLiftFunctions.updateRuntimeConfiguration(fleetId: String, runtimeConfiguration: com.amazonaws.services.gamelift.model.RuntimeConfiguration, init: (AmazonGameLiftUpdateRuntimeConfigurationCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.UpdateRuntimeConfigurationResult {
	return this.block.declare(AmazonGameLiftUpdateRuntimeConfigurationCommand(fleetId, runtimeConfiguration).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.UpdateRuntimeConfigurationResult
}
...
class AmazonGameLiftUpdateRuntimeConfigurationCommand(val fleetId: String, val runtimeConfiguration: com.amazonaws.services.gamelift.model.RuntimeConfiguration) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.UpdateRuntimeConfigurationRequest, com.amazonaws.services.gamelift.model.UpdateRuntimeConfigurationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.UpdateRuntimeConfigurationResult {
...
fun AmazonGameLiftFunctions.validateMatchmakingRuleSet(ruleSetBody: String, init: (AmazonGameLiftValidateMatchmakingRuleSetCommand.() -> Unit)? = null): com.amazonaws.services.gamelift.model.ValidateMatchmakingRuleSetResult {
	return this.block.declare(AmazonGameLiftValidateMatchmakingRuleSetCommand(ruleSetBody).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.gamelift.model.ValidateMatchmakingRuleSetResult
}
...
class AmazonGameLiftValidateMatchmakingRuleSetCommand(val ruleSetBody: String) : AmazonWebServiceCommand<com.amazonaws.services.gamelift.model.ValidateMatchmakingRuleSetRequest, com.amazonaws.services.gamelift.model.ValidateMatchmakingRuleSetResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.gamelift.model.ValidateMatchmakingRuleSetResult {
