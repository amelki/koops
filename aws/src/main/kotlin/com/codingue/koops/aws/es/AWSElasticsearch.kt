...
package com.codingue.koops.aws.es
...
var com.codingue.koops.core.Environment.es: AWSElasticsearch
	get() {
...
fun AWSElasticsearchFunctions.addTags(aRN: String, tagList: List<com.amazonaws.services.elasticsearch.model.Tag>, init: (AWSElasticsearchAddTagsCommand.() -> Unit)? = null): com.amazonaws.services.elasticsearch.model.AddTagsResult {
	return this.block.declare(AWSElasticsearchAddTagsCommand(aRN, tagList).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticsearch.model.AddTagsResult
}
...
class AWSElasticsearchAddTagsCommand(val aRN: String, val tagList: List<com.amazonaws.services.elasticsearch.model.Tag>) : AmazonWebServiceCommand<com.amazonaws.services.elasticsearch.model.AddTagsRequest, com.amazonaws.services.elasticsearch.model.AddTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticsearch.model.AddTagsResult {
...
fun AWSElasticsearchFunctions.createElasticsearchDomain(domainName: String, init: (AWSElasticsearchCreateElasticsearchDomainCommand.() -> Unit)? = null): com.amazonaws.services.elasticsearch.model.CreateElasticsearchDomainResult {
	return this.block.declare(AWSElasticsearchCreateElasticsearchDomainCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticsearch.model.CreateElasticsearchDomainResult
}
...
class AWSElasticsearchCreateElasticsearchDomainCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticsearch.model.CreateElasticsearchDomainRequest, com.amazonaws.services.elasticsearch.model.CreateElasticsearchDomainResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticsearch.model.CreateElasticsearchDomainResult {
...
fun AWSElasticsearchFunctions.deleteElasticsearchDomain(domainName: String, init: (AWSElasticsearchDeleteElasticsearchDomainCommand.() -> Unit)? = null): com.amazonaws.services.elasticsearch.model.DeleteElasticsearchDomainResult {
	return this.block.declare(AWSElasticsearchDeleteElasticsearchDomainCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticsearch.model.DeleteElasticsearchDomainResult
}
...
class AWSElasticsearchDeleteElasticsearchDomainCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticsearch.model.DeleteElasticsearchDomainRequest, com.amazonaws.services.elasticsearch.model.DeleteElasticsearchDomainResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticsearch.model.DeleteElasticsearchDomainResult {
...
fun AWSElasticsearchFunctions.deleteElasticsearchServiceRole(init: (AWSElasticsearchDeleteElasticsearchServiceRoleCommand.() -> Unit)? = null): com.amazonaws.services.elasticsearch.model.DeleteElasticsearchServiceRoleResult {
	return this.block.declare(AWSElasticsearchDeleteElasticsearchServiceRoleCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticsearch.model.DeleteElasticsearchServiceRoleResult
}
...
class AWSElasticsearchDeleteElasticsearchServiceRoleCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticsearch.model.DeleteElasticsearchServiceRoleRequest, com.amazonaws.services.elasticsearch.model.DeleteElasticsearchServiceRoleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticsearch.model.DeleteElasticsearchServiceRoleResult {
...
fun AWSElasticsearchFunctions.describeElasticsearchDomain(domainName: String, init: (AWSElasticsearchDescribeElasticsearchDomainCommand.() -> Unit)? = null): com.amazonaws.services.elasticsearch.model.DescribeElasticsearchDomainResult {
	return this.block.declare(AWSElasticsearchDescribeElasticsearchDomainCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticsearch.model.DescribeElasticsearchDomainResult
}
...
class AWSElasticsearchDescribeElasticsearchDomainCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticsearch.model.DescribeElasticsearchDomainRequest, com.amazonaws.services.elasticsearch.model.DescribeElasticsearchDomainResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticsearch.model.DescribeElasticsearchDomainResult {
...
fun AWSElasticsearchFunctions.describeElasticsearchDomainConfig(domainName: String, init: (AWSElasticsearchDescribeElasticsearchDomainConfigCommand.() -> Unit)? = null): com.amazonaws.services.elasticsearch.model.DescribeElasticsearchDomainConfigResult {
	return this.block.declare(AWSElasticsearchDescribeElasticsearchDomainConfigCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticsearch.model.DescribeElasticsearchDomainConfigResult
}
...
class AWSElasticsearchDescribeElasticsearchDomainConfigCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticsearch.model.DescribeElasticsearchDomainConfigRequest, com.amazonaws.services.elasticsearch.model.DescribeElasticsearchDomainConfigResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticsearch.model.DescribeElasticsearchDomainConfigResult {
...
fun AWSElasticsearchFunctions.describeElasticsearchDomains(domainNames: List<String>, init: (AWSElasticsearchDescribeElasticsearchDomainsCommand.() -> Unit)? = null): com.amazonaws.services.elasticsearch.model.DescribeElasticsearchDomainsResult {
	return this.block.declare(AWSElasticsearchDescribeElasticsearchDomainsCommand(domainNames).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticsearch.model.DescribeElasticsearchDomainsResult
}
...
class AWSElasticsearchDescribeElasticsearchDomainsCommand(val domainNames: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.elasticsearch.model.DescribeElasticsearchDomainsRequest, com.amazonaws.services.elasticsearch.model.DescribeElasticsearchDomainsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticsearch.model.DescribeElasticsearchDomainsResult {
...
fun AWSElasticsearchFunctions.describeElasticsearchInstanceTypeLimits(instanceType: ESPartitionInstanceType, elasticsearchVersion: String, init: (AWSElasticsearchDescribeElasticsearchInstanceTypeLimitsCommand.() -> Unit)? = null): com.amazonaws.services.elasticsearch.model.DescribeElasticsearchInstanceTypeLimitsResult {
	return this.block.declare(AWSElasticsearchDescribeElasticsearchInstanceTypeLimitsCommand(instanceType, elasticsearchVersion).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticsearch.model.DescribeElasticsearchInstanceTypeLimitsResult
}
...
class AWSElasticsearchDescribeElasticsearchInstanceTypeLimitsCommand(val instanceType: ESPartitionInstanceType, val elasticsearchVersion: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticsearch.model.DescribeElasticsearchInstanceTypeLimitsRequest, com.amazonaws.services.elasticsearch.model.DescribeElasticsearchInstanceTypeLimitsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticsearch.model.DescribeElasticsearchInstanceTypeLimitsResult {
...
fun AWSElasticsearchFunctions.listDomainNames(init: (AWSElasticsearchListDomainNamesCommand.() -> Unit)? = null): com.amazonaws.services.elasticsearch.model.ListDomainNamesResult {
	return this.block.declare(AWSElasticsearchListDomainNamesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticsearch.model.ListDomainNamesResult
}
...
class AWSElasticsearchListDomainNamesCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticsearch.model.ListDomainNamesRequest, com.amazonaws.services.elasticsearch.model.ListDomainNamesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticsearch.model.ListDomainNamesResult {
...
fun AWSElasticsearchFunctions.listElasticsearchInstanceTypes(elasticsearchVersion: String, init: (AWSElasticsearchListElasticsearchInstanceTypesCommand.() -> Unit)? = null): com.amazonaws.services.elasticsearch.model.ListElasticsearchInstanceTypesResult {
	return this.block.declare(AWSElasticsearchListElasticsearchInstanceTypesCommand(elasticsearchVersion).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticsearch.model.ListElasticsearchInstanceTypesResult
}
...
class AWSElasticsearchListElasticsearchInstanceTypesCommand(val elasticsearchVersion: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticsearch.model.ListElasticsearchInstanceTypesRequest, com.amazonaws.services.elasticsearch.model.ListElasticsearchInstanceTypesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticsearch.model.ListElasticsearchInstanceTypesResult {
...
fun AWSElasticsearchFunctions.listElasticsearchVersions(init: (AWSElasticsearchListElasticsearchVersionsCommand.() -> Unit)? = null): com.amazonaws.services.elasticsearch.model.ListElasticsearchVersionsResult {
	return this.block.declare(AWSElasticsearchListElasticsearchVersionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticsearch.model.ListElasticsearchVersionsResult
}
...
class AWSElasticsearchListElasticsearchVersionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticsearch.model.ListElasticsearchVersionsRequest, com.amazonaws.services.elasticsearch.model.ListElasticsearchVersionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticsearch.model.ListElasticsearchVersionsResult {
...
fun AWSElasticsearchFunctions.listTags(aRN: String, init: (AWSElasticsearchListTagsCommand.() -> Unit)? = null): com.amazonaws.services.elasticsearch.model.ListTagsResult {
	return this.block.declare(AWSElasticsearchListTagsCommand(aRN).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticsearch.model.ListTagsResult
}
...
class AWSElasticsearchListTagsCommand(val aRN: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticsearch.model.ListTagsRequest, com.amazonaws.services.elasticsearch.model.ListTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticsearch.model.ListTagsResult {
...
fun AWSElasticsearchFunctions.removeTags(aRN: String, tagKeys: List<String>, init: (AWSElasticsearchRemoveTagsCommand.() -> Unit)? = null): com.amazonaws.services.elasticsearch.model.RemoveTagsResult {
	return this.block.declare(AWSElasticsearchRemoveTagsCommand(aRN, tagKeys).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticsearch.model.RemoveTagsResult
}
...
class AWSElasticsearchRemoveTagsCommand(val aRN: String, val tagKeys: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.elasticsearch.model.RemoveTagsRequest, com.amazonaws.services.elasticsearch.model.RemoveTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticsearch.model.RemoveTagsResult {
...
fun AWSElasticsearchFunctions.updateElasticsearchDomainConfig(domainName: String, init: (AWSElasticsearchUpdateElasticsearchDomainConfigCommand.() -> Unit)? = null): com.amazonaws.services.elasticsearch.model.UpdateElasticsearchDomainConfigResult {
	return this.block.declare(AWSElasticsearchUpdateElasticsearchDomainConfigCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticsearch.model.UpdateElasticsearchDomainConfigResult
}
...
class AWSElasticsearchUpdateElasticsearchDomainConfigCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticsearch.model.UpdateElasticsearchDomainConfigRequest, com.amazonaws.services.elasticsearch.model.UpdateElasticsearchDomainConfigResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticsearch.model.UpdateElasticsearchDomainConfigResult {
