...
package com.codingue.koops.aws.cloudhsmv2
...
var com.codingue.koops.core.Environment.cloudhsmv2: AWSCloudHSMV2
	get() {
		var service = this.capabilities["aws-cloudhsmv2"]
		if (service == null) {
			service = AWSCloudHSMV2ClientBuilder.standard().build()
			this.capabilities["aws-cloudhsmv2"] = service
		}
		return service as AWSCloudHSMV2
	}
	set(cloudhsmv2) {
		this.capabilities["aws-cloudhsmv2"] = cloudhsmv2
	}
...
fun AWSCloudHSMV2Functions.createCluster(subnetIds: List<String>, hsmType: String, init: (AWSCloudHSMV2CreateClusterCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsmv2.model.CreateClusterResult {
	return this.block.declare(AWSCloudHSMV2CreateClusterCommand(subnetIds, hsmType).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsmv2.model.CreateClusterResult
}
...
class AWSCloudHSMV2CreateClusterCommand(val subnetIds: List<String>, val hsmType: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsmv2.model.CreateClusterRequest, com.amazonaws.services.cloudhsmv2.model.CreateClusterResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsmv2.model.CreateClusterResult {
...
fun AWSCloudHSMV2Functions.createHsm(clusterId: String, availabilityZone: String, init: (AWSCloudHSMV2CreateHsmCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsmv2.model.CreateHsmResult {
	return this.block.declare(AWSCloudHSMV2CreateHsmCommand(clusterId, availabilityZone).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsmv2.model.CreateHsmResult
}
...
class AWSCloudHSMV2CreateHsmCommand(val clusterId: String, val availabilityZone: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsmv2.model.CreateHsmRequest, com.amazonaws.services.cloudhsmv2.model.CreateHsmResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsmv2.model.CreateHsmResult {
...
fun AWSCloudHSMV2Functions.deleteCluster(clusterId: String, init: (AWSCloudHSMV2DeleteClusterCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsmv2.model.DeleteClusterResult {
	return this.block.declare(AWSCloudHSMV2DeleteClusterCommand(clusterId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsmv2.model.DeleteClusterResult
}
...
class AWSCloudHSMV2DeleteClusterCommand(val clusterId: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsmv2.model.DeleteClusterRequest, com.amazonaws.services.cloudhsmv2.model.DeleteClusterResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsmv2.model.DeleteClusterResult {
...
fun AWSCloudHSMV2Functions.deleteHsm(clusterId: String, init: (AWSCloudHSMV2DeleteHsmCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsmv2.model.DeleteHsmResult {
	return this.block.declare(AWSCloudHSMV2DeleteHsmCommand(clusterId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsmv2.model.DeleteHsmResult
}
...
class AWSCloudHSMV2DeleteHsmCommand(val clusterId: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsmv2.model.DeleteHsmRequest, com.amazonaws.services.cloudhsmv2.model.DeleteHsmResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsmv2.model.DeleteHsmResult {
...
fun AWSCloudHSMV2Functions.describeBackups(init: (AWSCloudHSMV2DescribeBackupsCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsmv2.model.DescribeBackupsResult {
	return this.block.declare(AWSCloudHSMV2DescribeBackupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsmv2.model.DescribeBackupsResult
}
...
class AWSCloudHSMV2DescribeBackupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudhsmv2.model.DescribeBackupsRequest, com.amazonaws.services.cloudhsmv2.model.DescribeBackupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsmv2.model.DescribeBackupsResult {
...
fun AWSCloudHSMV2Functions.describeClusters(init: (AWSCloudHSMV2DescribeClustersCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsmv2.model.DescribeClustersResult {
	return this.block.declare(AWSCloudHSMV2DescribeClustersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsmv2.model.DescribeClustersResult
}
...
class AWSCloudHSMV2DescribeClustersCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudhsmv2.model.DescribeClustersRequest, com.amazonaws.services.cloudhsmv2.model.DescribeClustersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsmv2.model.DescribeClustersResult {
...
fun AWSCloudHSMV2Functions.initializeCluster(clusterId: String, signedCert: String, trustAnchor: String, init: (AWSCloudHSMV2InitializeClusterCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsmv2.model.InitializeClusterResult {
	return this.block.declare(AWSCloudHSMV2InitializeClusterCommand(clusterId, signedCert, trustAnchor).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsmv2.model.InitializeClusterResult
}
...
class AWSCloudHSMV2InitializeClusterCommand(val clusterId: String, val signedCert: String, val trustAnchor: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsmv2.model.InitializeClusterRequest, com.amazonaws.services.cloudhsmv2.model.InitializeClusterResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsmv2.model.InitializeClusterResult {
...
fun AWSCloudHSMV2Functions.listTags(resourceId: String, init: (AWSCloudHSMV2ListTagsCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsmv2.model.ListTagsResult {
	return this.block.declare(AWSCloudHSMV2ListTagsCommand(resourceId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsmv2.model.ListTagsResult
}
...
class AWSCloudHSMV2ListTagsCommand(val resourceId: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsmv2.model.ListTagsRequest, com.amazonaws.services.cloudhsmv2.model.ListTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsmv2.model.ListTagsResult {
...
fun AWSCloudHSMV2Functions.tagResource(resourceId: String, tagList: List<com.amazonaws.services.cloudhsmv2.model.Tag>, init: (AWSCloudHSMV2TagResourceCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsmv2.model.TagResourceResult {
	return this.block.declare(AWSCloudHSMV2TagResourceCommand(resourceId, tagList).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsmv2.model.TagResourceResult
}
...
class AWSCloudHSMV2TagResourceCommand(val resourceId: String, val tagList: List<com.amazonaws.services.cloudhsmv2.model.Tag>) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsmv2.model.TagResourceRequest, com.amazonaws.services.cloudhsmv2.model.TagResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsmv2.model.TagResourceResult {
...
fun AWSCloudHSMV2Functions.untagResource(resourceId: String, tagKeyList: List<String>, init: (AWSCloudHSMV2UntagResourceCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsmv2.model.UntagResourceResult {
	return this.block.declare(AWSCloudHSMV2UntagResourceCommand(resourceId, tagKeyList).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsmv2.model.UntagResourceResult
}
...
class AWSCloudHSMV2UntagResourceCommand(val resourceId: String, val tagKeyList: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsmv2.model.UntagResourceRequest, com.amazonaws.services.cloudhsmv2.model.UntagResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsmv2.model.UntagResourceResult {
