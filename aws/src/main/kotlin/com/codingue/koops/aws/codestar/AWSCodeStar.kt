...
package com.codingue.koops.aws.codestar

import javax.annotation.Generated
import com.codingue.koops.common.*
import com.codingue.koops.core.*
import com.codingue.koops.aws.*
import com.amazonaws.services.codestar.*

var com.codingue.koops.core.Environment.codestar: AWSCodeStar
	get() {
		var service = this.capabilities["aws-codestar"]
		if (service == null) {
			service = AWSCodeStarClientBuilder.standard().build()
			this.capabilities["aws-codestar"] = service
		}
		return service as AWSCodeStar
	}
	set(codestar) {
		this.capabilities["aws-codestar"] = codestar
	}

@Generated
class AWSCodeStarFunctions(val block: Script)
...
fun AWSCodeStarFunctions.associateTeamMember(init: (AWSCodeStarAssociateTeamMemberCommand.() -> Unit)? = null): com.amazonaws.services.codestar.model.AssociateTeamMemberResult {
	return this.block.declare(AWSCodeStarAssociateTeamMemberCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codestar.model.AssociateTeamMemberResult
}
...
class AWSCodeStarAssociateTeamMemberCommand() : AmazonWebServiceCommand<com.amazonaws.services.codestar.model.AssociateTeamMemberRequest, com.amazonaws.services.codestar.model.AssociateTeamMemberResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codestar.model.AssociateTeamMemberResult {
...
fun AWSCodeStarFunctions.createProject(init: (AWSCodeStarCreateProjectCommand.() -> Unit)? = null): com.amazonaws.services.codestar.model.CreateProjectResult {
	return this.block.declare(AWSCodeStarCreateProjectCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codestar.model.CreateProjectResult
}
...
class AWSCodeStarCreateProjectCommand() : AmazonWebServiceCommand<com.amazonaws.services.codestar.model.CreateProjectRequest, com.amazonaws.services.codestar.model.CreateProjectResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codestar.model.CreateProjectResult {
...
fun AWSCodeStarFunctions.createUserProfile(init: (AWSCodeStarCreateUserProfileCommand.() -> Unit)? = null): com.amazonaws.services.codestar.model.CreateUserProfileResult {
	return this.block.declare(AWSCodeStarCreateUserProfileCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codestar.model.CreateUserProfileResult
}
...
class AWSCodeStarCreateUserProfileCommand() : AmazonWebServiceCommand<com.amazonaws.services.codestar.model.CreateUserProfileRequest, com.amazonaws.services.codestar.model.CreateUserProfileResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codestar.model.CreateUserProfileResult {
...
fun AWSCodeStarFunctions.deleteProject(init: (AWSCodeStarDeleteProjectCommand.() -> Unit)? = null): com.amazonaws.services.codestar.model.DeleteProjectResult {
	return this.block.declare(AWSCodeStarDeleteProjectCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codestar.model.DeleteProjectResult
}
...
class AWSCodeStarDeleteProjectCommand() : AmazonWebServiceCommand<com.amazonaws.services.codestar.model.DeleteProjectRequest, com.amazonaws.services.codestar.model.DeleteProjectResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codestar.model.DeleteProjectResult {
...
fun AWSCodeStarFunctions.deleteUserProfile(init: (AWSCodeStarDeleteUserProfileCommand.() -> Unit)? = null): com.amazonaws.services.codestar.model.DeleteUserProfileResult {
	return this.block.declare(AWSCodeStarDeleteUserProfileCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codestar.model.DeleteUserProfileResult
}
...
class AWSCodeStarDeleteUserProfileCommand() : AmazonWebServiceCommand<com.amazonaws.services.codestar.model.DeleteUserProfileRequest, com.amazonaws.services.codestar.model.DeleteUserProfileResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codestar.model.DeleteUserProfileResult {
...
fun AWSCodeStarFunctions.describeProject(init: (AWSCodeStarDescribeProjectCommand.() -> Unit)? = null): com.amazonaws.services.codestar.model.DescribeProjectResult {
	return this.block.declare(AWSCodeStarDescribeProjectCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codestar.model.DescribeProjectResult
}
...
class AWSCodeStarDescribeProjectCommand() : AmazonWebServiceCommand<com.amazonaws.services.codestar.model.DescribeProjectRequest, com.amazonaws.services.codestar.model.DescribeProjectResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codestar.model.DescribeProjectResult {
...
fun AWSCodeStarFunctions.describeUserProfile(init: (AWSCodeStarDescribeUserProfileCommand.() -> Unit)? = null): com.amazonaws.services.codestar.model.DescribeUserProfileResult {
	return this.block.declare(AWSCodeStarDescribeUserProfileCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codestar.model.DescribeUserProfileResult
}
...
class AWSCodeStarDescribeUserProfileCommand() : AmazonWebServiceCommand<com.amazonaws.services.codestar.model.DescribeUserProfileRequest, com.amazonaws.services.codestar.model.DescribeUserProfileResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codestar.model.DescribeUserProfileResult {
...
fun AWSCodeStarFunctions.disassociateTeamMember(init: (AWSCodeStarDisassociateTeamMemberCommand.() -> Unit)? = null): com.amazonaws.services.codestar.model.DisassociateTeamMemberResult {
	return this.block.declare(AWSCodeStarDisassociateTeamMemberCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codestar.model.DisassociateTeamMemberResult
}
...
class AWSCodeStarDisassociateTeamMemberCommand() : AmazonWebServiceCommand<com.amazonaws.services.codestar.model.DisassociateTeamMemberRequest, com.amazonaws.services.codestar.model.DisassociateTeamMemberResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codestar.model.DisassociateTeamMemberResult {
...
fun AWSCodeStarFunctions.listProjects(init: (AWSCodeStarListProjectsCommand.() -> Unit)? = null): com.amazonaws.services.codestar.model.ListProjectsResult {
	return this.block.declare(AWSCodeStarListProjectsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codestar.model.ListProjectsResult
}
...
class AWSCodeStarListProjectsCommand() : AmazonWebServiceCommand<com.amazonaws.services.codestar.model.ListProjectsRequest, com.amazonaws.services.codestar.model.ListProjectsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codestar.model.ListProjectsResult {
...
fun AWSCodeStarFunctions.listResources(init: (AWSCodeStarListResourcesCommand.() -> Unit)? = null): com.amazonaws.services.codestar.model.ListResourcesResult {
	return this.block.declare(AWSCodeStarListResourcesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codestar.model.ListResourcesResult
}
...
class AWSCodeStarListResourcesCommand() : AmazonWebServiceCommand<com.amazonaws.services.codestar.model.ListResourcesRequest, com.amazonaws.services.codestar.model.ListResourcesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codestar.model.ListResourcesResult {
...
fun AWSCodeStarFunctions.listTagsForProject(init: (AWSCodeStarListTagsForProjectCommand.() -> Unit)? = null): com.amazonaws.services.codestar.model.ListTagsForProjectResult {
	return this.block.declare(AWSCodeStarListTagsForProjectCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codestar.model.ListTagsForProjectResult
}
...
class AWSCodeStarListTagsForProjectCommand() : AmazonWebServiceCommand<com.amazonaws.services.codestar.model.ListTagsForProjectRequest, com.amazonaws.services.codestar.model.ListTagsForProjectResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codestar.model.ListTagsForProjectResult {
...
fun AWSCodeStarFunctions.listTeamMembers(init: (AWSCodeStarListTeamMembersCommand.() -> Unit)? = null): com.amazonaws.services.codestar.model.ListTeamMembersResult {
	return this.block.declare(AWSCodeStarListTeamMembersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codestar.model.ListTeamMembersResult
}
...
class AWSCodeStarListTeamMembersCommand() : AmazonWebServiceCommand<com.amazonaws.services.codestar.model.ListTeamMembersRequest, com.amazonaws.services.codestar.model.ListTeamMembersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codestar.model.ListTeamMembersResult {
...
fun AWSCodeStarFunctions.listUserProfiles(init: (AWSCodeStarListUserProfilesCommand.() -> Unit)? = null): com.amazonaws.services.codestar.model.ListUserProfilesResult {
	return this.block.declare(AWSCodeStarListUserProfilesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codestar.model.ListUserProfilesResult
}
...
class AWSCodeStarListUserProfilesCommand() : AmazonWebServiceCommand<com.amazonaws.services.codestar.model.ListUserProfilesRequest, com.amazonaws.services.codestar.model.ListUserProfilesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codestar.model.ListUserProfilesResult {
...
fun AWSCodeStarFunctions.tagProject(init: (AWSCodeStarTagProjectCommand.() -> Unit)? = null): com.amazonaws.services.codestar.model.TagProjectResult {
	return this.block.declare(AWSCodeStarTagProjectCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codestar.model.TagProjectResult
}
...
class AWSCodeStarTagProjectCommand() : AmazonWebServiceCommand<com.amazonaws.services.codestar.model.TagProjectRequest, com.amazonaws.services.codestar.model.TagProjectResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codestar.model.TagProjectResult {
...
fun AWSCodeStarFunctions.untagProject(init: (AWSCodeStarUntagProjectCommand.() -> Unit)? = null): com.amazonaws.services.codestar.model.UntagProjectResult {
	return this.block.declare(AWSCodeStarUntagProjectCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codestar.model.UntagProjectResult
}
...
class AWSCodeStarUntagProjectCommand() : AmazonWebServiceCommand<com.amazonaws.services.codestar.model.UntagProjectRequest, com.amazonaws.services.codestar.model.UntagProjectResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codestar.model.UntagProjectResult {
...
fun AWSCodeStarFunctions.updateProject(init: (AWSCodeStarUpdateProjectCommand.() -> Unit)? = null): com.amazonaws.services.codestar.model.UpdateProjectResult {
	return this.block.declare(AWSCodeStarUpdateProjectCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codestar.model.UpdateProjectResult
}
...
class AWSCodeStarUpdateProjectCommand() : AmazonWebServiceCommand<com.amazonaws.services.codestar.model.UpdateProjectRequest, com.amazonaws.services.codestar.model.UpdateProjectResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codestar.model.UpdateProjectResult {
...
fun AWSCodeStarFunctions.updateTeamMember(init: (AWSCodeStarUpdateTeamMemberCommand.() -> Unit)? = null): com.amazonaws.services.codestar.model.UpdateTeamMemberResult {
	return this.block.declare(AWSCodeStarUpdateTeamMemberCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codestar.model.UpdateTeamMemberResult
}
...
class AWSCodeStarUpdateTeamMemberCommand() : AmazonWebServiceCommand<com.amazonaws.services.codestar.model.UpdateTeamMemberRequest, com.amazonaws.services.codestar.model.UpdateTeamMemberResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codestar.model.UpdateTeamMemberResult {
...
fun AWSCodeStarFunctions.updateUserProfile(init: (AWSCodeStarUpdateUserProfileCommand.() -> Unit)? = null): com.amazonaws.services.codestar.model.UpdateUserProfileResult {
	return this.block.declare(AWSCodeStarUpdateUserProfileCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codestar.model.UpdateUserProfileResult
}
...
class AWSCodeStarUpdateUserProfileCommand() : AmazonWebServiceCommand<com.amazonaws.services.codestar.model.UpdateUserProfileRequest, com.amazonaws.services.codestar.model.UpdateUserProfileResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codestar.model.UpdateUserProfileResult {
