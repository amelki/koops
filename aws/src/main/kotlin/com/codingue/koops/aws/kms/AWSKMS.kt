...
package com.codingue.koops.aws.kms
...
var com.codingue.koops.core.Environment.kms: AWSKMS
	get() {
...
fun AWSKMSFunctions.cancelKeyDeletion(keyId: String, init: (AWSKMSCancelKeyDeletionCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.CancelKeyDeletionResult {
	return this.block.declare(AWSKMSCancelKeyDeletionCommand(keyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.CancelKeyDeletionResult
}
...
class AWSKMSCancelKeyDeletionCommand(val keyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.CancelKeyDeletionRequest, com.amazonaws.services.kms.model.CancelKeyDeletionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.CancelKeyDeletionResult {
...
fun AWSKMSFunctions.createAlias(aliasName: String, targetKeyId: String, init: (AWSKMSCreateAliasCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.CreateAliasResult {
	return this.block.declare(AWSKMSCreateAliasCommand(aliasName, targetKeyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.CreateAliasResult
}
...
class AWSKMSCreateAliasCommand(val aliasName: String, val targetKeyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.CreateAliasRequest, com.amazonaws.services.kms.model.CreateAliasResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.CreateAliasResult {
...
fun AWSKMSFunctions.createGrant(keyId: String, granteePrincipal: String, operations: List<GrantOperation>, init: (AWSKMSCreateGrantCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.CreateGrantResult {
	return this.block.declare(AWSKMSCreateGrantCommand(keyId, granteePrincipal, operations).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.CreateGrantResult
}
...
class AWSKMSCreateGrantCommand(val keyId: String, val granteePrincipal: String, val operations: List<GrantOperation>) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.CreateGrantRequest, com.amazonaws.services.kms.model.CreateGrantResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.CreateGrantResult {
...
fun AWSKMSFunctions.createKey(init: (AWSKMSCreateKeyCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.CreateKeyResult {
	return this.block.declare(AWSKMSCreateKeyCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.CreateKeyResult
}
...
class AWSKMSCreateKeyCommand() : AmazonWebServiceCommand<com.amazonaws.services.kms.model.CreateKeyRequest, com.amazonaws.services.kms.model.CreateKeyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.CreateKeyResult {
...
fun AWSKMSFunctions.decrypt(ciphertextBlob: java.nio.ByteBuffer, init: (AWSKMSDecryptCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.DecryptResult {
	return this.block.declare(AWSKMSDecryptCommand(ciphertextBlob).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.DecryptResult
}
...
class AWSKMSDecryptCommand(val ciphertextBlob: java.nio.ByteBuffer) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.DecryptRequest, com.amazonaws.services.kms.model.DecryptResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.DecryptResult {
...
fun AWSKMSFunctions.deleteAlias(aliasName: String, init: (AWSKMSDeleteAliasCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.DeleteAliasResult {
	return this.block.declare(AWSKMSDeleteAliasCommand(aliasName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.DeleteAliasResult
}
...
class AWSKMSDeleteAliasCommand(val aliasName: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.DeleteAliasRequest, com.amazonaws.services.kms.model.DeleteAliasResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.DeleteAliasResult {
...
fun AWSKMSFunctions.deleteImportedKeyMaterial(keyId: String, init: (AWSKMSDeleteImportedKeyMaterialCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.DeleteImportedKeyMaterialResult {
	return this.block.declare(AWSKMSDeleteImportedKeyMaterialCommand(keyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.DeleteImportedKeyMaterialResult
}
...
class AWSKMSDeleteImportedKeyMaterialCommand(val keyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.DeleteImportedKeyMaterialRequest, com.amazonaws.services.kms.model.DeleteImportedKeyMaterialResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.DeleteImportedKeyMaterialResult {
...
fun AWSKMSFunctions.describeKey(keyId: String, init: (AWSKMSDescribeKeyCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.DescribeKeyResult {
	return this.block.declare(AWSKMSDescribeKeyCommand(keyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.DescribeKeyResult
}
...
class AWSKMSDescribeKeyCommand(val keyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.DescribeKeyRequest, com.amazonaws.services.kms.model.DescribeKeyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.DescribeKeyResult {
...
fun AWSKMSFunctions.disableKey(keyId: String, init: (AWSKMSDisableKeyCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.DisableKeyResult {
	return this.block.declare(AWSKMSDisableKeyCommand(keyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.DisableKeyResult
}
...
class AWSKMSDisableKeyCommand(val keyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.DisableKeyRequest, com.amazonaws.services.kms.model.DisableKeyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.DisableKeyResult {
...
fun AWSKMSFunctions.disableKeyRotation(keyId: String, init: (AWSKMSDisableKeyRotationCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.DisableKeyRotationResult {
	return this.block.declare(AWSKMSDisableKeyRotationCommand(keyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.DisableKeyRotationResult
}
...
class AWSKMSDisableKeyRotationCommand(val keyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.DisableKeyRotationRequest, com.amazonaws.services.kms.model.DisableKeyRotationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.DisableKeyRotationResult {
...
fun AWSKMSFunctions.enableKey(keyId: String, init: (AWSKMSEnableKeyCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.EnableKeyResult {
	return this.block.declare(AWSKMSEnableKeyCommand(keyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.EnableKeyResult
}
...
class AWSKMSEnableKeyCommand(val keyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.EnableKeyRequest, com.amazonaws.services.kms.model.EnableKeyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.EnableKeyResult {
...
fun AWSKMSFunctions.enableKeyRotation(keyId: String, init: (AWSKMSEnableKeyRotationCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.EnableKeyRotationResult {
	return this.block.declare(AWSKMSEnableKeyRotationCommand(keyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.EnableKeyRotationResult
}
...
class AWSKMSEnableKeyRotationCommand(val keyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.EnableKeyRotationRequest, com.amazonaws.services.kms.model.EnableKeyRotationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.EnableKeyRotationResult {
...
fun AWSKMSFunctions.encrypt(keyId: String, plaintext: java.nio.ByteBuffer, init: (AWSKMSEncryptCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.EncryptResult {
	return this.block.declare(AWSKMSEncryptCommand(keyId, plaintext).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.EncryptResult
}
...
class AWSKMSEncryptCommand(val keyId: String, val plaintext: java.nio.ByteBuffer) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.EncryptRequest, com.amazonaws.services.kms.model.EncryptResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.EncryptResult {
...
fun AWSKMSFunctions.generateDataKey(keyId: String, init: (AWSKMSGenerateDataKeyCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.GenerateDataKeyResult {
	return this.block.declare(AWSKMSGenerateDataKeyCommand(keyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.GenerateDataKeyResult
}
...
class AWSKMSGenerateDataKeyCommand(val keyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.GenerateDataKeyRequest, com.amazonaws.services.kms.model.GenerateDataKeyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.GenerateDataKeyResult {
...
fun AWSKMSFunctions.generateDataKeyWithoutPlaintext(keyId: String, init: (AWSKMSGenerateDataKeyWithoutPlaintextCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.GenerateDataKeyWithoutPlaintextResult {
	return this.block.declare(AWSKMSGenerateDataKeyWithoutPlaintextCommand(keyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.GenerateDataKeyWithoutPlaintextResult
}
...
class AWSKMSGenerateDataKeyWithoutPlaintextCommand(val keyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.GenerateDataKeyWithoutPlaintextRequest, com.amazonaws.services.kms.model.GenerateDataKeyWithoutPlaintextResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.GenerateDataKeyWithoutPlaintextResult {
...
fun AWSKMSFunctions.generateRandom(init: (AWSKMSGenerateRandomCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.GenerateRandomResult {
	return this.block.declare(AWSKMSGenerateRandomCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.GenerateRandomResult
}
...
class AWSKMSGenerateRandomCommand() : AmazonWebServiceCommand<com.amazonaws.services.kms.model.GenerateRandomRequest, com.amazonaws.services.kms.model.GenerateRandomResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.GenerateRandomResult {
...
fun AWSKMSFunctions.getKeyPolicy(keyId: String, policyName: String, init: (AWSKMSGetKeyPolicyCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.GetKeyPolicyResult {
	return this.block.declare(AWSKMSGetKeyPolicyCommand(keyId, policyName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.GetKeyPolicyResult
}
...
class AWSKMSGetKeyPolicyCommand(val keyId: String, val policyName: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.GetKeyPolicyRequest, com.amazonaws.services.kms.model.GetKeyPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.GetKeyPolicyResult {
...
fun AWSKMSFunctions.getKeyRotationStatus(keyId: String, init: (AWSKMSGetKeyRotationStatusCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.GetKeyRotationStatusResult {
	return this.block.declare(AWSKMSGetKeyRotationStatusCommand(keyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.GetKeyRotationStatusResult
}
...
class AWSKMSGetKeyRotationStatusCommand(val keyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.GetKeyRotationStatusRequest, com.amazonaws.services.kms.model.GetKeyRotationStatusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.GetKeyRotationStatusResult {
...
fun AWSKMSFunctions.getParametersForImport(keyId: String, wrappingAlgorithm: AlgorithmSpec, wrappingKeySpec: WrappingKeySpec, init: (AWSKMSGetParametersForImportCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.GetParametersForImportResult {
	return this.block.declare(AWSKMSGetParametersForImportCommand(keyId, wrappingAlgorithm, wrappingKeySpec).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.GetParametersForImportResult
}
...
class AWSKMSGetParametersForImportCommand(val keyId: String, val wrappingAlgorithm: AlgorithmSpec, val wrappingKeySpec: WrappingKeySpec) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.GetParametersForImportRequest, com.amazonaws.services.kms.model.GetParametersForImportResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.GetParametersForImportResult {
...
fun AWSKMSFunctions.importKeyMaterial(keyId: String, importToken: java.nio.ByteBuffer, encryptedKeyMaterial: java.nio.ByteBuffer, init: (AWSKMSImportKeyMaterialCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.ImportKeyMaterialResult {
	return this.block.declare(AWSKMSImportKeyMaterialCommand(keyId, importToken, encryptedKeyMaterial).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.ImportKeyMaterialResult
}
...
class AWSKMSImportKeyMaterialCommand(val keyId: String, val importToken: java.nio.ByteBuffer, val encryptedKeyMaterial: java.nio.ByteBuffer) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.ImportKeyMaterialRequest, com.amazonaws.services.kms.model.ImportKeyMaterialResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.ImportKeyMaterialResult {
...
fun AWSKMSFunctions.listAliases(init: (AWSKMSListAliasesCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.ListAliasesResult {
	return this.block.declare(AWSKMSListAliasesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.ListAliasesResult
}
...
class AWSKMSListAliasesCommand() : AmazonWebServiceCommand<com.amazonaws.services.kms.model.ListAliasesRequest, com.amazonaws.services.kms.model.ListAliasesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.ListAliasesResult {
...
fun AWSKMSFunctions.listGrants(keyId: String, init: (AWSKMSListGrantsCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.ListGrantsResult {
	return this.block.declare(AWSKMSListGrantsCommand(keyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.ListGrantsResult
}
...
class AWSKMSListGrantsCommand(val keyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.ListGrantsRequest, com.amazonaws.services.kms.model.ListGrantsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.ListGrantsResult {
...
fun AWSKMSFunctions.listKeyPolicies(keyId: String, init: (AWSKMSListKeyPoliciesCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.ListKeyPoliciesResult {
	return this.block.declare(AWSKMSListKeyPoliciesCommand(keyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.ListKeyPoliciesResult
}
...
class AWSKMSListKeyPoliciesCommand(val keyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.ListKeyPoliciesRequest, com.amazonaws.services.kms.model.ListKeyPoliciesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.ListKeyPoliciesResult {
...
fun AWSKMSFunctions.listKeys(init: (AWSKMSListKeysCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.ListKeysResult {
	return this.block.declare(AWSKMSListKeysCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.ListKeysResult
}
...
class AWSKMSListKeysCommand() : AmazonWebServiceCommand<com.amazonaws.services.kms.model.ListKeysRequest, com.amazonaws.services.kms.model.ListKeysResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.ListKeysResult {
...
fun AWSKMSFunctions.listResourceTags(keyId: String, init: (AWSKMSListResourceTagsCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.ListResourceTagsResult {
	return this.block.declare(AWSKMSListResourceTagsCommand(keyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.ListResourceTagsResult
}
...
class AWSKMSListResourceTagsCommand(val keyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.ListResourceTagsRequest, com.amazonaws.services.kms.model.ListResourceTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.ListResourceTagsResult {
...
fun AWSKMSFunctions.listRetirableGrants(retiringPrincipal: String, init: (AWSKMSListRetirableGrantsCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.ListRetirableGrantsResult {
	return this.block.declare(AWSKMSListRetirableGrantsCommand(retiringPrincipal).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.ListRetirableGrantsResult
}
...
class AWSKMSListRetirableGrantsCommand(val retiringPrincipal: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.ListRetirableGrantsRequest, com.amazonaws.services.kms.model.ListRetirableGrantsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.ListRetirableGrantsResult {
...
fun AWSKMSFunctions.putKeyPolicy(keyId: String, policyName: String, policy: String, init: (AWSKMSPutKeyPolicyCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.PutKeyPolicyResult {
	return this.block.declare(AWSKMSPutKeyPolicyCommand(keyId, policyName, policy).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.PutKeyPolicyResult
}
...
class AWSKMSPutKeyPolicyCommand(val keyId: String, val policyName: String, val policy: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.PutKeyPolicyRequest, com.amazonaws.services.kms.model.PutKeyPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.PutKeyPolicyResult {
...
fun AWSKMSFunctions.reEncrypt(ciphertextBlob: java.nio.ByteBuffer, destinationKeyId: String, init: (AWSKMSReEncryptCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.ReEncryptResult {
	return this.block.declare(AWSKMSReEncryptCommand(ciphertextBlob, destinationKeyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.ReEncryptResult
}
...
class AWSKMSReEncryptCommand(val ciphertextBlob: java.nio.ByteBuffer, val destinationKeyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.ReEncryptRequest, com.amazonaws.services.kms.model.ReEncryptResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.ReEncryptResult {
...
fun AWSKMSFunctions.retireGrant(init: (AWSKMSRetireGrantCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.RetireGrantResult {
	return this.block.declare(AWSKMSRetireGrantCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.RetireGrantResult
}
...
class AWSKMSRetireGrantCommand() : AmazonWebServiceCommand<com.amazonaws.services.kms.model.RetireGrantRequest, com.amazonaws.services.kms.model.RetireGrantResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.RetireGrantResult {
...
fun AWSKMSFunctions.revokeGrant(keyId: String, grantId: String, init: (AWSKMSRevokeGrantCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.RevokeGrantResult {
	return this.block.declare(AWSKMSRevokeGrantCommand(keyId, grantId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.RevokeGrantResult
}
...
class AWSKMSRevokeGrantCommand(val keyId: String, val grantId: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.RevokeGrantRequest, com.amazonaws.services.kms.model.RevokeGrantResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.RevokeGrantResult {
...
fun AWSKMSFunctions.scheduleKeyDeletion(keyId: String, init: (AWSKMSScheduleKeyDeletionCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.ScheduleKeyDeletionResult {
	return this.block.declare(AWSKMSScheduleKeyDeletionCommand(keyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.ScheduleKeyDeletionResult
}
...
class AWSKMSScheduleKeyDeletionCommand(val keyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.ScheduleKeyDeletionRequest, com.amazonaws.services.kms.model.ScheduleKeyDeletionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.ScheduleKeyDeletionResult {
...
fun AWSKMSFunctions.tagResource(keyId: String, tags: List<com.amazonaws.services.kms.model.Tag>, init: (AWSKMSTagResourceCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.TagResourceResult {
	return this.block.declare(AWSKMSTagResourceCommand(keyId, tags).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.TagResourceResult
}
...
class AWSKMSTagResourceCommand(val keyId: String, val tags: List<com.amazonaws.services.kms.model.Tag>) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.TagResourceRequest, com.amazonaws.services.kms.model.TagResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.TagResourceResult {
...
fun AWSKMSFunctions.untagResource(keyId: String, tagKeys: List<String>, init: (AWSKMSUntagResourceCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.UntagResourceResult {
	return this.block.declare(AWSKMSUntagResourceCommand(keyId, tagKeys).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.UntagResourceResult
}
...
class AWSKMSUntagResourceCommand(val keyId: String, val tagKeys: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.UntagResourceRequest, com.amazonaws.services.kms.model.UntagResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.UntagResourceResult {
...
fun AWSKMSFunctions.updateAlias(aliasName: String, targetKeyId: String, init: (AWSKMSUpdateAliasCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.UpdateAliasResult {
	return this.block.declare(AWSKMSUpdateAliasCommand(aliasName, targetKeyId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.UpdateAliasResult
}
...
class AWSKMSUpdateAliasCommand(val aliasName: String, val targetKeyId: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.UpdateAliasRequest, com.amazonaws.services.kms.model.UpdateAliasResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.UpdateAliasResult {
...
fun AWSKMSFunctions.updateKeyDescription(keyId: String, description: String, init: (AWSKMSUpdateKeyDescriptionCommand.() -> Unit)? = null): com.amazonaws.services.kms.model.UpdateKeyDescriptionResult {
	return this.block.declare(AWSKMSUpdateKeyDescriptionCommand(keyId, description).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kms.model.UpdateKeyDescriptionResult
}
...
class AWSKMSUpdateKeyDescriptionCommand(val keyId: String, val description: String) : AmazonWebServiceCommand<com.amazonaws.services.kms.model.UpdateKeyDescriptionRequest, com.amazonaws.services.kms.model.UpdateKeyDescriptionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kms.model.UpdateKeyDescriptionResult {
