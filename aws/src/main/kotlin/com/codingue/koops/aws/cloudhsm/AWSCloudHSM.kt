...
package com.codingue.koops.aws.cloudhsm

import javax.annotation.Generated
import com.codingue.koops.common.*
import com.codingue.koops.core.*
import com.codingue.koops.aws.*
import com.amazonaws.services.cloudhsm.*
import com.amazonaws.services.cloudhsm.model.*

var com.codingue.koops.core.Environment.cloudhsm: AWSCloudHSM
	get() {
		var service = this.capabilities["aws-cloudhsm"]
		if (service == null) {
			service = AWSCloudHSMClientBuilder.standard().build()
			this.capabilities["aws-cloudhsm"] = service
		}
		return service as AWSCloudHSM
	}
	set(cloudhsm) {
		this.capabilities["aws-cloudhsm"] = cloudhsm
	}
...
fun AWSCloudHSMFunctions.addTagsToResource(resourceArn: String, tagList: List<com.amazonaws.services.cloudhsm.model.Tag>, init: (AWSCloudHSMAddTagsToResourceCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.AddTagsToResourceResult {
	return this.block.declare(AWSCloudHSMAddTagsToResourceCommand(resourceArn, tagList).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.AddTagsToResourceResult
}
...
class AWSCloudHSMAddTagsToResourceCommand(val resourceArn: String, val tagList: List<com.amazonaws.services.cloudhsm.model.Tag>) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.AddTagsToResourceRequest, com.amazonaws.services.cloudhsm.model.AddTagsToResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.AddTagsToResourceResult {
...
fun AWSCloudHSMFunctions.createHapg(label: String, init: (AWSCloudHSMCreateHapgCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.CreateHapgResult {
	return this.block.declare(AWSCloudHSMCreateHapgCommand(label).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.CreateHapgResult
}
...
class AWSCloudHSMCreateHapgCommand(val label: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.CreateHapgRequest, com.amazonaws.services.cloudhsm.model.CreateHapgResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.CreateHapgResult {
...
fun AWSCloudHSMFunctions.createHsm(subnetId: String, sshKey: String, iamRoleArn: String, subscriptionType: SubscriptionType, init: (AWSCloudHSMCreateHsmCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.CreateHsmResult {
	return this.block.declare(AWSCloudHSMCreateHsmCommand(subnetId, sshKey, iamRoleArn, subscriptionType).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.CreateHsmResult
}
...
class AWSCloudHSMCreateHsmCommand(val subnetId: String, val sshKey: String, val iamRoleArn: String, val subscriptionType: SubscriptionType) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.CreateHsmRequest, com.amazonaws.services.cloudhsm.model.CreateHsmResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.CreateHsmResult {
...
fun AWSCloudHSMFunctions.createLunaClient(certificate: String, init: (AWSCloudHSMCreateLunaClientCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.CreateLunaClientResult {
	return this.block.declare(AWSCloudHSMCreateLunaClientCommand(certificate).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.CreateLunaClientResult
}
...
class AWSCloudHSMCreateLunaClientCommand(val certificate: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.CreateLunaClientRequest, com.amazonaws.services.cloudhsm.model.CreateLunaClientResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.CreateLunaClientResult {
...
fun AWSCloudHSMFunctions.deleteHapg(hapgArn: String, init: (AWSCloudHSMDeleteHapgCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.DeleteHapgResult {
	return this.block.declare(AWSCloudHSMDeleteHapgCommand(hapgArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.DeleteHapgResult
}
...
class AWSCloudHSMDeleteHapgCommand(val hapgArn: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.DeleteHapgRequest, com.amazonaws.services.cloudhsm.model.DeleteHapgResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.DeleteHapgResult {
...
fun AWSCloudHSMFunctions.deleteHsm(hsmArn: String, init: (AWSCloudHSMDeleteHsmCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.DeleteHsmResult {
	return this.block.declare(AWSCloudHSMDeleteHsmCommand(hsmArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.DeleteHsmResult
}
...
class AWSCloudHSMDeleteHsmCommand(val hsmArn: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.DeleteHsmRequest, com.amazonaws.services.cloudhsm.model.DeleteHsmResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.DeleteHsmResult {
...
fun AWSCloudHSMFunctions.deleteLunaClient(clientArn: String, init: (AWSCloudHSMDeleteLunaClientCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.DeleteLunaClientResult {
	return this.block.declare(AWSCloudHSMDeleteLunaClientCommand(clientArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.DeleteLunaClientResult
}
...
class AWSCloudHSMDeleteLunaClientCommand(val clientArn: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.DeleteLunaClientRequest, com.amazonaws.services.cloudhsm.model.DeleteLunaClientResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.DeleteLunaClientResult {
...
fun AWSCloudHSMFunctions.describeHapg(hapgArn: String, init: (AWSCloudHSMDescribeHapgCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.DescribeHapgResult {
	return this.block.declare(AWSCloudHSMDescribeHapgCommand(hapgArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.DescribeHapgResult
}
...
class AWSCloudHSMDescribeHapgCommand(val hapgArn: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.DescribeHapgRequest, com.amazonaws.services.cloudhsm.model.DescribeHapgResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.DescribeHapgResult {
...
fun AWSCloudHSMFunctions.describeHsm(init: (AWSCloudHSMDescribeHsmCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.DescribeHsmResult {
	return this.block.declare(AWSCloudHSMDescribeHsmCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.DescribeHsmResult
}
...
class AWSCloudHSMDescribeHsmCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.DescribeHsmRequest, com.amazonaws.services.cloudhsm.model.DescribeHsmResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.DescribeHsmResult {
...
fun AWSCloudHSMFunctions.describeLunaClient(init: (AWSCloudHSMDescribeLunaClientCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.DescribeLunaClientResult {
	return this.block.declare(AWSCloudHSMDescribeLunaClientCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.DescribeLunaClientResult
}
...
class AWSCloudHSMDescribeLunaClientCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.DescribeLunaClientRequest, com.amazonaws.services.cloudhsm.model.DescribeLunaClientResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.DescribeLunaClientResult {
...
fun AWSCloudHSMFunctions.getConfig(clientArn: String, clientVersion: ClientVersion, hapgList: List<String>, init: (AWSCloudHSMGetConfigCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.GetConfigResult {
	return this.block.declare(AWSCloudHSMGetConfigCommand(clientArn, clientVersion, hapgList).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.GetConfigResult
}
...
class AWSCloudHSMGetConfigCommand(val clientArn: String, val clientVersion: ClientVersion, val hapgList: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.GetConfigRequest, com.amazonaws.services.cloudhsm.model.GetConfigResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.GetConfigResult {
...
fun AWSCloudHSMFunctions.listAvailableZones(init: (AWSCloudHSMListAvailableZonesCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.ListAvailableZonesResult {
	return this.block.declare(AWSCloudHSMListAvailableZonesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.ListAvailableZonesResult
}
...
class AWSCloudHSMListAvailableZonesCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.ListAvailableZonesRequest, com.amazonaws.services.cloudhsm.model.ListAvailableZonesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.ListAvailableZonesResult {
...
fun AWSCloudHSMFunctions.listHapgs(init: (AWSCloudHSMListHapgsCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.ListHapgsResult {
	return this.block.declare(AWSCloudHSMListHapgsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.ListHapgsResult
}
...
class AWSCloudHSMListHapgsCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.ListHapgsRequest, com.amazonaws.services.cloudhsm.model.ListHapgsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.ListHapgsResult {
...
fun AWSCloudHSMFunctions.listHsms(init: (AWSCloudHSMListHsmsCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.ListHsmsResult {
	return this.block.declare(AWSCloudHSMListHsmsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.ListHsmsResult
}
...
class AWSCloudHSMListHsmsCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.ListHsmsRequest, com.amazonaws.services.cloudhsm.model.ListHsmsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.ListHsmsResult {
...
fun AWSCloudHSMFunctions.listLunaClients(init: (AWSCloudHSMListLunaClientsCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.ListLunaClientsResult {
	return this.block.declare(AWSCloudHSMListLunaClientsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.ListLunaClientsResult
}
...
class AWSCloudHSMListLunaClientsCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.ListLunaClientsRequest, com.amazonaws.services.cloudhsm.model.ListLunaClientsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.ListLunaClientsResult {
...
fun AWSCloudHSMFunctions.listTagsForResource(resourceArn: String, init: (AWSCloudHSMListTagsForResourceCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.ListTagsForResourceResult {
	return this.block.declare(AWSCloudHSMListTagsForResourceCommand(resourceArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.ListTagsForResourceResult
}
...
class AWSCloudHSMListTagsForResourceCommand(val resourceArn: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.ListTagsForResourceRequest, com.amazonaws.services.cloudhsm.model.ListTagsForResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.ListTagsForResourceResult {
...
fun AWSCloudHSMFunctions.modifyHapg(hapgArn: String, init: (AWSCloudHSMModifyHapgCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.ModifyHapgResult {
	return this.block.declare(AWSCloudHSMModifyHapgCommand(hapgArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.ModifyHapgResult
}
...
class AWSCloudHSMModifyHapgCommand(val hapgArn: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.ModifyHapgRequest, com.amazonaws.services.cloudhsm.model.ModifyHapgResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.ModifyHapgResult {
...
fun AWSCloudHSMFunctions.modifyHsm(hsmArn: String, init: (AWSCloudHSMModifyHsmCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.ModifyHsmResult {
	return this.block.declare(AWSCloudHSMModifyHsmCommand(hsmArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.ModifyHsmResult
}
...
class AWSCloudHSMModifyHsmCommand(val hsmArn: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.ModifyHsmRequest, com.amazonaws.services.cloudhsm.model.ModifyHsmResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.ModifyHsmResult {
...
fun AWSCloudHSMFunctions.modifyLunaClient(clientArn: String, certificate: String, init: (AWSCloudHSMModifyLunaClientCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.ModifyLunaClientResult {
	return this.block.declare(AWSCloudHSMModifyLunaClientCommand(clientArn, certificate).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.ModifyLunaClientResult
}
...
class AWSCloudHSMModifyLunaClientCommand(val clientArn: String, val certificate: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.ModifyLunaClientRequest, com.amazonaws.services.cloudhsm.model.ModifyLunaClientResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.ModifyLunaClientResult {
...
fun AWSCloudHSMFunctions.removeTagsFromResource(resourceArn: String, tagKeyList: List<String>, init: (AWSCloudHSMRemoveTagsFromResourceCommand.() -> Unit)? = null): com.amazonaws.services.cloudhsm.model.RemoveTagsFromResourceResult {
	return this.block.declare(AWSCloudHSMRemoveTagsFromResourceCommand(resourceArn, tagKeyList).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudhsm.model.RemoveTagsFromResourceResult
}
...
class AWSCloudHSMRemoveTagsFromResourceCommand(val resourceArn: String, val tagKeyList: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.cloudhsm.model.RemoveTagsFromResourceRequest, com.amazonaws.services.cloudhsm.model.RemoveTagsFromResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudhsm.model.RemoveTagsFromResourceResult {
