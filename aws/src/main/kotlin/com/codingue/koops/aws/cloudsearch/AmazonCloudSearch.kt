...
package com.codingue.koops.aws.cloudsearch

import javax.annotation.Generated
import com.codingue.koops.common.*
import com.codingue.koops.core.*
import com.codingue.koops.aws.*
import com.amazonaws.services.cloudsearchv2.*

var com.codingue.koops.core.Environment.cloudsearch: AmazonCloudSearch
	get() {
		var service = this.capabilities["aws-cloudsearch"]
		if (service == null) {
			service = AmazonCloudSearchClientBuilder.standard().build()
			this.capabilities["aws-cloudsearch"] = service
		}
		return service as AmazonCloudSearch
	}
	set(cloudsearch) {
		this.capabilities["aws-cloudsearch"] = cloudsearch
	}

@Generated
class AmazonCloudSearchFunctions(val block: Script)
...
fun AmazonCloudSearchFunctions.buildSuggesters(domainName: String, init: (AmazonCloudSearchBuildSuggestersCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.BuildSuggestersResult {
	return this.block.declare(AmazonCloudSearchBuildSuggestersCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.BuildSuggestersResult
}
...
class AmazonCloudSearchBuildSuggestersCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.BuildSuggestersRequest, com.amazonaws.services.cloudsearchv2.model.BuildSuggestersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.BuildSuggestersResult {
...
fun AmazonCloudSearchFunctions.createDomain(domainName: String, init: (AmazonCloudSearchCreateDomainCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.CreateDomainResult {
	return this.block.declare(AmazonCloudSearchCreateDomainCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.CreateDomainResult
}
...
class AmazonCloudSearchCreateDomainCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.CreateDomainRequest, com.amazonaws.services.cloudsearchv2.model.CreateDomainResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.CreateDomainResult {
...
fun AmazonCloudSearchFunctions.defineAnalysisScheme(domainName: String, analysisScheme: com.amazonaws.services.cloudsearchv2.model.AnalysisScheme, init: (AmazonCloudSearchDefineAnalysisSchemeCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.DefineAnalysisSchemeResult {
	return this.block.declare(AmazonCloudSearchDefineAnalysisSchemeCommand(domainName, analysisScheme).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.DefineAnalysisSchemeResult
}
...
class AmazonCloudSearchDefineAnalysisSchemeCommand(val domainName: String, val analysisScheme: com.amazonaws.services.cloudsearchv2.model.AnalysisScheme) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.DefineAnalysisSchemeRequest, com.amazonaws.services.cloudsearchv2.model.DefineAnalysisSchemeResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.DefineAnalysisSchemeResult {
...
fun AmazonCloudSearchFunctions.defineExpression(domainName: String, expression: com.amazonaws.services.cloudsearchv2.model.Expression, init: (AmazonCloudSearchDefineExpressionCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.DefineExpressionResult {
	return this.block.declare(AmazonCloudSearchDefineExpressionCommand(domainName, expression).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.DefineExpressionResult
}
...
class AmazonCloudSearchDefineExpressionCommand(val domainName: String, val expression: com.amazonaws.services.cloudsearchv2.model.Expression) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.DefineExpressionRequest, com.amazonaws.services.cloudsearchv2.model.DefineExpressionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.DefineExpressionResult {
...
fun AmazonCloudSearchFunctions.defineIndexField(domainName: String, indexField: com.amazonaws.services.cloudsearchv2.model.IndexField, init: (AmazonCloudSearchDefineIndexFieldCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.DefineIndexFieldResult {
	return this.block.declare(AmazonCloudSearchDefineIndexFieldCommand(domainName, indexField).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.DefineIndexFieldResult
}
...
class AmazonCloudSearchDefineIndexFieldCommand(val domainName: String, val indexField: com.amazonaws.services.cloudsearchv2.model.IndexField) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.DefineIndexFieldRequest, com.amazonaws.services.cloudsearchv2.model.DefineIndexFieldResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.DefineIndexFieldResult {
...
fun AmazonCloudSearchFunctions.defineSuggester(domainName: String, suggester: com.amazonaws.services.cloudsearchv2.model.Suggester, init: (AmazonCloudSearchDefineSuggesterCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.DefineSuggesterResult {
	return this.block.declare(AmazonCloudSearchDefineSuggesterCommand(domainName, suggester).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.DefineSuggesterResult
}
...
class AmazonCloudSearchDefineSuggesterCommand(val domainName: String, val suggester: com.amazonaws.services.cloudsearchv2.model.Suggester) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.DefineSuggesterRequest, com.amazonaws.services.cloudsearchv2.model.DefineSuggesterResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.DefineSuggesterResult {
...
fun AmazonCloudSearchFunctions.deleteAnalysisScheme(domainName: String, analysisSchemeName: String, init: (AmazonCloudSearchDeleteAnalysisSchemeCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.DeleteAnalysisSchemeResult {
	return this.block.declare(AmazonCloudSearchDeleteAnalysisSchemeCommand(domainName, analysisSchemeName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.DeleteAnalysisSchemeResult
}
...
class AmazonCloudSearchDeleteAnalysisSchemeCommand(val domainName: String, val analysisSchemeName: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.DeleteAnalysisSchemeRequest, com.amazonaws.services.cloudsearchv2.model.DeleteAnalysisSchemeResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.DeleteAnalysisSchemeResult {
...
fun AmazonCloudSearchFunctions.deleteDomain(domainName: String, init: (AmazonCloudSearchDeleteDomainCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.DeleteDomainResult {
	return this.block.declare(AmazonCloudSearchDeleteDomainCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.DeleteDomainResult
}
...
class AmazonCloudSearchDeleteDomainCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.DeleteDomainRequest, com.amazonaws.services.cloudsearchv2.model.DeleteDomainResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.DeleteDomainResult {
...
fun AmazonCloudSearchFunctions.deleteExpression(domainName: String, expressionName: String, init: (AmazonCloudSearchDeleteExpressionCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.DeleteExpressionResult {
	return this.block.declare(AmazonCloudSearchDeleteExpressionCommand(domainName, expressionName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.DeleteExpressionResult
}
...
class AmazonCloudSearchDeleteExpressionCommand(val domainName: String, val expressionName: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.DeleteExpressionRequest, com.amazonaws.services.cloudsearchv2.model.DeleteExpressionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.DeleteExpressionResult {
...
fun AmazonCloudSearchFunctions.deleteIndexField(domainName: String, indexFieldName: String, init: (AmazonCloudSearchDeleteIndexFieldCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.DeleteIndexFieldResult {
	return this.block.declare(AmazonCloudSearchDeleteIndexFieldCommand(domainName, indexFieldName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.DeleteIndexFieldResult
}
...
class AmazonCloudSearchDeleteIndexFieldCommand(val domainName: String, val indexFieldName: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.DeleteIndexFieldRequest, com.amazonaws.services.cloudsearchv2.model.DeleteIndexFieldResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.DeleteIndexFieldResult {
...
fun AmazonCloudSearchFunctions.deleteSuggester(domainName: String, suggesterName: String, init: (AmazonCloudSearchDeleteSuggesterCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.DeleteSuggesterResult {
	return this.block.declare(AmazonCloudSearchDeleteSuggesterCommand(domainName, suggesterName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.DeleteSuggesterResult
}
...
class AmazonCloudSearchDeleteSuggesterCommand(val domainName: String, val suggesterName: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.DeleteSuggesterRequest, com.amazonaws.services.cloudsearchv2.model.DeleteSuggesterResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.DeleteSuggesterResult {
...
fun AmazonCloudSearchFunctions.describeAnalysisSchemes(domainName: String, init: (AmazonCloudSearchDescribeAnalysisSchemesCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.DescribeAnalysisSchemesResult {
	return this.block.declare(AmazonCloudSearchDescribeAnalysisSchemesCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.DescribeAnalysisSchemesResult
}
...
class AmazonCloudSearchDescribeAnalysisSchemesCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.DescribeAnalysisSchemesRequest, com.amazonaws.services.cloudsearchv2.model.DescribeAnalysisSchemesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.DescribeAnalysisSchemesResult {
...
fun AmazonCloudSearchFunctions.describeAvailabilityOptions(domainName: String, init: (AmazonCloudSearchDescribeAvailabilityOptionsCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.DescribeAvailabilityOptionsResult {
	return this.block.declare(AmazonCloudSearchDescribeAvailabilityOptionsCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.DescribeAvailabilityOptionsResult
}
...
class AmazonCloudSearchDescribeAvailabilityOptionsCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.DescribeAvailabilityOptionsRequest, com.amazonaws.services.cloudsearchv2.model.DescribeAvailabilityOptionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.DescribeAvailabilityOptionsResult {
...
fun AmazonCloudSearchFunctions.describeDomains(init: (AmazonCloudSearchDescribeDomainsCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.DescribeDomainsResult {
	return this.block.declare(AmazonCloudSearchDescribeDomainsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.DescribeDomainsResult
}
...
class AmazonCloudSearchDescribeDomainsCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.DescribeDomainsRequest, com.amazonaws.services.cloudsearchv2.model.DescribeDomainsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.DescribeDomainsResult {
...
fun AmazonCloudSearchFunctions.describeExpressions(domainName: String, init: (AmazonCloudSearchDescribeExpressionsCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.DescribeExpressionsResult {
	return this.block.declare(AmazonCloudSearchDescribeExpressionsCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.DescribeExpressionsResult
}
...
class AmazonCloudSearchDescribeExpressionsCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.DescribeExpressionsRequest, com.amazonaws.services.cloudsearchv2.model.DescribeExpressionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.DescribeExpressionsResult {
...
fun AmazonCloudSearchFunctions.describeIndexFields(domainName: String, init: (AmazonCloudSearchDescribeIndexFieldsCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.DescribeIndexFieldsResult {
	return this.block.declare(AmazonCloudSearchDescribeIndexFieldsCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.DescribeIndexFieldsResult
}
...
class AmazonCloudSearchDescribeIndexFieldsCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.DescribeIndexFieldsRequest, com.amazonaws.services.cloudsearchv2.model.DescribeIndexFieldsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.DescribeIndexFieldsResult {
...
fun AmazonCloudSearchFunctions.describeScalingParameters(domainName: String, init: (AmazonCloudSearchDescribeScalingParametersCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.DescribeScalingParametersResult {
	return this.block.declare(AmazonCloudSearchDescribeScalingParametersCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.DescribeScalingParametersResult
}
...
class AmazonCloudSearchDescribeScalingParametersCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.DescribeScalingParametersRequest, com.amazonaws.services.cloudsearchv2.model.DescribeScalingParametersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.DescribeScalingParametersResult {
...
fun AmazonCloudSearchFunctions.describeServiceAccessPolicies(domainName: String, init: (AmazonCloudSearchDescribeServiceAccessPoliciesCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.DescribeServiceAccessPoliciesResult {
	return this.block.declare(AmazonCloudSearchDescribeServiceAccessPoliciesCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.DescribeServiceAccessPoliciesResult
}
...
class AmazonCloudSearchDescribeServiceAccessPoliciesCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.DescribeServiceAccessPoliciesRequest, com.amazonaws.services.cloudsearchv2.model.DescribeServiceAccessPoliciesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.DescribeServiceAccessPoliciesResult {
...
fun AmazonCloudSearchFunctions.describeSuggesters(domainName: String, init: (AmazonCloudSearchDescribeSuggestersCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.DescribeSuggestersResult {
	return this.block.declare(AmazonCloudSearchDescribeSuggestersCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.DescribeSuggestersResult
}
...
class AmazonCloudSearchDescribeSuggestersCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.DescribeSuggestersRequest, com.amazonaws.services.cloudsearchv2.model.DescribeSuggestersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.DescribeSuggestersResult {
...
fun AmazonCloudSearchFunctions.indexDocuments(domainName: String, init: (AmazonCloudSearchIndexDocumentsCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.IndexDocumentsResult {
	return this.block.declare(AmazonCloudSearchIndexDocumentsCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.IndexDocumentsResult
}
...
class AmazonCloudSearchIndexDocumentsCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.IndexDocumentsRequest, com.amazonaws.services.cloudsearchv2.model.IndexDocumentsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.IndexDocumentsResult {
...
fun AmazonCloudSearchFunctions.listDomainNames(init: (AmazonCloudSearchListDomainNamesCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.ListDomainNamesResult {
	return this.block.declare(AmazonCloudSearchListDomainNamesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.ListDomainNamesResult
}
...
class AmazonCloudSearchListDomainNamesCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.ListDomainNamesRequest, com.amazonaws.services.cloudsearchv2.model.ListDomainNamesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.ListDomainNamesResult {
...
fun AmazonCloudSearchFunctions.updateAvailabilityOptions(domainName: String, multiAZ: Boolean, init: (AmazonCloudSearchUpdateAvailabilityOptionsCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.UpdateAvailabilityOptionsResult {
	return this.block.declare(AmazonCloudSearchUpdateAvailabilityOptionsCommand(domainName, multiAZ).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.UpdateAvailabilityOptionsResult
}
...
class AmazonCloudSearchUpdateAvailabilityOptionsCommand(val domainName: String, val multiAZ: Boolean) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.UpdateAvailabilityOptionsRequest, com.amazonaws.services.cloudsearchv2.model.UpdateAvailabilityOptionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.UpdateAvailabilityOptionsResult {
...
fun AmazonCloudSearchFunctions.updateScalingParameters(domainName: String, scalingParameters: com.amazonaws.services.cloudsearchv2.model.ScalingParameters, init: (AmazonCloudSearchUpdateScalingParametersCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.UpdateScalingParametersResult {
	return this.block.declare(AmazonCloudSearchUpdateScalingParametersCommand(domainName, scalingParameters).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.UpdateScalingParametersResult
}
...
class AmazonCloudSearchUpdateScalingParametersCommand(val domainName: String, val scalingParameters: com.amazonaws.services.cloudsearchv2.model.ScalingParameters) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.UpdateScalingParametersRequest, com.amazonaws.services.cloudsearchv2.model.UpdateScalingParametersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.UpdateScalingParametersResult {
...
fun AmazonCloudSearchFunctions.updateServiceAccessPolicies(domainName: String, accessPolicies: String, init: (AmazonCloudSearchUpdateServiceAccessPoliciesCommand.() -> Unit)? = null): com.amazonaws.services.cloudsearchv2.model.UpdateServiceAccessPoliciesResult {
	return this.block.declare(AmazonCloudSearchUpdateServiceAccessPoliciesCommand(domainName, accessPolicies).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudsearchv2.model.UpdateServiceAccessPoliciesResult
}
...
class AmazonCloudSearchUpdateServiceAccessPoliciesCommand(val domainName: String, val accessPolicies: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudsearchv2.model.UpdateServiceAccessPoliciesRequest, com.amazonaws.services.cloudsearchv2.model.UpdateServiceAccessPoliciesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudsearchv2.model.UpdateServiceAccessPoliciesResult {
