...
package com.codingue.koops.aws.medialive

import javax.annotation.Generated
import com.codingue.koops.common.*
import com.codingue.koops.core.*
import com.codingue.koops.aws.*
import com.amazonaws.services.medialive.*
import com.amazonaws.services.medialive.model.*

var com.codingue.koops.core.Environment.medialive: AWSMediaLive
	get() {
		var service = this.capabilities["aws-medialive"]
		if (service == null) {
			service = AWSMediaLiveClientBuilder.standard().build()
			this.capabilities["aws-medialive"] = service
		}
		return service as AWSMediaLive
	}
	set(medialive) {
		this.capabilities["aws-medialive"] = medialive
	}
...
fun AWSMediaLiveFunctions.createChannel(init: (AWSMediaLiveCreateChannelCommand.() -> Unit)? = null): com.amazonaws.services.medialive.model.CreateChannelResult {
	return this.block.declare(AWSMediaLiveCreateChannelCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.medialive.model.CreateChannelResult
}
...
class AWSMediaLiveCreateChannelCommand() : AmazonWebServiceCommand<com.amazonaws.services.medialive.model.CreateChannelRequest, com.amazonaws.services.medialive.model.CreateChannelResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.medialive.model.CreateChannelResult {
...
fun AWSMediaLiveFunctions.createInput(init: (AWSMediaLiveCreateInputCommand.() -> Unit)? = null): com.amazonaws.services.medialive.model.CreateInputResult {
	return this.block.declare(AWSMediaLiveCreateInputCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.medialive.model.CreateInputResult
}
...
class AWSMediaLiveCreateInputCommand() : AmazonWebServiceCommand<com.amazonaws.services.medialive.model.CreateInputRequest, com.amazonaws.services.medialive.model.CreateInputResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.medialive.model.CreateInputResult {
...
fun AWSMediaLiveFunctions.createInputSecurityGroup(init: (AWSMediaLiveCreateInputSecurityGroupCommand.() -> Unit)? = null): com.amazonaws.services.medialive.model.CreateInputSecurityGroupResult {
	return this.block.declare(AWSMediaLiveCreateInputSecurityGroupCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.medialive.model.CreateInputSecurityGroupResult
}
...
class AWSMediaLiveCreateInputSecurityGroupCommand() : AmazonWebServiceCommand<com.amazonaws.services.medialive.model.CreateInputSecurityGroupRequest, com.amazonaws.services.medialive.model.CreateInputSecurityGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.medialive.model.CreateInputSecurityGroupResult {
...
fun AWSMediaLiveFunctions.deleteChannel(channelId: String, init: (AWSMediaLiveDeleteChannelCommand.() -> Unit)? = null): com.amazonaws.services.medialive.model.DeleteChannelResult {
	return this.block.declare(AWSMediaLiveDeleteChannelCommand(channelId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.medialive.model.DeleteChannelResult
}
...
class AWSMediaLiveDeleteChannelCommand(val channelId: String) : AmazonWebServiceCommand<com.amazonaws.services.medialive.model.DeleteChannelRequest, com.amazonaws.services.medialive.model.DeleteChannelResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.medialive.model.DeleteChannelResult {
...
fun AWSMediaLiveFunctions.deleteInput(inputId: String, init: (AWSMediaLiveDeleteInputCommand.() -> Unit)? = null): com.amazonaws.services.medialive.model.DeleteInputResult {
	return this.block.declare(AWSMediaLiveDeleteInputCommand(inputId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.medialive.model.DeleteInputResult
}
...
class AWSMediaLiveDeleteInputCommand(val inputId: String) : AmazonWebServiceCommand<com.amazonaws.services.medialive.model.DeleteInputRequest, com.amazonaws.services.medialive.model.DeleteInputResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.medialive.model.DeleteInputResult {
...
fun AWSMediaLiveFunctions.deleteInputSecurityGroup(inputSecurityGroupId: String, init: (AWSMediaLiveDeleteInputSecurityGroupCommand.() -> Unit)? = null): com.amazonaws.services.medialive.model.DeleteInputSecurityGroupResult {
	return this.block.declare(AWSMediaLiveDeleteInputSecurityGroupCommand(inputSecurityGroupId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.medialive.model.DeleteInputSecurityGroupResult
}
...
class AWSMediaLiveDeleteInputSecurityGroupCommand(val inputSecurityGroupId: String) : AmazonWebServiceCommand<com.amazonaws.services.medialive.model.DeleteInputSecurityGroupRequest, com.amazonaws.services.medialive.model.DeleteInputSecurityGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.medialive.model.DeleteInputSecurityGroupResult {
...
fun AWSMediaLiveFunctions.describeChannel(channelId: String, init: (AWSMediaLiveDescribeChannelCommand.() -> Unit)? = null): com.amazonaws.services.medialive.model.DescribeChannelResult {
	return this.block.declare(AWSMediaLiveDescribeChannelCommand(channelId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.medialive.model.DescribeChannelResult
}
...
class AWSMediaLiveDescribeChannelCommand(val channelId: String) : AmazonWebServiceCommand<com.amazonaws.services.medialive.model.DescribeChannelRequest, com.amazonaws.services.medialive.model.DescribeChannelResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.medialive.model.DescribeChannelResult {
...
fun AWSMediaLiveFunctions.describeInput(inputId: String, init: (AWSMediaLiveDescribeInputCommand.() -> Unit)? = null): com.amazonaws.services.medialive.model.DescribeInputResult {
	return this.block.declare(AWSMediaLiveDescribeInputCommand(inputId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.medialive.model.DescribeInputResult
}
...
class AWSMediaLiveDescribeInputCommand(val inputId: String) : AmazonWebServiceCommand<com.amazonaws.services.medialive.model.DescribeInputRequest, com.amazonaws.services.medialive.model.DescribeInputResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.medialive.model.DescribeInputResult {
...
fun AWSMediaLiveFunctions.describeInputSecurityGroup(inputSecurityGroupId: String, init: (AWSMediaLiveDescribeInputSecurityGroupCommand.() -> Unit)? = null): com.amazonaws.services.medialive.model.DescribeInputSecurityGroupResult {
	return this.block.declare(AWSMediaLiveDescribeInputSecurityGroupCommand(inputSecurityGroupId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.medialive.model.DescribeInputSecurityGroupResult
}
...
class AWSMediaLiveDescribeInputSecurityGroupCommand(val inputSecurityGroupId: String) : AmazonWebServiceCommand<com.amazonaws.services.medialive.model.DescribeInputSecurityGroupRequest, com.amazonaws.services.medialive.model.DescribeInputSecurityGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.medialive.model.DescribeInputSecurityGroupResult {
...
fun AWSMediaLiveFunctions.listChannels(init: (AWSMediaLiveListChannelsCommand.() -> Unit)? = null): com.amazonaws.services.medialive.model.ListChannelsResult {
	return this.block.declare(AWSMediaLiveListChannelsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.medialive.model.ListChannelsResult
}
...
class AWSMediaLiveListChannelsCommand() : AmazonWebServiceCommand<com.amazonaws.services.medialive.model.ListChannelsRequest, com.amazonaws.services.medialive.model.ListChannelsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.medialive.model.ListChannelsResult {
...
fun AWSMediaLiveFunctions.listInputSecurityGroups(init: (AWSMediaLiveListInputSecurityGroupsCommand.() -> Unit)? = null): com.amazonaws.services.medialive.model.ListInputSecurityGroupsResult {
	return this.block.declare(AWSMediaLiveListInputSecurityGroupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.medialive.model.ListInputSecurityGroupsResult
}
...
class AWSMediaLiveListInputSecurityGroupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.medialive.model.ListInputSecurityGroupsRequest, com.amazonaws.services.medialive.model.ListInputSecurityGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.medialive.model.ListInputSecurityGroupsResult {
...
fun AWSMediaLiveFunctions.listInputs(init: (AWSMediaLiveListInputsCommand.() -> Unit)? = null): com.amazonaws.services.medialive.model.ListInputsResult {
	return this.block.declare(AWSMediaLiveListInputsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.medialive.model.ListInputsResult
}
...
class AWSMediaLiveListInputsCommand() : AmazonWebServiceCommand<com.amazonaws.services.medialive.model.ListInputsRequest, com.amazonaws.services.medialive.model.ListInputsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.medialive.model.ListInputsResult {
...
fun AWSMediaLiveFunctions.startChannel(channelId: String, init: (AWSMediaLiveStartChannelCommand.() -> Unit)? = null): com.amazonaws.services.medialive.model.StartChannelResult {
	return this.block.declare(AWSMediaLiveStartChannelCommand(channelId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.medialive.model.StartChannelResult
}
...
class AWSMediaLiveStartChannelCommand(val channelId: String) : AmazonWebServiceCommand<com.amazonaws.services.medialive.model.StartChannelRequest, com.amazonaws.services.medialive.model.StartChannelResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.medialive.model.StartChannelResult {
...
fun AWSMediaLiveFunctions.stopChannel(channelId: String, init: (AWSMediaLiveStopChannelCommand.() -> Unit)? = null): com.amazonaws.services.medialive.model.StopChannelResult {
	return this.block.declare(AWSMediaLiveStopChannelCommand(channelId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.medialive.model.StopChannelResult
}
...
class AWSMediaLiveStopChannelCommand(val channelId: String) : AmazonWebServiceCommand<com.amazonaws.services.medialive.model.StopChannelRequest, com.amazonaws.services.medialive.model.StopChannelResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.medialive.model.StopChannelResult {
...
fun AWSMediaLiveFunctions.updateChannel(channelId: String, init: (AWSMediaLiveUpdateChannelCommand.() -> Unit)? = null): com.amazonaws.services.medialive.model.UpdateChannelResult {
	return this.block.declare(AWSMediaLiveUpdateChannelCommand(channelId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.medialive.model.UpdateChannelResult
}
...
class AWSMediaLiveUpdateChannelCommand(val channelId: String) : AmazonWebServiceCommand<com.amazonaws.services.medialive.model.UpdateChannelRequest, com.amazonaws.services.medialive.model.UpdateChannelResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.medialive.model.UpdateChannelResult {
...
fun AWSMediaLiveFunctions.updateInput(inputId: String, init: (AWSMediaLiveUpdateInputCommand.() -> Unit)? = null): com.amazonaws.services.medialive.model.UpdateInputResult {
	return this.block.declare(AWSMediaLiveUpdateInputCommand(inputId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.medialive.model.UpdateInputResult
}
...
class AWSMediaLiveUpdateInputCommand(val inputId: String) : AmazonWebServiceCommand<com.amazonaws.services.medialive.model.UpdateInputRequest, com.amazonaws.services.medialive.model.UpdateInputResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.medialive.model.UpdateInputResult {
...
fun AWSMediaLiveFunctions.updateInputSecurityGroup(inputSecurityGroupId: String, init: (AWSMediaLiveUpdateInputSecurityGroupCommand.() -> Unit)? = null): com.amazonaws.services.medialive.model.UpdateInputSecurityGroupResult {
	return this.block.declare(AWSMediaLiveUpdateInputSecurityGroupCommand(inputSecurityGroupId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.medialive.model.UpdateInputSecurityGroupResult
}
...
class AWSMediaLiveUpdateInputSecurityGroupCommand(val inputSecurityGroupId: String) : AmazonWebServiceCommand<com.amazonaws.services.medialive.model.UpdateInputSecurityGroupRequest, com.amazonaws.services.medialive.model.UpdateInputSecurityGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.medialive.model.UpdateInputSecurityGroupResult {
