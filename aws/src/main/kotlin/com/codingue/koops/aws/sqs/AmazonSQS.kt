...
package com.codingue.koops.aws.sqs
...
var com.codingue.koops.core.Environment.sqs: AmazonSQS
	get() {
...
fun AmazonSQSFunctions.addPermission(queueUrl: String, label: String, aWSAccountIds: List<String>, actions: List<String>, init: (AmazonSQSAddPermissionCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.AddPermissionResult {
	return this.block.declare(AmazonSQSAddPermissionCommand(queueUrl, label, aWSAccountIds, actions).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.AddPermissionResult
}
...
class AmazonSQSAddPermissionCommand(val queueUrl: String, val label: String, val aWSAccountIds: List<String>, val actions: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.AddPermissionRequest, com.amazonaws.services.sqs.model.AddPermissionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.AddPermissionResult {
...
fun AmazonSQSFunctions.changeMessageVisibility(queueUrl: String, receiptHandle: String, visibilityTimeout: Int, init: (AmazonSQSChangeMessageVisibilityCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.ChangeMessageVisibilityResult {
	return this.block.declare(AmazonSQSChangeMessageVisibilityCommand(queueUrl, receiptHandle, visibilityTimeout).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.ChangeMessageVisibilityResult
}
...
class AmazonSQSChangeMessageVisibilityCommand(val queueUrl: String, val receiptHandle: String, val visibilityTimeout: Int) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.ChangeMessageVisibilityRequest, com.amazonaws.services.sqs.model.ChangeMessageVisibilityResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.ChangeMessageVisibilityResult {
...
fun AmazonSQSFunctions.changeMessageVisibilityBatch(queueUrl: String, entries: List<com.amazonaws.services.sqs.model.ChangeMessageVisibilityBatchRequestEntry>, init: (AmazonSQSChangeMessageVisibilityBatchCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.ChangeMessageVisibilityBatchResult {
	return this.block.declare(AmazonSQSChangeMessageVisibilityBatchCommand(queueUrl, entries).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.ChangeMessageVisibilityBatchResult
}
...
class AmazonSQSChangeMessageVisibilityBatchCommand(val queueUrl: String, val entries: List<com.amazonaws.services.sqs.model.ChangeMessageVisibilityBatchRequestEntry>) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.ChangeMessageVisibilityBatchRequest, com.amazonaws.services.sqs.model.ChangeMessageVisibilityBatchResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.ChangeMessageVisibilityBatchResult {
...
fun AmazonSQSFunctions.createQueue(queueName: String, init: (AmazonSQSCreateQueueCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.CreateQueueResult {
	return this.block.declare(AmazonSQSCreateQueueCommand(queueName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.CreateQueueResult
}
...
class AmazonSQSCreateQueueCommand(val queueName: String) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.CreateQueueRequest, com.amazonaws.services.sqs.model.CreateQueueResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.CreateQueueResult {
...
fun AmazonSQSFunctions.deleteMessage(queueUrl: String, receiptHandle: String, init: (AmazonSQSDeleteMessageCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.DeleteMessageResult {
	return this.block.declare(AmazonSQSDeleteMessageCommand(queueUrl, receiptHandle).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.DeleteMessageResult
}
...
class AmazonSQSDeleteMessageCommand(val queueUrl: String, val receiptHandle: String) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.DeleteMessageRequest, com.amazonaws.services.sqs.model.DeleteMessageResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.DeleteMessageResult {
...
fun AmazonSQSFunctions.deleteMessageBatch(queueUrl: String, entries: List<com.amazonaws.services.sqs.model.DeleteMessageBatchRequestEntry>, init: (AmazonSQSDeleteMessageBatchCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.DeleteMessageBatchResult {
	return this.block.declare(AmazonSQSDeleteMessageBatchCommand(queueUrl, entries).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.DeleteMessageBatchResult
}
...
class AmazonSQSDeleteMessageBatchCommand(val queueUrl: String, val entries: List<com.amazonaws.services.sqs.model.DeleteMessageBatchRequestEntry>) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.DeleteMessageBatchRequest, com.amazonaws.services.sqs.model.DeleteMessageBatchResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.DeleteMessageBatchResult {
...
fun AmazonSQSFunctions.deleteQueue(queueUrl: String, init: (AmazonSQSDeleteQueueCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.DeleteQueueResult {
	return this.block.declare(AmazonSQSDeleteQueueCommand(queueUrl).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.DeleteQueueResult
}
...
class AmazonSQSDeleteQueueCommand(val queueUrl: String) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.DeleteQueueRequest, com.amazonaws.services.sqs.model.DeleteQueueResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.DeleteQueueResult {
...
fun AmazonSQSFunctions.getQueueAttributes(queueUrl: String, init: (AmazonSQSGetQueueAttributesCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.GetQueueAttributesResult {
	return this.block.declare(AmazonSQSGetQueueAttributesCommand(queueUrl).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.GetQueueAttributesResult
}
...
class AmazonSQSGetQueueAttributesCommand(val queueUrl: String) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.GetQueueAttributesRequest, com.amazonaws.services.sqs.model.GetQueueAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.GetQueueAttributesResult {
...
fun AmazonSQSFunctions.getQueueUrl(queueName: String, init: (AmazonSQSGetQueueUrlCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.GetQueueUrlResult {
	return this.block.declare(AmazonSQSGetQueueUrlCommand(queueName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.GetQueueUrlResult
}
...
class AmazonSQSGetQueueUrlCommand(val queueName: String) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.GetQueueUrlRequest, com.amazonaws.services.sqs.model.GetQueueUrlResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.GetQueueUrlResult {
...
fun AmazonSQSFunctions.listDeadLetterSourceQueues(queueUrl: String, init: (AmazonSQSListDeadLetterSourceQueuesCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.ListDeadLetterSourceQueuesResult {
	return this.block.declare(AmazonSQSListDeadLetterSourceQueuesCommand(queueUrl).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.ListDeadLetterSourceQueuesResult
}
...
class AmazonSQSListDeadLetterSourceQueuesCommand(val queueUrl: String) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.ListDeadLetterSourceQueuesRequest, com.amazonaws.services.sqs.model.ListDeadLetterSourceQueuesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.ListDeadLetterSourceQueuesResult {
...
fun AmazonSQSFunctions.listQueueTags(queueUrl: String, init: (AmazonSQSListQueueTagsCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.ListQueueTagsResult {
	return this.block.declare(AmazonSQSListQueueTagsCommand(queueUrl).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.ListQueueTagsResult
}
...
class AmazonSQSListQueueTagsCommand(val queueUrl: String) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.ListQueueTagsRequest, com.amazonaws.services.sqs.model.ListQueueTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.ListQueueTagsResult {
...
fun AmazonSQSFunctions.listQueues(init: (AmazonSQSListQueuesCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.ListQueuesResult {
	return this.block.declare(AmazonSQSListQueuesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.ListQueuesResult
}
...
class AmazonSQSListQueuesCommand() : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.ListQueuesRequest, com.amazonaws.services.sqs.model.ListQueuesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.ListQueuesResult {
...
fun AmazonSQSFunctions.purgeQueue(queueUrl: String, init: (AmazonSQSPurgeQueueCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.PurgeQueueResult {
	return this.block.declare(AmazonSQSPurgeQueueCommand(queueUrl).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.PurgeQueueResult
}
...
class AmazonSQSPurgeQueueCommand(val queueUrl: String) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.PurgeQueueRequest, com.amazonaws.services.sqs.model.PurgeQueueResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.PurgeQueueResult {
...
fun AmazonSQSFunctions.receiveMessage(queueUrl: String, init: (AmazonSQSReceiveMessageCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.ReceiveMessageResult {
	return this.block.declare(AmazonSQSReceiveMessageCommand(queueUrl).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.ReceiveMessageResult
}
...
class AmazonSQSReceiveMessageCommand(val queueUrl: String) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.ReceiveMessageRequest, com.amazonaws.services.sqs.model.ReceiveMessageResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.ReceiveMessageResult {
...
fun AmazonSQSFunctions.removePermission(queueUrl: String, label: String, init: (AmazonSQSRemovePermissionCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.RemovePermissionResult {
	return this.block.declare(AmazonSQSRemovePermissionCommand(queueUrl, label).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.RemovePermissionResult
}
...
class AmazonSQSRemovePermissionCommand(val queueUrl: String, val label: String) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.RemovePermissionRequest, com.amazonaws.services.sqs.model.RemovePermissionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.RemovePermissionResult {
...
fun AmazonSQSFunctions.sendMessage(queueUrl: String, messageBody: String, init: (AmazonSQSSendMessageCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.SendMessageResult {
	return this.block.declare(AmazonSQSSendMessageCommand(queueUrl, messageBody).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.SendMessageResult
}
...
class AmazonSQSSendMessageCommand(val queueUrl: String, val messageBody: String) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.SendMessageRequest, com.amazonaws.services.sqs.model.SendMessageResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.SendMessageResult {
...
fun AmazonSQSFunctions.sendMessageBatch(queueUrl: String, entries: List<com.amazonaws.services.sqs.model.SendMessageBatchRequestEntry>, init: (AmazonSQSSendMessageBatchCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.SendMessageBatchResult {
	return this.block.declare(AmazonSQSSendMessageBatchCommand(queueUrl, entries).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.SendMessageBatchResult
}
...
class AmazonSQSSendMessageBatchCommand(val queueUrl: String, val entries: List<com.amazonaws.services.sqs.model.SendMessageBatchRequestEntry>) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.SendMessageBatchRequest, com.amazonaws.services.sqs.model.SendMessageBatchResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.SendMessageBatchResult {
...
fun AmazonSQSFunctions.setQueueAttributes(queueUrl: String, attributes: Map<QueueAttributeName, String>, init: (AmazonSQSSetQueueAttributesCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.SetQueueAttributesResult {
	return this.block.declare(AmazonSQSSetQueueAttributesCommand(queueUrl, attributes).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.SetQueueAttributesResult
}
...
class AmazonSQSSetQueueAttributesCommand(val queueUrl: String, val attributes: Map<QueueAttributeName, String>) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.SetQueueAttributesRequest, com.amazonaws.services.sqs.model.SetQueueAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.SetQueueAttributesResult {
...
fun AmazonSQSFunctions.tagQueue(queueUrl: String, tags: Map<String, String>, init: (AmazonSQSTagQueueCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.TagQueueResult {
	return this.block.declare(AmazonSQSTagQueueCommand(queueUrl, tags).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.TagQueueResult
}
...
class AmazonSQSTagQueueCommand(val queueUrl: String, val tags: Map<String, String>) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.TagQueueRequest, com.amazonaws.services.sqs.model.TagQueueResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.TagQueueResult {
...
fun AmazonSQSFunctions.untagQueue(queueUrl: String, tagKeys: List<String>, init: (AmazonSQSUntagQueueCommand.() -> Unit)? = null): com.amazonaws.services.sqs.model.UntagQueueResult {
	return this.block.declare(AmazonSQSUntagQueueCommand(queueUrl, tagKeys).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sqs.model.UntagQueueResult
}
...
class AmazonSQSUntagQueueCommand(val queueUrl: String, val tagKeys: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.sqs.model.UntagQueueRequest, com.amazonaws.services.sqs.model.UntagQueueResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sqs.model.UntagQueueResult {
