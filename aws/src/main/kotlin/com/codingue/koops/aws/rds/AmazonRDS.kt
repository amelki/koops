...
package com.codingue.koops.aws.rds
...
var com.codingue.koops.core.Environment.rds: AmazonRDS
	get() {
		var service = this.capabilities["aws-rds"]
		if (service == null) {
			service = AmazonRDSClientBuilder.standard().build()
			this.capabilities["aws-rds"] = service
		}
		return service as AmazonRDS
	}
	set(rds) {
		this.capabilities["aws-rds"] = rds
	}
...
fun AmazonRDSFunctions.addRoleToDBCluster(dBClusterIdentifier: String, roleArn: String, init: (AmazonRDSAddRoleToDBClusterCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.AddRoleToDBClusterResult {
	return this.block.declare(AmazonRDSAddRoleToDBClusterCommand(dBClusterIdentifier, roleArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.AddRoleToDBClusterResult
}
...
class AmazonRDSAddRoleToDBClusterCommand(val dBClusterIdentifier: String, val roleArn: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.AddRoleToDBClusterRequest, com.amazonaws.services.rds.model.AddRoleToDBClusterResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.AddRoleToDBClusterResult {
...
fun AmazonRDSFunctions.addSourceIdentifierToSubscription(subscriptionName: String, sourceIdentifier: String, init: (AmazonRDSAddSourceIdentifierToSubscriptionCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.EventSubscription {
	return this.block.declare(AmazonRDSAddSourceIdentifierToSubscriptionCommand(subscriptionName, sourceIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.EventSubscription
}
...
class AmazonRDSAddSourceIdentifierToSubscriptionCommand(val subscriptionName: String, val sourceIdentifier: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.AddSourceIdentifierToSubscriptionRequest, com.amazonaws.services.rds.model.EventSubscription> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.EventSubscription {
...
fun AmazonRDSFunctions.addTagsToResource(resourceName: String, tags: List<com.amazonaws.services.rds.model.Tag>, init: (AmazonRDSAddTagsToResourceCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.AddTagsToResourceResult {
	return this.block.declare(AmazonRDSAddTagsToResourceCommand(resourceName, tags).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.AddTagsToResourceResult
}
...
class AmazonRDSAddTagsToResourceCommand(val resourceName: String, val tags: List<com.amazonaws.services.rds.model.Tag>) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.AddTagsToResourceRequest, com.amazonaws.services.rds.model.AddTagsToResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.AddTagsToResourceResult {
...
fun AmazonRDSFunctions.applyPendingMaintenanceAction(resourceIdentifier: String, applyAction: String, optInType: String, init: (AmazonRDSApplyPendingMaintenanceActionCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.ResourcePendingMaintenanceActions {
	return this.block.declare(AmazonRDSApplyPendingMaintenanceActionCommand(resourceIdentifier, applyAction, optInType).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.ResourcePendingMaintenanceActions
}
...
class AmazonRDSApplyPendingMaintenanceActionCommand(val resourceIdentifier: String, val applyAction: String, val optInType: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.ApplyPendingMaintenanceActionRequest, com.amazonaws.services.rds.model.ResourcePendingMaintenanceActions> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.ResourcePendingMaintenanceActions {
...
fun AmazonRDSFunctions.authorizeDBSecurityGroupIngress(dBSecurityGroupName: String, init: (AmazonRDSAuthorizeDBSecurityGroupIngressCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBSecurityGroup {
	return this.block.declare(AmazonRDSAuthorizeDBSecurityGroupIngressCommand(dBSecurityGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBSecurityGroup
}
...
class AmazonRDSAuthorizeDBSecurityGroupIngressCommand(val dBSecurityGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.AuthorizeDBSecurityGroupIngressRequest, com.amazonaws.services.rds.model.DBSecurityGroup> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DBSecurityGroup {
...
fun AmazonRDSFunctions.copyDBClusterParameterGroup(sourceDBClusterParameterGroupIdentifier: String, targetDBClusterParameterGroupIdentifier: String, targetDBClusterParameterGroupDescription: String, init: (AmazonRDSCopyDBClusterParameterGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBClusterParameterGroup {
	return this.block.declare(AmazonRDSCopyDBClusterParameterGroupCommand(sourceDBClusterParameterGroupIdentifier, targetDBClusterParameterGroupIdentifier, targetDBClusterParameterGroupDescription).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBClusterParameterGroup
}
...
class AmazonRDSCopyDBClusterParameterGroupCommand(val sourceDBClusterParameterGroupIdentifier: String, val targetDBClusterParameterGroupIdentifier: String, val targetDBClusterParameterGroupDescription: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.CopyDBClusterParameterGroupRequest, com.amazonaws.services.rds.model.DBClusterParameterGroup> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DBClusterParameterGroup {
...
fun AmazonRDSFunctions.copyDBClusterSnapshot(sourceDBClusterSnapshotIdentifier: String, targetDBClusterSnapshotIdentifier: String, init: (AmazonRDSCopyDBClusterSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBClusterSnapshot {
	return this.block.declare(AmazonRDSCopyDBClusterSnapshotCommand(sourceDBClusterSnapshotIdentifier, targetDBClusterSnapshotIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBClusterSnapshot
}
...
class AmazonRDSCopyDBClusterSnapshotCommand(val sourceDBClusterSnapshotIdentifier: String, val targetDBClusterSnapshotIdentifier: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.CopyDBClusterSnapshotRequest, com.amazonaws.services.rds.model.DBClusterSnapshot> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DBClusterSnapshot {
...
fun AmazonRDSFunctions.copyDBParameterGroup(sourceDBParameterGroupIdentifier: String, targetDBParameterGroupIdentifier: String, targetDBParameterGroupDescription: String, init: (AmazonRDSCopyDBParameterGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBParameterGroup {
	return this.block.declare(AmazonRDSCopyDBParameterGroupCommand(sourceDBParameterGroupIdentifier, targetDBParameterGroupIdentifier, targetDBParameterGroupDescription).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBParameterGroup
}
...
class AmazonRDSCopyDBParameterGroupCommand(val sourceDBParameterGroupIdentifier: String, val targetDBParameterGroupIdentifier: String, val targetDBParameterGroupDescription: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.CopyDBParameterGroupRequest, com.amazonaws.services.rds.model.DBParameterGroup> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DBParameterGroup {
...
fun AmazonRDSFunctions.copyDBSnapshot(sourceDBSnapshotIdentifier: String, targetDBSnapshotIdentifier: String, init: (AmazonRDSCopyDBSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBSnapshot {
	return this.block.declare(AmazonRDSCopyDBSnapshotCommand(sourceDBSnapshotIdentifier, targetDBSnapshotIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBSnapshot
}
...
class AmazonRDSCopyDBSnapshotCommand(val sourceDBSnapshotIdentifier: String, val targetDBSnapshotIdentifier: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.CopyDBSnapshotRequest, com.amazonaws.services.rds.model.DBSnapshot> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DBSnapshot {
...
fun AmazonRDSFunctions.copyOptionGroup(sourceOptionGroupIdentifier: String, targetOptionGroupIdentifier: String, targetOptionGroupDescription: String, init: (AmazonRDSCopyOptionGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.OptionGroup {
	return this.block.declare(AmazonRDSCopyOptionGroupCommand(sourceOptionGroupIdentifier, targetOptionGroupIdentifier, targetOptionGroupDescription).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.OptionGroup
}
...
class AmazonRDSCopyOptionGroupCommand(val sourceOptionGroupIdentifier: String, val targetOptionGroupIdentifier: String, val targetOptionGroupDescription: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.CopyOptionGroupRequest, com.amazonaws.services.rds.model.OptionGroup> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.OptionGroup {
...
fun AmazonRDSFunctions.createDBCluster(dBClusterIdentifier: String, engine: String, init: (AmazonRDSCreateDBClusterCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBCluster {
	return this.block.declare(AmazonRDSCreateDBClusterCommand(dBClusterIdentifier, engine).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBCluster
}
...
class AmazonRDSCreateDBClusterCommand(val dBClusterIdentifier: String, val engine: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.CreateDBClusterRequest, com.amazonaws.services.rds.model.DBCluster> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DBCluster {
...
fun AmazonRDSFunctions.createDBClusterParameterGroup(dBClusterParameterGroupName: String, dBParameterGroupFamily: String, description: String, init: (AmazonRDSCreateDBClusterParameterGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBClusterParameterGroup {
	return this.block.declare(AmazonRDSCreateDBClusterParameterGroupCommand(dBClusterParameterGroupName, dBParameterGroupFamily, description).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBClusterParameterGroup
}
...
fun AmazonRDSFunctions.createDBClusterSnapshot(dBClusterSnapshotIdentifier: String, dBClusterIdentifier: String, init: (AmazonRDSCreateDBClusterSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBClusterSnapshot {
	return this.block.declare(AmazonRDSCreateDBClusterSnapshotCommand(dBClusterSnapshotIdentifier, dBClusterIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBClusterSnapshot
}
...
fun AmazonRDSFunctions.createDBInstance(dBInstanceIdentifier: String, dBInstanceClass: String, engine: String, init: (AmazonRDSCreateDBInstanceCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBInstance {
	return this.block.declare(AmazonRDSCreateDBInstanceCommand(dBInstanceIdentifier, dBInstanceClass, engine).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBInstance
}
...
class AmazonRDSCreateDBInstanceCommand(val dBInstanceIdentifier: String, val dBInstanceClass: String, val engine: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.CreateDBInstanceRequest, com.amazonaws.services.rds.model.DBInstance> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DBInstance {
...
fun AmazonRDSFunctions.createDBInstanceReadReplica(dBInstanceIdentifier: String, sourceDBInstanceIdentifier: String, init: (AmazonRDSCreateDBInstanceReadReplicaCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBInstance {
	return this.block.declare(AmazonRDSCreateDBInstanceReadReplicaCommand(dBInstanceIdentifier, sourceDBInstanceIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBInstance
}
...
fun AmazonRDSFunctions.createDBParameterGroup(dBParameterGroupName: String, dBParameterGroupFamily: String, description: String, init: (AmazonRDSCreateDBParameterGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBParameterGroup {
	return this.block.declare(AmazonRDSCreateDBParameterGroupCommand(dBParameterGroupName, dBParameterGroupFamily, description).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBParameterGroup
}
...
fun AmazonRDSFunctions.createDBSecurityGroup(dBSecurityGroupName: String, dBSecurityGroupDescription: String, init: (AmazonRDSCreateDBSecurityGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBSecurityGroup {
	return this.block.declare(AmazonRDSCreateDBSecurityGroupCommand(dBSecurityGroupName, dBSecurityGroupDescription).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBSecurityGroup
}
...
fun AmazonRDSFunctions.createDBSnapshot(dBSnapshotIdentifier: String, dBInstanceIdentifier: String, init: (AmazonRDSCreateDBSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBSnapshot {
	return this.block.declare(AmazonRDSCreateDBSnapshotCommand(dBSnapshotIdentifier, dBInstanceIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBSnapshot
}
...
fun AmazonRDSFunctions.createDBSubnetGroup(dBSubnetGroupName: String, dBSubnetGroupDescription: String, subnetIds: List<String>, init: (AmazonRDSCreateDBSubnetGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBSubnetGroup {
	return this.block.declare(AmazonRDSCreateDBSubnetGroupCommand(dBSubnetGroupName, dBSubnetGroupDescription, subnetIds).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBSubnetGroup
}
...
class AmazonRDSCreateDBSubnetGroupCommand(val dBSubnetGroupName: String, val dBSubnetGroupDescription: String, val subnetIds: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.CreateDBSubnetGroupRequest, com.amazonaws.services.rds.model.DBSubnetGroup> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DBSubnetGroup {
...
fun AmazonRDSFunctions.createEventSubscription(subscriptionName: String, snsTopicArn: String, init: (AmazonRDSCreateEventSubscriptionCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.EventSubscription {
	return this.block.declare(AmazonRDSCreateEventSubscriptionCommand(subscriptionName, snsTopicArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.EventSubscription
}
...
fun AmazonRDSFunctions.createOptionGroup(optionGroupName: String, engineName: String, majorEngineVersion: String, optionGroupDescription: String, init: (AmazonRDSCreateOptionGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.OptionGroup {
	return this.block.declare(AmazonRDSCreateOptionGroupCommand(optionGroupName, engineName, majorEngineVersion, optionGroupDescription).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.OptionGroup
}
...
fun AmazonRDSFunctions.deleteDBCluster(dBClusterIdentifier: String, init: (AmazonRDSDeleteDBClusterCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBCluster {
	return this.block.declare(AmazonRDSDeleteDBClusterCommand(dBClusterIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBCluster
}
...
fun AmazonRDSFunctions.deleteDBClusterParameterGroup(dBClusterParameterGroupName: String, init: (AmazonRDSDeleteDBClusterParameterGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DeleteDBClusterParameterGroupResult {
	return this.block.declare(AmazonRDSDeleteDBClusterParameterGroupCommand(dBClusterParameterGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DeleteDBClusterParameterGroupResult
}
...
class AmazonRDSDeleteDBClusterParameterGroupCommand(val dBClusterParameterGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DeleteDBClusterParameterGroupRequest, com.amazonaws.services.rds.model.DeleteDBClusterParameterGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DeleteDBClusterParameterGroupResult {
...
fun AmazonRDSFunctions.deleteDBClusterSnapshot(dBClusterSnapshotIdentifier: String, init: (AmazonRDSDeleteDBClusterSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBClusterSnapshot {
	return this.block.declare(AmazonRDSDeleteDBClusterSnapshotCommand(dBClusterSnapshotIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBClusterSnapshot
}
...
fun AmazonRDSFunctions.deleteDBInstance(dBInstanceIdentifier: String, init: (AmazonRDSDeleteDBInstanceCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBInstance {
	return this.block.declare(AmazonRDSDeleteDBInstanceCommand(dBInstanceIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBInstance
}
...
fun AmazonRDSFunctions.deleteDBParameterGroup(dBParameterGroupName: String, init: (AmazonRDSDeleteDBParameterGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DeleteDBParameterGroupResult {
	return this.block.declare(AmazonRDSDeleteDBParameterGroupCommand(dBParameterGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DeleteDBParameterGroupResult
}
...
class AmazonRDSDeleteDBParameterGroupCommand(val dBParameterGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DeleteDBParameterGroupRequest, com.amazonaws.services.rds.model.DeleteDBParameterGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DeleteDBParameterGroupResult {
...
fun AmazonRDSFunctions.deleteDBSecurityGroup(dBSecurityGroupName: String, init: (AmazonRDSDeleteDBSecurityGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DeleteDBSecurityGroupResult {
	return this.block.declare(AmazonRDSDeleteDBSecurityGroupCommand(dBSecurityGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DeleteDBSecurityGroupResult
}
...
class AmazonRDSDeleteDBSecurityGroupCommand(val dBSecurityGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DeleteDBSecurityGroupRequest, com.amazonaws.services.rds.model.DeleteDBSecurityGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DeleteDBSecurityGroupResult {
...
fun AmazonRDSFunctions.deleteDBSnapshot(dBSnapshotIdentifier: String, init: (AmazonRDSDeleteDBSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBSnapshot {
	return this.block.declare(AmazonRDSDeleteDBSnapshotCommand(dBSnapshotIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBSnapshot
}
...
fun AmazonRDSFunctions.deleteDBSubnetGroup(dBSubnetGroupName: String, init: (AmazonRDSDeleteDBSubnetGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DeleteDBSubnetGroupResult {
	return this.block.declare(AmazonRDSDeleteDBSubnetGroupCommand(dBSubnetGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DeleteDBSubnetGroupResult
}
...
class AmazonRDSDeleteDBSubnetGroupCommand(val dBSubnetGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DeleteDBSubnetGroupRequest, com.amazonaws.services.rds.model.DeleteDBSubnetGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DeleteDBSubnetGroupResult {
...
fun AmazonRDSFunctions.deleteEventSubscription(subscriptionName: String, init: (AmazonRDSDeleteEventSubscriptionCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.EventSubscription {
	return this.block.declare(AmazonRDSDeleteEventSubscriptionCommand(subscriptionName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.EventSubscription
}
...
fun AmazonRDSFunctions.deleteOptionGroup(optionGroupName: String, init: (AmazonRDSDeleteOptionGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DeleteOptionGroupResult {
	return this.block.declare(AmazonRDSDeleteOptionGroupCommand(optionGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DeleteOptionGroupResult
}
...
class AmazonRDSDeleteOptionGroupCommand(val optionGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DeleteOptionGroupRequest, com.amazonaws.services.rds.model.DeleteOptionGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DeleteOptionGroupResult {
...
fun AmazonRDSFunctions.describeAccountAttributes(init: (AmazonRDSDescribeAccountAttributesCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeAccountAttributesResult {
	return this.block.declare(AmazonRDSDescribeAccountAttributesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeAccountAttributesResult
}
...
class AmazonRDSDescribeAccountAttributesCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeAccountAttributesRequest, com.amazonaws.services.rds.model.DescribeAccountAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeAccountAttributesResult {
...
fun AmazonRDSFunctions.describeCertificates(init: (AmazonRDSDescribeCertificatesCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeCertificatesResult {
	return this.block.declare(AmazonRDSDescribeCertificatesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeCertificatesResult
}
...
class AmazonRDSDescribeCertificatesCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeCertificatesRequest, com.amazonaws.services.rds.model.DescribeCertificatesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeCertificatesResult {
...
fun AmazonRDSFunctions.describeDBClusterParameterGroups(init: (AmazonRDSDescribeDBClusterParameterGroupsCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeDBClusterParameterGroupsResult {
	return this.block.declare(AmazonRDSDescribeDBClusterParameterGroupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeDBClusterParameterGroupsResult
}
...
class AmazonRDSDescribeDBClusterParameterGroupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeDBClusterParameterGroupsRequest, com.amazonaws.services.rds.model.DescribeDBClusterParameterGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeDBClusterParameterGroupsResult {
...
fun AmazonRDSFunctions.describeDBClusterParameters(dBClusterParameterGroupName: String, init: (AmazonRDSDescribeDBClusterParametersCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeDBClusterParametersResult {
	return this.block.declare(AmazonRDSDescribeDBClusterParametersCommand(dBClusterParameterGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeDBClusterParametersResult
}
...
class AmazonRDSDescribeDBClusterParametersCommand(val dBClusterParameterGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeDBClusterParametersRequest, com.amazonaws.services.rds.model.DescribeDBClusterParametersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeDBClusterParametersResult {
...
fun AmazonRDSFunctions.describeDBClusterSnapshotAttributes(dBClusterSnapshotIdentifier: String, init: (AmazonRDSDescribeDBClusterSnapshotAttributesCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBClusterSnapshotAttributesResult {
	return this.block.declare(AmazonRDSDescribeDBClusterSnapshotAttributesCommand(dBClusterSnapshotIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBClusterSnapshotAttributesResult
}
...
class AmazonRDSDescribeDBClusterSnapshotAttributesCommand(val dBClusterSnapshotIdentifier: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeDBClusterSnapshotAttributesRequest, com.amazonaws.services.rds.model.DBClusterSnapshotAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DBClusterSnapshotAttributesResult {
...
fun AmazonRDSFunctions.describeDBClusterSnapshots(init: (AmazonRDSDescribeDBClusterSnapshotsCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeDBClusterSnapshotsResult {
	return this.block.declare(AmazonRDSDescribeDBClusterSnapshotsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeDBClusterSnapshotsResult
}
...
class AmazonRDSDescribeDBClusterSnapshotsCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeDBClusterSnapshotsRequest, com.amazonaws.services.rds.model.DescribeDBClusterSnapshotsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeDBClusterSnapshotsResult {
...
fun AmazonRDSFunctions.describeDBClusters(init: (AmazonRDSDescribeDBClustersCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeDBClustersResult {
	return this.block.declare(AmazonRDSDescribeDBClustersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeDBClustersResult
}
...
class AmazonRDSDescribeDBClustersCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeDBClustersRequest, com.amazonaws.services.rds.model.DescribeDBClustersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeDBClustersResult {
...
fun AmazonRDSFunctions.describeDBEngineVersions(init: (AmazonRDSDescribeDBEngineVersionsCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeDBEngineVersionsResult {
	return this.block.declare(AmazonRDSDescribeDBEngineVersionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeDBEngineVersionsResult
}
...
class AmazonRDSDescribeDBEngineVersionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeDBEngineVersionsRequest, com.amazonaws.services.rds.model.DescribeDBEngineVersionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeDBEngineVersionsResult {
...
fun AmazonRDSFunctions.describeDBInstances(init: (AmazonRDSDescribeDBInstancesCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeDBInstancesResult {
	return this.block.declare(AmazonRDSDescribeDBInstancesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeDBInstancesResult
}
...
class AmazonRDSDescribeDBInstancesCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeDBInstancesRequest, com.amazonaws.services.rds.model.DescribeDBInstancesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeDBInstancesResult {
...
fun AmazonRDSFunctions.describeDBLogFiles(dBInstanceIdentifier: String, init: (AmazonRDSDescribeDBLogFilesCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeDBLogFilesResult {
	return this.block.declare(AmazonRDSDescribeDBLogFilesCommand(dBInstanceIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeDBLogFilesResult
}
...
class AmazonRDSDescribeDBLogFilesCommand(val dBInstanceIdentifier: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeDBLogFilesRequest, com.amazonaws.services.rds.model.DescribeDBLogFilesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeDBLogFilesResult {
...
fun AmazonRDSFunctions.describeDBParameterGroups(init: (AmazonRDSDescribeDBParameterGroupsCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeDBParameterGroupsResult {
	return this.block.declare(AmazonRDSDescribeDBParameterGroupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeDBParameterGroupsResult
}
...
class AmazonRDSDescribeDBParameterGroupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeDBParameterGroupsRequest, com.amazonaws.services.rds.model.DescribeDBParameterGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeDBParameterGroupsResult {
...
fun AmazonRDSFunctions.describeDBParameters(dBParameterGroupName: String, init: (AmazonRDSDescribeDBParametersCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeDBParametersResult {
	return this.block.declare(AmazonRDSDescribeDBParametersCommand(dBParameterGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeDBParametersResult
}
...
class AmazonRDSDescribeDBParametersCommand(val dBParameterGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeDBParametersRequest, com.amazonaws.services.rds.model.DescribeDBParametersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeDBParametersResult {
...
fun AmazonRDSFunctions.describeDBSecurityGroups(init: (AmazonRDSDescribeDBSecurityGroupsCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeDBSecurityGroupsResult {
	return this.block.declare(AmazonRDSDescribeDBSecurityGroupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeDBSecurityGroupsResult
}
...
class AmazonRDSDescribeDBSecurityGroupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeDBSecurityGroupsRequest, com.amazonaws.services.rds.model.DescribeDBSecurityGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeDBSecurityGroupsResult {
...
fun AmazonRDSFunctions.describeDBSnapshotAttributes(dBSnapshotIdentifier: String, init: (AmazonRDSDescribeDBSnapshotAttributesCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBSnapshotAttributesResult {
	return this.block.declare(AmazonRDSDescribeDBSnapshotAttributesCommand(dBSnapshotIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBSnapshotAttributesResult
}
...
class AmazonRDSDescribeDBSnapshotAttributesCommand(val dBSnapshotIdentifier: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeDBSnapshotAttributesRequest, com.amazonaws.services.rds.model.DBSnapshotAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DBSnapshotAttributesResult {
...
fun AmazonRDSFunctions.describeDBSnapshots(init: (AmazonRDSDescribeDBSnapshotsCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeDBSnapshotsResult {
	return this.block.declare(AmazonRDSDescribeDBSnapshotsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeDBSnapshotsResult
}
...
class AmazonRDSDescribeDBSnapshotsCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeDBSnapshotsRequest, com.amazonaws.services.rds.model.DescribeDBSnapshotsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeDBSnapshotsResult {
...
fun AmazonRDSFunctions.describeDBSubnetGroups(init: (AmazonRDSDescribeDBSubnetGroupsCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeDBSubnetGroupsResult {
	return this.block.declare(AmazonRDSDescribeDBSubnetGroupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeDBSubnetGroupsResult
}
...
class AmazonRDSDescribeDBSubnetGroupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeDBSubnetGroupsRequest, com.amazonaws.services.rds.model.DescribeDBSubnetGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeDBSubnetGroupsResult {
...
fun AmazonRDSFunctions.describeEngineDefaultClusterParameters(dBParameterGroupFamily: String, init: (AmazonRDSDescribeEngineDefaultClusterParametersCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.EngineDefaults {
	return this.block.declare(AmazonRDSDescribeEngineDefaultClusterParametersCommand(dBParameterGroupFamily).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.EngineDefaults
}
...
class AmazonRDSDescribeEngineDefaultClusterParametersCommand(val dBParameterGroupFamily: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeEngineDefaultClusterParametersRequest, com.amazonaws.services.rds.model.EngineDefaults> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.EngineDefaults {
...
fun AmazonRDSFunctions.describeEngineDefaultParameters(dBParameterGroupFamily: String, init: (AmazonRDSDescribeEngineDefaultParametersCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.EngineDefaults {
	return this.block.declare(AmazonRDSDescribeEngineDefaultParametersCommand(dBParameterGroupFamily).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.EngineDefaults
}
...
fun AmazonRDSFunctions.describeEventCategories(init: (AmazonRDSDescribeEventCategoriesCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeEventCategoriesResult {
	return this.block.declare(AmazonRDSDescribeEventCategoriesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeEventCategoriesResult
}
...
class AmazonRDSDescribeEventCategoriesCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeEventCategoriesRequest, com.amazonaws.services.rds.model.DescribeEventCategoriesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeEventCategoriesResult {
...
fun AmazonRDSFunctions.describeEventSubscriptions(init: (AmazonRDSDescribeEventSubscriptionsCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeEventSubscriptionsResult {
	return this.block.declare(AmazonRDSDescribeEventSubscriptionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeEventSubscriptionsResult
}
...
class AmazonRDSDescribeEventSubscriptionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeEventSubscriptionsRequest, com.amazonaws.services.rds.model.DescribeEventSubscriptionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeEventSubscriptionsResult {
...
fun AmazonRDSFunctions.describeEvents(init: (AmazonRDSDescribeEventsCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeEventsResult {
	return this.block.declare(AmazonRDSDescribeEventsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeEventsResult
}
...
class AmazonRDSDescribeEventsCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeEventsRequest, com.amazonaws.services.rds.model.DescribeEventsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeEventsResult {
...
fun AmazonRDSFunctions.describeOptionGroupOptions(engineName: String, init: (AmazonRDSDescribeOptionGroupOptionsCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeOptionGroupOptionsResult {
	return this.block.declare(AmazonRDSDescribeOptionGroupOptionsCommand(engineName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeOptionGroupOptionsResult
}
...
class AmazonRDSDescribeOptionGroupOptionsCommand(val engineName: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeOptionGroupOptionsRequest, com.amazonaws.services.rds.model.DescribeOptionGroupOptionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeOptionGroupOptionsResult {
...
fun AmazonRDSFunctions.describeOptionGroups(init: (AmazonRDSDescribeOptionGroupsCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeOptionGroupsResult {
	return this.block.declare(AmazonRDSDescribeOptionGroupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeOptionGroupsResult
}
...
class AmazonRDSDescribeOptionGroupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeOptionGroupsRequest, com.amazonaws.services.rds.model.DescribeOptionGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeOptionGroupsResult {
...
fun AmazonRDSFunctions.describeOrderableDBInstanceOptions(engine: String, init: (AmazonRDSDescribeOrderableDBInstanceOptionsCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeOrderableDBInstanceOptionsResult {
	return this.block.declare(AmazonRDSDescribeOrderableDBInstanceOptionsCommand(engine).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeOrderableDBInstanceOptionsResult
}
...
class AmazonRDSDescribeOrderableDBInstanceOptionsCommand(val engine: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeOrderableDBInstanceOptionsRequest, com.amazonaws.services.rds.model.DescribeOrderableDBInstanceOptionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeOrderableDBInstanceOptionsResult {
...
fun AmazonRDSFunctions.describePendingMaintenanceActions(init: (AmazonRDSDescribePendingMaintenanceActionsCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribePendingMaintenanceActionsResult {
	return this.block.declare(AmazonRDSDescribePendingMaintenanceActionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribePendingMaintenanceActionsResult
}
...
class AmazonRDSDescribePendingMaintenanceActionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribePendingMaintenanceActionsRequest, com.amazonaws.services.rds.model.DescribePendingMaintenanceActionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribePendingMaintenanceActionsResult {
...
fun AmazonRDSFunctions.describeReservedDBInstances(init: (AmazonRDSDescribeReservedDBInstancesCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeReservedDBInstancesResult {
	return this.block.declare(AmazonRDSDescribeReservedDBInstancesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeReservedDBInstancesResult
}
...
class AmazonRDSDescribeReservedDBInstancesCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeReservedDBInstancesRequest, com.amazonaws.services.rds.model.DescribeReservedDBInstancesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeReservedDBInstancesResult {
...
fun AmazonRDSFunctions.describeReservedDBInstancesOfferings(init: (AmazonRDSDescribeReservedDBInstancesOfferingsCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeReservedDBInstancesOfferingsResult {
	return this.block.declare(AmazonRDSDescribeReservedDBInstancesOfferingsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeReservedDBInstancesOfferingsResult
}
...
class AmazonRDSDescribeReservedDBInstancesOfferingsCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeReservedDBInstancesOfferingsRequest, com.amazonaws.services.rds.model.DescribeReservedDBInstancesOfferingsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeReservedDBInstancesOfferingsResult {
...
fun AmazonRDSFunctions.describeSourceRegions(init: (AmazonRDSDescribeSourceRegionsCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DescribeSourceRegionsResult {
	return this.block.declare(AmazonRDSDescribeSourceRegionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DescribeSourceRegionsResult
}
...
class AmazonRDSDescribeSourceRegionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeSourceRegionsRequest, com.amazonaws.services.rds.model.DescribeSourceRegionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DescribeSourceRegionsResult {
...
fun AmazonRDSFunctions.describeValidDBInstanceModifications(dBInstanceIdentifier: String, init: (AmazonRDSDescribeValidDBInstanceModificationsCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.ValidDBInstanceModificationsMessage {
	return this.block.declare(AmazonRDSDescribeValidDBInstanceModificationsCommand(dBInstanceIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.ValidDBInstanceModificationsMessage
}
...
class AmazonRDSDescribeValidDBInstanceModificationsCommand(val dBInstanceIdentifier: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DescribeValidDBInstanceModificationsRequest, com.amazonaws.services.rds.model.ValidDBInstanceModificationsMessage> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.ValidDBInstanceModificationsMessage {
...
fun AmazonRDSFunctions.downloadDBLogFilePortion(dBInstanceIdentifier: String, logFileName: String, init: (AmazonRDSDownloadDBLogFilePortionCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DownloadDBLogFilePortionResult {
	return this.block.declare(AmazonRDSDownloadDBLogFilePortionCommand(dBInstanceIdentifier, logFileName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DownloadDBLogFilePortionResult
}
...
class AmazonRDSDownloadDBLogFilePortionCommand(val dBInstanceIdentifier: String, val logFileName: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.DownloadDBLogFilePortionRequest, com.amazonaws.services.rds.model.DownloadDBLogFilePortionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.DownloadDBLogFilePortionResult {
...
fun AmazonRDSFunctions.failoverDBCluster(init: (AmazonRDSFailoverDBClusterCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBCluster {
	return this.block.declare(AmazonRDSFailoverDBClusterCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBCluster
}
...
fun AmazonRDSFunctions.listTagsForResource(resourceName: String, init: (AmazonRDSListTagsForResourceCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.ListTagsForResourceResult {
	return this.block.declare(AmazonRDSListTagsForResourceCommand(resourceName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.ListTagsForResourceResult
}
...
class AmazonRDSListTagsForResourceCommand(val resourceName: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.ListTagsForResourceRequest, com.amazonaws.services.rds.model.ListTagsForResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.ListTagsForResourceResult {
...
fun AmazonRDSFunctions.modifyDBCluster(dBClusterIdentifier: String, init: (AmazonRDSModifyDBClusterCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBCluster {
	return this.block.declare(AmazonRDSModifyDBClusterCommand(dBClusterIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBCluster
}
...
fun AmazonRDSFunctions.modifyDBClusterParameterGroup(dBClusterParameterGroupName: String, parameters: List<com.amazonaws.services.rds.model.Parameter>, init: (AmazonRDSModifyDBClusterParameterGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.ModifyDBClusterParameterGroupResult {
	return this.block.declare(AmazonRDSModifyDBClusterParameterGroupCommand(dBClusterParameterGroupName, parameters).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.ModifyDBClusterParameterGroupResult
}
...
class AmazonRDSModifyDBClusterParameterGroupCommand(val dBClusterParameterGroupName: String, val parameters: List<com.amazonaws.services.rds.model.Parameter>) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.ModifyDBClusterParameterGroupRequest, com.amazonaws.services.rds.model.ModifyDBClusterParameterGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.ModifyDBClusterParameterGroupResult {
...
fun AmazonRDSFunctions.modifyDBClusterSnapshotAttribute(dBClusterSnapshotIdentifier: String, attributeName: String, init: (AmazonRDSModifyDBClusterSnapshotAttributeCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBClusterSnapshotAttributesResult {
	return this.block.declare(AmazonRDSModifyDBClusterSnapshotAttributeCommand(dBClusterSnapshotIdentifier, attributeName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBClusterSnapshotAttributesResult
}
...
fun AmazonRDSFunctions.modifyDBInstance(dBInstanceIdentifier: String, init: (AmazonRDSModifyDBInstanceCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBInstance {
	return this.block.declare(AmazonRDSModifyDBInstanceCommand(dBInstanceIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBInstance
}
...
fun AmazonRDSFunctions.modifyDBParameterGroup(dBParameterGroupName: String, parameters: List<com.amazonaws.services.rds.model.Parameter>, init: (AmazonRDSModifyDBParameterGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.ModifyDBParameterGroupResult {
	return this.block.declare(AmazonRDSModifyDBParameterGroupCommand(dBParameterGroupName, parameters).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.ModifyDBParameterGroupResult
}
...
class AmazonRDSModifyDBParameterGroupCommand(val dBParameterGroupName: String, val parameters: List<com.amazonaws.services.rds.model.Parameter>) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.ModifyDBParameterGroupRequest, com.amazonaws.services.rds.model.ModifyDBParameterGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.ModifyDBParameterGroupResult {
...
fun AmazonRDSFunctions.modifyDBSnapshot(dBSnapshotIdentifier: String, init: (AmazonRDSModifyDBSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBSnapshot {
	return this.block.declare(AmazonRDSModifyDBSnapshotCommand(dBSnapshotIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBSnapshot
}
...
fun AmazonRDSFunctions.modifyDBSnapshotAttribute(dBSnapshotIdentifier: String, attributeName: String, init: (AmazonRDSModifyDBSnapshotAttributeCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBSnapshotAttributesResult {
	return this.block.declare(AmazonRDSModifyDBSnapshotAttributeCommand(dBSnapshotIdentifier, attributeName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBSnapshotAttributesResult
}
...
fun AmazonRDSFunctions.modifyDBSubnetGroup(dBSubnetGroupName: String, subnetIds: List<String>, init: (AmazonRDSModifyDBSubnetGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBSubnetGroup {
	return this.block.declare(AmazonRDSModifyDBSubnetGroupCommand(dBSubnetGroupName, subnetIds).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBSubnetGroup
}
...
fun AmazonRDSFunctions.modifyEventSubscription(subscriptionName: String, init: (AmazonRDSModifyEventSubscriptionCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.EventSubscription {
	return this.block.declare(AmazonRDSModifyEventSubscriptionCommand(subscriptionName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.EventSubscription
}
...
fun AmazonRDSFunctions.modifyOptionGroup(optionGroupName: String, init: (AmazonRDSModifyOptionGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.OptionGroup {
	return this.block.declare(AmazonRDSModifyOptionGroupCommand(optionGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.OptionGroup
}
...
fun AmazonRDSFunctions.promoteReadReplica(dBInstanceIdentifier: String, init: (AmazonRDSPromoteReadReplicaCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBInstance {
	return this.block.declare(AmazonRDSPromoteReadReplicaCommand(dBInstanceIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBInstance
}
...
fun AmazonRDSFunctions.promoteReadReplicaDBCluster(dBClusterIdentifier: String, init: (AmazonRDSPromoteReadReplicaDBClusterCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBCluster {
	return this.block.declare(AmazonRDSPromoteReadReplicaDBClusterCommand(dBClusterIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBCluster
}
...
fun AmazonRDSFunctions.purchaseReservedDBInstancesOffering(reservedDBInstancesOfferingId: String, init: (AmazonRDSPurchaseReservedDBInstancesOfferingCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.ReservedDBInstance {
	return this.block.declare(AmazonRDSPurchaseReservedDBInstancesOfferingCommand(reservedDBInstancesOfferingId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.ReservedDBInstance
}
...
class AmazonRDSPurchaseReservedDBInstancesOfferingCommand(val reservedDBInstancesOfferingId: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.PurchaseReservedDBInstancesOfferingRequest, com.amazonaws.services.rds.model.ReservedDBInstance> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.ReservedDBInstance {
...
fun AmazonRDSFunctions.rebootDBInstance(dBInstanceIdentifier: String, init: (AmazonRDSRebootDBInstanceCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBInstance {
	return this.block.declare(AmazonRDSRebootDBInstanceCommand(dBInstanceIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBInstance
}
...
fun AmazonRDSFunctions.removeRoleFromDBCluster(dBClusterIdentifier: String, roleArn: String, init: (AmazonRDSRemoveRoleFromDBClusterCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.RemoveRoleFromDBClusterResult {
	return this.block.declare(AmazonRDSRemoveRoleFromDBClusterCommand(dBClusterIdentifier, roleArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.RemoveRoleFromDBClusterResult
}
...
class AmazonRDSRemoveRoleFromDBClusterCommand(val dBClusterIdentifier: String, val roleArn: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.RemoveRoleFromDBClusterRequest, com.amazonaws.services.rds.model.RemoveRoleFromDBClusterResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.RemoveRoleFromDBClusterResult {
...
fun AmazonRDSFunctions.removeSourceIdentifierFromSubscription(subscriptionName: String, sourceIdentifier: String, init: (AmazonRDSRemoveSourceIdentifierFromSubscriptionCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.EventSubscription {
	return this.block.declare(AmazonRDSRemoveSourceIdentifierFromSubscriptionCommand(subscriptionName, sourceIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.EventSubscription
}
...
fun AmazonRDSFunctions.removeTagsFromResource(resourceName: String, tagKeys: List<String>, init: (AmazonRDSRemoveTagsFromResourceCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.RemoveTagsFromResourceResult {
	return this.block.declare(AmazonRDSRemoveTagsFromResourceCommand(resourceName, tagKeys).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.RemoveTagsFromResourceResult
}
...
class AmazonRDSRemoveTagsFromResourceCommand(val resourceName: String, val tagKeys: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.RemoveTagsFromResourceRequest, com.amazonaws.services.rds.model.RemoveTagsFromResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.RemoveTagsFromResourceResult {
...
fun AmazonRDSFunctions.resetDBClusterParameterGroup(dBClusterParameterGroupName: String, init: (AmazonRDSResetDBClusterParameterGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.ResetDBClusterParameterGroupResult {
	return this.block.declare(AmazonRDSResetDBClusterParameterGroupCommand(dBClusterParameterGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.ResetDBClusterParameterGroupResult
}
...
class AmazonRDSResetDBClusterParameterGroupCommand(val dBClusterParameterGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.ResetDBClusterParameterGroupRequest, com.amazonaws.services.rds.model.ResetDBClusterParameterGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.ResetDBClusterParameterGroupResult {
...
fun AmazonRDSFunctions.resetDBParameterGroup(dBParameterGroupName: String, init: (AmazonRDSResetDBParameterGroupCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.ResetDBParameterGroupResult {
	return this.block.declare(AmazonRDSResetDBParameterGroupCommand(dBParameterGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.ResetDBParameterGroupResult
}
...
class AmazonRDSResetDBParameterGroupCommand(val dBParameterGroupName: String) : AmazonWebServiceCommand<com.amazonaws.services.rds.model.ResetDBParameterGroupRequest, com.amazonaws.services.rds.model.ResetDBParameterGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.rds.model.ResetDBParameterGroupResult {
...
fun AmazonRDSFunctions.restoreDBClusterFromS3(dBClusterIdentifier: String, engine: String, masterUsername: String, masterUserPassword: String, sourceEngine: String, sourceEngineVersion: String, s3BucketName: String, s3IngestionRoleArn: String, init: (AmazonRDSRestoreDBClusterFromS3Command.() -> Unit)? = null): com.amazonaws.services.rds.model.DBCluster {
	return this.block.declare(AmazonRDSRestoreDBClusterFromS3Command(dBClusterIdentifier, engine, masterUsername, masterUserPassword, sourceEngine, sourceEngineVersion, s3BucketName, s3IngestionRoleArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBCluster
}
...
fun AmazonRDSFunctions.restoreDBClusterFromSnapshot(dBClusterIdentifier: String, snapshotIdentifier: String, engine: String, init: (AmazonRDSRestoreDBClusterFromSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBCluster {
	return this.block.declare(AmazonRDSRestoreDBClusterFromSnapshotCommand(dBClusterIdentifier, snapshotIdentifier, engine).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBCluster
}
...
fun AmazonRDSFunctions.restoreDBClusterToPointInTime(dBClusterIdentifier: String, sourceDBClusterIdentifier: String, init: (AmazonRDSRestoreDBClusterToPointInTimeCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBCluster {
	return this.block.declare(AmazonRDSRestoreDBClusterToPointInTimeCommand(dBClusterIdentifier, sourceDBClusterIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBCluster
}
...
fun AmazonRDSFunctions.restoreDBInstanceFromDBSnapshot(dBInstanceIdentifier: String, dBSnapshotIdentifier: String, init: (AmazonRDSRestoreDBInstanceFromDBSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBInstance {
	return this.block.declare(AmazonRDSRestoreDBInstanceFromDBSnapshotCommand(dBInstanceIdentifier, dBSnapshotIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBInstance
}
...
fun AmazonRDSFunctions.restoreDBInstanceFromS3(dBInstanceIdentifier: String, dBInstanceClass: String, engine: String, sourceEngine: String, sourceEngineVersion: String, s3BucketName: String, s3IngestionRoleArn: String, init: (AmazonRDSRestoreDBInstanceFromS3Command.() -> Unit)? = null): com.amazonaws.services.rds.model.DBInstance {
	return this.block.declare(AmazonRDSRestoreDBInstanceFromS3Command(dBInstanceIdentifier, dBInstanceClass, engine, sourceEngine, sourceEngineVersion, s3BucketName, s3IngestionRoleArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBInstance
}
...
fun AmazonRDSFunctions.restoreDBInstanceToPointInTime(sourceDBInstanceIdentifier: String, targetDBInstanceIdentifier: String, init: (AmazonRDSRestoreDBInstanceToPointInTimeCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBInstance {
	return this.block.declare(AmazonRDSRestoreDBInstanceToPointInTimeCommand(sourceDBInstanceIdentifier, targetDBInstanceIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBInstance
}
...
fun AmazonRDSFunctions.revokeDBSecurityGroupIngress(dBSecurityGroupName: String, init: (AmazonRDSRevokeDBSecurityGroupIngressCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBSecurityGroup {
	return this.block.declare(AmazonRDSRevokeDBSecurityGroupIngressCommand(dBSecurityGroupName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBSecurityGroup
}
...
fun AmazonRDSFunctions.startDBInstance(dBInstanceIdentifier: String, init: (AmazonRDSStartDBInstanceCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBInstance {
	return this.block.declare(AmazonRDSStartDBInstanceCommand(dBInstanceIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBInstance
}
...
fun AmazonRDSFunctions.stopDBInstance(dBInstanceIdentifier: String, init: (AmazonRDSStopDBInstanceCommand.() -> Unit)? = null): com.amazonaws.services.rds.model.DBInstance {
	return this.block.declare(AmazonRDSStopDBInstanceCommand(dBInstanceIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.rds.model.DBInstance
}
