...
package com.codingue.koops.aws.events
...
var com.codingue.koops.core.Environment.events: AmazonCloudWatchEvents
	get() {
...
fun AmazonCloudWatchEventsFunctions.deleteRule(name: String, init: (AmazonCloudWatchEventsDeleteRuleCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatchevents.model.DeleteRuleResult {
	return this.block.declare(AmazonCloudWatchEventsDeleteRuleCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatchevents.model.DeleteRuleResult
}
...
class AmazonCloudWatchEventsDeleteRuleCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatchevents.model.DeleteRuleRequest, com.amazonaws.services.cloudwatchevents.model.DeleteRuleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatchevents.model.DeleteRuleResult {
...
fun AmazonCloudWatchEventsFunctions.describeEventBus(init: (AmazonCloudWatchEventsDescribeEventBusCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatchevents.model.DescribeEventBusResult {
	return this.block.declare(AmazonCloudWatchEventsDescribeEventBusCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatchevents.model.DescribeEventBusResult
}
...
class AmazonCloudWatchEventsDescribeEventBusCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudwatchevents.model.DescribeEventBusRequest, com.amazonaws.services.cloudwatchevents.model.DescribeEventBusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatchevents.model.DescribeEventBusResult {
...
fun AmazonCloudWatchEventsFunctions.describeRule(name: String, init: (AmazonCloudWatchEventsDescribeRuleCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatchevents.model.DescribeRuleResult {
	return this.block.declare(AmazonCloudWatchEventsDescribeRuleCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatchevents.model.DescribeRuleResult
}
...
class AmazonCloudWatchEventsDescribeRuleCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatchevents.model.DescribeRuleRequest, com.amazonaws.services.cloudwatchevents.model.DescribeRuleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatchevents.model.DescribeRuleResult {
...
fun AmazonCloudWatchEventsFunctions.disableRule(name: String, init: (AmazonCloudWatchEventsDisableRuleCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatchevents.model.DisableRuleResult {
	return this.block.declare(AmazonCloudWatchEventsDisableRuleCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatchevents.model.DisableRuleResult
}
...
class AmazonCloudWatchEventsDisableRuleCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatchevents.model.DisableRuleRequest, com.amazonaws.services.cloudwatchevents.model.DisableRuleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatchevents.model.DisableRuleResult {
...
fun AmazonCloudWatchEventsFunctions.enableRule(name: String, init: (AmazonCloudWatchEventsEnableRuleCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatchevents.model.EnableRuleResult {
	return this.block.declare(AmazonCloudWatchEventsEnableRuleCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatchevents.model.EnableRuleResult
}
...
class AmazonCloudWatchEventsEnableRuleCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatchevents.model.EnableRuleRequest, com.amazonaws.services.cloudwatchevents.model.EnableRuleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatchevents.model.EnableRuleResult {
...
fun AmazonCloudWatchEventsFunctions.listRuleNamesByTarget(targetArn: String, init: (AmazonCloudWatchEventsListRuleNamesByTargetCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatchevents.model.ListRuleNamesByTargetResult {
	return this.block.declare(AmazonCloudWatchEventsListRuleNamesByTargetCommand(targetArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatchevents.model.ListRuleNamesByTargetResult
}
...
class AmazonCloudWatchEventsListRuleNamesByTargetCommand(val targetArn: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatchevents.model.ListRuleNamesByTargetRequest, com.amazonaws.services.cloudwatchevents.model.ListRuleNamesByTargetResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatchevents.model.ListRuleNamesByTargetResult {
...
fun AmazonCloudWatchEventsFunctions.listRules(init: (AmazonCloudWatchEventsListRulesCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatchevents.model.ListRulesResult {
	return this.block.declare(AmazonCloudWatchEventsListRulesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatchevents.model.ListRulesResult
}
...
class AmazonCloudWatchEventsListRulesCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudwatchevents.model.ListRulesRequest, com.amazonaws.services.cloudwatchevents.model.ListRulesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatchevents.model.ListRulesResult {
...
fun AmazonCloudWatchEventsFunctions.listTargetsByRule(rule: String, init: (AmazonCloudWatchEventsListTargetsByRuleCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatchevents.model.ListTargetsByRuleResult {
	return this.block.declare(AmazonCloudWatchEventsListTargetsByRuleCommand(rule).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatchevents.model.ListTargetsByRuleResult
}
...
class AmazonCloudWatchEventsListTargetsByRuleCommand(val rule: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatchevents.model.ListTargetsByRuleRequest, com.amazonaws.services.cloudwatchevents.model.ListTargetsByRuleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatchevents.model.ListTargetsByRuleResult {
...
fun AmazonCloudWatchEventsFunctions.putEvents(entries: List<com.amazonaws.services.cloudwatchevents.model.PutEventsRequestEntry>, init: (AmazonCloudWatchEventsPutEventsCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatchevents.model.PutEventsResult {
	return this.block.declare(AmazonCloudWatchEventsPutEventsCommand(entries).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatchevents.model.PutEventsResult
}
...
class AmazonCloudWatchEventsPutEventsCommand(val entries: List<com.amazonaws.services.cloudwatchevents.model.PutEventsRequestEntry>) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatchevents.model.PutEventsRequest, com.amazonaws.services.cloudwatchevents.model.PutEventsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatchevents.model.PutEventsResult {
...
fun AmazonCloudWatchEventsFunctions.putPermission(action: String, principal: String, statementId: String, init: (AmazonCloudWatchEventsPutPermissionCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatchevents.model.PutPermissionResult {
	return this.block.declare(AmazonCloudWatchEventsPutPermissionCommand(action, principal, statementId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatchevents.model.PutPermissionResult
}
...
class AmazonCloudWatchEventsPutPermissionCommand(val action: String, val principal: String, val statementId: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatchevents.model.PutPermissionRequest, com.amazonaws.services.cloudwatchevents.model.PutPermissionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatchevents.model.PutPermissionResult {
...
fun AmazonCloudWatchEventsFunctions.putRule(name: String, init: (AmazonCloudWatchEventsPutRuleCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatchevents.model.PutRuleResult {
	return this.block.declare(AmazonCloudWatchEventsPutRuleCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatchevents.model.PutRuleResult
}
...
class AmazonCloudWatchEventsPutRuleCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatchevents.model.PutRuleRequest, com.amazonaws.services.cloudwatchevents.model.PutRuleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatchevents.model.PutRuleResult {
...
fun AmazonCloudWatchEventsFunctions.putTargets(rule: String, targets: List<com.amazonaws.services.cloudwatchevents.model.Target>, init: (AmazonCloudWatchEventsPutTargetsCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatchevents.model.PutTargetsResult {
	return this.block.declare(AmazonCloudWatchEventsPutTargetsCommand(rule, targets).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatchevents.model.PutTargetsResult
}
...
class AmazonCloudWatchEventsPutTargetsCommand(val rule: String, val targets: List<com.amazonaws.services.cloudwatchevents.model.Target>) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatchevents.model.PutTargetsRequest, com.amazonaws.services.cloudwatchevents.model.PutTargetsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatchevents.model.PutTargetsResult {
...
fun AmazonCloudWatchEventsFunctions.removePermission(statementId: String, init: (AmazonCloudWatchEventsRemovePermissionCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatchevents.model.RemovePermissionResult {
	return this.block.declare(AmazonCloudWatchEventsRemovePermissionCommand(statementId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatchevents.model.RemovePermissionResult
}
...
class AmazonCloudWatchEventsRemovePermissionCommand(val statementId: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatchevents.model.RemovePermissionRequest, com.amazonaws.services.cloudwatchevents.model.RemovePermissionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatchevents.model.RemovePermissionResult {
...
fun AmazonCloudWatchEventsFunctions.removeTargets(rule: String, ids: List<String>, init: (AmazonCloudWatchEventsRemoveTargetsCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatchevents.model.RemoveTargetsResult {
	return this.block.declare(AmazonCloudWatchEventsRemoveTargetsCommand(rule, ids).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatchevents.model.RemoveTargetsResult
}
...
class AmazonCloudWatchEventsRemoveTargetsCommand(val rule: String, val ids: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatchevents.model.RemoveTargetsRequest, com.amazonaws.services.cloudwatchevents.model.RemoveTargetsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatchevents.model.RemoveTargetsResult {
...
fun AmazonCloudWatchEventsFunctions.testEventPattern(eventPattern: String, event: String, init: (AmazonCloudWatchEventsTestEventPatternCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatchevents.model.TestEventPatternResult {
	return this.block.declare(AmazonCloudWatchEventsTestEventPatternCommand(eventPattern, event).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatchevents.model.TestEventPatternResult
}
...
class AmazonCloudWatchEventsTestEventPatternCommand(val eventPattern: String, val event: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatchevents.model.TestEventPatternRequest, com.amazonaws.services.cloudwatchevents.model.TestEventPatternResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatchevents.model.TestEventPatternResult {
