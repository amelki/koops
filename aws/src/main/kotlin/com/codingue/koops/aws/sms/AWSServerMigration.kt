...
package com.codingue.koops.aws.sms
...
var com.codingue.koops.core.Environment.sms: AWSServerMigration
	get() {
...
fun AWSServerMigrationFunctions.createReplicationJob(init: (AWSServerMigrationCreateReplicationJobCommand.() -> Unit)? = null): com.amazonaws.services.servermigration.model.CreateReplicationJobResult {
	return this.block.declare(AWSServerMigrationCreateReplicationJobCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servermigration.model.CreateReplicationJobResult
}
...
class AWSServerMigrationCreateReplicationJobCommand() : AmazonWebServiceCommand<com.amazonaws.services.servermigration.model.CreateReplicationJobRequest, com.amazonaws.services.servermigration.model.CreateReplicationJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servermigration.model.CreateReplicationJobResult {
...
fun AWSServerMigrationFunctions.deleteReplicationJob(init: (AWSServerMigrationDeleteReplicationJobCommand.() -> Unit)? = null): com.amazonaws.services.servermigration.model.DeleteReplicationJobResult {
	return this.block.declare(AWSServerMigrationDeleteReplicationJobCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servermigration.model.DeleteReplicationJobResult
}
...
class AWSServerMigrationDeleteReplicationJobCommand() : AmazonWebServiceCommand<com.amazonaws.services.servermigration.model.DeleteReplicationJobRequest, com.amazonaws.services.servermigration.model.DeleteReplicationJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servermigration.model.DeleteReplicationJobResult {
...
fun AWSServerMigrationFunctions.deleteServerCatalog(init: (AWSServerMigrationDeleteServerCatalogCommand.() -> Unit)? = null): com.amazonaws.services.servermigration.model.DeleteServerCatalogResult {
	return this.block.declare(AWSServerMigrationDeleteServerCatalogCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servermigration.model.DeleteServerCatalogResult
}
...
class AWSServerMigrationDeleteServerCatalogCommand() : AmazonWebServiceCommand<com.amazonaws.services.servermigration.model.DeleteServerCatalogRequest, com.amazonaws.services.servermigration.model.DeleteServerCatalogResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servermigration.model.DeleteServerCatalogResult {
...
fun AWSServerMigrationFunctions.disassociateConnector(init: (AWSServerMigrationDisassociateConnectorCommand.() -> Unit)? = null): com.amazonaws.services.servermigration.model.DisassociateConnectorResult {
	return this.block.declare(AWSServerMigrationDisassociateConnectorCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servermigration.model.DisassociateConnectorResult
}
...
class AWSServerMigrationDisassociateConnectorCommand() : AmazonWebServiceCommand<com.amazonaws.services.servermigration.model.DisassociateConnectorRequest, com.amazonaws.services.servermigration.model.DisassociateConnectorResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servermigration.model.DisassociateConnectorResult {
...
fun AWSServerMigrationFunctions.getConnectors(init: (AWSServerMigrationGetConnectorsCommand.() -> Unit)? = null): com.amazonaws.services.servermigration.model.GetConnectorsResult {
	return this.block.declare(AWSServerMigrationGetConnectorsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servermigration.model.GetConnectorsResult
}
...
class AWSServerMigrationGetConnectorsCommand() : AmazonWebServiceCommand<com.amazonaws.services.servermigration.model.GetConnectorsRequest, com.amazonaws.services.servermigration.model.GetConnectorsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servermigration.model.GetConnectorsResult {
...
fun AWSServerMigrationFunctions.getReplicationJobs(init: (AWSServerMigrationGetReplicationJobsCommand.() -> Unit)? = null): com.amazonaws.services.servermigration.model.GetReplicationJobsResult {
	return this.block.declare(AWSServerMigrationGetReplicationJobsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servermigration.model.GetReplicationJobsResult
}
...
class AWSServerMigrationGetReplicationJobsCommand() : AmazonWebServiceCommand<com.amazonaws.services.servermigration.model.GetReplicationJobsRequest, com.amazonaws.services.servermigration.model.GetReplicationJobsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servermigration.model.GetReplicationJobsResult {
...
fun AWSServerMigrationFunctions.getReplicationRuns(init: (AWSServerMigrationGetReplicationRunsCommand.() -> Unit)? = null): com.amazonaws.services.servermigration.model.GetReplicationRunsResult {
	return this.block.declare(AWSServerMigrationGetReplicationRunsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servermigration.model.GetReplicationRunsResult
}
...
class AWSServerMigrationGetReplicationRunsCommand() : AmazonWebServiceCommand<com.amazonaws.services.servermigration.model.GetReplicationRunsRequest, com.amazonaws.services.servermigration.model.GetReplicationRunsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servermigration.model.GetReplicationRunsResult {
...
fun AWSServerMigrationFunctions.getServers(init: (AWSServerMigrationGetServersCommand.() -> Unit)? = null): com.amazonaws.services.servermigration.model.GetServersResult {
	return this.block.declare(AWSServerMigrationGetServersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servermigration.model.GetServersResult
}
...
class AWSServerMigrationGetServersCommand() : AmazonWebServiceCommand<com.amazonaws.services.servermigration.model.GetServersRequest, com.amazonaws.services.servermigration.model.GetServersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servermigration.model.GetServersResult {
...
fun AWSServerMigrationFunctions.importServerCatalog(init: (AWSServerMigrationImportServerCatalogCommand.() -> Unit)? = null): com.amazonaws.services.servermigration.model.ImportServerCatalogResult {
	return this.block.declare(AWSServerMigrationImportServerCatalogCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servermigration.model.ImportServerCatalogResult
}
...
class AWSServerMigrationImportServerCatalogCommand() : AmazonWebServiceCommand<com.amazonaws.services.servermigration.model.ImportServerCatalogRequest, com.amazonaws.services.servermigration.model.ImportServerCatalogResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servermigration.model.ImportServerCatalogResult {
...
fun AWSServerMigrationFunctions.startOnDemandReplicationRun(init: (AWSServerMigrationStartOnDemandReplicationRunCommand.() -> Unit)? = null): com.amazonaws.services.servermigration.model.StartOnDemandReplicationRunResult {
	return this.block.declare(AWSServerMigrationStartOnDemandReplicationRunCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servermigration.model.StartOnDemandReplicationRunResult
}
...
class AWSServerMigrationStartOnDemandReplicationRunCommand() : AmazonWebServiceCommand<com.amazonaws.services.servermigration.model.StartOnDemandReplicationRunRequest, com.amazonaws.services.servermigration.model.StartOnDemandReplicationRunResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servermigration.model.StartOnDemandReplicationRunResult {
...
fun AWSServerMigrationFunctions.updateReplicationJob(init: (AWSServerMigrationUpdateReplicationJobCommand.() -> Unit)? = null): com.amazonaws.services.servermigration.model.UpdateReplicationJobResult {
	return this.block.declare(AWSServerMigrationUpdateReplicationJobCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servermigration.model.UpdateReplicationJobResult
}
...
class AWSServerMigrationUpdateReplicationJobCommand() : AmazonWebServiceCommand<com.amazonaws.services.servermigration.model.UpdateReplicationJobRequest, com.amazonaws.services.servermigration.model.UpdateReplicationJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servermigration.model.UpdateReplicationJobResult {
