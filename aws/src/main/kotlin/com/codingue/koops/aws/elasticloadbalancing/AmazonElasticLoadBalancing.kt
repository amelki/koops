...
package com.codingue.koops.aws.elasticloadbalancing
...
fun AmazonElasticLoadBalancingFunctions.addTags(loadBalancerNames: List<String>, tags: List<com.amazonaws.services.elasticloadbalancing.model.Tag>, init: (AmazonElasticLoadBalancingAddTagsCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.AddTagsResult {
	return this.block.declare(AmazonElasticLoadBalancingAddTagsCommand(loadBalancerNames, tags).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.AddTagsResult
}
...
class AmazonElasticLoadBalancingAddTagsCommand(val loadBalancerNames: List<String>, val tags: List<com.amazonaws.services.elasticloadbalancing.model.Tag>) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.AddTagsRequest, com.amazonaws.services.elasticloadbalancing.model.AddTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.AddTagsResult {
...
fun AmazonElasticLoadBalancingFunctions.applySecurityGroupsToLoadBalancer(loadBalancerName: String, securityGroups: List<String>, init: (AmazonElasticLoadBalancingApplySecurityGroupsToLoadBalancerCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.ApplySecurityGroupsToLoadBalancerResult {
	return this.block.declare(AmazonElasticLoadBalancingApplySecurityGroupsToLoadBalancerCommand(loadBalancerName, securityGroups).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.ApplySecurityGroupsToLoadBalancerResult
}
...
class AmazonElasticLoadBalancingApplySecurityGroupsToLoadBalancerCommand(val loadBalancerName: String, val securityGroups: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.ApplySecurityGroupsToLoadBalancerRequest, com.amazonaws.services.elasticloadbalancing.model.ApplySecurityGroupsToLoadBalancerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.ApplySecurityGroupsToLoadBalancerResult {
...
fun AmazonElasticLoadBalancingFunctions.attachLoadBalancerToSubnets(loadBalancerName: String, subnets: List<String>, init: (AmazonElasticLoadBalancingAttachLoadBalancerToSubnetsCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.AttachLoadBalancerToSubnetsResult {
	return this.block.declare(AmazonElasticLoadBalancingAttachLoadBalancerToSubnetsCommand(loadBalancerName, subnets).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.AttachLoadBalancerToSubnetsResult
}
...
class AmazonElasticLoadBalancingAttachLoadBalancerToSubnetsCommand(val loadBalancerName: String, val subnets: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.AttachLoadBalancerToSubnetsRequest, com.amazonaws.services.elasticloadbalancing.model.AttachLoadBalancerToSubnetsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.AttachLoadBalancerToSubnetsResult {
...
fun AmazonElasticLoadBalancingFunctions.configureHealthCheck(loadBalancerName: String, healthCheck: com.amazonaws.services.elasticloadbalancing.model.HealthCheck, init: (AmazonElasticLoadBalancingConfigureHealthCheckCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.ConfigureHealthCheckResult {
	return this.block.declare(AmazonElasticLoadBalancingConfigureHealthCheckCommand(loadBalancerName, healthCheck).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.ConfigureHealthCheckResult
}
...
class AmazonElasticLoadBalancingConfigureHealthCheckCommand(val loadBalancerName: String, val healthCheck: com.amazonaws.services.elasticloadbalancing.model.HealthCheck) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.ConfigureHealthCheckRequest, com.amazonaws.services.elasticloadbalancing.model.ConfigureHealthCheckResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.ConfigureHealthCheckResult {
...
fun AmazonElasticLoadBalancingFunctions.createAppCookieStickinessPolicy(loadBalancerName: String, policyName: String, cookieName: String, init: (AmazonElasticLoadBalancingCreateAppCookieStickinessPolicyCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.CreateAppCookieStickinessPolicyResult {
	return this.block.declare(AmazonElasticLoadBalancingCreateAppCookieStickinessPolicyCommand(loadBalancerName, policyName, cookieName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.CreateAppCookieStickinessPolicyResult
}
...
class AmazonElasticLoadBalancingCreateAppCookieStickinessPolicyCommand(val loadBalancerName: String, val policyName: String, val cookieName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.CreateAppCookieStickinessPolicyRequest, com.amazonaws.services.elasticloadbalancing.model.CreateAppCookieStickinessPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.CreateAppCookieStickinessPolicyResult {
...
fun AmazonElasticLoadBalancingFunctions.createLBCookieStickinessPolicy(loadBalancerName: String, policyName: String, init: (AmazonElasticLoadBalancingCreateLBCookieStickinessPolicyCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.CreateLBCookieStickinessPolicyResult {
	return this.block.declare(AmazonElasticLoadBalancingCreateLBCookieStickinessPolicyCommand(loadBalancerName, policyName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.CreateLBCookieStickinessPolicyResult
}
...
class AmazonElasticLoadBalancingCreateLBCookieStickinessPolicyCommand(val loadBalancerName: String, val policyName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.CreateLBCookieStickinessPolicyRequest, com.amazonaws.services.elasticloadbalancing.model.CreateLBCookieStickinessPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.CreateLBCookieStickinessPolicyResult {
...
fun AmazonElasticLoadBalancingFunctions.createLoadBalancer(loadBalancerName: String, listeners: List<com.amazonaws.services.elasticloadbalancing.model.Listener>, init: (AmazonElasticLoadBalancingCreateLoadBalancerCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.CreateLoadBalancerResult {
	return this.block.declare(AmazonElasticLoadBalancingCreateLoadBalancerCommand(loadBalancerName, listeners).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.CreateLoadBalancerResult
}
...
class AmazonElasticLoadBalancingCreateLoadBalancerCommand(val loadBalancerName: String, val listeners: List<com.amazonaws.services.elasticloadbalancing.model.Listener>) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.CreateLoadBalancerRequest, com.amazonaws.services.elasticloadbalancing.model.CreateLoadBalancerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.CreateLoadBalancerResult {
...
fun AmazonElasticLoadBalancingFunctions.createLoadBalancerListeners(loadBalancerName: String, listeners: List<com.amazonaws.services.elasticloadbalancing.model.Listener>, init: (AmazonElasticLoadBalancingCreateLoadBalancerListenersCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.CreateLoadBalancerListenersResult {
	return this.block.declare(AmazonElasticLoadBalancingCreateLoadBalancerListenersCommand(loadBalancerName, listeners).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.CreateLoadBalancerListenersResult
}
...
class AmazonElasticLoadBalancingCreateLoadBalancerListenersCommand(val loadBalancerName: String, val listeners: List<com.amazonaws.services.elasticloadbalancing.model.Listener>) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.CreateLoadBalancerListenersRequest, com.amazonaws.services.elasticloadbalancing.model.CreateLoadBalancerListenersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.CreateLoadBalancerListenersResult {
...
fun AmazonElasticLoadBalancingFunctions.createLoadBalancerPolicy(loadBalancerName: String, policyName: String, policyTypeName: String, init: (AmazonElasticLoadBalancingCreateLoadBalancerPolicyCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.CreateLoadBalancerPolicyResult {
	return this.block.declare(AmazonElasticLoadBalancingCreateLoadBalancerPolicyCommand(loadBalancerName, policyName, policyTypeName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.CreateLoadBalancerPolicyResult
}
...
class AmazonElasticLoadBalancingCreateLoadBalancerPolicyCommand(val loadBalancerName: String, val policyName: String, val policyTypeName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.CreateLoadBalancerPolicyRequest, com.amazonaws.services.elasticloadbalancing.model.CreateLoadBalancerPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.CreateLoadBalancerPolicyResult {
...
fun AmazonElasticLoadBalancingFunctions.deleteLoadBalancer(loadBalancerName: String, init: (AmazonElasticLoadBalancingDeleteLoadBalancerCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.DeleteLoadBalancerResult {
	return this.block.declare(AmazonElasticLoadBalancingDeleteLoadBalancerCommand(loadBalancerName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.DeleteLoadBalancerResult
}
...
class AmazonElasticLoadBalancingDeleteLoadBalancerCommand(val loadBalancerName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.DeleteLoadBalancerRequest, com.amazonaws.services.elasticloadbalancing.model.DeleteLoadBalancerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.DeleteLoadBalancerResult {
...
fun AmazonElasticLoadBalancingFunctions.deleteLoadBalancerListeners(loadBalancerName: String, loadBalancerPorts: List<Int>, init: (AmazonElasticLoadBalancingDeleteLoadBalancerListenersCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.DeleteLoadBalancerListenersResult {
	return this.block.declare(AmazonElasticLoadBalancingDeleteLoadBalancerListenersCommand(loadBalancerName, loadBalancerPorts).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.DeleteLoadBalancerListenersResult
}
...
class AmazonElasticLoadBalancingDeleteLoadBalancerListenersCommand(val loadBalancerName: String, val loadBalancerPorts: List<Int>) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.DeleteLoadBalancerListenersRequest, com.amazonaws.services.elasticloadbalancing.model.DeleteLoadBalancerListenersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.DeleteLoadBalancerListenersResult {
...
fun AmazonElasticLoadBalancingFunctions.deleteLoadBalancerPolicy(loadBalancerName: String, policyName: String, init: (AmazonElasticLoadBalancingDeleteLoadBalancerPolicyCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.DeleteLoadBalancerPolicyResult {
	return this.block.declare(AmazonElasticLoadBalancingDeleteLoadBalancerPolicyCommand(loadBalancerName, policyName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.DeleteLoadBalancerPolicyResult
}
...
class AmazonElasticLoadBalancingDeleteLoadBalancerPolicyCommand(val loadBalancerName: String, val policyName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.DeleteLoadBalancerPolicyRequest, com.amazonaws.services.elasticloadbalancing.model.DeleteLoadBalancerPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.DeleteLoadBalancerPolicyResult {
...
fun AmazonElasticLoadBalancingFunctions.deregisterInstancesFromLoadBalancer(loadBalancerName: String, instances: List<com.amazonaws.services.elasticloadbalancing.model.Instance>, init: (AmazonElasticLoadBalancingDeregisterInstancesFromLoadBalancerCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.DeregisterInstancesFromLoadBalancerResult {
	return this.block.declare(AmazonElasticLoadBalancingDeregisterInstancesFromLoadBalancerCommand(loadBalancerName, instances).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.DeregisterInstancesFromLoadBalancerResult
}
...
class AmazonElasticLoadBalancingDeregisterInstancesFromLoadBalancerCommand(val loadBalancerName: String, val instances: List<com.amazonaws.services.elasticloadbalancing.model.Instance>) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.DeregisterInstancesFromLoadBalancerRequest, com.amazonaws.services.elasticloadbalancing.model.DeregisterInstancesFromLoadBalancerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.DeregisterInstancesFromLoadBalancerResult {
...
fun AmazonElasticLoadBalancingFunctions.describeAccountLimits(init: (AmazonElasticLoadBalancingDescribeAccountLimitsCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.DescribeAccountLimitsResult {
	return this.block.declare(AmazonElasticLoadBalancingDescribeAccountLimitsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.DescribeAccountLimitsResult
}
...
class AmazonElasticLoadBalancingDescribeAccountLimitsCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.DescribeAccountLimitsRequest, com.amazonaws.services.elasticloadbalancing.model.DescribeAccountLimitsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.DescribeAccountLimitsResult {
...
fun AmazonElasticLoadBalancingFunctions.describeInstanceHealth(loadBalancerName: String, init: (AmazonElasticLoadBalancingDescribeInstanceHealthCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.DescribeInstanceHealthResult {
	return this.block.declare(AmazonElasticLoadBalancingDescribeInstanceHealthCommand(loadBalancerName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.DescribeInstanceHealthResult
}
...
class AmazonElasticLoadBalancingDescribeInstanceHealthCommand(val loadBalancerName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.DescribeInstanceHealthRequest, com.amazonaws.services.elasticloadbalancing.model.DescribeInstanceHealthResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.DescribeInstanceHealthResult {
...
fun AmazonElasticLoadBalancingFunctions.describeLoadBalancerAttributes(loadBalancerName: String, init: (AmazonElasticLoadBalancingDescribeLoadBalancerAttributesCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancerAttributesResult {
	return this.block.declare(AmazonElasticLoadBalancingDescribeLoadBalancerAttributesCommand(loadBalancerName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancerAttributesResult
}
...
class AmazonElasticLoadBalancingDescribeLoadBalancerAttributesCommand(val loadBalancerName: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancerAttributesRequest, com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancerAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancerAttributesResult {
...
fun AmazonElasticLoadBalancingFunctions.describeLoadBalancerPolicies(init: (AmazonElasticLoadBalancingDescribeLoadBalancerPoliciesCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancerPoliciesResult {
	return this.block.declare(AmazonElasticLoadBalancingDescribeLoadBalancerPoliciesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancerPoliciesResult
}
...
class AmazonElasticLoadBalancingDescribeLoadBalancerPoliciesCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancerPoliciesRequest, com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancerPoliciesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancerPoliciesResult {
...
fun AmazonElasticLoadBalancingFunctions.describeLoadBalancerPolicyTypes(init: (AmazonElasticLoadBalancingDescribeLoadBalancerPolicyTypesCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancerPolicyTypesResult {
	return this.block.declare(AmazonElasticLoadBalancingDescribeLoadBalancerPolicyTypesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancerPolicyTypesResult
}
...
class AmazonElasticLoadBalancingDescribeLoadBalancerPolicyTypesCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancerPolicyTypesRequest, com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancerPolicyTypesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancerPolicyTypesResult {
...
fun AmazonElasticLoadBalancingFunctions.describeLoadBalancers(init: (AmazonElasticLoadBalancingDescribeLoadBalancersCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancersResult {
	return this.block.declare(AmazonElasticLoadBalancingDescribeLoadBalancersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancersResult
}
...
class AmazonElasticLoadBalancingDescribeLoadBalancersCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancersRequest, com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.DescribeLoadBalancersResult {
...
fun AmazonElasticLoadBalancingFunctions.describeTags(loadBalancerNames: List<String>, init: (AmazonElasticLoadBalancingDescribeTagsCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.DescribeTagsResult {
	return this.block.declare(AmazonElasticLoadBalancingDescribeTagsCommand(loadBalancerNames).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.DescribeTagsResult
}
...
class AmazonElasticLoadBalancingDescribeTagsCommand(val loadBalancerNames: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.DescribeTagsRequest, com.amazonaws.services.elasticloadbalancing.model.DescribeTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.DescribeTagsResult {
...
fun AmazonElasticLoadBalancingFunctions.detachLoadBalancerFromSubnets(loadBalancerName: String, subnets: List<String>, init: (AmazonElasticLoadBalancingDetachLoadBalancerFromSubnetsCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.DetachLoadBalancerFromSubnetsResult {
	return this.block.declare(AmazonElasticLoadBalancingDetachLoadBalancerFromSubnetsCommand(loadBalancerName, subnets).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.DetachLoadBalancerFromSubnetsResult
}
...
class AmazonElasticLoadBalancingDetachLoadBalancerFromSubnetsCommand(val loadBalancerName: String, val subnets: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.DetachLoadBalancerFromSubnetsRequest, com.amazonaws.services.elasticloadbalancing.model.DetachLoadBalancerFromSubnetsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.DetachLoadBalancerFromSubnetsResult {
...
fun AmazonElasticLoadBalancingFunctions.disableAvailabilityZonesForLoadBalancer(loadBalancerName: String, availabilityZones: List<String>, init: (AmazonElasticLoadBalancingDisableAvailabilityZonesForLoadBalancerCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.DisableAvailabilityZonesForLoadBalancerResult {
	return this.block.declare(AmazonElasticLoadBalancingDisableAvailabilityZonesForLoadBalancerCommand(loadBalancerName, availabilityZones).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.DisableAvailabilityZonesForLoadBalancerResult
}
...
class AmazonElasticLoadBalancingDisableAvailabilityZonesForLoadBalancerCommand(val loadBalancerName: String, val availabilityZones: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.DisableAvailabilityZonesForLoadBalancerRequest, com.amazonaws.services.elasticloadbalancing.model.DisableAvailabilityZonesForLoadBalancerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.DisableAvailabilityZonesForLoadBalancerResult {
...
fun AmazonElasticLoadBalancingFunctions.enableAvailabilityZonesForLoadBalancer(loadBalancerName: String, availabilityZones: List<String>, init: (AmazonElasticLoadBalancingEnableAvailabilityZonesForLoadBalancerCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.EnableAvailabilityZonesForLoadBalancerResult {
	return this.block.declare(AmazonElasticLoadBalancingEnableAvailabilityZonesForLoadBalancerCommand(loadBalancerName, availabilityZones).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.EnableAvailabilityZonesForLoadBalancerResult
}
...
class AmazonElasticLoadBalancingEnableAvailabilityZonesForLoadBalancerCommand(val loadBalancerName: String, val availabilityZones: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.EnableAvailabilityZonesForLoadBalancerRequest, com.amazonaws.services.elasticloadbalancing.model.EnableAvailabilityZonesForLoadBalancerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.EnableAvailabilityZonesForLoadBalancerResult {
...
fun AmazonElasticLoadBalancingFunctions.modifyLoadBalancerAttributes(loadBalancerName: String, loadBalancerAttributes: com.amazonaws.services.elasticloadbalancing.model.LoadBalancerAttributes, init: (AmazonElasticLoadBalancingModifyLoadBalancerAttributesCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.ModifyLoadBalancerAttributesResult {
	return this.block.declare(AmazonElasticLoadBalancingModifyLoadBalancerAttributesCommand(loadBalancerName, loadBalancerAttributes).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.ModifyLoadBalancerAttributesResult
}
...
class AmazonElasticLoadBalancingModifyLoadBalancerAttributesCommand(val loadBalancerName: String, val loadBalancerAttributes: com.amazonaws.services.elasticloadbalancing.model.LoadBalancerAttributes) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.ModifyLoadBalancerAttributesRequest, com.amazonaws.services.elasticloadbalancing.model.ModifyLoadBalancerAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.ModifyLoadBalancerAttributesResult {
...
fun AmazonElasticLoadBalancingFunctions.registerInstancesWithLoadBalancer(loadBalancerName: String, instances: List<com.amazonaws.services.elasticloadbalancing.model.Instance>, init: (AmazonElasticLoadBalancingRegisterInstancesWithLoadBalancerCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.RegisterInstancesWithLoadBalancerResult {
	return this.block.declare(AmazonElasticLoadBalancingRegisterInstancesWithLoadBalancerCommand(loadBalancerName, instances).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.RegisterInstancesWithLoadBalancerResult
}
...
class AmazonElasticLoadBalancingRegisterInstancesWithLoadBalancerCommand(val loadBalancerName: String, val instances: List<com.amazonaws.services.elasticloadbalancing.model.Instance>) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.RegisterInstancesWithLoadBalancerRequest, com.amazonaws.services.elasticloadbalancing.model.RegisterInstancesWithLoadBalancerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.RegisterInstancesWithLoadBalancerResult {
...
fun AmazonElasticLoadBalancingFunctions.removeTags(loadBalancerNames: List<String>, tags: List<com.amazonaws.services.elasticloadbalancing.model.TagKeyOnly>, init: (AmazonElasticLoadBalancingRemoveTagsCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.RemoveTagsResult {
	return this.block.declare(AmazonElasticLoadBalancingRemoveTagsCommand(loadBalancerNames, tags).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.RemoveTagsResult
}
...
class AmazonElasticLoadBalancingRemoveTagsCommand(val loadBalancerNames: List<String>, val tags: List<com.amazonaws.services.elasticloadbalancing.model.TagKeyOnly>) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.RemoveTagsRequest, com.amazonaws.services.elasticloadbalancing.model.RemoveTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.RemoveTagsResult {
...
fun AmazonElasticLoadBalancingFunctions.setLoadBalancerListenerSSLCertificate(loadBalancerName: String, loadBalancerPort: Int, sSLCertificateId: String, init: (AmazonElasticLoadBalancingSetLoadBalancerListenerSSLCertificateCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.SetLoadBalancerListenerSSLCertificateResult {
	return this.block.declare(AmazonElasticLoadBalancingSetLoadBalancerListenerSSLCertificateCommand(loadBalancerName, loadBalancerPort, sSLCertificateId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.SetLoadBalancerListenerSSLCertificateResult
}
...
class AmazonElasticLoadBalancingSetLoadBalancerListenerSSLCertificateCommand(val loadBalancerName: String, val loadBalancerPort: Int, val sSLCertificateId: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.SetLoadBalancerListenerSSLCertificateRequest, com.amazonaws.services.elasticloadbalancing.model.SetLoadBalancerListenerSSLCertificateResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.SetLoadBalancerListenerSSLCertificateResult {
...
fun AmazonElasticLoadBalancingFunctions.setLoadBalancerPoliciesForBackendServer(loadBalancerName: String, instancePort: Int, policyNames: List<String>, init: (AmazonElasticLoadBalancingSetLoadBalancerPoliciesForBackendServerCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.SetLoadBalancerPoliciesForBackendServerResult {
	return this.block.declare(AmazonElasticLoadBalancingSetLoadBalancerPoliciesForBackendServerCommand(loadBalancerName, instancePort, policyNames).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.SetLoadBalancerPoliciesForBackendServerResult
}
...
class AmazonElasticLoadBalancingSetLoadBalancerPoliciesForBackendServerCommand(val loadBalancerName: String, val instancePort: Int, val policyNames: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.SetLoadBalancerPoliciesForBackendServerRequest, com.amazonaws.services.elasticloadbalancing.model.SetLoadBalancerPoliciesForBackendServerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.SetLoadBalancerPoliciesForBackendServerResult {
...
fun AmazonElasticLoadBalancingFunctions.setLoadBalancerPoliciesOfListener(loadBalancerName: String, loadBalancerPort: Int, policyNames: List<String>, init: (AmazonElasticLoadBalancingSetLoadBalancerPoliciesOfListenerCommand.() -> Unit)? = null): com.amazonaws.services.elasticloadbalancing.model.SetLoadBalancerPoliciesOfListenerResult {
	return this.block.declare(AmazonElasticLoadBalancingSetLoadBalancerPoliciesOfListenerCommand(loadBalancerName, loadBalancerPort, policyNames).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticloadbalancing.model.SetLoadBalancerPoliciesOfListenerResult
}
...
class AmazonElasticLoadBalancingSetLoadBalancerPoliciesOfListenerCommand(val loadBalancerName: String, val loadBalancerPort: Int, val policyNames: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.elasticloadbalancing.model.SetLoadBalancerPoliciesOfListenerRequest, com.amazonaws.services.elasticloadbalancing.model.SetLoadBalancerPoliciesOfListenerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticloadbalancing.model.SetLoadBalancerPoliciesOfListenerResult {
