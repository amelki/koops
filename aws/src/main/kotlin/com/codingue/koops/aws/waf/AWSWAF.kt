...
package com.codingue.koops.aws.waf
...
var com.codingue.koops.core.Environment.waf: AWSWAF
	get() {
		var service = this.capabilities["aws-waf"]
		if (service == null) {
			service = AWSWAFClientBuilder.standard().build()
			this.capabilities["aws-waf"] = service
		}
		return service as AWSWAF
	}
	set(waf) {
		this.capabilities["aws-waf"] = waf
	}
...
fun AWSWAFFunctions.createByteMatchSet(name: String, changeToken: String, init: (AWSWAFCreateByteMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.CreateByteMatchSetResult {
	return this.block.declare(AWSWAFCreateByteMatchSetCommand(name, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.CreateByteMatchSetResult
}
...
fun AWSWAFFunctions.createGeoMatchSet(name: String, changeToken: String, init: (AWSWAFCreateGeoMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.CreateGeoMatchSetResult {
	return this.block.declare(AWSWAFCreateGeoMatchSetCommand(name, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.CreateGeoMatchSetResult
}
...
fun AWSWAFFunctions.createIPSet(name: String, changeToken: String, init: (AWSWAFCreateIPSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.CreateIPSetResult {
	return this.block.declare(AWSWAFCreateIPSetCommand(name, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.CreateIPSetResult
}
...
fun AWSWAFFunctions.createRateBasedRule(name: String, metricName: String, rateKey: RateKey, rateLimit: Long, changeToken: String, init: (AWSWAFCreateRateBasedRuleCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.CreateRateBasedRuleResult {
	return this.block.declare(AWSWAFCreateRateBasedRuleCommand(name, metricName, rateKey, rateLimit, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.CreateRateBasedRuleResult
}
...
fun AWSWAFFunctions.createRegexMatchSet(name: String, changeToken: String, init: (AWSWAFCreateRegexMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.CreateRegexMatchSetResult {
	return this.block.declare(AWSWAFCreateRegexMatchSetCommand(name, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.CreateRegexMatchSetResult
}
...
fun AWSWAFFunctions.createRegexPatternSet(name: String, changeToken: String, init: (AWSWAFCreateRegexPatternSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.CreateRegexPatternSetResult {
	return this.block.declare(AWSWAFCreateRegexPatternSetCommand(name, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.CreateRegexPatternSetResult
}
...
fun AWSWAFFunctions.createRule(name: String, metricName: String, changeToken: String, init: (AWSWAFCreateRuleCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.CreateRuleResult {
	return this.block.declare(AWSWAFCreateRuleCommand(name, metricName, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.CreateRuleResult
}
...
fun AWSWAFFunctions.createRuleGroup(name: String, metricName: String, changeToken: String, init: (AWSWAFCreateRuleGroupCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.CreateRuleGroupResult {
	return this.block.declare(AWSWAFCreateRuleGroupCommand(name, metricName, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.CreateRuleGroupResult
}
...
fun AWSWAFFunctions.createSizeConstraintSet(name: String, changeToken: String, init: (AWSWAFCreateSizeConstraintSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.CreateSizeConstraintSetResult {
	return this.block.declare(AWSWAFCreateSizeConstraintSetCommand(name, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.CreateSizeConstraintSetResult
}
...
fun AWSWAFFunctions.createSqlInjectionMatchSet(name: String, changeToken: String, init: (AWSWAFCreateSqlInjectionMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.CreateSqlInjectionMatchSetResult {
	return this.block.declare(AWSWAFCreateSqlInjectionMatchSetCommand(name, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.CreateSqlInjectionMatchSetResult
}
...
fun AWSWAFFunctions.createWebACL(name: String, metricName: String, defaultAction: com.amazonaws.services.waf.model.WafAction, changeToken: String, init: (AWSWAFCreateWebACLCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.CreateWebACLResult {
	return this.block.declare(AWSWAFCreateWebACLCommand(name, metricName, defaultAction, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.CreateWebACLResult
}
...
fun AWSWAFFunctions.createXssMatchSet(name: String, changeToken: String, init: (AWSWAFCreateXssMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.CreateXssMatchSetResult {
	return this.block.declare(AWSWAFCreateXssMatchSetCommand(name, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.CreateXssMatchSetResult
}
...
fun AWSWAFFunctions.deleteByteMatchSet(byteMatchSetId: String, changeToken: String, init: (AWSWAFDeleteByteMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.DeleteByteMatchSetResult {
	return this.block.declare(AWSWAFDeleteByteMatchSetCommand(byteMatchSetId, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.DeleteByteMatchSetResult
}
...
fun AWSWAFFunctions.deleteGeoMatchSet(geoMatchSetId: String, changeToken: String, init: (AWSWAFDeleteGeoMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.DeleteGeoMatchSetResult {
	return this.block.declare(AWSWAFDeleteGeoMatchSetCommand(geoMatchSetId, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.DeleteGeoMatchSetResult
}
...
fun AWSWAFFunctions.deleteIPSet(iPSetId: String, changeToken: String, init: (AWSWAFDeleteIPSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.DeleteIPSetResult {
	return this.block.declare(AWSWAFDeleteIPSetCommand(iPSetId, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.DeleteIPSetResult
}
...
fun AWSWAFFunctions.deletePermissionPolicy(resourceArn: String, init: (AWSWAFDeletePermissionPolicyCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.DeletePermissionPolicyResult {
	return this.block.declare(AWSWAFDeletePermissionPolicyCommand(resourceArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.DeletePermissionPolicyResult
}
...
fun AWSWAFFunctions.deleteRateBasedRule(ruleId: String, changeToken: String, init: (AWSWAFDeleteRateBasedRuleCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.DeleteRateBasedRuleResult {
	return this.block.declare(AWSWAFDeleteRateBasedRuleCommand(ruleId, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.DeleteRateBasedRuleResult
}
...
fun AWSWAFFunctions.deleteRegexMatchSet(regexMatchSetId: String, changeToken: String, init: (AWSWAFDeleteRegexMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.DeleteRegexMatchSetResult {
	return this.block.declare(AWSWAFDeleteRegexMatchSetCommand(regexMatchSetId, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.DeleteRegexMatchSetResult
}
...
fun AWSWAFFunctions.deleteRegexPatternSet(regexPatternSetId: String, changeToken: String, init: (AWSWAFDeleteRegexPatternSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.DeleteRegexPatternSetResult {
	return this.block.declare(AWSWAFDeleteRegexPatternSetCommand(regexPatternSetId, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.DeleteRegexPatternSetResult
}
...
fun AWSWAFFunctions.deleteRule(ruleId: String, changeToken: String, init: (AWSWAFDeleteRuleCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.DeleteRuleResult {
	return this.block.declare(AWSWAFDeleteRuleCommand(ruleId, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.DeleteRuleResult
}
...
fun AWSWAFFunctions.deleteRuleGroup(ruleGroupId: String, changeToken: String, init: (AWSWAFDeleteRuleGroupCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.DeleteRuleGroupResult {
	return this.block.declare(AWSWAFDeleteRuleGroupCommand(ruleGroupId, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.DeleteRuleGroupResult
}
...
fun AWSWAFFunctions.deleteSizeConstraintSet(sizeConstraintSetId: String, changeToken: String, init: (AWSWAFDeleteSizeConstraintSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.DeleteSizeConstraintSetResult {
	return this.block.declare(AWSWAFDeleteSizeConstraintSetCommand(sizeConstraintSetId, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.DeleteSizeConstraintSetResult
}
...
fun AWSWAFFunctions.deleteSqlInjectionMatchSet(sqlInjectionMatchSetId: String, changeToken: String, init: (AWSWAFDeleteSqlInjectionMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.DeleteSqlInjectionMatchSetResult {
	return this.block.declare(AWSWAFDeleteSqlInjectionMatchSetCommand(sqlInjectionMatchSetId, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.DeleteSqlInjectionMatchSetResult
}
...
fun AWSWAFFunctions.deleteWebACL(webACLId: String, changeToken: String, init: (AWSWAFDeleteWebACLCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.DeleteWebACLResult {
	return this.block.declare(AWSWAFDeleteWebACLCommand(webACLId, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.DeleteWebACLResult
}
...
fun AWSWAFFunctions.deleteXssMatchSet(xssMatchSetId: String, changeToken: String, init: (AWSWAFDeleteXssMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.DeleteXssMatchSetResult {
	return this.block.declare(AWSWAFDeleteXssMatchSetCommand(xssMatchSetId, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.DeleteXssMatchSetResult
}
...
fun AWSWAFFunctions.getByteMatchSet(byteMatchSetId: String, init: (AWSWAFGetByteMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.GetByteMatchSetResult {
	return this.block.declare(AWSWAFGetByteMatchSetCommand(byteMatchSetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.GetByteMatchSetResult
}
...
fun AWSWAFFunctions.getChangeToken(init: (AWSWAFGetChangeTokenCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.GetChangeTokenResult {
	return this.block.declare(AWSWAFGetChangeTokenCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.GetChangeTokenResult
}
...
fun AWSWAFFunctions.getChangeTokenStatus(changeToken: String, init: (AWSWAFGetChangeTokenStatusCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.GetChangeTokenStatusResult {
	return this.block.declare(AWSWAFGetChangeTokenStatusCommand(changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.GetChangeTokenStatusResult
}
...
fun AWSWAFFunctions.getGeoMatchSet(geoMatchSetId: String, init: (AWSWAFGetGeoMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.GetGeoMatchSetResult {
	return this.block.declare(AWSWAFGetGeoMatchSetCommand(geoMatchSetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.GetGeoMatchSetResult
}
...
fun AWSWAFFunctions.getIPSet(iPSetId: String, init: (AWSWAFGetIPSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.GetIPSetResult {
	return this.block.declare(AWSWAFGetIPSetCommand(iPSetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.GetIPSetResult
}
...
fun AWSWAFFunctions.getPermissionPolicy(resourceArn: String, init: (AWSWAFGetPermissionPolicyCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.GetPermissionPolicyResult {
	return this.block.declare(AWSWAFGetPermissionPolicyCommand(resourceArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.GetPermissionPolicyResult
}
...
fun AWSWAFFunctions.getRateBasedRule(ruleId: String, init: (AWSWAFGetRateBasedRuleCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.GetRateBasedRuleResult {
	return this.block.declare(AWSWAFGetRateBasedRuleCommand(ruleId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.GetRateBasedRuleResult
}
...
fun AWSWAFFunctions.getRateBasedRuleManagedKeys(ruleId: String, init: (AWSWAFGetRateBasedRuleManagedKeysCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.GetRateBasedRuleManagedKeysResult {
	return this.block.declare(AWSWAFGetRateBasedRuleManagedKeysCommand(ruleId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.GetRateBasedRuleManagedKeysResult
}
...
fun AWSWAFFunctions.getRegexMatchSet(regexMatchSetId: String, init: (AWSWAFGetRegexMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.GetRegexMatchSetResult {
	return this.block.declare(AWSWAFGetRegexMatchSetCommand(regexMatchSetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.GetRegexMatchSetResult
}
...
fun AWSWAFFunctions.getRegexPatternSet(regexPatternSetId: String, init: (AWSWAFGetRegexPatternSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.GetRegexPatternSetResult {
	return this.block.declare(AWSWAFGetRegexPatternSetCommand(regexPatternSetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.GetRegexPatternSetResult
}
...
fun AWSWAFFunctions.getRule(ruleId: String, init: (AWSWAFGetRuleCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.GetRuleResult {
	return this.block.declare(AWSWAFGetRuleCommand(ruleId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.GetRuleResult
}
...
fun AWSWAFFunctions.getRuleGroup(ruleGroupId: String, init: (AWSWAFGetRuleGroupCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.GetRuleGroupResult {
	return this.block.declare(AWSWAFGetRuleGroupCommand(ruleGroupId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.GetRuleGroupResult
}
...
fun AWSWAFFunctions.getSampledRequests(webAclId: String, ruleId: String, timeWindow: com.amazonaws.services.waf.model.TimeWindow, maxItems: Long, init: (AWSWAFGetSampledRequestsCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.GetSampledRequestsResult {
	return this.block.declare(AWSWAFGetSampledRequestsCommand(webAclId, ruleId, timeWindow, maxItems).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.GetSampledRequestsResult
}
...
fun AWSWAFFunctions.getSizeConstraintSet(sizeConstraintSetId: String, init: (AWSWAFGetSizeConstraintSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.GetSizeConstraintSetResult {
	return this.block.declare(AWSWAFGetSizeConstraintSetCommand(sizeConstraintSetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.GetSizeConstraintSetResult
}
...
fun AWSWAFFunctions.getSqlInjectionMatchSet(sqlInjectionMatchSetId: String, init: (AWSWAFGetSqlInjectionMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.GetSqlInjectionMatchSetResult {
	return this.block.declare(AWSWAFGetSqlInjectionMatchSetCommand(sqlInjectionMatchSetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.GetSqlInjectionMatchSetResult
}
...
fun AWSWAFFunctions.getWebACL(webACLId: String, init: (AWSWAFGetWebACLCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.GetWebACLResult {
	return this.block.declare(AWSWAFGetWebACLCommand(webACLId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.GetWebACLResult
}
...
fun AWSWAFFunctions.getXssMatchSet(xssMatchSetId: String, init: (AWSWAFGetXssMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.GetXssMatchSetResult {
	return this.block.declare(AWSWAFGetXssMatchSetCommand(xssMatchSetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.GetXssMatchSetResult
}
...
fun AWSWAFFunctions.listActivatedRulesInRuleGroup(init: (AWSWAFListActivatedRulesInRuleGroupCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.ListActivatedRulesInRuleGroupResult {
	return this.block.declare(AWSWAFListActivatedRulesInRuleGroupCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.ListActivatedRulesInRuleGroupResult
}
...
fun AWSWAFFunctions.listByteMatchSets(init: (AWSWAFListByteMatchSetsCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.ListByteMatchSetsResult {
	return this.block.declare(AWSWAFListByteMatchSetsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.ListByteMatchSetsResult
}
...
fun AWSWAFFunctions.listGeoMatchSets(init: (AWSWAFListGeoMatchSetsCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.ListGeoMatchSetsResult {
	return this.block.declare(AWSWAFListGeoMatchSetsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.ListGeoMatchSetsResult
}
...
fun AWSWAFFunctions.listIPSets(init: (AWSWAFListIPSetsCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.ListIPSetsResult {
	return this.block.declare(AWSWAFListIPSetsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.ListIPSetsResult
}
...
fun AWSWAFFunctions.listRateBasedRules(init: (AWSWAFListRateBasedRulesCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.ListRateBasedRulesResult {
	return this.block.declare(AWSWAFListRateBasedRulesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.ListRateBasedRulesResult
}
...
fun AWSWAFFunctions.listRegexMatchSets(init: (AWSWAFListRegexMatchSetsCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.ListRegexMatchSetsResult {
	return this.block.declare(AWSWAFListRegexMatchSetsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.ListRegexMatchSetsResult
}
...
fun AWSWAFFunctions.listRegexPatternSets(init: (AWSWAFListRegexPatternSetsCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.ListRegexPatternSetsResult {
	return this.block.declare(AWSWAFListRegexPatternSetsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.ListRegexPatternSetsResult
}
...
fun AWSWAFFunctions.listRuleGroups(init: (AWSWAFListRuleGroupsCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.ListRuleGroupsResult {
	return this.block.declare(AWSWAFListRuleGroupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.ListRuleGroupsResult
}
...
fun AWSWAFFunctions.listRules(init: (AWSWAFListRulesCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.ListRulesResult {
	return this.block.declare(AWSWAFListRulesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.ListRulesResult
}
...
fun AWSWAFFunctions.listSizeConstraintSets(init: (AWSWAFListSizeConstraintSetsCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.ListSizeConstraintSetsResult {
	return this.block.declare(AWSWAFListSizeConstraintSetsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.ListSizeConstraintSetsResult
}
...
fun AWSWAFFunctions.listSqlInjectionMatchSets(init: (AWSWAFListSqlInjectionMatchSetsCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.ListSqlInjectionMatchSetsResult {
	return this.block.declare(AWSWAFListSqlInjectionMatchSetsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.ListSqlInjectionMatchSetsResult
}
...
fun AWSWAFFunctions.listSubscribedRuleGroups(init: (AWSWAFListSubscribedRuleGroupsCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.ListSubscribedRuleGroupsResult {
	return this.block.declare(AWSWAFListSubscribedRuleGroupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.ListSubscribedRuleGroupsResult
}
...
fun AWSWAFFunctions.listWebACLs(init: (AWSWAFListWebACLsCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.ListWebACLsResult {
	return this.block.declare(AWSWAFListWebACLsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.ListWebACLsResult
}
...
fun AWSWAFFunctions.listXssMatchSets(init: (AWSWAFListXssMatchSetsCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.ListXssMatchSetsResult {
	return this.block.declare(AWSWAFListXssMatchSetsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.ListXssMatchSetsResult
}
...
fun AWSWAFFunctions.putPermissionPolicy(resourceArn: String, policy: String, init: (AWSWAFPutPermissionPolicyCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.PutPermissionPolicyResult {
	return this.block.declare(AWSWAFPutPermissionPolicyCommand(resourceArn, policy).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.PutPermissionPolicyResult
}
...
fun AWSWAFFunctions.updateByteMatchSet(byteMatchSetId: String, changeToken: String, updates: List<com.amazonaws.services.waf.model.ByteMatchSetUpdate>, init: (AWSWAFUpdateByteMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.UpdateByteMatchSetResult {
	return this.block.declare(AWSWAFUpdateByteMatchSetCommand(byteMatchSetId, changeToken, updates).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.UpdateByteMatchSetResult
}
...
fun AWSWAFFunctions.updateGeoMatchSet(geoMatchSetId: String, changeToken: String, updates: List<com.amazonaws.services.waf.model.GeoMatchSetUpdate>, init: (AWSWAFUpdateGeoMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.UpdateGeoMatchSetResult {
	return this.block.declare(AWSWAFUpdateGeoMatchSetCommand(geoMatchSetId, changeToken, updates).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.UpdateGeoMatchSetResult
}
...
fun AWSWAFFunctions.updateIPSet(iPSetId: String, changeToken: String, updates: List<com.amazonaws.services.waf.model.IPSetUpdate>, init: (AWSWAFUpdateIPSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.UpdateIPSetResult {
	return this.block.declare(AWSWAFUpdateIPSetCommand(iPSetId, changeToken, updates).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.UpdateIPSetResult
}
...
fun AWSWAFFunctions.updateRateBasedRule(ruleId: String, changeToken: String, updates: List<com.amazonaws.services.waf.model.RuleUpdate>, rateLimit: Long, init: (AWSWAFUpdateRateBasedRuleCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.UpdateRateBasedRuleResult {
	return this.block.declare(AWSWAFUpdateRateBasedRuleCommand(ruleId, changeToken, updates, rateLimit).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.UpdateRateBasedRuleResult
}
...
fun AWSWAFFunctions.updateRegexMatchSet(regexMatchSetId: String, updates: List<com.amazonaws.services.waf.model.RegexMatchSetUpdate>, changeToken: String, init: (AWSWAFUpdateRegexMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.UpdateRegexMatchSetResult {
	return this.block.declare(AWSWAFUpdateRegexMatchSetCommand(regexMatchSetId, updates, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.UpdateRegexMatchSetResult
}
...
fun AWSWAFFunctions.updateRegexPatternSet(regexPatternSetId: String, updates: List<com.amazonaws.services.waf.model.RegexPatternSetUpdate>, changeToken: String, init: (AWSWAFUpdateRegexPatternSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.UpdateRegexPatternSetResult {
	return this.block.declare(AWSWAFUpdateRegexPatternSetCommand(regexPatternSetId, updates, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.UpdateRegexPatternSetResult
}
...
fun AWSWAFFunctions.updateRule(ruleId: String, changeToken: String, updates: List<com.amazonaws.services.waf.model.RuleUpdate>, init: (AWSWAFUpdateRuleCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.UpdateRuleResult {
	return this.block.declare(AWSWAFUpdateRuleCommand(ruleId, changeToken, updates).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.UpdateRuleResult
}
...
fun AWSWAFFunctions.updateRuleGroup(ruleGroupId: String, updates: List<com.amazonaws.services.waf.model.RuleGroupUpdate>, changeToken: String, init: (AWSWAFUpdateRuleGroupCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.UpdateRuleGroupResult {
	return this.block.declare(AWSWAFUpdateRuleGroupCommand(ruleGroupId, updates, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.UpdateRuleGroupResult
}
...
fun AWSWAFFunctions.updateSizeConstraintSet(sizeConstraintSetId: String, changeToken: String, updates: List<com.amazonaws.services.waf.model.SizeConstraintSetUpdate>, init: (AWSWAFUpdateSizeConstraintSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.UpdateSizeConstraintSetResult {
	return this.block.declare(AWSWAFUpdateSizeConstraintSetCommand(sizeConstraintSetId, changeToken, updates).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.UpdateSizeConstraintSetResult
}
...
fun AWSWAFFunctions.updateSqlInjectionMatchSet(sqlInjectionMatchSetId: String, changeToken: String, updates: List<com.amazonaws.services.waf.model.SqlInjectionMatchSetUpdate>, init: (AWSWAFUpdateSqlInjectionMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.UpdateSqlInjectionMatchSetResult {
	return this.block.declare(AWSWAFUpdateSqlInjectionMatchSetCommand(sqlInjectionMatchSetId, changeToken, updates).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.UpdateSqlInjectionMatchSetResult
}
...
fun AWSWAFFunctions.updateWebACL(webACLId: String, changeToken: String, init: (AWSWAFUpdateWebACLCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.UpdateWebACLResult {
	return this.block.declare(AWSWAFUpdateWebACLCommand(webACLId, changeToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.UpdateWebACLResult
}
...
fun AWSWAFFunctions.updateXssMatchSet(xssMatchSetId: String, changeToken: String, updates: List<com.amazonaws.services.waf.model.XssMatchSetUpdate>, init: (AWSWAFUpdateXssMatchSetCommand.() -> Unit)? = null): com.amazonaws.services.waf.model.UpdateXssMatchSetResult {
	return this.block.declare(AWSWAFUpdateXssMatchSetCommand(xssMatchSetId, changeToken, updates).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.waf.model.UpdateXssMatchSetResult
}
