...
package com.codingue.koops.aws.comprehend
...
var com.codingue.koops.core.Environment.comprehend: AmazonComprehend
	get() {
		var service = this.capabilities["aws-comprehend"]
		if (service == null) {
			service = AmazonComprehendClientBuilder.standard().build()
			this.capabilities["aws-comprehend"] = service
		}
		return service as AmazonComprehend
	}
	set(comprehend) {
		this.capabilities["aws-comprehend"] = comprehend
	}
...
fun AmazonComprehendFunctions.batchDetectDominantLanguage(textList: List<String>, init: (AmazonComprehendBatchDetectDominantLanguageCommand.() -> Unit)? = null): com.amazonaws.services.comprehend.model.BatchDetectDominantLanguageResult {
	return this.block.declare(AmazonComprehendBatchDetectDominantLanguageCommand(textList).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.comprehend.model.BatchDetectDominantLanguageResult
}
...
class AmazonComprehendBatchDetectDominantLanguageCommand(val textList: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.comprehend.model.BatchDetectDominantLanguageRequest, com.amazonaws.services.comprehend.model.BatchDetectDominantLanguageResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.comprehend.model.BatchDetectDominantLanguageResult {
...
fun AmazonComprehendFunctions.batchDetectEntities(textList: List<String>, languageCode: String, init: (AmazonComprehendBatchDetectEntitiesCommand.() -> Unit)? = null): com.amazonaws.services.comprehend.model.BatchDetectEntitiesResult {
	return this.block.declare(AmazonComprehendBatchDetectEntitiesCommand(textList, languageCode).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.comprehend.model.BatchDetectEntitiesResult
}
...
class AmazonComprehendBatchDetectEntitiesCommand(val textList: List<String>, val languageCode: String) : AmazonWebServiceCommand<com.amazonaws.services.comprehend.model.BatchDetectEntitiesRequest, com.amazonaws.services.comprehend.model.BatchDetectEntitiesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.comprehend.model.BatchDetectEntitiesResult {
...
fun AmazonComprehendFunctions.batchDetectKeyPhrases(textList: List<String>, languageCode: String, init: (AmazonComprehendBatchDetectKeyPhrasesCommand.() -> Unit)? = null): com.amazonaws.services.comprehend.model.BatchDetectKeyPhrasesResult {
	return this.block.declare(AmazonComprehendBatchDetectKeyPhrasesCommand(textList, languageCode).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.comprehend.model.BatchDetectKeyPhrasesResult
}
...
class AmazonComprehendBatchDetectKeyPhrasesCommand(val textList: List<String>, val languageCode: String) : AmazonWebServiceCommand<com.amazonaws.services.comprehend.model.BatchDetectKeyPhrasesRequest, com.amazonaws.services.comprehend.model.BatchDetectKeyPhrasesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.comprehend.model.BatchDetectKeyPhrasesResult {
...
fun AmazonComprehendFunctions.batchDetectSentiment(textList: List<String>, languageCode: String, init: (AmazonComprehendBatchDetectSentimentCommand.() -> Unit)? = null): com.amazonaws.services.comprehend.model.BatchDetectSentimentResult {
	return this.block.declare(AmazonComprehendBatchDetectSentimentCommand(textList, languageCode).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.comprehend.model.BatchDetectSentimentResult
}
...
class AmazonComprehendBatchDetectSentimentCommand(val textList: List<String>, val languageCode: String) : AmazonWebServiceCommand<com.amazonaws.services.comprehend.model.BatchDetectSentimentRequest, com.amazonaws.services.comprehend.model.BatchDetectSentimentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.comprehend.model.BatchDetectSentimentResult {
...
fun AmazonComprehendFunctions.describeTopicsDetectionJob(jobId: String, init: (AmazonComprehendDescribeTopicsDetectionJobCommand.() -> Unit)? = null): com.amazonaws.services.comprehend.model.DescribeTopicsDetectionJobResult {
	return this.block.declare(AmazonComprehendDescribeTopicsDetectionJobCommand(jobId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.comprehend.model.DescribeTopicsDetectionJobResult
}
...
class AmazonComprehendDescribeTopicsDetectionJobCommand(val jobId: String) : AmazonWebServiceCommand<com.amazonaws.services.comprehend.model.DescribeTopicsDetectionJobRequest, com.amazonaws.services.comprehend.model.DescribeTopicsDetectionJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.comprehend.model.DescribeTopicsDetectionJobResult {
...
fun AmazonComprehendFunctions.detectDominantLanguage(text: String, init: (AmazonComprehendDetectDominantLanguageCommand.() -> Unit)? = null): com.amazonaws.services.comprehend.model.DetectDominantLanguageResult {
	return this.block.declare(AmazonComprehendDetectDominantLanguageCommand(text).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.comprehend.model.DetectDominantLanguageResult
}
...
class AmazonComprehendDetectDominantLanguageCommand(val text: String) : AmazonWebServiceCommand<com.amazonaws.services.comprehend.model.DetectDominantLanguageRequest, com.amazonaws.services.comprehend.model.DetectDominantLanguageResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.comprehend.model.DetectDominantLanguageResult {
...
fun AmazonComprehendFunctions.detectEntities(text: String, languageCode: LanguageCode, init: (AmazonComprehendDetectEntitiesCommand.() -> Unit)? = null): com.amazonaws.services.comprehend.model.DetectEntitiesResult {
	return this.block.declare(AmazonComprehendDetectEntitiesCommand(text, languageCode).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.comprehend.model.DetectEntitiesResult
}
...
class AmazonComprehendDetectEntitiesCommand(val text: String, val languageCode: LanguageCode) : AmazonWebServiceCommand<com.amazonaws.services.comprehend.model.DetectEntitiesRequest, com.amazonaws.services.comprehend.model.DetectEntitiesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.comprehend.model.DetectEntitiesResult {
...
fun AmazonComprehendFunctions.detectKeyPhrases(text: String, languageCode: LanguageCode, init: (AmazonComprehendDetectKeyPhrasesCommand.() -> Unit)? = null): com.amazonaws.services.comprehend.model.DetectKeyPhrasesResult {
	return this.block.declare(AmazonComprehendDetectKeyPhrasesCommand(text, languageCode).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.comprehend.model.DetectKeyPhrasesResult
}
...
class AmazonComprehendDetectKeyPhrasesCommand(val text: String, val languageCode: LanguageCode) : AmazonWebServiceCommand<com.amazonaws.services.comprehend.model.DetectKeyPhrasesRequest, com.amazonaws.services.comprehend.model.DetectKeyPhrasesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.comprehend.model.DetectKeyPhrasesResult {
...
fun AmazonComprehendFunctions.detectSentiment(text: String, languageCode: LanguageCode, init: (AmazonComprehendDetectSentimentCommand.() -> Unit)? = null): com.amazonaws.services.comprehend.model.DetectSentimentResult {
	return this.block.declare(AmazonComprehendDetectSentimentCommand(text, languageCode).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.comprehend.model.DetectSentimentResult
}
...
class AmazonComprehendDetectSentimentCommand(val text: String, val languageCode: LanguageCode) : AmazonWebServiceCommand<com.amazonaws.services.comprehend.model.DetectSentimentRequest, com.amazonaws.services.comprehend.model.DetectSentimentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.comprehend.model.DetectSentimentResult {
...
fun AmazonComprehendFunctions.listTopicsDetectionJobs(init: (AmazonComprehendListTopicsDetectionJobsCommand.() -> Unit)? = null): com.amazonaws.services.comprehend.model.ListTopicsDetectionJobsResult {
	return this.block.declare(AmazonComprehendListTopicsDetectionJobsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.comprehend.model.ListTopicsDetectionJobsResult
}
...
class AmazonComprehendListTopicsDetectionJobsCommand() : AmazonWebServiceCommand<com.amazonaws.services.comprehend.model.ListTopicsDetectionJobsRequest, com.amazonaws.services.comprehend.model.ListTopicsDetectionJobsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.comprehend.model.ListTopicsDetectionJobsResult {
...
fun AmazonComprehendFunctions.startTopicsDetectionJob(inputDataConfig: com.amazonaws.services.comprehend.model.InputDataConfig, outputDataConfig: com.amazonaws.services.comprehend.model.OutputDataConfig, dataAccessRoleArn: String, init: (AmazonComprehendStartTopicsDetectionJobCommand.() -> Unit)? = null): com.amazonaws.services.comprehend.model.StartTopicsDetectionJobResult {
	return this.block.declare(AmazonComprehendStartTopicsDetectionJobCommand(inputDataConfig, outputDataConfig, dataAccessRoleArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.comprehend.model.StartTopicsDetectionJobResult
}
...
class AmazonComprehendStartTopicsDetectionJobCommand(val inputDataConfig: com.amazonaws.services.comprehend.model.InputDataConfig, val outputDataConfig: com.amazonaws.services.comprehend.model.OutputDataConfig, val dataAccessRoleArn: String) : AmazonWebServiceCommand<com.amazonaws.services.comprehend.model.StartTopicsDetectionJobRequest, com.amazonaws.services.comprehend.model.StartTopicsDetectionJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.comprehend.model.StartTopicsDetectionJobResult {
