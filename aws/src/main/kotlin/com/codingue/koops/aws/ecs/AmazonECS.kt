...
package com.codingue.koops.aws.ecs
...
var com.codingue.koops.core.Environment.ecs: AmazonECS
	get() {
		var service = this.capabilities["aws-ecs"]
		if (service == null) {
			service = AmazonECSClientBuilder.standard().build()
			this.capabilities["aws-ecs"] = service
		}
		return service as AmazonECS
	}
	set(ecs) {
		this.capabilities["aws-ecs"] = ecs
	}
...
fun AmazonECSFunctions.createCluster(init: (AmazonECSCreateClusterCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.CreateClusterResult {
	return this.block.declare(AmazonECSCreateClusterCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.CreateClusterResult
}
...
class AmazonECSCreateClusterCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.CreateClusterRequest, com.amazonaws.services.ecs.model.CreateClusterResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.CreateClusterResult {
...
fun AmazonECSFunctions.createService(init: (AmazonECSCreateServiceCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.CreateServiceResult {
	return this.block.declare(AmazonECSCreateServiceCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.CreateServiceResult
}
...
class AmazonECSCreateServiceCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.CreateServiceRequest, com.amazonaws.services.ecs.model.CreateServiceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.CreateServiceResult {
...
fun AmazonECSFunctions.deleteAttributes(init: (AmazonECSDeleteAttributesCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.DeleteAttributesResult {
	return this.block.declare(AmazonECSDeleteAttributesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.DeleteAttributesResult
}
...
class AmazonECSDeleteAttributesCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.DeleteAttributesRequest, com.amazonaws.services.ecs.model.DeleteAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.DeleteAttributesResult {
...
fun AmazonECSFunctions.deleteCluster(init: (AmazonECSDeleteClusterCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.DeleteClusterResult {
	return this.block.declare(AmazonECSDeleteClusterCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.DeleteClusterResult
}
...
class AmazonECSDeleteClusterCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.DeleteClusterRequest, com.amazonaws.services.ecs.model.DeleteClusterResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.DeleteClusterResult {
...
fun AmazonECSFunctions.deleteService(init: (AmazonECSDeleteServiceCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.DeleteServiceResult {
	return this.block.declare(AmazonECSDeleteServiceCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.DeleteServiceResult
}
...
class AmazonECSDeleteServiceCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.DeleteServiceRequest, com.amazonaws.services.ecs.model.DeleteServiceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.DeleteServiceResult {
...
fun AmazonECSFunctions.deregisterContainerInstance(init: (AmazonECSDeregisterContainerInstanceCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.DeregisterContainerInstanceResult {
	return this.block.declare(AmazonECSDeregisterContainerInstanceCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.DeregisterContainerInstanceResult
}
...
class AmazonECSDeregisterContainerInstanceCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.DeregisterContainerInstanceRequest, com.amazonaws.services.ecs.model.DeregisterContainerInstanceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.DeregisterContainerInstanceResult {
...
fun AmazonECSFunctions.deregisterTaskDefinition(init: (AmazonECSDeregisterTaskDefinitionCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.DeregisterTaskDefinitionResult {
	return this.block.declare(AmazonECSDeregisterTaskDefinitionCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.DeregisterTaskDefinitionResult
}
...
class AmazonECSDeregisterTaskDefinitionCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.DeregisterTaskDefinitionRequest, com.amazonaws.services.ecs.model.DeregisterTaskDefinitionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.DeregisterTaskDefinitionResult {
...
fun AmazonECSFunctions.describeClusters(init: (AmazonECSDescribeClustersCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.DescribeClustersResult {
	return this.block.declare(AmazonECSDescribeClustersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.DescribeClustersResult
}
...
class AmazonECSDescribeClustersCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.DescribeClustersRequest, com.amazonaws.services.ecs.model.DescribeClustersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.DescribeClustersResult {
...
fun AmazonECSFunctions.describeContainerInstances(init: (AmazonECSDescribeContainerInstancesCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.DescribeContainerInstancesResult {
	return this.block.declare(AmazonECSDescribeContainerInstancesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.DescribeContainerInstancesResult
}
...
class AmazonECSDescribeContainerInstancesCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.DescribeContainerInstancesRequest, com.amazonaws.services.ecs.model.DescribeContainerInstancesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.DescribeContainerInstancesResult {
...
fun AmazonECSFunctions.describeServices(init: (AmazonECSDescribeServicesCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.DescribeServicesResult {
	return this.block.declare(AmazonECSDescribeServicesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.DescribeServicesResult
}
...
class AmazonECSDescribeServicesCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.DescribeServicesRequest, com.amazonaws.services.ecs.model.DescribeServicesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.DescribeServicesResult {
...
fun AmazonECSFunctions.describeTaskDefinition(init: (AmazonECSDescribeTaskDefinitionCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.DescribeTaskDefinitionResult {
	return this.block.declare(AmazonECSDescribeTaskDefinitionCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.DescribeTaskDefinitionResult
}
...
class AmazonECSDescribeTaskDefinitionCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.DescribeTaskDefinitionRequest, com.amazonaws.services.ecs.model.DescribeTaskDefinitionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.DescribeTaskDefinitionResult {
...
fun AmazonECSFunctions.describeTasks(init: (AmazonECSDescribeTasksCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.DescribeTasksResult {
	return this.block.declare(AmazonECSDescribeTasksCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.DescribeTasksResult
}
...
class AmazonECSDescribeTasksCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.DescribeTasksRequest, com.amazonaws.services.ecs.model.DescribeTasksResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.DescribeTasksResult {
...
fun AmazonECSFunctions.discoverPollEndpoint(init: (AmazonECSDiscoverPollEndpointCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.DiscoverPollEndpointResult {
	return this.block.declare(AmazonECSDiscoverPollEndpointCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.DiscoverPollEndpointResult
}
...
class AmazonECSDiscoverPollEndpointCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.DiscoverPollEndpointRequest, com.amazonaws.services.ecs.model.DiscoverPollEndpointResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.DiscoverPollEndpointResult {
...
fun AmazonECSFunctions.listAttributes(init: (AmazonECSListAttributesCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.ListAttributesResult {
	return this.block.declare(AmazonECSListAttributesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.ListAttributesResult
}
...
class AmazonECSListAttributesCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.ListAttributesRequest, com.amazonaws.services.ecs.model.ListAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.ListAttributesResult {
...
fun AmazonECSFunctions.listClusters(init: (AmazonECSListClustersCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.ListClustersResult {
	return this.block.declare(AmazonECSListClustersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.ListClustersResult
}
...
class AmazonECSListClustersCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.ListClustersRequest, com.amazonaws.services.ecs.model.ListClustersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.ListClustersResult {
...
fun AmazonECSFunctions.listContainerInstances(init: (AmazonECSListContainerInstancesCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.ListContainerInstancesResult {
	return this.block.declare(AmazonECSListContainerInstancesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.ListContainerInstancesResult
}
...
class AmazonECSListContainerInstancesCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.ListContainerInstancesRequest, com.amazonaws.services.ecs.model.ListContainerInstancesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.ListContainerInstancesResult {
...
fun AmazonECSFunctions.listServices(init: (AmazonECSListServicesCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.ListServicesResult {
	return this.block.declare(AmazonECSListServicesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.ListServicesResult
}
...
class AmazonECSListServicesCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.ListServicesRequest, com.amazonaws.services.ecs.model.ListServicesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.ListServicesResult {
...
fun AmazonECSFunctions.listTaskDefinitionFamilies(init: (AmazonECSListTaskDefinitionFamiliesCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.ListTaskDefinitionFamiliesResult {
	return this.block.declare(AmazonECSListTaskDefinitionFamiliesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.ListTaskDefinitionFamiliesResult
}
...
class AmazonECSListTaskDefinitionFamiliesCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.ListTaskDefinitionFamiliesRequest, com.amazonaws.services.ecs.model.ListTaskDefinitionFamiliesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.ListTaskDefinitionFamiliesResult {
...
fun AmazonECSFunctions.listTaskDefinitions(init: (AmazonECSListTaskDefinitionsCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.ListTaskDefinitionsResult {
	return this.block.declare(AmazonECSListTaskDefinitionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.ListTaskDefinitionsResult
}
...
class AmazonECSListTaskDefinitionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.ListTaskDefinitionsRequest, com.amazonaws.services.ecs.model.ListTaskDefinitionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.ListTaskDefinitionsResult {
...
fun AmazonECSFunctions.listTasks(init: (AmazonECSListTasksCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.ListTasksResult {
	return this.block.declare(AmazonECSListTasksCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.ListTasksResult
}
...
class AmazonECSListTasksCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.ListTasksRequest, com.amazonaws.services.ecs.model.ListTasksResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.ListTasksResult {
...
fun AmazonECSFunctions.putAttributes(init: (AmazonECSPutAttributesCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.PutAttributesResult {
	return this.block.declare(AmazonECSPutAttributesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.PutAttributesResult
}
...
class AmazonECSPutAttributesCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.PutAttributesRequest, com.amazonaws.services.ecs.model.PutAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.PutAttributesResult {
...
fun AmazonECSFunctions.registerContainerInstance(init: (AmazonECSRegisterContainerInstanceCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.RegisterContainerInstanceResult {
	return this.block.declare(AmazonECSRegisterContainerInstanceCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.RegisterContainerInstanceResult
}
...
class AmazonECSRegisterContainerInstanceCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.RegisterContainerInstanceRequest, com.amazonaws.services.ecs.model.RegisterContainerInstanceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.RegisterContainerInstanceResult {
...
fun AmazonECSFunctions.registerTaskDefinition(init: (AmazonECSRegisterTaskDefinitionCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.RegisterTaskDefinitionResult {
	return this.block.declare(AmazonECSRegisterTaskDefinitionCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.RegisterTaskDefinitionResult
}
...
class AmazonECSRegisterTaskDefinitionCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.RegisterTaskDefinitionRequest, com.amazonaws.services.ecs.model.RegisterTaskDefinitionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.RegisterTaskDefinitionResult {
...
fun AmazonECSFunctions.runTask(init: (AmazonECSRunTaskCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.RunTaskResult {
	return this.block.declare(AmazonECSRunTaskCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.RunTaskResult
}
...
class AmazonECSRunTaskCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.RunTaskRequest, com.amazonaws.services.ecs.model.RunTaskResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.RunTaskResult {
...
fun AmazonECSFunctions.startTask(init: (AmazonECSStartTaskCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.StartTaskResult {
	return this.block.declare(AmazonECSStartTaskCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.StartTaskResult
}
...
class AmazonECSStartTaskCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.StartTaskRequest, com.amazonaws.services.ecs.model.StartTaskResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.StartTaskResult {
...
fun AmazonECSFunctions.stopTask(init: (AmazonECSStopTaskCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.StopTaskResult {
	return this.block.declare(AmazonECSStopTaskCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.StopTaskResult
}
...
class AmazonECSStopTaskCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.StopTaskRequest, com.amazonaws.services.ecs.model.StopTaskResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.StopTaskResult {
...
fun AmazonECSFunctions.submitContainerStateChange(init: (AmazonECSSubmitContainerStateChangeCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.SubmitContainerStateChangeResult {
	return this.block.declare(AmazonECSSubmitContainerStateChangeCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.SubmitContainerStateChangeResult
}
...
class AmazonECSSubmitContainerStateChangeCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.SubmitContainerStateChangeRequest, com.amazonaws.services.ecs.model.SubmitContainerStateChangeResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.SubmitContainerStateChangeResult {
...
fun AmazonECSFunctions.submitTaskStateChange(init: (AmazonECSSubmitTaskStateChangeCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.SubmitTaskStateChangeResult {
	return this.block.declare(AmazonECSSubmitTaskStateChangeCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.SubmitTaskStateChangeResult
}
...
class AmazonECSSubmitTaskStateChangeCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.SubmitTaskStateChangeRequest, com.amazonaws.services.ecs.model.SubmitTaskStateChangeResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.SubmitTaskStateChangeResult {
...
fun AmazonECSFunctions.updateContainerAgent(init: (AmazonECSUpdateContainerAgentCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.UpdateContainerAgentResult {
	return this.block.declare(AmazonECSUpdateContainerAgentCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.UpdateContainerAgentResult
}
...
class AmazonECSUpdateContainerAgentCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.UpdateContainerAgentRequest, com.amazonaws.services.ecs.model.UpdateContainerAgentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.UpdateContainerAgentResult {
...
fun AmazonECSFunctions.updateContainerInstancesState(init: (AmazonECSUpdateContainerInstancesStateCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.UpdateContainerInstancesStateResult {
	return this.block.declare(AmazonECSUpdateContainerInstancesStateCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.UpdateContainerInstancesStateResult
}
...
class AmazonECSUpdateContainerInstancesStateCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.UpdateContainerInstancesStateRequest, com.amazonaws.services.ecs.model.UpdateContainerInstancesStateResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.UpdateContainerInstancesStateResult {
...
fun AmazonECSFunctions.updateService(init: (AmazonECSUpdateServiceCommand.() -> Unit)? = null): com.amazonaws.services.ecs.model.UpdateServiceResult {
	return this.block.declare(AmazonECSUpdateServiceCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.ecs.model.UpdateServiceResult
}
...
class AmazonECSUpdateServiceCommand() : AmazonWebServiceCommand<com.amazonaws.services.ecs.model.UpdateServiceRequest, com.amazonaws.services.ecs.model.UpdateServiceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.ecs.model.UpdateServiceResult {
