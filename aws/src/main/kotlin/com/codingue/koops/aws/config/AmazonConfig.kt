...
package com.codingue.koops.aws.config

import javax.annotation.Generated
import com.codingue.koops.common.*
import com.codingue.koops.core.*
import com.codingue.koops.aws.*
import com.amazonaws.services.config.*
import com.amazonaws.services.config.model.*

var com.codingue.koops.core.Environment.config: AmazonConfig
	get() {
		var service = this.capabilities["aws-config"]
		if (service == null) {
			service = AmazonConfigClientBuilder.standard().build()
			this.capabilities["aws-config"] = service
		}
		return service as AmazonConfig
	}
	set(config) {
		this.capabilities["aws-config"] = config
	}
...
fun AmazonConfigFunctions.batchGetResourceConfig(init: (AmazonConfigBatchGetResourceConfigCommand.() -> Unit)? = null): com.amazonaws.services.config.model.BatchGetResourceConfigResult {
	return this.block.declare(AmazonConfigBatchGetResourceConfigCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.BatchGetResourceConfigResult
}
...
class AmazonConfigBatchGetResourceConfigCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.BatchGetResourceConfigRequest, com.amazonaws.services.config.model.BatchGetResourceConfigResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.BatchGetResourceConfigResult {
...
fun AmazonConfigFunctions.deleteAggregationAuthorization(authorizedAccountId: String, authorizedAwsRegion: String, init: (AmazonConfigDeleteAggregationAuthorizationCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DeleteAggregationAuthorizationResult {
	return this.block.declare(AmazonConfigDeleteAggregationAuthorizationCommand(authorizedAccountId, authorizedAwsRegion).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DeleteAggregationAuthorizationResult
}
...
class AmazonConfigDeleteAggregationAuthorizationCommand(val authorizedAccountId: String, val authorizedAwsRegion: String) : AmazonWebServiceCommand<com.amazonaws.services.config.model.DeleteAggregationAuthorizationRequest, com.amazonaws.services.config.model.DeleteAggregationAuthorizationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DeleteAggregationAuthorizationResult {
...
fun AmazonConfigFunctions.deleteConfigRule(configRuleName: String, init: (AmazonConfigDeleteConfigRuleCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DeleteConfigRuleResult {
	return this.block.declare(AmazonConfigDeleteConfigRuleCommand(configRuleName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DeleteConfigRuleResult
}
...
class AmazonConfigDeleteConfigRuleCommand(val configRuleName: String) : AmazonWebServiceCommand<com.amazonaws.services.config.model.DeleteConfigRuleRequest, com.amazonaws.services.config.model.DeleteConfigRuleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DeleteConfigRuleResult {
...
fun AmazonConfigFunctions.deleteConfigurationAggregator(configurationAggregatorName: String, init: (AmazonConfigDeleteConfigurationAggregatorCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DeleteConfigurationAggregatorResult {
	return this.block.declare(AmazonConfigDeleteConfigurationAggregatorCommand(configurationAggregatorName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DeleteConfigurationAggregatorResult
}
...
class AmazonConfigDeleteConfigurationAggregatorCommand(val configurationAggregatorName: String) : AmazonWebServiceCommand<com.amazonaws.services.config.model.DeleteConfigurationAggregatorRequest, com.amazonaws.services.config.model.DeleteConfigurationAggregatorResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DeleteConfigurationAggregatorResult {
...
fun AmazonConfigFunctions.deleteConfigurationRecorder(configurationRecorderName: String, init: (AmazonConfigDeleteConfigurationRecorderCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DeleteConfigurationRecorderResult {
	return this.block.declare(AmazonConfigDeleteConfigurationRecorderCommand(configurationRecorderName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DeleteConfigurationRecorderResult
}
...
class AmazonConfigDeleteConfigurationRecorderCommand(val configurationRecorderName: String) : AmazonWebServiceCommand<com.amazonaws.services.config.model.DeleteConfigurationRecorderRequest, com.amazonaws.services.config.model.DeleteConfigurationRecorderResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DeleteConfigurationRecorderResult {
...
fun AmazonConfigFunctions.deleteDeliveryChannel(deliveryChannelName: String, init: (AmazonConfigDeleteDeliveryChannelCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DeleteDeliveryChannelResult {
	return this.block.declare(AmazonConfigDeleteDeliveryChannelCommand(deliveryChannelName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DeleteDeliveryChannelResult
}
...
class AmazonConfigDeleteDeliveryChannelCommand(val deliveryChannelName: String) : AmazonWebServiceCommand<com.amazonaws.services.config.model.DeleteDeliveryChannelRequest, com.amazonaws.services.config.model.DeleteDeliveryChannelResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DeleteDeliveryChannelResult {
...
fun AmazonConfigFunctions.deleteEvaluationResults(configRuleName: String, init: (AmazonConfigDeleteEvaluationResultsCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DeleteEvaluationResultsResult {
	return this.block.declare(AmazonConfigDeleteEvaluationResultsCommand(configRuleName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DeleteEvaluationResultsResult
}
...
class AmazonConfigDeleteEvaluationResultsCommand(val configRuleName: String) : AmazonWebServiceCommand<com.amazonaws.services.config.model.DeleteEvaluationResultsRequest, com.amazonaws.services.config.model.DeleteEvaluationResultsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DeleteEvaluationResultsResult {
...
fun AmazonConfigFunctions.deletePendingAggregationRequest(requesterAccountId: String, requesterAwsRegion: String, init: (AmazonConfigDeletePendingAggregationRequestCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DeletePendingAggregationRequestResult {
	return this.block.declare(AmazonConfigDeletePendingAggregationRequestCommand(requesterAccountId, requesterAwsRegion).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DeletePendingAggregationRequestResult
}
...
class AmazonConfigDeletePendingAggregationRequestCommand(val requesterAccountId: String, val requesterAwsRegion: String) : AmazonWebServiceCommand<com.amazonaws.services.config.model.DeletePendingAggregationRequestRequest, com.amazonaws.services.config.model.DeletePendingAggregationRequestResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DeletePendingAggregationRequestResult {
...
fun AmazonConfigFunctions.deliverConfigSnapshot(init: (AmazonConfigDeliverConfigSnapshotCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DeliverConfigSnapshotResult {
	return this.block.declare(AmazonConfigDeliverConfigSnapshotCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DeliverConfigSnapshotResult
}
...
class AmazonConfigDeliverConfigSnapshotCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.DeliverConfigSnapshotRequest, com.amazonaws.services.config.model.DeliverConfigSnapshotResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DeliverConfigSnapshotResult {
...
fun AmazonConfigFunctions.describeAggregateComplianceByConfigRules(configurationAggregatorName: String, init: (AmazonConfigDescribeAggregateComplianceByConfigRulesCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DescribeAggregateComplianceByConfigRulesResult {
	return this.block.declare(AmazonConfigDescribeAggregateComplianceByConfigRulesCommand(configurationAggregatorName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DescribeAggregateComplianceByConfigRulesResult
}
...
class AmazonConfigDescribeAggregateComplianceByConfigRulesCommand(val configurationAggregatorName: String) : AmazonWebServiceCommand<com.amazonaws.services.config.model.DescribeAggregateComplianceByConfigRulesRequest, com.amazonaws.services.config.model.DescribeAggregateComplianceByConfigRulesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DescribeAggregateComplianceByConfigRulesResult {
...
fun AmazonConfigFunctions.describeAggregationAuthorizations(init: (AmazonConfigDescribeAggregationAuthorizationsCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DescribeAggregationAuthorizationsResult {
	return this.block.declare(AmazonConfigDescribeAggregationAuthorizationsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DescribeAggregationAuthorizationsResult
}
...
class AmazonConfigDescribeAggregationAuthorizationsCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.DescribeAggregationAuthorizationsRequest, com.amazonaws.services.config.model.DescribeAggregationAuthorizationsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DescribeAggregationAuthorizationsResult {
...
fun AmazonConfigFunctions.describeComplianceByConfigRule(init: (AmazonConfigDescribeComplianceByConfigRuleCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DescribeComplianceByConfigRuleResult {
	return this.block.declare(AmazonConfigDescribeComplianceByConfigRuleCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DescribeComplianceByConfigRuleResult
}
...
class AmazonConfigDescribeComplianceByConfigRuleCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.DescribeComplianceByConfigRuleRequest, com.amazonaws.services.config.model.DescribeComplianceByConfigRuleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DescribeComplianceByConfigRuleResult {
...
fun AmazonConfigFunctions.describeComplianceByResource(init: (AmazonConfigDescribeComplianceByResourceCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DescribeComplianceByResourceResult {
	return this.block.declare(AmazonConfigDescribeComplianceByResourceCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DescribeComplianceByResourceResult
}
...
class AmazonConfigDescribeComplianceByResourceCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.DescribeComplianceByResourceRequest, com.amazonaws.services.config.model.DescribeComplianceByResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DescribeComplianceByResourceResult {
...
fun AmazonConfigFunctions.describeConfigRuleEvaluationStatus(init: (AmazonConfigDescribeConfigRuleEvaluationStatusCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DescribeConfigRuleEvaluationStatusResult {
	return this.block.declare(AmazonConfigDescribeConfigRuleEvaluationStatusCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DescribeConfigRuleEvaluationStatusResult
}
...
class AmazonConfigDescribeConfigRuleEvaluationStatusCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.DescribeConfigRuleEvaluationStatusRequest, com.amazonaws.services.config.model.DescribeConfigRuleEvaluationStatusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DescribeConfigRuleEvaluationStatusResult {
...
fun AmazonConfigFunctions.describeConfigRules(init: (AmazonConfigDescribeConfigRulesCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DescribeConfigRulesResult {
	return this.block.declare(AmazonConfigDescribeConfigRulesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DescribeConfigRulesResult
}
...
class AmazonConfigDescribeConfigRulesCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.DescribeConfigRulesRequest, com.amazonaws.services.config.model.DescribeConfigRulesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DescribeConfigRulesResult {
...
fun AmazonConfigFunctions.describeConfigurationAggregatorSourcesStatus(configurationAggregatorName: String, init: (AmazonConfigDescribeConfigurationAggregatorSourcesStatusCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DescribeConfigurationAggregatorSourcesStatusResult {
	return this.block.declare(AmazonConfigDescribeConfigurationAggregatorSourcesStatusCommand(configurationAggregatorName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DescribeConfigurationAggregatorSourcesStatusResult
}
...
class AmazonConfigDescribeConfigurationAggregatorSourcesStatusCommand(val configurationAggregatorName: String) : AmazonWebServiceCommand<com.amazonaws.services.config.model.DescribeConfigurationAggregatorSourcesStatusRequest, com.amazonaws.services.config.model.DescribeConfigurationAggregatorSourcesStatusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DescribeConfigurationAggregatorSourcesStatusResult {
...
fun AmazonConfigFunctions.describeConfigurationAggregators(init: (AmazonConfigDescribeConfigurationAggregatorsCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DescribeConfigurationAggregatorsResult {
	return this.block.declare(AmazonConfigDescribeConfigurationAggregatorsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DescribeConfigurationAggregatorsResult
}
...
class AmazonConfigDescribeConfigurationAggregatorsCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.DescribeConfigurationAggregatorsRequest, com.amazonaws.services.config.model.DescribeConfigurationAggregatorsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DescribeConfigurationAggregatorsResult {
...
fun AmazonConfigFunctions.describeConfigurationRecorderStatus(init: (AmazonConfigDescribeConfigurationRecorderStatusCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DescribeConfigurationRecorderStatusResult {
	return this.block.declare(AmazonConfigDescribeConfigurationRecorderStatusCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DescribeConfigurationRecorderStatusResult
}
...
class AmazonConfigDescribeConfigurationRecorderStatusCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.DescribeConfigurationRecorderStatusRequest, com.amazonaws.services.config.model.DescribeConfigurationRecorderStatusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DescribeConfigurationRecorderStatusResult {
...
fun AmazonConfigFunctions.describeConfigurationRecorders(init: (AmazonConfigDescribeConfigurationRecordersCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DescribeConfigurationRecordersResult {
	return this.block.declare(AmazonConfigDescribeConfigurationRecordersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DescribeConfigurationRecordersResult
}
...
class AmazonConfigDescribeConfigurationRecordersCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.DescribeConfigurationRecordersRequest, com.amazonaws.services.config.model.DescribeConfigurationRecordersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DescribeConfigurationRecordersResult {
...
fun AmazonConfigFunctions.describeDeliveryChannelStatus(init: (AmazonConfigDescribeDeliveryChannelStatusCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DescribeDeliveryChannelStatusResult {
	return this.block.declare(AmazonConfigDescribeDeliveryChannelStatusCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DescribeDeliveryChannelStatusResult
}
...
class AmazonConfigDescribeDeliveryChannelStatusCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.DescribeDeliveryChannelStatusRequest, com.amazonaws.services.config.model.DescribeDeliveryChannelStatusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DescribeDeliveryChannelStatusResult {
...
fun AmazonConfigFunctions.describeDeliveryChannels(init: (AmazonConfigDescribeDeliveryChannelsCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DescribeDeliveryChannelsResult {
	return this.block.declare(AmazonConfigDescribeDeliveryChannelsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DescribeDeliveryChannelsResult
}
...
class AmazonConfigDescribeDeliveryChannelsCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.DescribeDeliveryChannelsRequest, com.amazonaws.services.config.model.DescribeDeliveryChannelsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DescribeDeliveryChannelsResult {
...
fun AmazonConfigFunctions.describePendingAggregationRequests(init: (AmazonConfigDescribePendingAggregationRequestsCommand.() -> Unit)? = null): com.amazonaws.services.config.model.DescribePendingAggregationRequestsResult {
	return this.block.declare(AmazonConfigDescribePendingAggregationRequestsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.DescribePendingAggregationRequestsResult
}
...
class AmazonConfigDescribePendingAggregationRequestsCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.DescribePendingAggregationRequestsRequest, com.amazonaws.services.config.model.DescribePendingAggregationRequestsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.DescribePendingAggregationRequestsResult {
...
fun AmazonConfigFunctions.getAggregateComplianceDetailsByConfigRule(configurationAggregatorName: String, configRuleName: String, accountId: String, awsRegion: String, init: (AmazonConfigGetAggregateComplianceDetailsByConfigRuleCommand.() -> Unit)? = null): com.amazonaws.services.config.model.GetAggregateComplianceDetailsByConfigRuleResult {
	return this.block.declare(AmazonConfigGetAggregateComplianceDetailsByConfigRuleCommand(configurationAggregatorName, configRuleName, accountId, awsRegion).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.GetAggregateComplianceDetailsByConfigRuleResult
}
...
class AmazonConfigGetAggregateComplianceDetailsByConfigRuleCommand(val configurationAggregatorName: String, val configRuleName: String, val accountId: String, val awsRegion: String) : AmazonWebServiceCommand<com.amazonaws.services.config.model.GetAggregateComplianceDetailsByConfigRuleRequest, com.amazonaws.services.config.model.GetAggregateComplianceDetailsByConfigRuleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.GetAggregateComplianceDetailsByConfigRuleResult {
...
fun AmazonConfigFunctions.getAggregateConfigRuleComplianceSummary(configurationAggregatorName: String, init: (AmazonConfigGetAggregateConfigRuleComplianceSummaryCommand.() -> Unit)? = null): com.amazonaws.services.config.model.GetAggregateConfigRuleComplianceSummaryResult {
	return this.block.declare(AmazonConfigGetAggregateConfigRuleComplianceSummaryCommand(configurationAggregatorName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.GetAggregateConfigRuleComplianceSummaryResult
}
...
class AmazonConfigGetAggregateConfigRuleComplianceSummaryCommand(val configurationAggregatorName: String) : AmazonWebServiceCommand<com.amazonaws.services.config.model.GetAggregateConfigRuleComplianceSummaryRequest, com.amazonaws.services.config.model.GetAggregateConfigRuleComplianceSummaryResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.GetAggregateConfigRuleComplianceSummaryResult {
...
fun AmazonConfigFunctions.getComplianceDetailsByConfigRule(configRuleName: String, init: (AmazonConfigGetComplianceDetailsByConfigRuleCommand.() -> Unit)? = null): com.amazonaws.services.config.model.GetComplianceDetailsByConfigRuleResult {
	return this.block.declare(AmazonConfigGetComplianceDetailsByConfigRuleCommand(configRuleName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.GetComplianceDetailsByConfigRuleResult
}
...
class AmazonConfigGetComplianceDetailsByConfigRuleCommand(val configRuleName: String) : AmazonWebServiceCommand<com.amazonaws.services.config.model.GetComplianceDetailsByConfigRuleRequest, com.amazonaws.services.config.model.GetComplianceDetailsByConfigRuleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.GetComplianceDetailsByConfigRuleResult {
...
fun AmazonConfigFunctions.getComplianceDetailsByResource(resourceType: String, resourceId: String, init: (AmazonConfigGetComplianceDetailsByResourceCommand.() -> Unit)? = null): com.amazonaws.services.config.model.GetComplianceDetailsByResourceResult {
	return this.block.declare(AmazonConfigGetComplianceDetailsByResourceCommand(resourceType, resourceId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.GetComplianceDetailsByResourceResult
}
...
class AmazonConfigGetComplianceDetailsByResourceCommand(val resourceType: String, val resourceId: String) : AmazonWebServiceCommand<com.amazonaws.services.config.model.GetComplianceDetailsByResourceRequest, com.amazonaws.services.config.model.GetComplianceDetailsByResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.GetComplianceDetailsByResourceResult {
...
fun AmazonConfigFunctions.getComplianceSummaryByConfigRule(init: (AmazonConfigGetComplianceSummaryByConfigRuleCommand.() -> Unit)? = null): com.amazonaws.services.config.model.GetComplianceSummaryByConfigRuleResult {
	return this.block.declare(AmazonConfigGetComplianceSummaryByConfigRuleCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.GetComplianceSummaryByConfigRuleResult
}
...
class AmazonConfigGetComplianceSummaryByConfigRuleCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.GetComplianceSummaryByConfigRuleRequest, com.amazonaws.services.config.model.GetComplianceSummaryByConfigRuleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.GetComplianceSummaryByConfigRuleResult {
...
fun AmazonConfigFunctions.getComplianceSummaryByResourceType(init: (AmazonConfigGetComplianceSummaryByResourceTypeCommand.() -> Unit)? = null): com.amazonaws.services.config.model.GetComplianceSummaryByResourceTypeResult {
	return this.block.declare(AmazonConfigGetComplianceSummaryByResourceTypeCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.GetComplianceSummaryByResourceTypeResult
}
...
class AmazonConfigGetComplianceSummaryByResourceTypeCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.GetComplianceSummaryByResourceTypeRequest, com.amazonaws.services.config.model.GetComplianceSummaryByResourceTypeResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.GetComplianceSummaryByResourceTypeResult {
...
fun AmazonConfigFunctions.getDiscoveredResourceCounts(init: (AmazonConfigGetDiscoveredResourceCountsCommand.() -> Unit)? = null): com.amazonaws.services.config.model.GetDiscoveredResourceCountsResult {
	return this.block.declare(AmazonConfigGetDiscoveredResourceCountsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.GetDiscoveredResourceCountsResult
}
...
class AmazonConfigGetDiscoveredResourceCountsCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.GetDiscoveredResourceCountsRequest, com.amazonaws.services.config.model.GetDiscoveredResourceCountsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.GetDiscoveredResourceCountsResult {
...
fun AmazonConfigFunctions.getResourceConfigHistory(init: (AmazonConfigGetResourceConfigHistoryCommand.() -> Unit)? = null): com.amazonaws.services.config.model.GetResourceConfigHistoryResult {
	return this.block.declare(AmazonConfigGetResourceConfigHistoryCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.GetResourceConfigHistoryResult
}
...
class AmazonConfigGetResourceConfigHistoryCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.GetResourceConfigHistoryRequest, com.amazonaws.services.config.model.GetResourceConfigHistoryResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.GetResourceConfigHistoryResult {
...
fun AmazonConfigFunctions.listDiscoveredResources(init: (AmazonConfigListDiscoveredResourcesCommand.() -> Unit)? = null): com.amazonaws.services.config.model.ListDiscoveredResourcesResult {
	return this.block.declare(AmazonConfigListDiscoveredResourcesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.ListDiscoveredResourcesResult
}
...
class AmazonConfigListDiscoveredResourcesCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.ListDiscoveredResourcesRequest, com.amazonaws.services.config.model.ListDiscoveredResourcesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.ListDiscoveredResourcesResult {
...
fun AmazonConfigFunctions.putAggregationAuthorization(authorizedAccountId: String, authorizedAwsRegion: String, init: (AmazonConfigPutAggregationAuthorizationCommand.() -> Unit)? = null): com.amazonaws.services.config.model.PutAggregationAuthorizationResult {
	return this.block.declare(AmazonConfigPutAggregationAuthorizationCommand(authorizedAccountId, authorizedAwsRegion).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.PutAggregationAuthorizationResult
}
...
class AmazonConfigPutAggregationAuthorizationCommand(val authorizedAccountId: String, val authorizedAwsRegion: String) : AmazonWebServiceCommand<com.amazonaws.services.config.model.PutAggregationAuthorizationRequest, com.amazonaws.services.config.model.PutAggregationAuthorizationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.PutAggregationAuthorizationResult {
...
fun AmazonConfigFunctions.putConfigRule(configRule: com.amazonaws.services.config.model.ConfigRule, init: (AmazonConfigPutConfigRuleCommand.() -> Unit)? = null): com.amazonaws.services.config.model.PutConfigRuleResult {
	return this.block.declare(AmazonConfigPutConfigRuleCommand(configRule).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.PutConfigRuleResult
}
...
class AmazonConfigPutConfigRuleCommand(val configRule: com.amazonaws.services.config.model.ConfigRule) : AmazonWebServiceCommand<com.amazonaws.services.config.model.PutConfigRuleRequest, com.amazonaws.services.config.model.PutConfigRuleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.PutConfigRuleResult {
...
fun AmazonConfigFunctions.putConfigurationAggregator(configurationAggregatorName: String, init: (AmazonConfigPutConfigurationAggregatorCommand.() -> Unit)? = null): com.amazonaws.services.config.model.PutConfigurationAggregatorResult {
	return this.block.declare(AmazonConfigPutConfigurationAggregatorCommand(configurationAggregatorName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.PutConfigurationAggregatorResult
}
...
class AmazonConfigPutConfigurationAggregatorCommand(val configurationAggregatorName: String) : AmazonWebServiceCommand<com.amazonaws.services.config.model.PutConfigurationAggregatorRequest, com.amazonaws.services.config.model.PutConfigurationAggregatorResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.PutConfigurationAggregatorResult {
...
fun AmazonConfigFunctions.putConfigurationRecorder(configurationRecorder: com.amazonaws.services.config.model.ConfigurationRecorder, init: (AmazonConfigPutConfigurationRecorderCommand.() -> Unit)? = null): com.amazonaws.services.config.model.PutConfigurationRecorderResult {
	return this.block.declare(AmazonConfigPutConfigurationRecorderCommand(configurationRecorder).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.PutConfigurationRecorderResult
}
...
class AmazonConfigPutConfigurationRecorderCommand(val configurationRecorder: com.amazonaws.services.config.model.ConfigurationRecorder) : AmazonWebServiceCommand<com.amazonaws.services.config.model.PutConfigurationRecorderRequest, com.amazonaws.services.config.model.PutConfigurationRecorderResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.PutConfigurationRecorderResult {
...
fun AmazonConfigFunctions.putDeliveryChannel(deliveryChannel: com.amazonaws.services.config.model.DeliveryChannel, init: (AmazonConfigPutDeliveryChannelCommand.() -> Unit)? = null): com.amazonaws.services.config.model.PutDeliveryChannelResult {
	return this.block.declare(AmazonConfigPutDeliveryChannelCommand(deliveryChannel).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.PutDeliveryChannelResult
}
...
class AmazonConfigPutDeliveryChannelCommand(val deliveryChannel: com.amazonaws.services.config.model.DeliveryChannel) : AmazonWebServiceCommand<com.amazonaws.services.config.model.PutDeliveryChannelRequest, com.amazonaws.services.config.model.PutDeliveryChannelResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.PutDeliveryChannelResult {
...
fun AmazonConfigFunctions.putEvaluations(resultToken: String, init: (AmazonConfigPutEvaluationsCommand.() -> Unit)? = null): com.amazonaws.services.config.model.PutEvaluationsResult {
	return this.block.declare(AmazonConfigPutEvaluationsCommand(resultToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.PutEvaluationsResult
}
...
class AmazonConfigPutEvaluationsCommand(val resultToken: String) : AmazonWebServiceCommand<com.amazonaws.services.config.model.PutEvaluationsRequest, com.amazonaws.services.config.model.PutEvaluationsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.PutEvaluationsResult {
...
fun AmazonConfigFunctions.startConfigRulesEvaluation(init: (AmazonConfigStartConfigRulesEvaluationCommand.() -> Unit)? = null): com.amazonaws.services.config.model.StartConfigRulesEvaluationResult {
	return this.block.declare(AmazonConfigStartConfigRulesEvaluationCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.StartConfigRulesEvaluationResult
}
...
class AmazonConfigStartConfigRulesEvaluationCommand() : AmazonWebServiceCommand<com.amazonaws.services.config.model.StartConfigRulesEvaluationRequest, com.amazonaws.services.config.model.StartConfigRulesEvaluationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.StartConfigRulesEvaluationResult {
...
fun AmazonConfigFunctions.startConfigurationRecorder(configurationRecorderName: String, init: (AmazonConfigStartConfigurationRecorderCommand.() -> Unit)? = null): com.amazonaws.services.config.model.StartConfigurationRecorderResult {
	return this.block.declare(AmazonConfigStartConfigurationRecorderCommand(configurationRecorderName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.StartConfigurationRecorderResult
}
...
class AmazonConfigStartConfigurationRecorderCommand(val configurationRecorderName: String) : AmazonWebServiceCommand<com.amazonaws.services.config.model.StartConfigurationRecorderRequest, com.amazonaws.services.config.model.StartConfigurationRecorderResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.StartConfigurationRecorderResult {
...
fun AmazonConfigFunctions.stopConfigurationRecorder(configurationRecorderName: String, init: (AmazonConfigStopConfigurationRecorderCommand.() -> Unit)? = null): com.amazonaws.services.config.model.StopConfigurationRecorderResult {
	return this.block.declare(AmazonConfigStopConfigurationRecorderCommand(configurationRecorderName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.config.model.StopConfigurationRecorderResult
}
...
class AmazonConfigStopConfigurationRecorderCommand(val configurationRecorderName: String) : AmazonWebServiceCommand<com.amazonaws.services.config.model.StopConfigurationRecorderRequest, com.amazonaws.services.config.model.StopConfigurationRecorderResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.config.model.StopConfigurationRecorderResult {
