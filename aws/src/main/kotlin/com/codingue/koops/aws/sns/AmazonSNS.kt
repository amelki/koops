...
package com.codingue.koops.aws.sns
...
var com.codingue.koops.core.Environment.sns: AmazonSNS
	get() {
		var service = this.capabilities["aws-sns"]
		if (service == null) {
			service = AmazonSNSClientBuilder.standard().build()
			this.capabilities["aws-sns"] = service
		}
		return service as AmazonSNS
	}
	set(sns) {
		this.capabilities["aws-sns"] = sns
	}
...
fun AmazonSNSFunctions.addPermission(topicArn: String, label: String, init: (AmazonSNSAddPermissionCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.AddPermissionResult {
	return this.block.declare(AmazonSNSAddPermissionCommand(topicArn, label).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.AddPermissionResult
}
...
class AmazonSNSAddPermissionCommand(val topicArn: String, val label: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.AddPermissionRequest, com.amazonaws.services.sns.model.AddPermissionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.AddPermissionResult {
...
fun AmazonSNSFunctions.checkIfPhoneNumberIsOptedOut(init: (AmazonSNSCheckIfPhoneNumberIsOptedOutCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.CheckIfPhoneNumberIsOptedOutResult {
	return this.block.declare(AmazonSNSCheckIfPhoneNumberIsOptedOutCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.CheckIfPhoneNumberIsOptedOutResult
}
...
class AmazonSNSCheckIfPhoneNumberIsOptedOutCommand() : AmazonWebServiceCommand<com.amazonaws.services.sns.model.CheckIfPhoneNumberIsOptedOutRequest, com.amazonaws.services.sns.model.CheckIfPhoneNumberIsOptedOutResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.CheckIfPhoneNumberIsOptedOutResult {
...
fun AmazonSNSFunctions.confirmSubscription(topicArn: String, token: String, init: (AmazonSNSConfirmSubscriptionCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.ConfirmSubscriptionResult {
	return this.block.declare(AmazonSNSConfirmSubscriptionCommand(topicArn, token).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.ConfirmSubscriptionResult
}
...
class AmazonSNSConfirmSubscriptionCommand(val topicArn: String, val token: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.ConfirmSubscriptionRequest, com.amazonaws.services.sns.model.ConfirmSubscriptionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.ConfirmSubscriptionResult {
...
fun AmazonSNSFunctions.createPlatformApplication(name: String, platform: String, attributes: Map<String, String>, init: (AmazonSNSCreatePlatformApplicationCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.CreatePlatformApplicationResult {
	return this.block.declare(AmazonSNSCreatePlatformApplicationCommand(name, platform, attributes).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.CreatePlatformApplicationResult
}
...
class AmazonSNSCreatePlatformApplicationCommand(val name: String, val platform: String, val attributes: Map<String, String>) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.CreatePlatformApplicationRequest, com.amazonaws.services.sns.model.CreatePlatformApplicationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.CreatePlatformApplicationResult {
...
fun AmazonSNSFunctions.createPlatformEndpoint(platformApplicationArn: String, token: String, init: (AmazonSNSCreatePlatformEndpointCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.CreatePlatformEndpointResult {
	return this.block.declare(AmazonSNSCreatePlatformEndpointCommand(platformApplicationArn, token).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.CreatePlatformEndpointResult
}
...
class AmazonSNSCreatePlatformEndpointCommand(val platformApplicationArn: String, val token: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.CreatePlatformEndpointRequest, com.amazonaws.services.sns.model.CreatePlatformEndpointResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.CreatePlatformEndpointResult {
...
fun AmazonSNSFunctions.createTopic(name: String, init: (AmazonSNSCreateTopicCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.CreateTopicResult {
	return this.block.declare(AmazonSNSCreateTopicCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.CreateTopicResult
}
...
class AmazonSNSCreateTopicCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.CreateTopicRequest, com.amazonaws.services.sns.model.CreateTopicResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.CreateTopicResult {
...
fun AmazonSNSFunctions.deleteEndpoint(endpointArn: String, init: (AmazonSNSDeleteEndpointCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.DeleteEndpointResult {
	return this.block.declare(AmazonSNSDeleteEndpointCommand(endpointArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.DeleteEndpointResult
}
...
class AmazonSNSDeleteEndpointCommand(val endpointArn: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.DeleteEndpointRequest, com.amazonaws.services.sns.model.DeleteEndpointResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.DeleteEndpointResult {
...
fun AmazonSNSFunctions.deletePlatformApplication(platformApplicationArn: String, init: (AmazonSNSDeletePlatformApplicationCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.DeletePlatformApplicationResult {
	return this.block.declare(AmazonSNSDeletePlatformApplicationCommand(platformApplicationArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.DeletePlatformApplicationResult
}
...
class AmazonSNSDeletePlatformApplicationCommand(val platformApplicationArn: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.DeletePlatformApplicationRequest, com.amazonaws.services.sns.model.DeletePlatformApplicationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.DeletePlatformApplicationResult {
...
fun AmazonSNSFunctions.deleteTopic(topicArn: String, init: (AmazonSNSDeleteTopicCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.DeleteTopicResult {
	return this.block.declare(AmazonSNSDeleteTopicCommand(topicArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.DeleteTopicResult
}
...
class AmazonSNSDeleteTopicCommand(val topicArn: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.DeleteTopicRequest, com.amazonaws.services.sns.model.DeleteTopicResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.DeleteTopicResult {
...
fun AmazonSNSFunctions.getEndpointAttributes(endpointArn: String, init: (AmazonSNSGetEndpointAttributesCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.GetEndpointAttributesResult {
	return this.block.declare(AmazonSNSGetEndpointAttributesCommand(endpointArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.GetEndpointAttributesResult
}
...
class AmazonSNSGetEndpointAttributesCommand(val endpointArn: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.GetEndpointAttributesRequest, com.amazonaws.services.sns.model.GetEndpointAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.GetEndpointAttributesResult {
...
fun AmazonSNSFunctions.getPlatformApplicationAttributes(platformApplicationArn: String, init: (AmazonSNSGetPlatformApplicationAttributesCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.GetPlatformApplicationAttributesResult {
	return this.block.declare(AmazonSNSGetPlatformApplicationAttributesCommand(platformApplicationArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.GetPlatformApplicationAttributesResult
}
...
class AmazonSNSGetPlatformApplicationAttributesCommand(val platformApplicationArn: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.GetPlatformApplicationAttributesRequest, com.amazonaws.services.sns.model.GetPlatformApplicationAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.GetPlatformApplicationAttributesResult {
...
fun AmazonSNSFunctions.getSMSAttributes(init: (AmazonSNSGetSMSAttributesCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.GetSMSAttributesResult {
	return this.block.declare(AmazonSNSGetSMSAttributesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.GetSMSAttributesResult
}
...
class AmazonSNSGetSMSAttributesCommand() : AmazonWebServiceCommand<com.amazonaws.services.sns.model.GetSMSAttributesRequest, com.amazonaws.services.sns.model.GetSMSAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.GetSMSAttributesResult {
...
fun AmazonSNSFunctions.getSubscriptionAttributes(subscriptionArn: String, init: (AmazonSNSGetSubscriptionAttributesCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.GetSubscriptionAttributesResult {
	return this.block.declare(AmazonSNSGetSubscriptionAttributesCommand(subscriptionArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.GetSubscriptionAttributesResult
}
...
class AmazonSNSGetSubscriptionAttributesCommand(val subscriptionArn: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.GetSubscriptionAttributesRequest, com.amazonaws.services.sns.model.GetSubscriptionAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.GetSubscriptionAttributesResult {
...
fun AmazonSNSFunctions.getTopicAttributes(topicArn: String, init: (AmazonSNSGetTopicAttributesCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.GetTopicAttributesResult {
	return this.block.declare(AmazonSNSGetTopicAttributesCommand(topicArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.GetTopicAttributesResult
}
...
class AmazonSNSGetTopicAttributesCommand(val topicArn: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.GetTopicAttributesRequest, com.amazonaws.services.sns.model.GetTopicAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.GetTopicAttributesResult {
...
fun AmazonSNSFunctions.listEndpointsByPlatformApplication(platformApplicationArn: String, init: (AmazonSNSListEndpointsByPlatformApplicationCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.ListEndpointsByPlatformApplicationResult {
	return this.block.declare(AmazonSNSListEndpointsByPlatformApplicationCommand(platformApplicationArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.ListEndpointsByPlatformApplicationResult
}
...
class AmazonSNSListEndpointsByPlatformApplicationCommand(val platformApplicationArn: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.ListEndpointsByPlatformApplicationRequest, com.amazonaws.services.sns.model.ListEndpointsByPlatformApplicationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.ListEndpointsByPlatformApplicationResult {
...
fun AmazonSNSFunctions.listPhoneNumbersOptedOut(init: (AmazonSNSListPhoneNumbersOptedOutCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.ListPhoneNumbersOptedOutResult {
	return this.block.declare(AmazonSNSListPhoneNumbersOptedOutCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.ListPhoneNumbersOptedOutResult
}
...
class AmazonSNSListPhoneNumbersOptedOutCommand() : AmazonWebServiceCommand<com.amazonaws.services.sns.model.ListPhoneNumbersOptedOutRequest, com.amazonaws.services.sns.model.ListPhoneNumbersOptedOutResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.ListPhoneNumbersOptedOutResult {
...
fun AmazonSNSFunctions.listPlatformApplications(init: (AmazonSNSListPlatformApplicationsCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.ListPlatformApplicationsResult {
	return this.block.declare(AmazonSNSListPlatformApplicationsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.ListPlatformApplicationsResult
}
...
class AmazonSNSListPlatformApplicationsCommand() : AmazonWebServiceCommand<com.amazonaws.services.sns.model.ListPlatformApplicationsRequest, com.amazonaws.services.sns.model.ListPlatformApplicationsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.ListPlatformApplicationsResult {
...
fun AmazonSNSFunctions.listSubscriptions(init: (AmazonSNSListSubscriptionsCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.ListSubscriptionsResult {
	return this.block.declare(AmazonSNSListSubscriptionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.ListSubscriptionsResult
}
...
class AmazonSNSListSubscriptionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.sns.model.ListSubscriptionsRequest, com.amazonaws.services.sns.model.ListSubscriptionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.ListSubscriptionsResult {
...
fun AmazonSNSFunctions.listSubscriptionsByTopic(topicArn: String, init: (AmazonSNSListSubscriptionsByTopicCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.ListSubscriptionsByTopicResult {
	return this.block.declare(AmazonSNSListSubscriptionsByTopicCommand(topicArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.ListSubscriptionsByTopicResult
}
...
class AmazonSNSListSubscriptionsByTopicCommand(val topicArn: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.ListSubscriptionsByTopicRequest, com.amazonaws.services.sns.model.ListSubscriptionsByTopicResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.ListSubscriptionsByTopicResult {
...
fun AmazonSNSFunctions.listTopics(init: (AmazonSNSListTopicsCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.ListTopicsResult {
	return this.block.declare(AmazonSNSListTopicsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.ListTopicsResult
}
...
class AmazonSNSListTopicsCommand() : AmazonWebServiceCommand<com.amazonaws.services.sns.model.ListTopicsRequest, com.amazonaws.services.sns.model.ListTopicsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.ListTopicsResult {
...
fun AmazonSNSFunctions.optInPhoneNumber(init: (AmazonSNSOptInPhoneNumberCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.OptInPhoneNumberResult {
	return this.block.declare(AmazonSNSOptInPhoneNumberCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.OptInPhoneNumberResult
}
...
class AmazonSNSOptInPhoneNumberCommand() : AmazonWebServiceCommand<com.amazonaws.services.sns.model.OptInPhoneNumberRequest, com.amazonaws.services.sns.model.OptInPhoneNumberResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.OptInPhoneNumberResult {
...
fun AmazonSNSFunctions.publish(message: String, init: (AmazonSNSPublishCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.PublishResult {
	return this.block.declare(AmazonSNSPublishCommand(message).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.PublishResult
}
...
class AmazonSNSPublishCommand(val message: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.PublishRequest, com.amazonaws.services.sns.model.PublishResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.PublishResult {
...
fun AmazonSNSFunctions.removePermission(topicArn: String, label: String, init: (AmazonSNSRemovePermissionCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.RemovePermissionResult {
	return this.block.declare(AmazonSNSRemovePermissionCommand(topicArn, label).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.RemovePermissionResult
}
...
class AmazonSNSRemovePermissionCommand(val topicArn: String, val label: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.RemovePermissionRequest, com.amazonaws.services.sns.model.RemovePermissionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.RemovePermissionResult {
...
fun AmazonSNSFunctions.setEndpointAttributes(endpointArn: String, attributes: Map<String, String>, init: (AmazonSNSSetEndpointAttributesCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.SetEndpointAttributesResult {
	return this.block.declare(AmazonSNSSetEndpointAttributesCommand(endpointArn, attributes).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.SetEndpointAttributesResult
}
...
class AmazonSNSSetEndpointAttributesCommand(val endpointArn: String, val attributes: Map<String, String>) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.SetEndpointAttributesRequest, com.amazonaws.services.sns.model.SetEndpointAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.SetEndpointAttributesResult {
...
fun AmazonSNSFunctions.setPlatformApplicationAttributes(platformApplicationArn: String, attributes: Map<String, String>, init: (AmazonSNSSetPlatformApplicationAttributesCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.SetPlatformApplicationAttributesResult {
	return this.block.declare(AmazonSNSSetPlatformApplicationAttributesCommand(platformApplicationArn, attributes).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.SetPlatformApplicationAttributesResult
}
...
class AmazonSNSSetPlatformApplicationAttributesCommand(val platformApplicationArn: String, val attributes: Map<String, String>) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.SetPlatformApplicationAttributesRequest, com.amazonaws.services.sns.model.SetPlatformApplicationAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.SetPlatformApplicationAttributesResult {
...
fun AmazonSNSFunctions.setSMSAttributes(init: (AmazonSNSSetSMSAttributesCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.SetSMSAttributesResult {
	return this.block.declare(AmazonSNSSetSMSAttributesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.SetSMSAttributesResult
}
...
class AmazonSNSSetSMSAttributesCommand() : AmazonWebServiceCommand<com.amazonaws.services.sns.model.SetSMSAttributesRequest, com.amazonaws.services.sns.model.SetSMSAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.SetSMSAttributesResult {
...
fun AmazonSNSFunctions.setSubscriptionAttributes(subscriptionArn: String, attributeName: String, init: (AmazonSNSSetSubscriptionAttributesCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.SetSubscriptionAttributesResult {
	return this.block.declare(AmazonSNSSetSubscriptionAttributesCommand(subscriptionArn, attributeName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.SetSubscriptionAttributesResult
}
...
class AmazonSNSSetSubscriptionAttributesCommand(val subscriptionArn: String, val attributeName: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.SetSubscriptionAttributesRequest, com.amazonaws.services.sns.model.SetSubscriptionAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.SetSubscriptionAttributesResult {
...
fun AmazonSNSFunctions.setTopicAttributes(topicArn: String, attributeName: String, init: (AmazonSNSSetTopicAttributesCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.SetTopicAttributesResult {
	return this.block.declare(AmazonSNSSetTopicAttributesCommand(topicArn, attributeName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.SetTopicAttributesResult
}
...
class AmazonSNSSetTopicAttributesCommand(val topicArn: String, val attributeName: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.SetTopicAttributesRequest, com.amazonaws.services.sns.model.SetTopicAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.SetTopicAttributesResult {
...
fun AmazonSNSFunctions.subscribe(topicArn: String, protocol: String, init: (AmazonSNSSubscribeCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.SubscribeResult {
	return this.block.declare(AmazonSNSSubscribeCommand(topicArn, protocol).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.SubscribeResult
}
...
class AmazonSNSSubscribeCommand(val topicArn: String, val protocol: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.SubscribeRequest, com.amazonaws.services.sns.model.SubscribeResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.SubscribeResult {
...
fun AmazonSNSFunctions.unsubscribe(subscriptionArn: String, init: (AmazonSNSUnsubscribeCommand.() -> Unit)? = null): com.amazonaws.services.sns.model.UnsubscribeResult {
	return this.block.declare(AmazonSNSUnsubscribeCommand(subscriptionArn).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.sns.model.UnsubscribeResult
}
...
class AmazonSNSUnsubscribeCommand(val subscriptionArn: String) : AmazonWebServiceCommand<com.amazonaws.services.sns.model.UnsubscribeRequest, com.amazonaws.services.sns.model.UnsubscribeResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.sns.model.UnsubscribeResult {
