...
package com.codingue.koops.aws.servicecatalog
...
var com.codingue.koops.core.Environment.servicecatalog: AWSServiceCatalog
	get() {
		var service = this.capabilities["aws-servicecatalog"]
		if (service == null) {
			service = AWSServiceCatalogClientBuilder.standard().build()
			this.capabilities["aws-servicecatalog"] = service
		}
		return service as AWSServiceCatalog
	}
	set(servicecatalog) {
		this.capabilities["aws-servicecatalog"] = servicecatalog
	}
...
fun AWSServiceCatalogFunctions.acceptPortfolioShare(portfolioId: String, init: (AWSServiceCatalogAcceptPortfolioShareCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.AcceptPortfolioShareResult {
	return this.block.declare(AWSServiceCatalogAcceptPortfolioShareCommand(portfolioId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.AcceptPortfolioShareResult
}
...
class AWSServiceCatalogAcceptPortfolioShareCommand(val portfolioId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.AcceptPortfolioShareRequest, com.amazonaws.services.servicecatalog.model.AcceptPortfolioShareResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.AcceptPortfolioShareResult {
...
fun AWSServiceCatalogFunctions.associatePrincipalWithPortfolio(portfolioId: String, principalARN: String, principalType: PrincipalType, init: (AWSServiceCatalogAssociatePrincipalWithPortfolioCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.AssociatePrincipalWithPortfolioResult {
	return this.block.declare(AWSServiceCatalogAssociatePrincipalWithPortfolioCommand(portfolioId, principalARN, principalType).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.AssociatePrincipalWithPortfolioResult
}
...
class AWSServiceCatalogAssociatePrincipalWithPortfolioCommand(val portfolioId: String, val principalARN: String, val principalType: PrincipalType) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.AssociatePrincipalWithPortfolioRequest, com.amazonaws.services.servicecatalog.model.AssociatePrincipalWithPortfolioResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.AssociatePrincipalWithPortfolioResult {
...
fun AWSServiceCatalogFunctions.associateProductWithPortfolio(productId: String, portfolioId: String, init: (AWSServiceCatalogAssociateProductWithPortfolioCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.AssociateProductWithPortfolioResult {
	return this.block.declare(AWSServiceCatalogAssociateProductWithPortfolioCommand(productId, portfolioId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.AssociateProductWithPortfolioResult
}
...
class AWSServiceCatalogAssociateProductWithPortfolioCommand(val productId: String, val portfolioId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.AssociateProductWithPortfolioRequest, com.amazonaws.services.servicecatalog.model.AssociateProductWithPortfolioResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.AssociateProductWithPortfolioResult {
...
fun AWSServiceCatalogFunctions.associateTagOptionWithResource(resourceId: String, tagOptionId: String, init: (AWSServiceCatalogAssociateTagOptionWithResourceCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.AssociateTagOptionWithResourceResult {
	return this.block.declare(AWSServiceCatalogAssociateTagOptionWithResourceCommand(resourceId, tagOptionId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.AssociateTagOptionWithResourceResult
}
...
class AWSServiceCatalogAssociateTagOptionWithResourceCommand(val resourceId: String, val tagOptionId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.AssociateTagOptionWithResourceRequest, com.amazonaws.services.servicecatalog.model.AssociateTagOptionWithResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.AssociateTagOptionWithResourceResult {
...
fun AWSServiceCatalogFunctions.copyProduct(sourceProductArn: String, idempotencyToken: String, init: (AWSServiceCatalogCopyProductCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.CopyProductResult {
	return this.block.declare(AWSServiceCatalogCopyProductCommand(sourceProductArn, idempotencyToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.CopyProductResult
}
...
class AWSServiceCatalogCopyProductCommand(val sourceProductArn: String, val idempotencyToken: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.CopyProductRequest, com.amazonaws.services.servicecatalog.model.CopyProductResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.CopyProductResult {
...
fun AWSServiceCatalogFunctions.createConstraint(portfolioId: String, productId: String, parameters: String, type: String, idempotencyToken: String, init: (AWSServiceCatalogCreateConstraintCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.CreateConstraintResult {
	return this.block.declare(AWSServiceCatalogCreateConstraintCommand(portfolioId, productId, parameters, type, idempotencyToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.CreateConstraintResult
}
...
class AWSServiceCatalogCreateConstraintCommand(val portfolioId: String, val productId: String, val parameters: String, val type: String, val idempotencyToken: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.CreateConstraintRequest, com.amazonaws.services.servicecatalog.model.CreateConstraintResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.CreateConstraintResult {
...
fun AWSServiceCatalogFunctions.createPortfolio(displayName: String, providerName: String, idempotencyToken: String, init: (AWSServiceCatalogCreatePortfolioCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.CreatePortfolioResult {
	return this.block.declare(AWSServiceCatalogCreatePortfolioCommand(displayName, providerName, idempotencyToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.CreatePortfolioResult
}
...
class AWSServiceCatalogCreatePortfolioCommand(val displayName: String, val providerName: String, val idempotencyToken: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.CreatePortfolioRequest, com.amazonaws.services.servicecatalog.model.CreatePortfolioResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.CreatePortfolioResult {
...
fun AWSServiceCatalogFunctions.createPortfolioShare(portfolioId: String, accountId: String, init: (AWSServiceCatalogCreatePortfolioShareCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.CreatePortfolioShareResult {
	return this.block.declare(AWSServiceCatalogCreatePortfolioShareCommand(portfolioId, accountId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.CreatePortfolioShareResult
}
...
class AWSServiceCatalogCreatePortfolioShareCommand(val portfolioId: String, val accountId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.CreatePortfolioShareRequest, com.amazonaws.services.servicecatalog.model.CreatePortfolioShareResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.CreatePortfolioShareResult {
...
fun AWSServiceCatalogFunctions.createProduct(name: String, owner: String, productType: ProductType, provisioningArtifactParameters: com.amazonaws.services.servicecatalog.model.ProvisioningArtifactProperties, idempotencyToken: String, init: (AWSServiceCatalogCreateProductCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.CreateProductResult {
	return this.block.declare(AWSServiceCatalogCreateProductCommand(name, owner, productType, provisioningArtifactParameters, idempotencyToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.CreateProductResult
}
...
class AWSServiceCatalogCreateProductCommand(val name: String, val owner: String, val productType: ProductType, val provisioningArtifactParameters: com.amazonaws.services.servicecatalog.model.ProvisioningArtifactProperties, val idempotencyToken: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.CreateProductRequest, com.amazonaws.services.servicecatalog.model.CreateProductResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.CreateProductResult {
...
fun AWSServiceCatalogFunctions.createProvisionedProductPlan(planName: String, planType: ProvisionedProductPlanType, productId: String, provisionedProductName: String, provisioningArtifactId: String, idempotencyToken: String, init: (AWSServiceCatalogCreateProvisionedProductPlanCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.CreateProvisionedProductPlanResult {
	return this.block.declare(AWSServiceCatalogCreateProvisionedProductPlanCommand(planName, planType, productId, provisionedProductName, provisioningArtifactId, idempotencyToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.CreateProvisionedProductPlanResult
}
...
class AWSServiceCatalogCreateProvisionedProductPlanCommand(val planName: String, val planType: ProvisionedProductPlanType, val productId: String, val provisionedProductName: String, val provisioningArtifactId: String, val idempotencyToken: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.CreateProvisionedProductPlanRequest, com.amazonaws.services.servicecatalog.model.CreateProvisionedProductPlanResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.CreateProvisionedProductPlanResult {
...
fun AWSServiceCatalogFunctions.createProvisioningArtifact(productId: String, parameters: com.amazonaws.services.servicecatalog.model.ProvisioningArtifactProperties, idempotencyToken: String, init: (AWSServiceCatalogCreateProvisioningArtifactCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.CreateProvisioningArtifactResult {
	return this.block.declare(AWSServiceCatalogCreateProvisioningArtifactCommand(productId, parameters, idempotencyToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.CreateProvisioningArtifactResult
}
...
class AWSServiceCatalogCreateProvisioningArtifactCommand(val productId: String, val parameters: com.amazonaws.services.servicecatalog.model.ProvisioningArtifactProperties, val idempotencyToken: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.CreateProvisioningArtifactRequest, com.amazonaws.services.servicecatalog.model.CreateProvisioningArtifactResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.CreateProvisioningArtifactResult {
...
fun AWSServiceCatalogFunctions.createTagOption(key: String, value: String, init: (AWSServiceCatalogCreateTagOptionCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.CreateTagOptionResult {
	return this.block.declare(AWSServiceCatalogCreateTagOptionCommand(key, value).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.CreateTagOptionResult
}
...
class AWSServiceCatalogCreateTagOptionCommand(val key: String, val value: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.CreateTagOptionRequest, com.amazonaws.services.servicecatalog.model.CreateTagOptionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.CreateTagOptionResult {
...
fun AWSServiceCatalogFunctions.deleteConstraint(id: String, init: (AWSServiceCatalogDeleteConstraintCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DeleteConstraintResult {
	return this.block.declare(AWSServiceCatalogDeleteConstraintCommand(id).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DeleteConstraintResult
}
...
class AWSServiceCatalogDeleteConstraintCommand(val id: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DeleteConstraintRequest, com.amazonaws.services.servicecatalog.model.DeleteConstraintResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DeleteConstraintResult {
...
fun AWSServiceCatalogFunctions.deletePortfolio(id: String, init: (AWSServiceCatalogDeletePortfolioCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DeletePortfolioResult {
	return this.block.declare(AWSServiceCatalogDeletePortfolioCommand(id).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DeletePortfolioResult
}
...
class AWSServiceCatalogDeletePortfolioCommand(val id: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DeletePortfolioRequest, com.amazonaws.services.servicecatalog.model.DeletePortfolioResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DeletePortfolioResult {
...
fun AWSServiceCatalogFunctions.deletePortfolioShare(portfolioId: String, accountId: String, init: (AWSServiceCatalogDeletePortfolioShareCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DeletePortfolioShareResult {
	return this.block.declare(AWSServiceCatalogDeletePortfolioShareCommand(portfolioId, accountId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DeletePortfolioShareResult
}
...
class AWSServiceCatalogDeletePortfolioShareCommand(val portfolioId: String, val accountId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DeletePortfolioShareRequest, com.amazonaws.services.servicecatalog.model.DeletePortfolioShareResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DeletePortfolioShareResult {
...
fun AWSServiceCatalogFunctions.deleteProduct(id: String, init: (AWSServiceCatalogDeleteProductCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DeleteProductResult {
	return this.block.declare(AWSServiceCatalogDeleteProductCommand(id).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DeleteProductResult
}
...
class AWSServiceCatalogDeleteProductCommand(val id: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DeleteProductRequest, com.amazonaws.services.servicecatalog.model.DeleteProductResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DeleteProductResult {
...
fun AWSServiceCatalogFunctions.deleteProvisionedProductPlan(planId: String, init: (AWSServiceCatalogDeleteProvisionedProductPlanCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DeleteProvisionedProductPlanResult {
	return this.block.declare(AWSServiceCatalogDeleteProvisionedProductPlanCommand(planId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DeleteProvisionedProductPlanResult
}
...
class AWSServiceCatalogDeleteProvisionedProductPlanCommand(val planId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DeleteProvisionedProductPlanRequest, com.amazonaws.services.servicecatalog.model.DeleteProvisionedProductPlanResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DeleteProvisionedProductPlanResult {
...
fun AWSServiceCatalogFunctions.deleteProvisioningArtifact(productId: String, provisioningArtifactId: String, init: (AWSServiceCatalogDeleteProvisioningArtifactCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DeleteProvisioningArtifactResult {
	return this.block.declare(AWSServiceCatalogDeleteProvisioningArtifactCommand(productId, provisioningArtifactId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DeleteProvisioningArtifactResult
}
...
class AWSServiceCatalogDeleteProvisioningArtifactCommand(val productId: String, val provisioningArtifactId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DeleteProvisioningArtifactRequest, com.amazonaws.services.servicecatalog.model.DeleteProvisioningArtifactResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DeleteProvisioningArtifactResult {
...
fun AWSServiceCatalogFunctions.deleteTagOption(id: String, init: (AWSServiceCatalogDeleteTagOptionCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DeleteTagOptionResult {
	return this.block.declare(AWSServiceCatalogDeleteTagOptionCommand(id).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DeleteTagOptionResult
}
...
class AWSServiceCatalogDeleteTagOptionCommand(val id: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DeleteTagOptionRequest, com.amazonaws.services.servicecatalog.model.DeleteTagOptionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DeleteTagOptionResult {
...
fun AWSServiceCatalogFunctions.describeConstraint(id: String, init: (AWSServiceCatalogDescribeConstraintCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DescribeConstraintResult {
	return this.block.declare(AWSServiceCatalogDescribeConstraintCommand(id).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DescribeConstraintResult
}
...
class AWSServiceCatalogDescribeConstraintCommand(val id: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DescribeConstraintRequest, com.amazonaws.services.servicecatalog.model.DescribeConstraintResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DescribeConstraintResult {
...
fun AWSServiceCatalogFunctions.describeCopyProductStatus(copyProductToken: String, init: (AWSServiceCatalogDescribeCopyProductStatusCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DescribeCopyProductStatusResult {
	return this.block.declare(AWSServiceCatalogDescribeCopyProductStatusCommand(copyProductToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DescribeCopyProductStatusResult
}
...
class AWSServiceCatalogDescribeCopyProductStatusCommand(val copyProductToken: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DescribeCopyProductStatusRequest, com.amazonaws.services.servicecatalog.model.DescribeCopyProductStatusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DescribeCopyProductStatusResult {
...
fun AWSServiceCatalogFunctions.describePortfolio(id: String, init: (AWSServiceCatalogDescribePortfolioCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DescribePortfolioResult {
	return this.block.declare(AWSServiceCatalogDescribePortfolioCommand(id).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DescribePortfolioResult
}
...
class AWSServiceCatalogDescribePortfolioCommand(val id: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DescribePortfolioRequest, com.amazonaws.services.servicecatalog.model.DescribePortfolioResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DescribePortfolioResult {
...
fun AWSServiceCatalogFunctions.describeProduct(id: String, init: (AWSServiceCatalogDescribeProductCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DescribeProductResult {
	return this.block.declare(AWSServiceCatalogDescribeProductCommand(id).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DescribeProductResult
}
...
class AWSServiceCatalogDescribeProductCommand(val id: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DescribeProductRequest, com.amazonaws.services.servicecatalog.model.DescribeProductResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DescribeProductResult {
...
fun AWSServiceCatalogFunctions.describeProductAsAdmin(id: String, init: (AWSServiceCatalogDescribeProductAsAdminCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DescribeProductAsAdminResult {
	return this.block.declare(AWSServiceCatalogDescribeProductAsAdminCommand(id).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DescribeProductAsAdminResult
}
...
class AWSServiceCatalogDescribeProductAsAdminCommand(val id: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DescribeProductAsAdminRequest, com.amazonaws.services.servicecatalog.model.DescribeProductAsAdminResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DescribeProductAsAdminResult {
...
fun AWSServiceCatalogFunctions.describeProductView(id: String, init: (AWSServiceCatalogDescribeProductViewCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DescribeProductViewResult {
	return this.block.declare(AWSServiceCatalogDescribeProductViewCommand(id).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DescribeProductViewResult
}
...
class AWSServiceCatalogDescribeProductViewCommand(val id: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DescribeProductViewRequest, com.amazonaws.services.servicecatalog.model.DescribeProductViewResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DescribeProductViewResult {
...
fun AWSServiceCatalogFunctions.describeProvisionedProduct(id: String, init: (AWSServiceCatalogDescribeProvisionedProductCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DescribeProvisionedProductResult {
	return this.block.declare(AWSServiceCatalogDescribeProvisionedProductCommand(id).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DescribeProvisionedProductResult
}
...
class AWSServiceCatalogDescribeProvisionedProductCommand(val id: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DescribeProvisionedProductRequest, com.amazonaws.services.servicecatalog.model.DescribeProvisionedProductResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DescribeProvisionedProductResult {
...
fun AWSServiceCatalogFunctions.describeProvisionedProductPlan(planId: String, init: (AWSServiceCatalogDescribeProvisionedProductPlanCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DescribeProvisionedProductPlanResult {
	return this.block.declare(AWSServiceCatalogDescribeProvisionedProductPlanCommand(planId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DescribeProvisionedProductPlanResult
}
...
class AWSServiceCatalogDescribeProvisionedProductPlanCommand(val planId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DescribeProvisionedProductPlanRequest, com.amazonaws.services.servicecatalog.model.DescribeProvisionedProductPlanResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DescribeProvisionedProductPlanResult {
...
fun AWSServiceCatalogFunctions.describeProvisioningArtifact(provisioningArtifactId: String, productId: String, init: (AWSServiceCatalogDescribeProvisioningArtifactCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DescribeProvisioningArtifactResult {
	return this.block.declare(AWSServiceCatalogDescribeProvisioningArtifactCommand(provisioningArtifactId, productId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DescribeProvisioningArtifactResult
}
...
class AWSServiceCatalogDescribeProvisioningArtifactCommand(val provisioningArtifactId: String, val productId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DescribeProvisioningArtifactRequest, com.amazonaws.services.servicecatalog.model.DescribeProvisioningArtifactResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DescribeProvisioningArtifactResult {
...
fun AWSServiceCatalogFunctions.describeProvisioningParameters(productId: String, provisioningArtifactId: String, init: (AWSServiceCatalogDescribeProvisioningParametersCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DescribeProvisioningParametersResult {
	return this.block.declare(AWSServiceCatalogDescribeProvisioningParametersCommand(productId, provisioningArtifactId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DescribeProvisioningParametersResult
}
...
class AWSServiceCatalogDescribeProvisioningParametersCommand(val productId: String, val provisioningArtifactId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DescribeProvisioningParametersRequest, com.amazonaws.services.servicecatalog.model.DescribeProvisioningParametersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DescribeProvisioningParametersResult {
...
fun AWSServiceCatalogFunctions.describeRecord(id: String, init: (AWSServiceCatalogDescribeRecordCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DescribeRecordResult {
	return this.block.declare(AWSServiceCatalogDescribeRecordCommand(id).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DescribeRecordResult
}
...
class AWSServiceCatalogDescribeRecordCommand(val id: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DescribeRecordRequest, com.amazonaws.services.servicecatalog.model.DescribeRecordResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DescribeRecordResult {
...
fun AWSServiceCatalogFunctions.describeTagOption(id: String, init: (AWSServiceCatalogDescribeTagOptionCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DescribeTagOptionResult {
	return this.block.declare(AWSServiceCatalogDescribeTagOptionCommand(id).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DescribeTagOptionResult
}
...
class AWSServiceCatalogDescribeTagOptionCommand(val id: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DescribeTagOptionRequest, com.amazonaws.services.servicecatalog.model.DescribeTagOptionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DescribeTagOptionResult {
...
fun AWSServiceCatalogFunctions.disassociatePrincipalFromPortfolio(portfolioId: String, principalARN: String, init: (AWSServiceCatalogDisassociatePrincipalFromPortfolioCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DisassociatePrincipalFromPortfolioResult {
	return this.block.declare(AWSServiceCatalogDisassociatePrincipalFromPortfolioCommand(portfolioId, principalARN).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DisassociatePrincipalFromPortfolioResult
}
...
class AWSServiceCatalogDisassociatePrincipalFromPortfolioCommand(val portfolioId: String, val principalARN: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DisassociatePrincipalFromPortfolioRequest, com.amazonaws.services.servicecatalog.model.DisassociatePrincipalFromPortfolioResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DisassociatePrincipalFromPortfolioResult {
...
fun AWSServiceCatalogFunctions.disassociateProductFromPortfolio(productId: String, portfolioId: String, init: (AWSServiceCatalogDisassociateProductFromPortfolioCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DisassociateProductFromPortfolioResult {
	return this.block.declare(AWSServiceCatalogDisassociateProductFromPortfolioCommand(productId, portfolioId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DisassociateProductFromPortfolioResult
}
...
class AWSServiceCatalogDisassociateProductFromPortfolioCommand(val productId: String, val portfolioId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DisassociateProductFromPortfolioRequest, com.amazonaws.services.servicecatalog.model.DisassociateProductFromPortfolioResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DisassociateProductFromPortfolioResult {
...
fun AWSServiceCatalogFunctions.disassociateTagOptionFromResource(resourceId: String, tagOptionId: String, init: (AWSServiceCatalogDisassociateTagOptionFromResourceCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.DisassociateTagOptionFromResourceResult {
	return this.block.declare(AWSServiceCatalogDisassociateTagOptionFromResourceCommand(resourceId, tagOptionId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.DisassociateTagOptionFromResourceResult
}
...
class AWSServiceCatalogDisassociateTagOptionFromResourceCommand(val resourceId: String, val tagOptionId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.DisassociateTagOptionFromResourceRequest, com.amazonaws.services.servicecatalog.model.DisassociateTagOptionFromResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.DisassociateTagOptionFromResourceResult {
...
fun AWSServiceCatalogFunctions.executeProvisionedProductPlan(planId: String, idempotencyToken: String, init: (AWSServiceCatalogExecuteProvisionedProductPlanCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.ExecuteProvisionedProductPlanResult {
	return this.block.declare(AWSServiceCatalogExecuteProvisionedProductPlanCommand(planId, idempotencyToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.ExecuteProvisionedProductPlanResult
}
...
class AWSServiceCatalogExecuteProvisionedProductPlanCommand(val planId: String, val idempotencyToken: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.ExecuteProvisionedProductPlanRequest, com.amazonaws.services.servicecatalog.model.ExecuteProvisionedProductPlanResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.ExecuteProvisionedProductPlanResult {
...
fun AWSServiceCatalogFunctions.listAcceptedPortfolioShares(init: (AWSServiceCatalogListAcceptedPortfolioSharesCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.ListAcceptedPortfolioSharesResult {
	return this.block.declare(AWSServiceCatalogListAcceptedPortfolioSharesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.ListAcceptedPortfolioSharesResult
}
...
class AWSServiceCatalogListAcceptedPortfolioSharesCommand() : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.ListAcceptedPortfolioSharesRequest, com.amazonaws.services.servicecatalog.model.ListAcceptedPortfolioSharesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.ListAcceptedPortfolioSharesResult {
...
fun AWSServiceCatalogFunctions.listConstraintsForPortfolio(portfolioId: String, init: (AWSServiceCatalogListConstraintsForPortfolioCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.ListConstraintsForPortfolioResult {
	return this.block.declare(AWSServiceCatalogListConstraintsForPortfolioCommand(portfolioId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.ListConstraintsForPortfolioResult
}
...
class AWSServiceCatalogListConstraintsForPortfolioCommand(val portfolioId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.ListConstraintsForPortfolioRequest, com.amazonaws.services.servicecatalog.model.ListConstraintsForPortfolioResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.ListConstraintsForPortfolioResult {
...
fun AWSServiceCatalogFunctions.listLaunchPaths(productId: String, init: (AWSServiceCatalogListLaunchPathsCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.ListLaunchPathsResult {
	return this.block.declare(AWSServiceCatalogListLaunchPathsCommand(productId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.ListLaunchPathsResult
}
...
class AWSServiceCatalogListLaunchPathsCommand(val productId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.ListLaunchPathsRequest, com.amazonaws.services.servicecatalog.model.ListLaunchPathsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.ListLaunchPathsResult {
...
fun AWSServiceCatalogFunctions.listPortfolioAccess(portfolioId: String, init: (AWSServiceCatalogListPortfolioAccessCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.ListPortfolioAccessResult {
	return this.block.declare(AWSServiceCatalogListPortfolioAccessCommand(portfolioId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.ListPortfolioAccessResult
}
...
class AWSServiceCatalogListPortfolioAccessCommand(val portfolioId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.ListPortfolioAccessRequest, com.amazonaws.services.servicecatalog.model.ListPortfolioAccessResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.ListPortfolioAccessResult {
...
fun AWSServiceCatalogFunctions.listPortfolios(init: (AWSServiceCatalogListPortfoliosCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.ListPortfoliosResult {
	return this.block.declare(AWSServiceCatalogListPortfoliosCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.ListPortfoliosResult
}
...
class AWSServiceCatalogListPortfoliosCommand() : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.ListPortfoliosRequest, com.amazonaws.services.servicecatalog.model.ListPortfoliosResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.ListPortfoliosResult {
...
fun AWSServiceCatalogFunctions.listPortfoliosForProduct(productId: String, init: (AWSServiceCatalogListPortfoliosForProductCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.ListPortfoliosForProductResult {
	return this.block.declare(AWSServiceCatalogListPortfoliosForProductCommand(productId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.ListPortfoliosForProductResult
}
...
class AWSServiceCatalogListPortfoliosForProductCommand(val productId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.ListPortfoliosForProductRequest, com.amazonaws.services.servicecatalog.model.ListPortfoliosForProductResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.ListPortfoliosForProductResult {
...
fun AWSServiceCatalogFunctions.listPrincipalsForPortfolio(portfolioId: String, init: (AWSServiceCatalogListPrincipalsForPortfolioCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.ListPrincipalsForPortfolioResult {
	return this.block.declare(AWSServiceCatalogListPrincipalsForPortfolioCommand(portfolioId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.ListPrincipalsForPortfolioResult
}
...
class AWSServiceCatalogListPrincipalsForPortfolioCommand(val portfolioId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.ListPrincipalsForPortfolioRequest, com.amazonaws.services.servicecatalog.model.ListPrincipalsForPortfolioResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.ListPrincipalsForPortfolioResult {
...
fun AWSServiceCatalogFunctions.listProvisionedProductPlans(init: (AWSServiceCatalogListProvisionedProductPlansCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.ListProvisionedProductPlansResult {
	return this.block.declare(AWSServiceCatalogListProvisionedProductPlansCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.ListProvisionedProductPlansResult
}
...
class AWSServiceCatalogListProvisionedProductPlansCommand() : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.ListProvisionedProductPlansRequest, com.amazonaws.services.servicecatalog.model.ListProvisionedProductPlansResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.ListProvisionedProductPlansResult {
...
fun AWSServiceCatalogFunctions.listProvisioningArtifacts(productId: String, init: (AWSServiceCatalogListProvisioningArtifactsCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.ListProvisioningArtifactsResult {
	return this.block.declare(AWSServiceCatalogListProvisioningArtifactsCommand(productId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.ListProvisioningArtifactsResult
}
...
class AWSServiceCatalogListProvisioningArtifactsCommand(val productId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.ListProvisioningArtifactsRequest, com.amazonaws.services.servicecatalog.model.ListProvisioningArtifactsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.ListProvisioningArtifactsResult {
...
fun AWSServiceCatalogFunctions.listRecordHistory(init: (AWSServiceCatalogListRecordHistoryCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.ListRecordHistoryResult {
	return this.block.declare(AWSServiceCatalogListRecordHistoryCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.ListRecordHistoryResult
}
...
class AWSServiceCatalogListRecordHistoryCommand() : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.ListRecordHistoryRequest, com.amazonaws.services.servicecatalog.model.ListRecordHistoryResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.ListRecordHistoryResult {
...
fun AWSServiceCatalogFunctions.listResourcesForTagOption(tagOptionId: String, init: (AWSServiceCatalogListResourcesForTagOptionCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.ListResourcesForTagOptionResult {
	return this.block.declare(AWSServiceCatalogListResourcesForTagOptionCommand(tagOptionId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.ListResourcesForTagOptionResult
}
...
class AWSServiceCatalogListResourcesForTagOptionCommand(val tagOptionId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.ListResourcesForTagOptionRequest, com.amazonaws.services.servicecatalog.model.ListResourcesForTagOptionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.ListResourcesForTagOptionResult {
...
fun AWSServiceCatalogFunctions.listTagOptions(init: (AWSServiceCatalogListTagOptionsCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.ListTagOptionsResult {
	return this.block.declare(AWSServiceCatalogListTagOptionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.ListTagOptionsResult
}
...
class AWSServiceCatalogListTagOptionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.ListTagOptionsRequest, com.amazonaws.services.servicecatalog.model.ListTagOptionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.ListTagOptionsResult {
...
fun AWSServiceCatalogFunctions.provisionProduct(productId: String, provisioningArtifactId: String, provisionedProductName: String, provisionToken: String, init: (AWSServiceCatalogProvisionProductCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.ProvisionProductResult {
	return this.block.declare(AWSServiceCatalogProvisionProductCommand(productId, provisioningArtifactId, provisionedProductName, provisionToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.ProvisionProductResult
}
...
class AWSServiceCatalogProvisionProductCommand(val productId: String, val provisioningArtifactId: String, val provisionedProductName: String, val provisionToken: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.ProvisionProductRequest, com.amazonaws.services.servicecatalog.model.ProvisionProductResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.ProvisionProductResult {
...
fun AWSServiceCatalogFunctions.rejectPortfolioShare(portfolioId: String, init: (AWSServiceCatalogRejectPortfolioShareCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.RejectPortfolioShareResult {
	return this.block.declare(AWSServiceCatalogRejectPortfolioShareCommand(portfolioId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.RejectPortfolioShareResult
}
...
class AWSServiceCatalogRejectPortfolioShareCommand(val portfolioId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.RejectPortfolioShareRequest, com.amazonaws.services.servicecatalog.model.RejectPortfolioShareResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.RejectPortfolioShareResult {
...
fun AWSServiceCatalogFunctions.scanProvisionedProducts(init: (AWSServiceCatalogScanProvisionedProductsCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.ScanProvisionedProductsResult {
	return this.block.declare(AWSServiceCatalogScanProvisionedProductsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.ScanProvisionedProductsResult
}
...
class AWSServiceCatalogScanProvisionedProductsCommand() : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.ScanProvisionedProductsRequest, com.amazonaws.services.servicecatalog.model.ScanProvisionedProductsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.ScanProvisionedProductsResult {
...
fun AWSServiceCatalogFunctions.searchProducts(init: (AWSServiceCatalogSearchProductsCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.SearchProductsResult {
	return this.block.declare(AWSServiceCatalogSearchProductsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.SearchProductsResult
}
...
class AWSServiceCatalogSearchProductsCommand() : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.SearchProductsRequest, com.amazonaws.services.servicecatalog.model.SearchProductsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.SearchProductsResult {
...
fun AWSServiceCatalogFunctions.searchProductsAsAdmin(init: (AWSServiceCatalogSearchProductsAsAdminCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.SearchProductsAsAdminResult {
	return this.block.declare(AWSServiceCatalogSearchProductsAsAdminCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.SearchProductsAsAdminResult
}
...
class AWSServiceCatalogSearchProductsAsAdminCommand() : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.SearchProductsAsAdminRequest, com.amazonaws.services.servicecatalog.model.SearchProductsAsAdminResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.SearchProductsAsAdminResult {
...
fun AWSServiceCatalogFunctions.searchProvisionedProducts(init: (AWSServiceCatalogSearchProvisionedProductsCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.SearchProvisionedProductsResult {
	return this.block.declare(AWSServiceCatalogSearchProvisionedProductsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.SearchProvisionedProductsResult
}
...
class AWSServiceCatalogSearchProvisionedProductsCommand() : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.SearchProvisionedProductsRequest, com.amazonaws.services.servicecatalog.model.SearchProvisionedProductsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.SearchProvisionedProductsResult {
...
fun AWSServiceCatalogFunctions.terminateProvisionedProduct(terminateToken: String, init: (AWSServiceCatalogTerminateProvisionedProductCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.TerminateProvisionedProductResult {
	return this.block.declare(AWSServiceCatalogTerminateProvisionedProductCommand(terminateToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.TerminateProvisionedProductResult
}
...
class AWSServiceCatalogTerminateProvisionedProductCommand(val terminateToken: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.TerminateProvisionedProductRequest, com.amazonaws.services.servicecatalog.model.TerminateProvisionedProductResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.TerminateProvisionedProductResult {
...
fun AWSServiceCatalogFunctions.updateConstraint(id: String, init: (AWSServiceCatalogUpdateConstraintCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.UpdateConstraintResult {
	return this.block.declare(AWSServiceCatalogUpdateConstraintCommand(id).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.UpdateConstraintResult
}
...
class AWSServiceCatalogUpdateConstraintCommand(val id: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.UpdateConstraintRequest, com.amazonaws.services.servicecatalog.model.UpdateConstraintResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.UpdateConstraintResult {
...
fun AWSServiceCatalogFunctions.updatePortfolio(id: String, init: (AWSServiceCatalogUpdatePortfolioCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.UpdatePortfolioResult {
	return this.block.declare(AWSServiceCatalogUpdatePortfolioCommand(id).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.UpdatePortfolioResult
}
...
class AWSServiceCatalogUpdatePortfolioCommand(val id: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.UpdatePortfolioRequest, com.amazonaws.services.servicecatalog.model.UpdatePortfolioResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.UpdatePortfolioResult {
...
fun AWSServiceCatalogFunctions.updateProduct(id: String, init: (AWSServiceCatalogUpdateProductCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.UpdateProductResult {
	return this.block.declare(AWSServiceCatalogUpdateProductCommand(id).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.UpdateProductResult
}
...
class AWSServiceCatalogUpdateProductCommand(val id: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.UpdateProductRequest, com.amazonaws.services.servicecatalog.model.UpdateProductResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.UpdateProductResult {
...
fun AWSServiceCatalogFunctions.updateProvisionedProduct(updateToken: String, init: (AWSServiceCatalogUpdateProvisionedProductCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.UpdateProvisionedProductResult {
	return this.block.declare(AWSServiceCatalogUpdateProvisionedProductCommand(updateToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.UpdateProvisionedProductResult
}
...
class AWSServiceCatalogUpdateProvisionedProductCommand(val updateToken: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.UpdateProvisionedProductRequest, com.amazonaws.services.servicecatalog.model.UpdateProvisionedProductResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.UpdateProvisionedProductResult {
...
fun AWSServiceCatalogFunctions.updateProvisioningArtifact(productId: String, provisioningArtifactId: String, init: (AWSServiceCatalogUpdateProvisioningArtifactCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.UpdateProvisioningArtifactResult {
	return this.block.declare(AWSServiceCatalogUpdateProvisioningArtifactCommand(productId, provisioningArtifactId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.UpdateProvisioningArtifactResult
}
...
class AWSServiceCatalogUpdateProvisioningArtifactCommand(val productId: String, val provisioningArtifactId: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.UpdateProvisioningArtifactRequest, com.amazonaws.services.servicecatalog.model.UpdateProvisioningArtifactResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.UpdateProvisioningArtifactResult {
...
fun AWSServiceCatalogFunctions.updateTagOption(id: String, init: (AWSServiceCatalogUpdateTagOptionCommand.() -> Unit)? = null): com.amazonaws.services.servicecatalog.model.UpdateTagOptionResult {
	return this.block.declare(AWSServiceCatalogUpdateTagOptionCommand(id).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.servicecatalog.model.UpdateTagOptionResult
}
...
class AWSServiceCatalogUpdateTagOptionCommand(val id: String) : AmazonWebServiceCommand<com.amazonaws.services.servicecatalog.model.UpdateTagOptionRequest, com.amazonaws.services.servicecatalog.model.UpdateTagOptionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.servicecatalog.model.UpdateTagOptionResult {
