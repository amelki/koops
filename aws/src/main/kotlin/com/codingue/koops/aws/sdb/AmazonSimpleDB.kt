...
package com.codingue.koops.aws.sdb
...
fun AmazonSimpleDBFunctions.batchDeleteAttributes(domainName: String, items: List<com.amazonaws.services.simpledb.model.DeletableItem>, init: (AmazonSimpleDBBatchDeleteAttributesCommand.() -> Unit)? = null): com.amazonaws.services.simpledb.model.BatchDeleteAttributesResult {
	return this.block.declare(AmazonSimpleDBBatchDeleteAttributesCommand(domainName, items).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.simpledb.model.BatchDeleteAttributesResult
}
...
class AmazonSimpleDBBatchDeleteAttributesCommand(val domainName: String, val items: List<com.amazonaws.services.simpledb.model.DeletableItem>) : AmazonWebServiceCommand<com.amazonaws.services.simpledb.model.BatchDeleteAttributesRequest, com.amazonaws.services.simpledb.model.BatchDeleteAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.simpledb.model.BatchDeleteAttributesResult {
...
fun AmazonSimpleDBFunctions.batchPutAttributes(domainName: String, items: List<com.amazonaws.services.simpledb.model.ReplaceableItem>, init: (AmazonSimpleDBBatchPutAttributesCommand.() -> Unit)? = null): com.amazonaws.services.simpledb.model.BatchPutAttributesResult {
	return this.block.declare(AmazonSimpleDBBatchPutAttributesCommand(domainName, items).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.simpledb.model.BatchPutAttributesResult
}
...
class AmazonSimpleDBBatchPutAttributesCommand(val domainName: String, val items: List<com.amazonaws.services.simpledb.model.ReplaceableItem>) : AmazonWebServiceCommand<com.amazonaws.services.simpledb.model.BatchPutAttributesRequest, com.amazonaws.services.simpledb.model.BatchPutAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.simpledb.model.BatchPutAttributesResult {
...
fun AmazonSimpleDBFunctions.createDomain(domainName: String, init: (AmazonSimpleDBCreateDomainCommand.() -> Unit)? = null): com.amazonaws.services.simpledb.model.CreateDomainResult {
	return this.block.declare(AmazonSimpleDBCreateDomainCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.simpledb.model.CreateDomainResult
}
...
class AmazonSimpleDBCreateDomainCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.simpledb.model.CreateDomainRequest, com.amazonaws.services.simpledb.model.CreateDomainResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.simpledb.model.CreateDomainResult {
...
fun AmazonSimpleDBFunctions.deleteAttributes(domainName: String, itemName: String, init: (AmazonSimpleDBDeleteAttributesCommand.() -> Unit)? = null): com.amazonaws.services.simpledb.model.DeleteAttributesResult {
	return this.block.declare(AmazonSimpleDBDeleteAttributesCommand(domainName, itemName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.simpledb.model.DeleteAttributesResult
}
...
class AmazonSimpleDBDeleteAttributesCommand(val domainName: String, val itemName: String) : AmazonWebServiceCommand<com.amazonaws.services.simpledb.model.DeleteAttributesRequest, com.amazonaws.services.simpledb.model.DeleteAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.simpledb.model.DeleteAttributesResult {
...
fun AmazonSimpleDBFunctions.deleteDomain(domainName: String, init: (AmazonSimpleDBDeleteDomainCommand.() -> Unit)? = null): com.amazonaws.services.simpledb.model.DeleteDomainResult {
	return this.block.declare(AmazonSimpleDBDeleteDomainCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.simpledb.model.DeleteDomainResult
}
...
class AmazonSimpleDBDeleteDomainCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.simpledb.model.DeleteDomainRequest, com.amazonaws.services.simpledb.model.DeleteDomainResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.simpledb.model.DeleteDomainResult {
...
fun AmazonSimpleDBFunctions.domainMetadata(domainName: String, init: (AmazonSimpleDBDomainMetadataCommand.() -> Unit)? = null): com.amazonaws.services.simpledb.model.DomainMetadataResult {
	return this.block.declare(AmazonSimpleDBDomainMetadataCommand(domainName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.simpledb.model.DomainMetadataResult
}
...
class AmazonSimpleDBDomainMetadataCommand(val domainName: String) : AmazonWebServiceCommand<com.amazonaws.services.simpledb.model.DomainMetadataRequest, com.amazonaws.services.simpledb.model.DomainMetadataResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.simpledb.model.DomainMetadataResult {
...
fun AmazonSimpleDBFunctions.getAttributes(domainName: String, itemName: String, init: (AmazonSimpleDBGetAttributesCommand.() -> Unit)? = null): com.amazonaws.services.simpledb.model.GetAttributesResult {
	return this.block.declare(AmazonSimpleDBGetAttributesCommand(domainName, itemName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.simpledb.model.GetAttributesResult
}
...
class AmazonSimpleDBGetAttributesCommand(val domainName: String, val itemName: String) : AmazonWebServiceCommand<com.amazonaws.services.simpledb.model.GetAttributesRequest, com.amazonaws.services.simpledb.model.GetAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.simpledb.model.GetAttributesResult {
...
fun AmazonSimpleDBFunctions.listDomains(init: (AmazonSimpleDBListDomainsCommand.() -> Unit)? = null): com.amazonaws.services.simpledb.model.ListDomainsResult {
	return this.block.declare(AmazonSimpleDBListDomainsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.simpledb.model.ListDomainsResult
}
...
class AmazonSimpleDBListDomainsCommand() : AmazonWebServiceCommand<com.amazonaws.services.simpledb.model.ListDomainsRequest, com.amazonaws.services.simpledb.model.ListDomainsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.simpledb.model.ListDomainsResult {
...
fun AmazonSimpleDBFunctions.putAttributes(domainName: String, itemName: String, attributes: List<com.amazonaws.services.simpledb.model.ReplaceableAttribute>, init: (AmazonSimpleDBPutAttributesCommand.() -> Unit)? = null): com.amazonaws.services.simpledb.model.PutAttributesResult {
	return this.block.declare(AmazonSimpleDBPutAttributesCommand(domainName, itemName, attributes).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.simpledb.model.PutAttributesResult
}
...
class AmazonSimpleDBPutAttributesCommand(val domainName: String, val itemName: String, val attributes: List<com.amazonaws.services.simpledb.model.ReplaceableAttribute>) : AmazonWebServiceCommand<com.amazonaws.services.simpledb.model.PutAttributesRequest, com.amazonaws.services.simpledb.model.PutAttributesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.simpledb.model.PutAttributesResult {
...
fun AmazonSimpleDBFunctions.select(selectExpression: String, init: (AmazonSimpleDBSelectCommand.() -> Unit)? = null): com.amazonaws.services.simpledb.model.SelectResult {
	return this.block.declare(AmazonSimpleDBSelectCommand(selectExpression).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.simpledb.model.SelectResult
}
...
class AmazonSimpleDBSelectCommand(val selectExpression: String) : AmazonWebServiceCommand<com.amazonaws.services.simpledb.model.SelectRequest, com.amazonaws.services.simpledb.model.SelectResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.simpledb.model.SelectResult {
