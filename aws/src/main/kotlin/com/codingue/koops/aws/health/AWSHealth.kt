...
package com.codingue.koops.aws.health
...
fun AWSHealthFunctions.describeAffectedEntities(init: (AWSHealthDescribeAffectedEntitiesCommand.() -> Unit)? = null): com.amazonaws.services.health.model.DescribeAffectedEntitiesResult {
	return this.block.declare(AWSHealthDescribeAffectedEntitiesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.health.model.DescribeAffectedEntitiesResult
}
...
class AWSHealthDescribeAffectedEntitiesCommand() : AmazonWebServiceCommand<com.amazonaws.services.health.model.DescribeAffectedEntitiesRequest, com.amazonaws.services.health.model.DescribeAffectedEntitiesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.health.model.DescribeAffectedEntitiesResult {
...
fun AWSHealthFunctions.describeEntityAggregates(init: (AWSHealthDescribeEntityAggregatesCommand.() -> Unit)? = null): com.amazonaws.services.health.model.DescribeEntityAggregatesResult {
	return this.block.declare(AWSHealthDescribeEntityAggregatesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.health.model.DescribeEntityAggregatesResult
}
...
class AWSHealthDescribeEntityAggregatesCommand() : AmazonWebServiceCommand<com.amazonaws.services.health.model.DescribeEntityAggregatesRequest, com.amazonaws.services.health.model.DescribeEntityAggregatesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.health.model.DescribeEntityAggregatesResult {
...
fun AWSHealthFunctions.describeEventAggregates(init: (AWSHealthDescribeEventAggregatesCommand.() -> Unit)? = null): com.amazonaws.services.health.model.DescribeEventAggregatesResult {
	return this.block.declare(AWSHealthDescribeEventAggregatesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.health.model.DescribeEventAggregatesResult
}
...
class AWSHealthDescribeEventAggregatesCommand() : AmazonWebServiceCommand<com.amazonaws.services.health.model.DescribeEventAggregatesRequest, com.amazonaws.services.health.model.DescribeEventAggregatesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.health.model.DescribeEventAggregatesResult {
...
fun AWSHealthFunctions.describeEventDetails(init: (AWSHealthDescribeEventDetailsCommand.() -> Unit)? = null): com.amazonaws.services.health.model.DescribeEventDetailsResult {
	return this.block.declare(AWSHealthDescribeEventDetailsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.health.model.DescribeEventDetailsResult
}
...
class AWSHealthDescribeEventDetailsCommand() : AmazonWebServiceCommand<com.amazonaws.services.health.model.DescribeEventDetailsRequest, com.amazonaws.services.health.model.DescribeEventDetailsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.health.model.DescribeEventDetailsResult {
...
fun AWSHealthFunctions.describeEventTypes(init: (AWSHealthDescribeEventTypesCommand.() -> Unit)? = null): com.amazonaws.services.health.model.DescribeEventTypesResult {
	return this.block.declare(AWSHealthDescribeEventTypesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.health.model.DescribeEventTypesResult
}
...
class AWSHealthDescribeEventTypesCommand() : AmazonWebServiceCommand<com.amazonaws.services.health.model.DescribeEventTypesRequest, com.amazonaws.services.health.model.DescribeEventTypesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.health.model.DescribeEventTypesResult {
...
fun AWSHealthFunctions.describeEvents(init: (AWSHealthDescribeEventsCommand.() -> Unit)? = null): com.amazonaws.services.health.model.DescribeEventsResult {
	return this.block.declare(AWSHealthDescribeEventsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.health.model.DescribeEventsResult
}
...
class AWSHealthDescribeEventsCommand() : AmazonWebServiceCommand<com.amazonaws.services.health.model.DescribeEventsRequest, com.amazonaws.services.health.model.DescribeEventsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.health.model.DescribeEventsResult {
