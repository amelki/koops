...
package com.codingue.koops.aws.athena
...
var com.codingue.koops.core.Environment.athena: AmazonAthena
	get() {
		var service = this.capabilities["aws-athena"]
		if (service == null) {
			service = AmazonAthenaClientBuilder.standard().build()
			this.capabilities["aws-athena"] = service
		}
		return service as AmazonAthena
	}
	set(athena) {
		this.capabilities["aws-athena"] = athena
	}
...
fun AmazonAthenaFunctions.batchGetNamedQuery(namedQueryIds: List<String>, init: (AmazonAthenaBatchGetNamedQueryCommand.() -> Unit)? = null): com.amazonaws.services.athena.model.BatchGetNamedQueryResult {
	return this.block.declare(AmazonAthenaBatchGetNamedQueryCommand(namedQueryIds).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.athena.model.BatchGetNamedQueryResult
}
...
class AmazonAthenaBatchGetNamedQueryCommand(val namedQueryIds: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.athena.model.BatchGetNamedQueryRequest, com.amazonaws.services.athena.model.BatchGetNamedQueryResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.athena.model.BatchGetNamedQueryResult {
...
fun AmazonAthenaFunctions.batchGetQueryExecution(queryExecutionIds: List<String>, init: (AmazonAthenaBatchGetQueryExecutionCommand.() -> Unit)? = null): com.amazonaws.services.athena.model.BatchGetQueryExecutionResult {
	return this.block.declare(AmazonAthenaBatchGetQueryExecutionCommand(queryExecutionIds).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.athena.model.BatchGetQueryExecutionResult
}
...
class AmazonAthenaBatchGetQueryExecutionCommand(val queryExecutionIds: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.athena.model.BatchGetQueryExecutionRequest, com.amazonaws.services.athena.model.BatchGetQueryExecutionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.athena.model.BatchGetQueryExecutionResult {
...
fun AmazonAthenaFunctions.createNamedQuery(name: String, database: String, queryString: String, init: (AmazonAthenaCreateNamedQueryCommand.() -> Unit)? = null): com.amazonaws.services.athena.model.CreateNamedQueryResult {
	return this.block.declare(AmazonAthenaCreateNamedQueryCommand(name, database, queryString).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.athena.model.CreateNamedQueryResult
}
...
class AmazonAthenaCreateNamedQueryCommand(val name: String, val database: String, val queryString: String) : AmazonWebServiceCommand<com.amazonaws.services.athena.model.CreateNamedQueryRequest, com.amazonaws.services.athena.model.CreateNamedQueryResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.athena.model.CreateNamedQueryResult {
...
fun AmazonAthenaFunctions.deleteNamedQuery(namedQueryId: String, init: (AmazonAthenaDeleteNamedQueryCommand.() -> Unit)? = null): com.amazonaws.services.athena.model.DeleteNamedQueryResult {
	return this.block.declare(AmazonAthenaDeleteNamedQueryCommand(namedQueryId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.athena.model.DeleteNamedQueryResult
}
...
class AmazonAthenaDeleteNamedQueryCommand(val namedQueryId: String) : AmazonWebServiceCommand<com.amazonaws.services.athena.model.DeleteNamedQueryRequest, com.amazonaws.services.athena.model.DeleteNamedQueryResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.athena.model.DeleteNamedQueryResult {
...
fun AmazonAthenaFunctions.getNamedQuery(namedQueryId: String, init: (AmazonAthenaGetNamedQueryCommand.() -> Unit)? = null): com.amazonaws.services.athena.model.GetNamedQueryResult {
	return this.block.declare(AmazonAthenaGetNamedQueryCommand(namedQueryId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.athena.model.GetNamedQueryResult
}
...
class AmazonAthenaGetNamedQueryCommand(val namedQueryId: String) : AmazonWebServiceCommand<com.amazonaws.services.athena.model.GetNamedQueryRequest, com.amazonaws.services.athena.model.GetNamedQueryResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.athena.model.GetNamedQueryResult {
...
fun AmazonAthenaFunctions.getQueryExecution(queryExecutionId: String, init: (AmazonAthenaGetQueryExecutionCommand.() -> Unit)? = null): com.amazonaws.services.athena.model.GetQueryExecutionResult {
	return this.block.declare(AmazonAthenaGetQueryExecutionCommand(queryExecutionId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.athena.model.GetQueryExecutionResult
}
...
class AmazonAthenaGetQueryExecutionCommand(val queryExecutionId: String) : AmazonWebServiceCommand<com.amazonaws.services.athena.model.GetQueryExecutionRequest, com.amazonaws.services.athena.model.GetQueryExecutionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.athena.model.GetQueryExecutionResult {
...
fun AmazonAthenaFunctions.getQueryResults(queryExecutionId: String, init: (AmazonAthenaGetQueryResultsCommand.() -> Unit)? = null): com.amazonaws.services.athena.model.GetQueryResultsResult {
	return this.block.declare(AmazonAthenaGetQueryResultsCommand(queryExecutionId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.athena.model.GetQueryResultsResult
}
...
class AmazonAthenaGetQueryResultsCommand(val queryExecutionId: String) : AmazonWebServiceCommand<com.amazonaws.services.athena.model.GetQueryResultsRequest, com.amazonaws.services.athena.model.GetQueryResultsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.athena.model.GetQueryResultsResult {
...
fun AmazonAthenaFunctions.listNamedQueries(init: (AmazonAthenaListNamedQueriesCommand.() -> Unit)? = null): com.amazonaws.services.athena.model.ListNamedQueriesResult {
	return this.block.declare(AmazonAthenaListNamedQueriesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.athena.model.ListNamedQueriesResult
}
...
class AmazonAthenaListNamedQueriesCommand() : AmazonWebServiceCommand<com.amazonaws.services.athena.model.ListNamedQueriesRequest, com.amazonaws.services.athena.model.ListNamedQueriesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.athena.model.ListNamedQueriesResult {
...
fun AmazonAthenaFunctions.listQueryExecutions(init: (AmazonAthenaListQueryExecutionsCommand.() -> Unit)? = null): com.amazonaws.services.athena.model.ListQueryExecutionsResult {
	return this.block.declare(AmazonAthenaListQueryExecutionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.athena.model.ListQueryExecutionsResult
}
...
class AmazonAthenaListQueryExecutionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.athena.model.ListQueryExecutionsRequest, com.amazonaws.services.athena.model.ListQueryExecutionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.athena.model.ListQueryExecutionsResult {
...
fun AmazonAthenaFunctions.startQueryExecution(queryString: String, resultConfiguration: com.amazonaws.services.athena.model.ResultConfiguration, init: (AmazonAthenaStartQueryExecutionCommand.() -> Unit)? = null): com.amazonaws.services.athena.model.StartQueryExecutionResult {
	return this.block.declare(AmazonAthenaStartQueryExecutionCommand(queryString, resultConfiguration).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.athena.model.StartQueryExecutionResult
}
...
class AmazonAthenaStartQueryExecutionCommand(val queryString: String, val resultConfiguration: com.amazonaws.services.athena.model.ResultConfiguration) : AmazonWebServiceCommand<com.amazonaws.services.athena.model.StartQueryExecutionRequest, com.amazonaws.services.athena.model.StartQueryExecutionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.athena.model.StartQueryExecutionResult {
...
fun AmazonAthenaFunctions.stopQueryExecution(queryExecutionId: String, init: (AmazonAthenaStopQueryExecutionCommand.() -> Unit)? = null): com.amazonaws.services.athena.model.StopQueryExecutionResult {
	return this.block.declare(AmazonAthenaStopQueryExecutionCommand(queryExecutionId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.athena.model.StopQueryExecutionResult
}
...
class AmazonAthenaStopQueryExecutionCommand(val queryExecutionId: String) : AmazonWebServiceCommand<com.amazonaws.services.athena.model.StopQueryExecutionRequest, com.amazonaws.services.athena.model.StopQueryExecutionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.athena.model.StopQueryExecutionResult {
