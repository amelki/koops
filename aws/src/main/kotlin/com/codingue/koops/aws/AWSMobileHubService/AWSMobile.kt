...
package com.codingue.koops.aws.AWSMobileHubService

import javax.annotation.Generated
import com.codingue.koops.common.*
import com.codingue.koops.core.*
import com.codingue.koops.aws.*
import com.amazonaws.services.mobile.*
import com.amazonaws.services.mobile.model.*

var com.codingue.koops.core.Environment.AWSMobileHubService: AWSMobile
	get() {
		var service = this.capabilities["aws-AWSMobileHubService"]
		if (service == null) {
			service = AWSMobileClientBuilder.standard().build()
			this.capabilities["aws-AWSMobileHubService"] = service
		}
		return service as AWSMobile
	}
	set(AWSMobileHubService) {
		this.capabilities["aws-AWSMobileHubService"] = AWSMobileHubService
	}
...
fun AWSMobileFunctions.createProject(init: (AWSMobileCreateProjectCommand.() -> Unit)? = null): com.amazonaws.services.mobile.model.CreateProjectResult {
	return this.block.declare(AWSMobileCreateProjectCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mobile.model.CreateProjectResult
}
...
class AWSMobileCreateProjectCommand() : AmazonWebServiceCommand<com.amazonaws.services.mobile.model.CreateProjectRequest, com.amazonaws.services.mobile.model.CreateProjectResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mobile.model.CreateProjectResult {
...
fun AWSMobileFunctions.deleteProject(init: (AWSMobileDeleteProjectCommand.() -> Unit)? = null): com.amazonaws.services.mobile.model.DeleteProjectResult {
	return this.block.declare(AWSMobileDeleteProjectCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mobile.model.DeleteProjectResult
}
...
class AWSMobileDeleteProjectCommand() : AmazonWebServiceCommand<com.amazonaws.services.mobile.model.DeleteProjectRequest, com.amazonaws.services.mobile.model.DeleteProjectResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mobile.model.DeleteProjectResult {
...
fun AWSMobileFunctions.describeBundle(init: (AWSMobileDescribeBundleCommand.() -> Unit)? = null): com.amazonaws.services.mobile.model.DescribeBundleResult {
	return this.block.declare(AWSMobileDescribeBundleCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mobile.model.DescribeBundleResult
}
...
class AWSMobileDescribeBundleCommand() : AmazonWebServiceCommand<com.amazonaws.services.mobile.model.DescribeBundleRequest, com.amazonaws.services.mobile.model.DescribeBundleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mobile.model.DescribeBundleResult {
...
fun AWSMobileFunctions.describeProject(init: (AWSMobileDescribeProjectCommand.() -> Unit)? = null): com.amazonaws.services.mobile.model.DescribeProjectResult {
	return this.block.declare(AWSMobileDescribeProjectCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mobile.model.DescribeProjectResult
}
...
class AWSMobileDescribeProjectCommand() : AmazonWebServiceCommand<com.amazonaws.services.mobile.model.DescribeProjectRequest, com.amazonaws.services.mobile.model.DescribeProjectResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mobile.model.DescribeProjectResult {
...
fun AWSMobileFunctions.exportBundle(init: (AWSMobileExportBundleCommand.() -> Unit)? = null): com.amazonaws.services.mobile.model.ExportBundleResult {
	return this.block.declare(AWSMobileExportBundleCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mobile.model.ExportBundleResult
}
...
class AWSMobileExportBundleCommand() : AmazonWebServiceCommand<com.amazonaws.services.mobile.model.ExportBundleRequest, com.amazonaws.services.mobile.model.ExportBundleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mobile.model.ExportBundleResult {
...
fun AWSMobileFunctions.exportProject(init: (AWSMobileExportProjectCommand.() -> Unit)? = null): com.amazonaws.services.mobile.model.ExportProjectResult {
	return this.block.declare(AWSMobileExportProjectCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mobile.model.ExportProjectResult
}
...
class AWSMobileExportProjectCommand() : AmazonWebServiceCommand<com.amazonaws.services.mobile.model.ExportProjectRequest, com.amazonaws.services.mobile.model.ExportProjectResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mobile.model.ExportProjectResult {
...
fun AWSMobileFunctions.listBundles(init: (AWSMobileListBundlesCommand.() -> Unit)? = null): com.amazonaws.services.mobile.model.ListBundlesResult {
	return this.block.declare(AWSMobileListBundlesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mobile.model.ListBundlesResult
}
...
class AWSMobileListBundlesCommand() : AmazonWebServiceCommand<com.amazonaws.services.mobile.model.ListBundlesRequest, com.amazonaws.services.mobile.model.ListBundlesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mobile.model.ListBundlesResult {
...
fun AWSMobileFunctions.listProjects(init: (AWSMobileListProjectsCommand.() -> Unit)? = null): com.amazonaws.services.mobile.model.ListProjectsResult {
	return this.block.declare(AWSMobileListProjectsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mobile.model.ListProjectsResult
}
...
class AWSMobileListProjectsCommand() : AmazonWebServiceCommand<com.amazonaws.services.mobile.model.ListProjectsRequest, com.amazonaws.services.mobile.model.ListProjectsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mobile.model.ListProjectsResult {
...
fun AWSMobileFunctions.updateProject(init: (AWSMobileUpdateProjectCommand.() -> Unit)? = null): com.amazonaws.services.mobile.model.UpdateProjectResult {
	return this.block.declare(AWSMobileUpdateProjectCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mobile.model.UpdateProjectResult
}
...
class AWSMobileUpdateProjectCommand() : AmazonWebServiceCommand<com.amazonaws.services.mobile.model.UpdateProjectRequest, com.amazonaws.services.mobile.model.UpdateProjectResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mobile.model.UpdateProjectResult {
