...
package com.codingue.koops.aws.workmail
...
var com.codingue.koops.core.Environment.workmail: AmazonWorkMail
	get() {
...
fun AmazonWorkMailFunctions.associateDelegateToResource(organizationId: String, resourceId: String, entityId: String, init: (AmazonWorkMailAssociateDelegateToResourceCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.AssociateDelegateToResourceResult {
	return this.block.declare(AmazonWorkMailAssociateDelegateToResourceCommand(organizationId, resourceId, entityId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.AssociateDelegateToResourceResult
}
...
class AmazonWorkMailAssociateDelegateToResourceCommand(val organizationId: String, val resourceId: String, val entityId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.AssociateDelegateToResourceRequest, com.amazonaws.services.workmail.model.AssociateDelegateToResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.AssociateDelegateToResourceResult {
...
fun AmazonWorkMailFunctions.associateMemberToGroup(organizationId: String, groupId: String, memberId: String, init: (AmazonWorkMailAssociateMemberToGroupCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.AssociateMemberToGroupResult {
	return this.block.declare(AmazonWorkMailAssociateMemberToGroupCommand(organizationId, groupId, memberId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.AssociateMemberToGroupResult
}
...
class AmazonWorkMailAssociateMemberToGroupCommand(val organizationId: String, val groupId: String, val memberId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.AssociateMemberToGroupRequest, com.amazonaws.services.workmail.model.AssociateMemberToGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.AssociateMemberToGroupResult {
...
fun AmazonWorkMailFunctions.createAlias(organizationId: String, entityId: String, alias: String, init: (AmazonWorkMailCreateAliasCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.CreateAliasResult {
	return this.block.declare(AmazonWorkMailCreateAliasCommand(organizationId, entityId, alias).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.CreateAliasResult
}
...
class AmazonWorkMailCreateAliasCommand(val organizationId: String, val entityId: String, val alias: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.CreateAliasRequest, com.amazonaws.services.workmail.model.CreateAliasResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.CreateAliasResult {
...
fun AmazonWorkMailFunctions.createGroup(organizationId: String, name: String, init: (AmazonWorkMailCreateGroupCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.CreateGroupResult {
	return this.block.declare(AmazonWorkMailCreateGroupCommand(organizationId, name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.CreateGroupResult
}
...
class AmazonWorkMailCreateGroupCommand(val organizationId: String, val name: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.CreateGroupRequest, com.amazonaws.services.workmail.model.CreateGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.CreateGroupResult {
...
fun AmazonWorkMailFunctions.createResource(organizationId: String, name: String, type: ResourceType, init: (AmazonWorkMailCreateResourceCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.CreateResourceResult {
	return this.block.declare(AmazonWorkMailCreateResourceCommand(organizationId, name, type).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.CreateResourceResult
}
...
class AmazonWorkMailCreateResourceCommand(val organizationId: String, val name: String, val type: ResourceType) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.CreateResourceRequest, com.amazonaws.services.workmail.model.CreateResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.CreateResourceResult {
...
fun AmazonWorkMailFunctions.createUser(organizationId: String, name: String, displayName: String, password: String, init: (AmazonWorkMailCreateUserCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.CreateUserResult {
	return this.block.declare(AmazonWorkMailCreateUserCommand(organizationId, name, displayName, password).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.CreateUserResult
}
...
class AmazonWorkMailCreateUserCommand(val organizationId: String, val name: String, val displayName: String, val password: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.CreateUserRequest, com.amazonaws.services.workmail.model.CreateUserResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.CreateUserResult {
...
fun AmazonWorkMailFunctions.deleteAlias(organizationId: String, entityId: String, alias: String, init: (AmazonWorkMailDeleteAliasCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.DeleteAliasResult {
	return this.block.declare(AmazonWorkMailDeleteAliasCommand(organizationId, entityId, alias).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.DeleteAliasResult
}
...
class AmazonWorkMailDeleteAliasCommand(val organizationId: String, val entityId: String, val alias: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.DeleteAliasRequest, com.amazonaws.services.workmail.model.DeleteAliasResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.DeleteAliasResult {
...
fun AmazonWorkMailFunctions.deleteGroup(organizationId: String, groupId: String, init: (AmazonWorkMailDeleteGroupCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.DeleteGroupResult {
	return this.block.declare(AmazonWorkMailDeleteGroupCommand(organizationId, groupId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.DeleteGroupResult
}
...
class AmazonWorkMailDeleteGroupCommand(val organizationId: String, val groupId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.DeleteGroupRequest, com.amazonaws.services.workmail.model.DeleteGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.DeleteGroupResult {
...
fun AmazonWorkMailFunctions.deleteResource(organizationId: String, resourceId: String, init: (AmazonWorkMailDeleteResourceCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.DeleteResourceResult {
	return this.block.declare(AmazonWorkMailDeleteResourceCommand(organizationId, resourceId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.DeleteResourceResult
}
...
class AmazonWorkMailDeleteResourceCommand(val organizationId: String, val resourceId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.DeleteResourceRequest, com.amazonaws.services.workmail.model.DeleteResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.DeleteResourceResult {
...
fun AmazonWorkMailFunctions.deleteUser(organizationId: String, userId: String, init: (AmazonWorkMailDeleteUserCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.DeleteUserResult {
	return this.block.declare(AmazonWorkMailDeleteUserCommand(organizationId, userId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.DeleteUserResult
}
...
class AmazonWorkMailDeleteUserCommand(val organizationId: String, val userId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.DeleteUserRequest, com.amazonaws.services.workmail.model.DeleteUserResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.DeleteUserResult {
...
fun AmazonWorkMailFunctions.deregisterFromWorkMail(organizationId: String, entityId: String, init: (AmazonWorkMailDeregisterFromWorkMailCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.DeregisterFromWorkMailResult {
	return this.block.declare(AmazonWorkMailDeregisterFromWorkMailCommand(organizationId, entityId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.DeregisterFromWorkMailResult
}
...
class AmazonWorkMailDeregisterFromWorkMailCommand(val organizationId: String, val entityId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.DeregisterFromWorkMailRequest, com.amazonaws.services.workmail.model.DeregisterFromWorkMailResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.DeregisterFromWorkMailResult {
...
fun AmazonWorkMailFunctions.describeGroup(organizationId: String, groupId: String, init: (AmazonWorkMailDescribeGroupCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.DescribeGroupResult {
	return this.block.declare(AmazonWorkMailDescribeGroupCommand(organizationId, groupId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.DescribeGroupResult
}
...
class AmazonWorkMailDescribeGroupCommand(val organizationId: String, val groupId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.DescribeGroupRequest, com.amazonaws.services.workmail.model.DescribeGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.DescribeGroupResult {
...
fun AmazonWorkMailFunctions.describeOrganization(organizationId: String, init: (AmazonWorkMailDescribeOrganizationCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.DescribeOrganizationResult {
	return this.block.declare(AmazonWorkMailDescribeOrganizationCommand(organizationId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.DescribeOrganizationResult
}
...
class AmazonWorkMailDescribeOrganizationCommand(val organizationId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.DescribeOrganizationRequest, com.amazonaws.services.workmail.model.DescribeOrganizationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.DescribeOrganizationResult {
...
fun AmazonWorkMailFunctions.describeResource(organizationId: String, resourceId: String, init: (AmazonWorkMailDescribeResourceCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.DescribeResourceResult {
	return this.block.declare(AmazonWorkMailDescribeResourceCommand(organizationId, resourceId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.DescribeResourceResult
}
...
class AmazonWorkMailDescribeResourceCommand(val organizationId: String, val resourceId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.DescribeResourceRequest, com.amazonaws.services.workmail.model.DescribeResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.DescribeResourceResult {
...
fun AmazonWorkMailFunctions.describeUser(organizationId: String, userId: String, init: (AmazonWorkMailDescribeUserCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.DescribeUserResult {
	return this.block.declare(AmazonWorkMailDescribeUserCommand(organizationId, userId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.DescribeUserResult
}
...
class AmazonWorkMailDescribeUserCommand(val organizationId: String, val userId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.DescribeUserRequest, com.amazonaws.services.workmail.model.DescribeUserResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.DescribeUserResult {
...
fun AmazonWorkMailFunctions.disassociateDelegateFromResource(organizationId: String, resourceId: String, entityId: String, init: (AmazonWorkMailDisassociateDelegateFromResourceCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.DisassociateDelegateFromResourceResult {
	return this.block.declare(AmazonWorkMailDisassociateDelegateFromResourceCommand(organizationId, resourceId, entityId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.DisassociateDelegateFromResourceResult
}
...
class AmazonWorkMailDisassociateDelegateFromResourceCommand(val organizationId: String, val resourceId: String, val entityId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.DisassociateDelegateFromResourceRequest, com.amazonaws.services.workmail.model.DisassociateDelegateFromResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.DisassociateDelegateFromResourceResult {
...
fun AmazonWorkMailFunctions.disassociateMemberFromGroup(organizationId: String, groupId: String, memberId: String, init: (AmazonWorkMailDisassociateMemberFromGroupCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.DisassociateMemberFromGroupResult {
	return this.block.declare(AmazonWorkMailDisassociateMemberFromGroupCommand(organizationId, groupId, memberId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.DisassociateMemberFromGroupResult
}
...
class AmazonWorkMailDisassociateMemberFromGroupCommand(val organizationId: String, val groupId: String, val memberId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.DisassociateMemberFromGroupRequest, com.amazonaws.services.workmail.model.DisassociateMemberFromGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.DisassociateMemberFromGroupResult {
...
fun AmazonWorkMailFunctions.listAliases(organizationId: String, entityId: String, init: (AmazonWorkMailListAliasesCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.ListAliasesResult {
	return this.block.declare(AmazonWorkMailListAliasesCommand(organizationId, entityId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.ListAliasesResult
}
...
class AmazonWorkMailListAliasesCommand(val organizationId: String, val entityId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.ListAliasesRequest, com.amazonaws.services.workmail.model.ListAliasesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.ListAliasesResult {
...
fun AmazonWorkMailFunctions.listGroupMembers(organizationId: String, groupId: String, init: (AmazonWorkMailListGroupMembersCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.ListGroupMembersResult {
	return this.block.declare(AmazonWorkMailListGroupMembersCommand(organizationId, groupId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.ListGroupMembersResult
}
...
class AmazonWorkMailListGroupMembersCommand(val organizationId: String, val groupId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.ListGroupMembersRequest, com.amazonaws.services.workmail.model.ListGroupMembersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.ListGroupMembersResult {
...
fun AmazonWorkMailFunctions.listGroups(organizationId: String, init: (AmazonWorkMailListGroupsCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.ListGroupsResult {
	return this.block.declare(AmazonWorkMailListGroupsCommand(organizationId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.ListGroupsResult
}
...
class AmazonWorkMailListGroupsCommand(val organizationId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.ListGroupsRequest, com.amazonaws.services.workmail.model.ListGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.ListGroupsResult {
...
fun AmazonWorkMailFunctions.listOrganizations(init: (AmazonWorkMailListOrganizationsCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.ListOrganizationsResult {
	return this.block.declare(AmazonWorkMailListOrganizationsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.ListOrganizationsResult
}
...
class AmazonWorkMailListOrganizationsCommand() : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.ListOrganizationsRequest, com.amazonaws.services.workmail.model.ListOrganizationsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.ListOrganizationsResult {
...
fun AmazonWorkMailFunctions.listResourceDelegates(organizationId: String, resourceId: String, init: (AmazonWorkMailListResourceDelegatesCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.ListResourceDelegatesResult {
	return this.block.declare(AmazonWorkMailListResourceDelegatesCommand(organizationId, resourceId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.ListResourceDelegatesResult
}
...
class AmazonWorkMailListResourceDelegatesCommand(val organizationId: String, val resourceId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.ListResourceDelegatesRequest, com.amazonaws.services.workmail.model.ListResourceDelegatesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.ListResourceDelegatesResult {
...
fun AmazonWorkMailFunctions.listResources(organizationId: String, init: (AmazonWorkMailListResourcesCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.ListResourcesResult {
	return this.block.declare(AmazonWorkMailListResourcesCommand(organizationId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.ListResourcesResult
}
...
class AmazonWorkMailListResourcesCommand(val organizationId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.ListResourcesRequest, com.amazonaws.services.workmail.model.ListResourcesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.ListResourcesResult {
...
fun AmazonWorkMailFunctions.listUsers(organizationId: String, init: (AmazonWorkMailListUsersCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.ListUsersResult {
	return this.block.declare(AmazonWorkMailListUsersCommand(organizationId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.ListUsersResult
}
...
class AmazonWorkMailListUsersCommand(val organizationId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.ListUsersRequest, com.amazonaws.services.workmail.model.ListUsersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.ListUsersResult {
...
fun AmazonWorkMailFunctions.registerToWorkMail(organizationId: String, entityId: String, email: String, init: (AmazonWorkMailRegisterToWorkMailCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.RegisterToWorkMailResult {
	return this.block.declare(AmazonWorkMailRegisterToWorkMailCommand(organizationId, entityId, email).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.RegisterToWorkMailResult
}
...
class AmazonWorkMailRegisterToWorkMailCommand(val organizationId: String, val entityId: String, val email: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.RegisterToWorkMailRequest, com.amazonaws.services.workmail.model.RegisterToWorkMailResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.RegisterToWorkMailResult {
...
fun AmazonWorkMailFunctions.resetPassword(organizationId: String, userId: String, password: String, init: (AmazonWorkMailResetPasswordCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.ResetPasswordResult {
	return this.block.declare(AmazonWorkMailResetPasswordCommand(organizationId, userId, password).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.ResetPasswordResult
}
...
class AmazonWorkMailResetPasswordCommand(val organizationId: String, val userId: String, val password: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.ResetPasswordRequest, com.amazonaws.services.workmail.model.ResetPasswordResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.ResetPasswordResult {
...
fun AmazonWorkMailFunctions.updatePrimaryEmailAddress(organizationId: String, entityId: String, email: String, init: (AmazonWorkMailUpdatePrimaryEmailAddressCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.UpdatePrimaryEmailAddressResult {
	return this.block.declare(AmazonWorkMailUpdatePrimaryEmailAddressCommand(organizationId, entityId, email).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.UpdatePrimaryEmailAddressResult
}
...
class AmazonWorkMailUpdatePrimaryEmailAddressCommand(val organizationId: String, val entityId: String, val email: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.UpdatePrimaryEmailAddressRequest, com.amazonaws.services.workmail.model.UpdatePrimaryEmailAddressResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.UpdatePrimaryEmailAddressResult {
...
fun AmazonWorkMailFunctions.updateResource(organizationId: String, resourceId: String, init: (AmazonWorkMailUpdateResourceCommand.() -> Unit)? = null): com.amazonaws.services.workmail.model.UpdateResourceResult {
	return this.block.declare(AmazonWorkMailUpdateResourceCommand(organizationId, resourceId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workmail.model.UpdateResourceResult
}
...
class AmazonWorkMailUpdateResourceCommand(val organizationId: String, val resourceId: String) : AmazonWebServiceCommand<com.amazonaws.services.workmail.model.UpdateResourceRequest, com.amazonaws.services.workmail.model.UpdateResourceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workmail.model.UpdateResourceResult {
