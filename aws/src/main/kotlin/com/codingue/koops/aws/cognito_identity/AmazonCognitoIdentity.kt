...
package com.codingue.koops.aws.cognito_identity
...
var com.codingue.koops.core.Environment.cognito_identity: AmazonCognitoIdentity
	get() {
		var service = this.capabilities["aws-cognito_identity"]
		if (service == null) {
			service = AmazonCognitoIdentityClientBuilder.standard().build()
			this.capabilities["aws-cognito_identity"] = service
		}
		return service as AmazonCognitoIdentity
	}
	set(cognito_identity) {
		this.capabilities["aws-cognito_identity"] = cognito_identity
	}
...
fun AmazonCognitoIdentityFunctions.createIdentityPool(identityPoolName: String, allowUnauthenticatedIdentities: Boolean, init: (AmazonCognitoIdentityCreateIdentityPoolCommand.() -> Unit)? = null): com.amazonaws.services.cognitoidentity.model.CreateIdentityPoolResult {
	return this.block.declare(AmazonCognitoIdentityCreateIdentityPoolCommand(identityPoolName, allowUnauthenticatedIdentities).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitoidentity.model.CreateIdentityPoolResult
}
...
class AmazonCognitoIdentityCreateIdentityPoolCommand(val identityPoolName: String, val allowUnauthenticatedIdentities: Boolean) : AmazonWebServiceCommand<com.amazonaws.services.cognitoidentity.model.CreateIdentityPoolRequest, com.amazonaws.services.cognitoidentity.model.CreateIdentityPoolResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitoidentity.model.CreateIdentityPoolResult {
...
fun AmazonCognitoIdentityFunctions.deleteIdentities(identityIdsToDelete: List<String>, init: (AmazonCognitoIdentityDeleteIdentitiesCommand.() -> Unit)? = null): com.amazonaws.services.cognitoidentity.model.DeleteIdentitiesResult {
	return this.block.declare(AmazonCognitoIdentityDeleteIdentitiesCommand(identityIdsToDelete).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitoidentity.model.DeleteIdentitiesResult
}
...
class AmazonCognitoIdentityDeleteIdentitiesCommand(val identityIdsToDelete: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.cognitoidentity.model.DeleteIdentitiesRequest, com.amazonaws.services.cognitoidentity.model.DeleteIdentitiesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitoidentity.model.DeleteIdentitiesResult {
...
fun AmazonCognitoIdentityFunctions.deleteIdentityPool(identityPoolId: String, init: (AmazonCognitoIdentityDeleteIdentityPoolCommand.() -> Unit)? = null): com.amazonaws.services.cognitoidentity.model.DeleteIdentityPoolResult {
	return this.block.declare(AmazonCognitoIdentityDeleteIdentityPoolCommand(identityPoolId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitoidentity.model.DeleteIdentityPoolResult
}
...
class AmazonCognitoIdentityDeleteIdentityPoolCommand(val identityPoolId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitoidentity.model.DeleteIdentityPoolRequest, com.amazonaws.services.cognitoidentity.model.DeleteIdentityPoolResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitoidentity.model.DeleteIdentityPoolResult {
...
fun AmazonCognitoIdentityFunctions.describeIdentity(identityId: String, init: (AmazonCognitoIdentityDescribeIdentityCommand.() -> Unit)? = null): com.amazonaws.services.cognitoidentity.model.DescribeIdentityResult {
	return this.block.declare(AmazonCognitoIdentityDescribeIdentityCommand(identityId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitoidentity.model.DescribeIdentityResult
}
...
class AmazonCognitoIdentityDescribeIdentityCommand(val identityId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitoidentity.model.DescribeIdentityRequest, com.amazonaws.services.cognitoidentity.model.DescribeIdentityResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitoidentity.model.DescribeIdentityResult {
...
fun AmazonCognitoIdentityFunctions.describeIdentityPool(identityPoolId: String, init: (AmazonCognitoIdentityDescribeIdentityPoolCommand.() -> Unit)? = null): com.amazonaws.services.cognitoidentity.model.DescribeIdentityPoolResult {
	return this.block.declare(AmazonCognitoIdentityDescribeIdentityPoolCommand(identityPoolId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitoidentity.model.DescribeIdentityPoolResult
}
...
class AmazonCognitoIdentityDescribeIdentityPoolCommand(val identityPoolId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitoidentity.model.DescribeIdentityPoolRequest, com.amazonaws.services.cognitoidentity.model.DescribeIdentityPoolResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitoidentity.model.DescribeIdentityPoolResult {
...
fun AmazonCognitoIdentityFunctions.getCredentialsForIdentity(identityId: String, init: (AmazonCognitoIdentityGetCredentialsForIdentityCommand.() -> Unit)? = null): com.amazonaws.services.cognitoidentity.model.GetCredentialsForIdentityResult {
	return this.block.declare(AmazonCognitoIdentityGetCredentialsForIdentityCommand(identityId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitoidentity.model.GetCredentialsForIdentityResult
}
...
class AmazonCognitoIdentityGetCredentialsForIdentityCommand(val identityId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitoidentity.model.GetCredentialsForIdentityRequest, com.amazonaws.services.cognitoidentity.model.GetCredentialsForIdentityResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitoidentity.model.GetCredentialsForIdentityResult {
...
fun AmazonCognitoIdentityFunctions.getId(identityPoolId: String, init: (AmazonCognitoIdentityGetIdCommand.() -> Unit)? = null): com.amazonaws.services.cognitoidentity.model.GetIdResult {
	return this.block.declare(AmazonCognitoIdentityGetIdCommand(identityPoolId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitoidentity.model.GetIdResult
}
...
class AmazonCognitoIdentityGetIdCommand(val identityPoolId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitoidentity.model.GetIdRequest, com.amazonaws.services.cognitoidentity.model.GetIdResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitoidentity.model.GetIdResult {
...
fun AmazonCognitoIdentityFunctions.getIdentityPoolRoles(identityPoolId: String, init: (AmazonCognitoIdentityGetIdentityPoolRolesCommand.() -> Unit)? = null): com.amazonaws.services.cognitoidentity.model.GetIdentityPoolRolesResult {
	return this.block.declare(AmazonCognitoIdentityGetIdentityPoolRolesCommand(identityPoolId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitoidentity.model.GetIdentityPoolRolesResult
}
...
class AmazonCognitoIdentityGetIdentityPoolRolesCommand(val identityPoolId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitoidentity.model.GetIdentityPoolRolesRequest, com.amazonaws.services.cognitoidentity.model.GetIdentityPoolRolesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitoidentity.model.GetIdentityPoolRolesResult {
...
fun AmazonCognitoIdentityFunctions.getOpenIdToken(identityId: String, init: (AmazonCognitoIdentityGetOpenIdTokenCommand.() -> Unit)? = null): com.amazonaws.services.cognitoidentity.model.GetOpenIdTokenResult {
	return this.block.declare(AmazonCognitoIdentityGetOpenIdTokenCommand(identityId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitoidentity.model.GetOpenIdTokenResult
}
...
class AmazonCognitoIdentityGetOpenIdTokenCommand(val identityId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitoidentity.model.GetOpenIdTokenRequest, com.amazonaws.services.cognitoidentity.model.GetOpenIdTokenResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitoidentity.model.GetOpenIdTokenResult {
...
fun AmazonCognitoIdentityFunctions.getOpenIdTokenForDeveloperIdentity(identityPoolId: String, logins: Map<String, String>, init: (AmazonCognitoIdentityGetOpenIdTokenForDeveloperIdentityCommand.() -> Unit)? = null): com.amazonaws.services.cognitoidentity.model.GetOpenIdTokenForDeveloperIdentityResult {
	return this.block.declare(AmazonCognitoIdentityGetOpenIdTokenForDeveloperIdentityCommand(identityPoolId, logins).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitoidentity.model.GetOpenIdTokenForDeveloperIdentityResult
}
...
class AmazonCognitoIdentityGetOpenIdTokenForDeveloperIdentityCommand(val identityPoolId: String, val logins: Map<String, String>) : AmazonWebServiceCommand<com.amazonaws.services.cognitoidentity.model.GetOpenIdTokenForDeveloperIdentityRequest, com.amazonaws.services.cognitoidentity.model.GetOpenIdTokenForDeveloperIdentityResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitoidentity.model.GetOpenIdTokenForDeveloperIdentityResult {
...
fun AmazonCognitoIdentityFunctions.listIdentities(identityPoolId: String, maxResults: Int, init: (AmazonCognitoIdentityListIdentitiesCommand.() -> Unit)? = null): com.amazonaws.services.cognitoidentity.model.ListIdentitiesResult {
	return this.block.declare(AmazonCognitoIdentityListIdentitiesCommand(identityPoolId, maxResults).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitoidentity.model.ListIdentitiesResult
}
...
class AmazonCognitoIdentityListIdentitiesCommand(val identityPoolId: String, val maxResults: Int) : AmazonWebServiceCommand<com.amazonaws.services.cognitoidentity.model.ListIdentitiesRequest, com.amazonaws.services.cognitoidentity.model.ListIdentitiesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitoidentity.model.ListIdentitiesResult {
...
fun AmazonCognitoIdentityFunctions.listIdentityPools(maxResults: Int, init: (AmazonCognitoIdentityListIdentityPoolsCommand.() -> Unit)? = null): com.amazonaws.services.cognitoidentity.model.ListIdentityPoolsResult {
	return this.block.declare(AmazonCognitoIdentityListIdentityPoolsCommand(maxResults).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitoidentity.model.ListIdentityPoolsResult
}
...
class AmazonCognitoIdentityListIdentityPoolsCommand(val maxResults: Int) : AmazonWebServiceCommand<com.amazonaws.services.cognitoidentity.model.ListIdentityPoolsRequest, com.amazonaws.services.cognitoidentity.model.ListIdentityPoolsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitoidentity.model.ListIdentityPoolsResult {
...
fun AmazonCognitoIdentityFunctions.lookupDeveloperIdentity(identityPoolId: String, init: (AmazonCognitoIdentityLookupDeveloperIdentityCommand.() -> Unit)? = null): com.amazonaws.services.cognitoidentity.model.LookupDeveloperIdentityResult {
	return this.block.declare(AmazonCognitoIdentityLookupDeveloperIdentityCommand(identityPoolId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitoidentity.model.LookupDeveloperIdentityResult
}
...
class AmazonCognitoIdentityLookupDeveloperIdentityCommand(val identityPoolId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitoidentity.model.LookupDeveloperIdentityRequest, com.amazonaws.services.cognitoidentity.model.LookupDeveloperIdentityResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitoidentity.model.LookupDeveloperIdentityResult {
...
fun AmazonCognitoIdentityFunctions.mergeDeveloperIdentities(sourceUserIdentifier: String, destinationUserIdentifier: String, developerProviderName: String, identityPoolId: String, init: (AmazonCognitoIdentityMergeDeveloperIdentitiesCommand.() -> Unit)? = null): com.amazonaws.services.cognitoidentity.model.MergeDeveloperIdentitiesResult {
	return this.block.declare(AmazonCognitoIdentityMergeDeveloperIdentitiesCommand(sourceUserIdentifier, destinationUserIdentifier, developerProviderName, identityPoolId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitoidentity.model.MergeDeveloperIdentitiesResult
}
...
class AmazonCognitoIdentityMergeDeveloperIdentitiesCommand(val sourceUserIdentifier: String, val destinationUserIdentifier: String, val developerProviderName: String, val identityPoolId: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitoidentity.model.MergeDeveloperIdentitiesRequest, com.amazonaws.services.cognitoidentity.model.MergeDeveloperIdentitiesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitoidentity.model.MergeDeveloperIdentitiesResult {
...
fun AmazonCognitoIdentityFunctions.setIdentityPoolRoles(identityPoolId: String, roles: Map<String, String>, init: (AmazonCognitoIdentitySetIdentityPoolRolesCommand.() -> Unit)? = null): com.amazonaws.services.cognitoidentity.model.SetIdentityPoolRolesResult {
	return this.block.declare(AmazonCognitoIdentitySetIdentityPoolRolesCommand(identityPoolId, roles).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitoidentity.model.SetIdentityPoolRolesResult
}
...
class AmazonCognitoIdentitySetIdentityPoolRolesCommand(val identityPoolId: String, val roles: Map<String, String>) : AmazonWebServiceCommand<com.amazonaws.services.cognitoidentity.model.SetIdentityPoolRolesRequest, com.amazonaws.services.cognitoidentity.model.SetIdentityPoolRolesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitoidentity.model.SetIdentityPoolRolesResult {
...
fun AmazonCognitoIdentityFunctions.unlinkDeveloperIdentity(identityId: String, identityPoolId: String, developerProviderName: String, developerUserIdentifier: String, init: (AmazonCognitoIdentityUnlinkDeveloperIdentityCommand.() -> Unit)? = null): com.amazonaws.services.cognitoidentity.model.UnlinkDeveloperIdentityResult {
	return this.block.declare(AmazonCognitoIdentityUnlinkDeveloperIdentityCommand(identityId, identityPoolId, developerProviderName, developerUserIdentifier).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitoidentity.model.UnlinkDeveloperIdentityResult
}
...
class AmazonCognitoIdentityUnlinkDeveloperIdentityCommand(val identityId: String, val identityPoolId: String, val developerProviderName: String, val developerUserIdentifier: String) : AmazonWebServiceCommand<com.amazonaws.services.cognitoidentity.model.UnlinkDeveloperIdentityRequest, com.amazonaws.services.cognitoidentity.model.UnlinkDeveloperIdentityResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitoidentity.model.UnlinkDeveloperIdentityResult {
...
fun AmazonCognitoIdentityFunctions.unlinkIdentity(identityId: String, logins: Map<String, String>, loginsToRemove: List<String>, init: (AmazonCognitoIdentityUnlinkIdentityCommand.() -> Unit)? = null): com.amazonaws.services.cognitoidentity.model.UnlinkIdentityResult {
	return this.block.declare(AmazonCognitoIdentityUnlinkIdentityCommand(identityId, logins, loginsToRemove).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitoidentity.model.UnlinkIdentityResult
}
...
class AmazonCognitoIdentityUnlinkIdentityCommand(val identityId: String, val logins: Map<String, String>, val loginsToRemove: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.cognitoidentity.model.UnlinkIdentityRequest, com.amazonaws.services.cognitoidentity.model.UnlinkIdentityResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitoidentity.model.UnlinkIdentityResult {
...
fun AmazonCognitoIdentityFunctions.updateIdentityPool(identityPoolId: String, identityPoolName: String, allowUnauthenticatedIdentities: Boolean, init: (AmazonCognitoIdentityUpdateIdentityPoolCommand.() -> Unit)? = null): com.amazonaws.services.cognitoidentity.model.UpdateIdentityPoolResult {
	return this.block.declare(AmazonCognitoIdentityUpdateIdentityPoolCommand(identityPoolId, identityPoolName, allowUnauthenticatedIdentities).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cognitoidentity.model.UpdateIdentityPoolResult
}
...
class AmazonCognitoIdentityUpdateIdentityPoolCommand(val identityPoolId: String, val identityPoolName: String, val allowUnauthenticatedIdentities: Boolean) : AmazonWebServiceCommand<com.amazonaws.services.cognitoidentity.model.UpdateIdentityPoolRequest, com.amazonaws.services.cognitoidentity.model.UpdateIdentityPoolResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cognitoidentity.model.UpdateIdentityPoolResult {
