...
package com.codingue.koops.aws.importexport

import javax.annotation.Generated
import com.codingue.koops.common.*
import com.codingue.koops.core.*
import com.codingue.koops.aws.*
import com.amazonaws.services.importexport.*
import com.amazonaws.services.importexport.model.*

var com.codingue.koops.core.Environment.importexport: AmazonImportExport
	get() {
		var service = this.capabilities["aws-importexport"]
		if (service == null) {
			service = AmazonImportExportClientBuilder.standard().build()
			this.capabilities["aws-importexport"] = service
		}
		return service as AmazonImportExport
	}
	set(importexport) {
		this.capabilities["aws-importexport"] = importexport
	}
...
fun AmazonImportExportFunctions.cancelJob(jobId: String, init: (AmazonImportExportCancelJobCommand.() -> Unit)? = null): com.amazonaws.services.importexport.model.CancelJobResult {
	return this.block.declare(AmazonImportExportCancelJobCommand(jobId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.importexport.model.CancelJobResult
}
...
class AmazonImportExportCancelJobCommand(val jobId: String) : AmazonWebServiceCommand<com.amazonaws.services.importexport.model.CancelJobRequest, com.amazonaws.services.importexport.model.CancelJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.importexport.model.CancelJobResult {
...
fun AmazonImportExportFunctions.createJob(jobType: JobType, manifest: String, validateOnly: Boolean, init: (AmazonImportExportCreateJobCommand.() -> Unit)? = null): com.amazonaws.services.importexport.model.CreateJobResult {
	return this.block.declare(AmazonImportExportCreateJobCommand(jobType, manifest, validateOnly).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.importexport.model.CreateJobResult
}
...
class AmazonImportExportCreateJobCommand(val jobType: JobType, val manifest: String, val validateOnly: Boolean) : AmazonWebServiceCommand<com.amazonaws.services.importexport.model.CreateJobRequest, com.amazonaws.services.importexport.model.CreateJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.importexport.model.CreateJobResult {
...
fun AmazonImportExportFunctions.getShippingLabel(init: (AmazonImportExportGetShippingLabelCommand.() -> Unit)? = null): com.amazonaws.services.importexport.model.GetShippingLabelResult {
	return this.block.declare(AmazonImportExportGetShippingLabelCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.importexport.model.GetShippingLabelResult
}
...
class AmazonImportExportGetShippingLabelCommand() : AmazonWebServiceCommand<com.amazonaws.services.importexport.model.GetShippingLabelRequest, com.amazonaws.services.importexport.model.GetShippingLabelResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.importexport.model.GetShippingLabelResult {
...
fun AmazonImportExportFunctions.getStatus(jobId: String, init: (AmazonImportExportGetStatusCommand.() -> Unit)? = null): com.amazonaws.services.importexport.model.GetStatusResult {
	return this.block.declare(AmazonImportExportGetStatusCommand(jobId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.importexport.model.GetStatusResult
}
...
class AmazonImportExportGetStatusCommand(val jobId: String) : AmazonWebServiceCommand<com.amazonaws.services.importexport.model.GetStatusRequest, com.amazonaws.services.importexport.model.GetStatusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.importexport.model.GetStatusResult {
...
fun AmazonImportExportFunctions.listJobs(init: (AmazonImportExportListJobsCommand.() -> Unit)? = null): com.amazonaws.services.importexport.model.ListJobsResult {
	return this.block.declare(AmazonImportExportListJobsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.importexport.model.ListJobsResult
}
...
class AmazonImportExportListJobsCommand() : AmazonWebServiceCommand<com.amazonaws.services.importexport.model.ListJobsRequest, com.amazonaws.services.importexport.model.ListJobsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.importexport.model.ListJobsResult {
...
fun AmazonImportExportFunctions.updateJob(jobId: String, manifest: String, jobType: JobType, validateOnly: Boolean, init: (AmazonImportExportUpdateJobCommand.() -> Unit)? = null): com.amazonaws.services.importexport.model.UpdateJobResult {
	return this.block.declare(AmazonImportExportUpdateJobCommand(jobId, manifest, jobType, validateOnly).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.importexport.model.UpdateJobResult
}
...
class AmazonImportExportUpdateJobCommand(val jobId: String, val manifest: String, val jobType: JobType, val validateOnly: Boolean) : AmazonWebServiceCommand<com.amazonaws.services.importexport.model.UpdateJobRequest, com.amazonaws.services.importexport.model.UpdateJobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.importexport.model.UpdateJobResult {
