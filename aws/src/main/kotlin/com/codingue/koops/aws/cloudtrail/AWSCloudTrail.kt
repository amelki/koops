...
package com.codingue.koops.aws.cloudtrail
...
fun AWSCloudTrailFunctions.addTags(resourceId: String, init: (AWSCloudTrailAddTagsCommand.() -> Unit)? = null): com.amazonaws.services.cloudtrail.model.AddTagsResult {
	return this.block.declare(AWSCloudTrailAddTagsCommand(resourceId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudtrail.model.AddTagsResult
}
...
class AWSCloudTrailAddTagsCommand(val resourceId: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudtrail.model.AddTagsRequest, com.amazonaws.services.cloudtrail.model.AddTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudtrail.model.AddTagsResult {
...
fun AWSCloudTrailFunctions.createTrail(name: String, s3BucketName: String, init: (AWSCloudTrailCreateTrailCommand.() -> Unit)? = null): com.amazonaws.services.cloudtrail.model.CreateTrailResult {
	return this.block.declare(AWSCloudTrailCreateTrailCommand(name, s3BucketName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudtrail.model.CreateTrailResult
}
...
class AWSCloudTrailCreateTrailCommand(val name: String, val s3BucketName: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudtrail.model.CreateTrailRequest, com.amazonaws.services.cloudtrail.model.CreateTrailResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudtrail.model.CreateTrailResult {
...
fun AWSCloudTrailFunctions.deleteTrail(name: String, init: (AWSCloudTrailDeleteTrailCommand.() -> Unit)? = null): com.amazonaws.services.cloudtrail.model.DeleteTrailResult {
	return this.block.declare(AWSCloudTrailDeleteTrailCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudtrail.model.DeleteTrailResult
}
...
class AWSCloudTrailDeleteTrailCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudtrail.model.DeleteTrailRequest, com.amazonaws.services.cloudtrail.model.DeleteTrailResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudtrail.model.DeleteTrailResult {
...
fun AWSCloudTrailFunctions.describeTrails(init: (AWSCloudTrailDescribeTrailsCommand.() -> Unit)? = null): com.amazonaws.services.cloudtrail.model.DescribeTrailsResult {
	return this.block.declare(AWSCloudTrailDescribeTrailsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudtrail.model.DescribeTrailsResult
}
...
class AWSCloudTrailDescribeTrailsCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudtrail.model.DescribeTrailsRequest, com.amazonaws.services.cloudtrail.model.DescribeTrailsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudtrail.model.DescribeTrailsResult {
...
fun AWSCloudTrailFunctions.getEventSelectors(trailName: String, init: (AWSCloudTrailGetEventSelectorsCommand.() -> Unit)? = null): com.amazonaws.services.cloudtrail.model.GetEventSelectorsResult {
	return this.block.declare(AWSCloudTrailGetEventSelectorsCommand(trailName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudtrail.model.GetEventSelectorsResult
}
...
class AWSCloudTrailGetEventSelectorsCommand(val trailName: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudtrail.model.GetEventSelectorsRequest, com.amazonaws.services.cloudtrail.model.GetEventSelectorsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudtrail.model.GetEventSelectorsResult {
...
fun AWSCloudTrailFunctions.getTrailStatus(name: String, init: (AWSCloudTrailGetTrailStatusCommand.() -> Unit)? = null): com.amazonaws.services.cloudtrail.model.GetTrailStatusResult {
	return this.block.declare(AWSCloudTrailGetTrailStatusCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudtrail.model.GetTrailStatusResult
}
...
class AWSCloudTrailGetTrailStatusCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudtrail.model.GetTrailStatusRequest, com.amazonaws.services.cloudtrail.model.GetTrailStatusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudtrail.model.GetTrailStatusResult {
...
fun AWSCloudTrailFunctions.listPublicKeys(init: (AWSCloudTrailListPublicKeysCommand.() -> Unit)? = null): com.amazonaws.services.cloudtrail.model.ListPublicKeysResult {
	return this.block.declare(AWSCloudTrailListPublicKeysCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudtrail.model.ListPublicKeysResult
}
...
class AWSCloudTrailListPublicKeysCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudtrail.model.ListPublicKeysRequest, com.amazonaws.services.cloudtrail.model.ListPublicKeysResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudtrail.model.ListPublicKeysResult {
...
fun AWSCloudTrailFunctions.listTags(resourceIdList: List<String>, init: (AWSCloudTrailListTagsCommand.() -> Unit)? = null): com.amazonaws.services.cloudtrail.model.ListTagsResult {
	return this.block.declare(AWSCloudTrailListTagsCommand(resourceIdList).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudtrail.model.ListTagsResult
}
...
class AWSCloudTrailListTagsCommand(val resourceIdList: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.cloudtrail.model.ListTagsRequest, com.amazonaws.services.cloudtrail.model.ListTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudtrail.model.ListTagsResult {
...
fun AWSCloudTrailFunctions.lookupEvents(init: (AWSCloudTrailLookupEventsCommand.() -> Unit)? = null): com.amazonaws.services.cloudtrail.model.LookupEventsResult {
	return this.block.declare(AWSCloudTrailLookupEventsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudtrail.model.LookupEventsResult
}
...
class AWSCloudTrailLookupEventsCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudtrail.model.LookupEventsRequest, com.amazonaws.services.cloudtrail.model.LookupEventsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudtrail.model.LookupEventsResult {
...
fun AWSCloudTrailFunctions.putEventSelectors(trailName: String, eventSelectors: List<com.amazonaws.services.cloudtrail.model.EventSelector>, init: (AWSCloudTrailPutEventSelectorsCommand.() -> Unit)? = null): com.amazonaws.services.cloudtrail.model.PutEventSelectorsResult {
	return this.block.declare(AWSCloudTrailPutEventSelectorsCommand(trailName, eventSelectors).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudtrail.model.PutEventSelectorsResult
}
...
class AWSCloudTrailPutEventSelectorsCommand(val trailName: String, val eventSelectors: List<com.amazonaws.services.cloudtrail.model.EventSelector>) : AmazonWebServiceCommand<com.amazonaws.services.cloudtrail.model.PutEventSelectorsRequest, com.amazonaws.services.cloudtrail.model.PutEventSelectorsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudtrail.model.PutEventSelectorsResult {
...
fun AWSCloudTrailFunctions.removeTags(resourceId: String, init: (AWSCloudTrailRemoveTagsCommand.() -> Unit)? = null): com.amazonaws.services.cloudtrail.model.RemoveTagsResult {
	return this.block.declare(AWSCloudTrailRemoveTagsCommand(resourceId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudtrail.model.RemoveTagsResult
}
...
class AWSCloudTrailRemoveTagsCommand(val resourceId: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudtrail.model.RemoveTagsRequest, com.amazonaws.services.cloudtrail.model.RemoveTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudtrail.model.RemoveTagsResult {
...
fun AWSCloudTrailFunctions.startLogging(name: String, init: (AWSCloudTrailStartLoggingCommand.() -> Unit)? = null): com.amazonaws.services.cloudtrail.model.StartLoggingResult {
	return this.block.declare(AWSCloudTrailStartLoggingCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudtrail.model.StartLoggingResult
}
...
class AWSCloudTrailStartLoggingCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudtrail.model.StartLoggingRequest, com.amazonaws.services.cloudtrail.model.StartLoggingResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudtrail.model.StartLoggingResult {
...
fun AWSCloudTrailFunctions.stopLogging(name: String, init: (AWSCloudTrailStopLoggingCommand.() -> Unit)? = null): com.amazonaws.services.cloudtrail.model.StopLoggingResult {
	return this.block.declare(AWSCloudTrailStopLoggingCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudtrail.model.StopLoggingResult
}
...
class AWSCloudTrailStopLoggingCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudtrail.model.StopLoggingRequest, com.amazonaws.services.cloudtrail.model.StopLoggingResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudtrail.model.StopLoggingResult {
...
fun AWSCloudTrailFunctions.updateTrail(name: String, init: (AWSCloudTrailUpdateTrailCommand.() -> Unit)? = null): com.amazonaws.services.cloudtrail.model.UpdateTrailResult {
	return this.block.declare(AWSCloudTrailUpdateTrailCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudtrail.model.UpdateTrailResult
}
...
class AWSCloudTrailUpdateTrailCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudtrail.model.UpdateTrailRequest, com.amazonaws.services.cloudtrail.model.UpdateTrailResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudtrail.model.UpdateTrailResult {
