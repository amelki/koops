...
package com.codingue.koops.aws.polly
...
var com.codingue.koops.core.Environment.polly: AmazonPolly
	get() {
...
fun AmazonPollyFunctions.deleteLexicon(name: String, init: (AmazonPollyDeleteLexiconCommand.() -> Unit)? = null): com.amazonaws.services.polly.model.DeleteLexiconResult {
	return this.block.declare(AmazonPollyDeleteLexiconCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.polly.model.DeleteLexiconResult
}
...
class AmazonPollyDeleteLexiconCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.polly.model.DeleteLexiconRequest, com.amazonaws.services.polly.model.DeleteLexiconResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.polly.model.DeleteLexiconResult {
...
fun AmazonPollyFunctions.describeVoices(init: (AmazonPollyDescribeVoicesCommand.() -> Unit)? = null): com.amazonaws.services.polly.model.DescribeVoicesResult {
	return this.block.declare(AmazonPollyDescribeVoicesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.polly.model.DescribeVoicesResult
}
...
class AmazonPollyDescribeVoicesCommand() : AmazonWebServiceCommand<com.amazonaws.services.polly.model.DescribeVoicesRequest, com.amazonaws.services.polly.model.DescribeVoicesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.polly.model.DescribeVoicesResult {
...
fun AmazonPollyFunctions.getLexicon(name: String, init: (AmazonPollyGetLexiconCommand.() -> Unit)? = null): com.amazonaws.services.polly.model.GetLexiconResult {
	return this.block.declare(AmazonPollyGetLexiconCommand(name).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.polly.model.GetLexiconResult
}
...
class AmazonPollyGetLexiconCommand(val name: String) : AmazonWebServiceCommand<com.amazonaws.services.polly.model.GetLexiconRequest, com.amazonaws.services.polly.model.GetLexiconResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.polly.model.GetLexiconResult {
...
fun AmazonPollyFunctions.listLexicons(init: (AmazonPollyListLexiconsCommand.() -> Unit)? = null): com.amazonaws.services.polly.model.ListLexiconsResult {
	return this.block.declare(AmazonPollyListLexiconsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.polly.model.ListLexiconsResult
}
...
class AmazonPollyListLexiconsCommand() : AmazonWebServiceCommand<com.amazonaws.services.polly.model.ListLexiconsRequest, com.amazonaws.services.polly.model.ListLexiconsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.polly.model.ListLexiconsResult {
...
fun AmazonPollyFunctions.putLexicon(name: String, content: String, init: (AmazonPollyPutLexiconCommand.() -> Unit)? = null): com.amazonaws.services.polly.model.PutLexiconResult {
	return this.block.declare(AmazonPollyPutLexiconCommand(name, content).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.polly.model.PutLexiconResult
}
...
class AmazonPollyPutLexiconCommand(val name: String, val content: String) : AmazonWebServiceCommand<com.amazonaws.services.polly.model.PutLexiconRequest, com.amazonaws.services.polly.model.PutLexiconResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.polly.model.PutLexiconResult {
...
fun AmazonPollyFunctions.synthesizeSpeech(outputFormat: OutputFormat, text: String, voiceId: VoiceId, init: (AmazonPollySynthesizeSpeechCommand.() -> Unit)? = null): com.amazonaws.services.polly.model.SynthesizeSpeechResult {
	return this.block.declare(AmazonPollySynthesizeSpeechCommand(outputFormat, text, voiceId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.polly.model.SynthesizeSpeechResult
}
...
class AmazonPollySynthesizeSpeechCommand(val outputFormat: OutputFormat, val text: String, val voiceId: VoiceId) : AmazonWebServiceCommand<com.amazonaws.services.polly.model.SynthesizeSpeechRequest, com.amazonaws.services.polly.model.SynthesizeSpeechResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.polly.model.SynthesizeSpeechResult {
