...
package com.codingue.koops.aws.firehose
...
var com.codingue.koops.core.Environment.firehose: AmazonKinesisFirehose
	get() {
		var service = this.capabilities["aws-firehose"]
		if (service == null) {
			service = AmazonKinesisFirehoseClientBuilder.standard().build()
			this.capabilities["aws-firehose"] = service
		}
		return service as AmazonKinesisFirehose
	}
	set(firehose) {
		this.capabilities["aws-firehose"] = firehose
	}
...
fun AmazonKinesisFirehoseFunctions.createDeliveryStream(deliveryStreamName: String, init: (AmazonKinesisFirehoseCreateDeliveryStreamCommand.() -> Unit)? = null): com.amazonaws.services.kinesisfirehose.model.CreateDeliveryStreamResult {
	return this.block.declare(AmazonKinesisFirehoseCreateDeliveryStreamCommand(deliveryStreamName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesisfirehose.model.CreateDeliveryStreamResult
}
...
class AmazonKinesisFirehoseCreateDeliveryStreamCommand(val deliveryStreamName: String) : AmazonWebServiceCommand<com.amazonaws.services.kinesisfirehose.model.CreateDeliveryStreamRequest, com.amazonaws.services.kinesisfirehose.model.CreateDeliveryStreamResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesisfirehose.model.CreateDeliveryStreamResult {
...
fun AmazonKinesisFirehoseFunctions.deleteDeliveryStream(deliveryStreamName: String, init: (AmazonKinesisFirehoseDeleteDeliveryStreamCommand.() -> Unit)? = null): com.amazonaws.services.kinesisfirehose.model.DeleteDeliveryStreamResult {
	return this.block.declare(AmazonKinesisFirehoseDeleteDeliveryStreamCommand(deliveryStreamName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesisfirehose.model.DeleteDeliveryStreamResult
}
...
class AmazonKinesisFirehoseDeleteDeliveryStreamCommand(val deliveryStreamName: String) : AmazonWebServiceCommand<com.amazonaws.services.kinesisfirehose.model.DeleteDeliveryStreamRequest, com.amazonaws.services.kinesisfirehose.model.DeleteDeliveryStreamResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesisfirehose.model.DeleteDeliveryStreamResult {
...
fun AmazonKinesisFirehoseFunctions.describeDeliveryStream(deliveryStreamName: String, init: (AmazonKinesisFirehoseDescribeDeliveryStreamCommand.() -> Unit)? = null): com.amazonaws.services.kinesisfirehose.model.DescribeDeliveryStreamResult {
	return this.block.declare(AmazonKinesisFirehoseDescribeDeliveryStreamCommand(deliveryStreamName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesisfirehose.model.DescribeDeliveryStreamResult
}
...
class AmazonKinesisFirehoseDescribeDeliveryStreamCommand(val deliveryStreamName: String) : AmazonWebServiceCommand<com.amazonaws.services.kinesisfirehose.model.DescribeDeliveryStreamRequest, com.amazonaws.services.kinesisfirehose.model.DescribeDeliveryStreamResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesisfirehose.model.DescribeDeliveryStreamResult {
...
fun AmazonKinesisFirehoseFunctions.listDeliveryStreams(init: (AmazonKinesisFirehoseListDeliveryStreamsCommand.() -> Unit)? = null): com.amazonaws.services.kinesisfirehose.model.ListDeliveryStreamsResult {
	return this.block.declare(AmazonKinesisFirehoseListDeliveryStreamsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesisfirehose.model.ListDeliveryStreamsResult
}
...
class AmazonKinesisFirehoseListDeliveryStreamsCommand() : AmazonWebServiceCommand<com.amazonaws.services.kinesisfirehose.model.ListDeliveryStreamsRequest, com.amazonaws.services.kinesisfirehose.model.ListDeliveryStreamsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesisfirehose.model.ListDeliveryStreamsResult {
...
fun AmazonKinesisFirehoseFunctions.putRecord(deliveryStreamName: String, record: com.amazonaws.services.kinesisfirehose.model.Record, init: (AmazonKinesisFirehosePutRecordCommand.() -> Unit)? = null): com.amazonaws.services.kinesisfirehose.model.PutRecordResult {
	return this.block.declare(AmazonKinesisFirehosePutRecordCommand(deliveryStreamName, record).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesisfirehose.model.PutRecordResult
}
...
class AmazonKinesisFirehosePutRecordCommand(val deliveryStreamName: String, val record: com.amazonaws.services.kinesisfirehose.model.Record) : AmazonWebServiceCommand<com.amazonaws.services.kinesisfirehose.model.PutRecordRequest, com.amazonaws.services.kinesisfirehose.model.PutRecordResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesisfirehose.model.PutRecordResult {
...
fun AmazonKinesisFirehoseFunctions.putRecordBatch(deliveryStreamName: String, records: List<com.amazonaws.services.kinesisfirehose.model.Record>, init: (AmazonKinesisFirehosePutRecordBatchCommand.() -> Unit)? = null): com.amazonaws.services.kinesisfirehose.model.PutRecordBatchResult {
	return this.block.declare(AmazonKinesisFirehosePutRecordBatchCommand(deliveryStreamName, records).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesisfirehose.model.PutRecordBatchResult
}
...
class AmazonKinesisFirehosePutRecordBatchCommand(val deliveryStreamName: String, val records: List<com.amazonaws.services.kinesisfirehose.model.Record>) : AmazonWebServiceCommand<com.amazonaws.services.kinesisfirehose.model.PutRecordBatchRequest, com.amazonaws.services.kinesisfirehose.model.PutRecordBatchResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesisfirehose.model.PutRecordBatchResult {
...
fun AmazonKinesisFirehoseFunctions.updateDestination(deliveryStreamName: String, currentDeliveryStreamVersionId: String, destinationId: String, init: (AmazonKinesisFirehoseUpdateDestinationCommand.() -> Unit)? = null): com.amazonaws.services.kinesisfirehose.model.UpdateDestinationResult {
	return this.block.declare(AmazonKinesisFirehoseUpdateDestinationCommand(deliveryStreamName, currentDeliveryStreamVersionId, destinationId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.kinesisfirehose.model.UpdateDestinationResult
}
...
class AmazonKinesisFirehoseUpdateDestinationCommand(val deliveryStreamName: String, val currentDeliveryStreamVersionId: String, val destinationId: String) : AmazonWebServiceCommand<com.amazonaws.services.kinesisfirehose.model.UpdateDestinationRequest, com.amazonaws.services.kinesisfirehose.model.UpdateDestinationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.kinesisfirehose.model.UpdateDestinationResult {
