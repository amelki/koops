...
package com.codingue.koops.aws.mediastore
...
fun AWSMediaStoreFunctions.createContainer(containerName: String, init: (AWSMediaStoreCreateContainerCommand.() -> Unit)? = null): com.amazonaws.services.mediastore.model.CreateContainerResult {
	return this.block.declare(AWSMediaStoreCreateContainerCommand(containerName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediastore.model.CreateContainerResult
}
...
class AWSMediaStoreCreateContainerCommand(val containerName: String) : AmazonWebServiceCommand<com.amazonaws.services.mediastore.model.CreateContainerRequest, com.amazonaws.services.mediastore.model.CreateContainerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediastore.model.CreateContainerResult {
...
fun AWSMediaStoreFunctions.deleteContainer(containerName: String, init: (AWSMediaStoreDeleteContainerCommand.() -> Unit)? = null): com.amazonaws.services.mediastore.model.DeleteContainerResult {
	return this.block.declare(AWSMediaStoreDeleteContainerCommand(containerName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediastore.model.DeleteContainerResult
}
...
class AWSMediaStoreDeleteContainerCommand(val containerName: String) : AmazonWebServiceCommand<com.amazonaws.services.mediastore.model.DeleteContainerRequest, com.amazonaws.services.mediastore.model.DeleteContainerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediastore.model.DeleteContainerResult {
...
fun AWSMediaStoreFunctions.deleteContainerPolicy(containerName: String, init: (AWSMediaStoreDeleteContainerPolicyCommand.() -> Unit)? = null): com.amazonaws.services.mediastore.model.DeleteContainerPolicyResult {
	return this.block.declare(AWSMediaStoreDeleteContainerPolicyCommand(containerName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediastore.model.DeleteContainerPolicyResult
}
...
class AWSMediaStoreDeleteContainerPolicyCommand(val containerName: String) : AmazonWebServiceCommand<com.amazonaws.services.mediastore.model.DeleteContainerPolicyRequest, com.amazonaws.services.mediastore.model.DeleteContainerPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediastore.model.DeleteContainerPolicyResult {
...
fun AWSMediaStoreFunctions.deleteCorsPolicy(containerName: String, init: (AWSMediaStoreDeleteCorsPolicyCommand.() -> Unit)? = null): com.amazonaws.services.mediastore.model.DeleteCorsPolicyResult {
	return this.block.declare(AWSMediaStoreDeleteCorsPolicyCommand(containerName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediastore.model.DeleteCorsPolicyResult
}
...
class AWSMediaStoreDeleteCorsPolicyCommand(val containerName: String) : AmazonWebServiceCommand<com.amazonaws.services.mediastore.model.DeleteCorsPolicyRequest, com.amazonaws.services.mediastore.model.DeleteCorsPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediastore.model.DeleteCorsPolicyResult {
...
fun AWSMediaStoreFunctions.describeContainer(init: (AWSMediaStoreDescribeContainerCommand.() -> Unit)? = null): com.amazonaws.services.mediastore.model.DescribeContainerResult {
	return this.block.declare(AWSMediaStoreDescribeContainerCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediastore.model.DescribeContainerResult
}
...
class AWSMediaStoreDescribeContainerCommand() : AmazonWebServiceCommand<com.amazonaws.services.mediastore.model.DescribeContainerRequest, com.amazonaws.services.mediastore.model.DescribeContainerResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediastore.model.DescribeContainerResult {
...
fun AWSMediaStoreFunctions.getContainerPolicy(containerName: String, init: (AWSMediaStoreGetContainerPolicyCommand.() -> Unit)? = null): com.amazonaws.services.mediastore.model.GetContainerPolicyResult {
	return this.block.declare(AWSMediaStoreGetContainerPolicyCommand(containerName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediastore.model.GetContainerPolicyResult
}
...
class AWSMediaStoreGetContainerPolicyCommand(val containerName: String) : AmazonWebServiceCommand<com.amazonaws.services.mediastore.model.GetContainerPolicyRequest, com.amazonaws.services.mediastore.model.GetContainerPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediastore.model.GetContainerPolicyResult {
...
fun AWSMediaStoreFunctions.getCorsPolicy(containerName: String, init: (AWSMediaStoreGetCorsPolicyCommand.() -> Unit)? = null): com.amazonaws.services.mediastore.model.GetCorsPolicyResult {
	return this.block.declare(AWSMediaStoreGetCorsPolicyCommand(containerName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediastore.model.GetCorsPolicyResult
}
...
class AWSMediaStoreGetCorsPolicyCommand(val containerName: String) : AmazonWebServiceCommand<com.amazonaws.services.mediastore.model.GetCorsPolicyRequest, com.amazonaws.services.mediastore.model.GetCorsPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediastore.model.GetCorsPolicyResult {
...
fun AWSMediaStoreFunctions.listContainers(init: (AWSMediaStoreListContainersCommand.() -> Unit)? = null): com.amazonaws.services.mediastore.model.ListContainersResult {
	return this.block.declare(AWSMediaStoreListContainersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediastore.model.ListContainersResult
}
...
class AWSMediaStoreListContainersCommand() : AmazonWebServiceCommand<com.amazonaws.services.mediastore.model.ListContainersRequest, com.amazonaws.services.mediastore.model.ListContainersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediastore.model.ListContainersResult {
...
fun AWSMediaStoreFunctions.putContainerPolicy(containerName: String, policy: String, init: (AWSMediaStorePutContainerPolicyCommand.() -> Unit)? = null): com.amazonaws.services.mediastore.model.PutContainerPolicyResult {
	return this.block.declare(AWSMediaStorePutContainerPolicyCommand(containerName, policy).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediastore.model.PutContainerPolicyResult
}
...
class AWSMediaStorePutContainerPolicyCommand(val containerName: String, val policy: String) : AmazonWebServiceCommand<com.amazonaws.services.mediastore.model.PutContainerPolicyRequest, com.amazonaws.services.mediastore.model.PutContainerPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediastore.model.PutContainerPolicyResult {
...
fun AWSMediaStoreFunctions.putCorsPolicy(containerName: String, corsPolicy: List<com.amazonaws.services.mediastore.model.CorsRule>, init: (AWSMediaStorePutCorsPolicyCommand.() -> Unit)? = null): com.amazonaws.services.mediastore.model.PutCorsPolicyResult {
	return this.block.declare(AWSMediaStorePutCorsPolicyCommand(containerName, corsPolicy).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.mediastore.model.PutCorsPolicyResult
}
...
class AWSMediaStorePutCorsPolicyCommand(val containerName: String, val corsPolicy: List<com.amazonaws.services.mediastore.model.CorsRule>) : AmazonWebServiceCommand<com.amazonaws.services.mediastore.model.PutCorsPolicyRequest, com.amazonaws.services.mediastore.model.PutCorsPolicyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.mediastore.model.PutCorsPolicyResult {
