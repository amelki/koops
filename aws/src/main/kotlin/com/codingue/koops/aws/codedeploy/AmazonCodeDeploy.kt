...
package com.codingue.koops.aws.codedeploy
...
var com.codingue.koops.core.Environment.codedeploy: AmazonCodeDeploy
	get() {
		var service = this.capabilities["aws-codedeploy"]
		if (service == null) {
			service = AmazonCodeDeployClientBuilder.standard().build()
			this.capabilities["aws-codedeploy"] = service
		}
		return service as AmazonCodeDeploy
	}
	set(codedeploy) {
		this.capabilities["aws-codedeploy"] = codedeploy
	}
...
fun AmazonCodeDeployFunctions.addTagsToOnPremisesInstances(init: (AmazonCodeDeployAddTagsToOnPremisesInstancesCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.AddTagsToOnPremisesInstancesResult {
	return this.block.declare(AmazonCodeDeployAddTagsToOnPremisesInstancesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.AddTagsToOnPremisesInstancesResult
}
...
class AmazonCodeDeployAddTagsToOnPremisesInstancesCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.AddTagsToOnPremisesInstancesRequest, com.amazonaws.services.codedeploy.model.AddTagsToOnPremisesInstancesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.AddTagsToOnPremisesInstancesResult {
...
fun AmazonCodeDeployFunctions.batchGetApplicationRevisions(init: (AmazonCodeDeployBatchGetApplicationRevisionsCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.BatchGetApplicationRevisionsResult {
	return this.block.declare(AmazonCodeDeployBatchGetApplicationRevisionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.BatchGetApplicationRevisionsResult
}
...
class AmazonCodeDeployBatchGetApplicationRevisionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.BatchGetApplicationRevisionsRequest, com.amazonaws.services.codedeploy.model.BatchGetApplicationRevisionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.BatchGetApplicationRevisionsResult {
...
fun AmazonCodeDeployFunctions.batchGetApplications(init: (AmazonCodeDeployBatchGetApplicationsCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.BatchGetApplicationsResult {
	return this.block.declare(AmazonCodeDeployBatchGetApplicationsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.BatchGetApplicationsResult
}
...
class AmazonCodeDeployBatchGetApplicationsCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.BatchGetApplicationsRequest, com.amazonaws.services.codedeploy.model.BatchGetApplicationsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.BatchGetApplicationsResult {
...
fun AmazonCodeDeployFunctions.batchGetDeploymentGroups(init: (AmazonCodeDeployBatchGetDeploymentGroupsCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.BatchGetDeploymentGroupsResult {
	return this.block.declare(AmazonCodeDeployBatchGetDeploymentGroupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.BatchGetDeploymentGroupsResult
}
...
class AmazonCodeDeployBatchGetDeploymentGroupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.BatchGetDeploymentGroupsRequest, com.amazonaws.services.codedeploy.model.BatchGetDeploymentGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.BatchGetDeploymentGroupsResult {
...
fun AmazonCodeDeployFunctions.batchGetDeploymentInstances(init: (AmazonCodeDeployBatchGetDeploymentInstancesCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.BatchGetDeploymentInstancesResult {
	return this.block.declare(AmazonCodeDeployBatchGetDeploymentInstancesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.BatchGetDeploymentInstancesResult
}
...
class AmazonCodeDeployBatchGetDeploymentInstancesCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.BatchGetDeploymentInstancesRequest, com.amazonaws.services.codedeploy.model.BatchGetDeploymentInstancesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.BatchGetDeploymentInstancesResult {
...
fun AmazonCodeDeployFunctions.batchGetDeployments(init: (AmazonCodeDeployBatchGetDeploymentsCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.BatchGetDeploymentsResult {
	return this.block.declare(AmazonCodeDeployBatchGetDeploymentsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.BatchGetDeploymentsResult
}
...
class AmazonCodeDeployBatchGetDeploymentsCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.BatchGetDeploymentsRequest, com.amazonaws.services.codedeploy.model.BatchGetDeploymentsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.BatchGetDeploymentsResult {
...
fun AmazonCodeDeployFunctions.batchGetOnPremisesInstances(init: (AmazonCodeDeployBatchGetOnPremisesInstancesCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.BatchGetOnPremisesInstancesResult {
	return this.block.declare(AmazonCodeDeployBatchGetOnPremisesInstancesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.BatchGetOnPremisesInstancesResult
}
...
class AmazonCodeDeployBatchGetOnPremisesInstancesCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.BatchGetOnPremisesInstancesRequest, com.amazonaws.services.codedeploy.model.BatchGetOnPremisesInstancesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.BatchGetOnPremisesInstancesResult {
...
fun AmazonCodeDeployFunctions.continueDeployment(init: (AmazonCodeDeployContinueDeploymentCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.ContinueDeploymentResult {
	return this.block.declare(AmazonCodeDeployContinueDeploymentCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.ContinueDeploymentResult
}
...
class AmazonCodeDeployContinueDeploymentCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.ContinueDeploymentRequest, com.amazonaws.services.codedeploy.model.ContinueDeploymentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.ContinueDeploymentResult {
...
fun AmazonCodeDeployFunctions.createApplication(init: (AmazonCodeDeployCreateApplicationCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.CreateApplicationResult {
	return this.block.declare(AmazonCodeDeployCreateApplicationCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.CreateApplicationResult
}
...
class AmazonCodeDeployCreateApplicationCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.CreateApplicationRequest, com.amazonaws.services.codedeploy.model.CreateApplicationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.CreateApplicationResult {
...
fun AmazonCodeDeployFunctions.createDeployment(init: (AmazonCodeDeployCreateDeploymentCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.CreateDeploymentResult {
	return this.block.declare(AmazonCodeDeployCreateDeploymentCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.CreateDeploymentResult
}
...
class AmazonCodeDeployCreateDeploymentCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.CreateDeploymentRequest, com.amazonaws.services.codedeploy.model.CreateDeploymentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.CreateDeploymentResult {
...
fun AmazonCodeDeployFunctions.createDeploymentConfig(init: (AmazonCodeDeployCreateDeploymentConfigCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.CreateDeploymentConfigResult {
	return this.block.declare(AmazonCodeDeployCreateDeploymentConfigCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.CreateDeploymentConfigResult
}
...
class AmazonCodeDeployCreateDeploymentConfigCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.CreateDeploymentConfigRequest, com.amazonaws.services.codedeploy.model.CreateDeploymentConfigResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.CreateDeploymentConfigResult {
...
fun AmazonCodeDeployFunctions.createDeploymentGroup(init: (AmazonCodeDeployCreateDeploymentGroupCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.CreateDeploymentGroupResult {
	return this.block.declare(AmazonCodeDeployCreateDeploymentGroupCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.CreateDeploymentGroupResult
}
...
class AmazonCodeDeployCreateDeploymentGroupCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.CreateDeploymentGroupRequest, com.amazonaws.services.codedeploy.model.CreateDeploymentGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.CreateDeploymentGroupResult {
...
fun AmazonCodeDeployFunctions.deleteApplication(init: (AmazonCodeDeployDeleteApplicationCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.DeleteApplicationResult {
	return this.block.declare(AmazonCodeDeployDeleteApplicationCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.DeleteApplicationResult
}
...
class AmazonCodeDeployDeleteApplicationCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.DeleteApplicationRequest, com.amazonaws.services.codedeploy.model.DeleteApplicationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.DeleteApplicationResult {
...
fun AmazonCodeDeployFunctions.deleteDeploymentConfig(init: (AmazonCodeDeployDeleteDeploymentConfigCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.DeleteDeploymentConfigResult {
	return this.block.declare(AmazonCodeDeployDeleteDeploymentConfigCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.DeleteDeploymentConfigResult
}
...
class AmazonCodeDeployDeleteDeploymentConfigCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.DeleteDeploymentConfigRequest, com.amazonaws.services.codedeploy.model.DeleteDeploymentConfigResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.DeleteDeploymentConfigResult {
...
fun AmazonCodeDeployFunctions.deleteDeploymentGroup(init: (AmazonCodeDeployDeleteDeploymentGroupCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.DeleteDeploymentGroupResult {
	return this.block.declare(AmazonCodeDeployDeleteDeploymentGroupCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.DeleteDeploymentGroupResult
}
...
class AmazonCodeDeployDeleteDeploymentGroupCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.DeleteDeploymentGroupRequest, com.amazonaws.services.codedeploy.model.DeleteDeploymentGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.DeleteDeploymentGroupResult {
...
fun AmazonCodeDeployFunctions.deleteGitHubAccountToken(init: (AmazonCodeDeployDeleteGitHubAccountTokenCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.DeleteGitHubAccountTokenResult {
	return this.block.declare(AmazonCodeDeployDeleteGitHubAccountTokenCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.DeleteGitHubAccountTokenResult
}
...
class AmazonCodeDeployDeleteGitHubAccountTokenCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.DeleteGitHubAccountTokenRequest, com.amazonaws.services.codedeploy.model.DeleteGitHubAccountTokenResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.DeleteGitHubAccountTokenResult {
...
fun AmazonCodeDeployFunctions.deregisterOnPremisesInstance(init: (AmazonCodeDeployDeregisterOnPremisesInstanceCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.DeregisterOnPremisesInstanceResult {
	return this.block.declare(AmazonCodeDeployDeregisterOnPremisesInstanceCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.DeregisterOnPremisesInstanceResult
}
...
class AmazonCodeDeployDeregisterOnPremisesInstanceCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.DeregisterOnPremisesInstanceRequest, com.amazonaws.services.codedeploy.model.DeregisterOnPremisesInstanceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.DeregisterOnPremisesInstanceResult {
...
fun AmazonCodeDeployFunctions.getApplication(init: (AmazonCodeDeployGetApplicationCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.GetApplicationResult {
	return this.block.declare(AmazonCodeDeployGetApplicationCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.GetApplicationResult
}
...
class AmazonCodeDeployGetApplicationCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.GetApplicationRequest, com.amazonaws.services.codedeploy.model.GetApplicationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.GetApplicationResult {
...
fun AmazonCodeDeployFunctions.getApplicationRevision(init: (AmazonCodeDeployGetApplicationRevisionCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.GetApplicationRevisionResult {
	return this.block.declare(AmazonCodeDeployGetApplicationRevisionCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.GetApplicationRevisionResult
}
...
class AmazonCodeDeployGetApplicationRevisionCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.GetApplicationRevisionRequest, com.amazonaws.services.codedeploy.model.GetApplicationRevisionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.GetApplicationRevisionResult {
...
fun AmazonCodeDeployFunctions.getDeployment(init: (AmazonCodeDeployGetDeploymentCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.GetDeploymentResult {
	return this.block.declare(AmazonCodeDeployGetDeploymentCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.GetDeploymentResult
}
...
class AmazonCodeDeployGetDeploymentCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.GetDeploymentRequest, com.amazonaws.services.codedeploy.model.GetDeploymentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.GetDeploymentResult {
...
fun AmazonCodeDeployFunctions.getDeploymentConfig(init: (AmazonCodeDeployGetDeploymentConfigCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.GetDeploymentConfigResult {
	return this.block.declare(AmazonCodeDeployGetDeploymentConfigCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.GetDeploymentConfigResult
}
...
class AmazonCodeDeployGetDeploymentConfigCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.GetDeploymentConfigRequest, com.amazonaws.services.codedeploy.model.GetDeploymentConfigResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.GetDeploymentConfigResult {
...
fun AmazonCodeDeployFunctions.getDeploymentGroup(init: (AmazonCodeDeployGetDeploymentGroupCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.GetDeploymentGroupResult {
	return this.block.declare(AmazonCodeDeployGetDeploymentGroupCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.GetDeploymentGroupResult
}
...
class AmazonCodeDeployGetDeploymentGroupCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.GetDeploymentGroupRequest, com.amazonaws.services.codedeploy.model.GetDeploymentGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.GetDeploymentGroupResult {
...
fun AmazonCodeDeployFunctions.getDeploymentInstance(init: (AmazonCodeDeployGetDeploymentInstanceCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.GetDeploymentInstanceResult {
	return this.block.declare(AmazonCodeDeployGetDeploymentInstanceCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.GetDeploymentInstanceResult
}
...
class AmazonCodeDeployGetDeploymentInstanceCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.GetDeploymentInstanceRequest, com.amazonaws.services.codedeploy.model.GetDeploymentInstanceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.GetDeploymentInstanceResult {
...
fun AmazonCodeDeployFunctions.getOnPremisesInstance(init: (AmazonCodeDeployGetOnPremisesInstanceCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.GetOnPremisesInstanceResult {
	return this.block.declare(AmazonCodeDeployGetOnPremisesInstanceCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.GetOnPremisesInstanceResult
}
...
class AmazonCodeDeployGetOnPremisesInstanceCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.GetOnPremisesInstanceRequest, com.amazonaws.services.codedeploy.model.GetOnPremisesInstanceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.GetOnPremisesInstanceResult {
...
fun AmazonCodeDeployFunctions.listApplicationRevisions(init: (AmazonCodeDeployListApplicationRevisionsCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.ListApplicationRevisionsResult {
	return this.block.declare(AmazonCodeDeployListApplicationRevisionsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.ListApplicationRevisionsResult
}
...
class AmazonCodeDeployListApplicationRevisionsCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.ListApplicationRevisionsRequest, com.amazonaws.services.codedeploy.model.ListApplicationRevisionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.ListApplicationRevisionsResult {
...
fun AmazonCodeDeployFunctions.listApplications(init: (AmazonCodeDeployListApplicationsCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.ListApplicationsResult {
	return this.block.declare(AmazonCodeDeployListApplicationsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.ListApplicationsResult
}
...
class AmazonCodeDeployListApplicationsCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.ListApplicationsRequest, com.amazonaws.services.codedeploy.model.ListApplicationsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.ListApplicationsResult {
...
fun AmazonCodeDeployFunctions.listDeploymentConfigs(init: (AmazonCodeDeployListDeploymentConfigsCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.ListDeploymentConfigsResult {
	return this.block.declare(AmazonCodeDeployListDeploymentConfigsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.ListDeploymentConfigsResult
}
...
class AmazonCodeDeployListDeploymentConfigsCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.ListDeploymentConfigsRequest, com.amazonaws.services.codedeploy.model.ListDeploymentConfigsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.ListDeploymentConfigsResult {
...
fun AmazonCodeDeployFunctions.listDeploymentGroups(init: (AmazonCodeDeployListDeploymentGroupsCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.ListDeploymentGroupsResult {
	return this.block.declare(AmazonCodeDeployListDeploymentGroupsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.ListDeploymentGroupsResult
}
...
class AmazonCodeDeployListDeploymentGroupsCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.ListDeploymentGroupsRequest, com.amazonaws.services.codedeploy.model.ListDeploymentGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.ListDeploymentGroupsResult {
...
fun AmazonCodeDeployFunctions.listDeploymentInstances(init: (AmazonCodeDeployListDeploymentInstancesCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.ListDeploymentInstancesResult {
	return this.block.declare(AmazonCodeDeployListDeploymentInstancesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.ListDeploymentInstancesResult
}
...
class AmazonCodeDeployListDeploymentInstancesCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.ListDeploymentInstancesRequest, com.amazonaws.services.codedeploy.model.ListDeploymentInstancesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.ListDeploymentInstancesResult {
...
fun AmazonCodeDeployFunctions.listDeployments(init: (AmazonCodeDeployListDeploymentsCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.ListDeploymentsResult {
	return this.block.declare(AmazonCodeDeployListDeploymentsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.ListDeploymentsResult
}
...
class AmazonCodeDeployListDeploymentsCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.ListDeploymentsRequest, com.amazonaws.services.codedeploy.model.ListDeploymentsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.ListDeploymentsResult {
...
fun AmazonCodeDeployFunctions.listGitHubAccountTokenNames(init: (AmazonCodeDeployListGitHubAccountTokenNamesCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.ListGitHubAccountTokenNamesResult {
	return this.block.declare(AmazonCodeDeployListGitHubAccountTokenNamesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.ListGitHubAccountTokenNamesResult
}
...
class AmazonCodeDeployListGitHubAccountTokenNamesCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.ListGitHubAccountTokenNamesRequest, com.amazonaws.services.codedeploy.model.ListGitHubAccountTokenNamesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.ListGitHubAccountTokenNamesResult {
...
fun AmazonCodeDeployFunctions.listOnPremisesInstances(init: (AmazonCodeDeployListOnPremisesInstancesCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.ListOnPremisesInstancesResult {
	return this.block.declare(AmazonCodeDeployListOnPremisesInstancesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.ListOnPremisesInstancesResult
}
...
class AmazonCodeDeployListOnPremisesInstancesCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.ListOnPremisesInstancesRequest, com.amazonaws.services.codedeploy.model.ListOnPremisesInstancesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.ListOnPremisesInstancesResult {
...
fun AmazonCodeDeployFunctions.putLifecycleEventHookExecutionStatus(init: (AmazonCodeDeployPutLifecycleEventHookExecutionStatusCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.PutLifecycleEventHookExecutionStatusResult {
	return this.block.declare(AmazonCodeDeployPutLifecycleEventHookExecutionStatusCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.PutLifecycleEventHookExecutionStatusResult
}
...
class AmazonCodeDeployPutLifecycleEventHookExecutionStatusCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.PutLifecycleEventHookExecutionStatusRequest, com.amazonaws.services.codedeploy.model.PutLifecycleEventHookExecutionStatusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.PutLifecycleEventHookExecutionStatusResult {
...
fun AmazonCodeDeployFunctions.registerApplicationRevision(init: (AmazonCodeDeployRegisterApplicationRevisionCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.RegisterApplicationRevisionResult {
	return this.block.declare(AmazonCodeDeployRegisterApplicationRevisionCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.RegisterApplicationRevisionResult
}
...
class AmazonCodeDeployRegisterApplicationRevisionCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.RegisterApplicationRevisionRequest, com.amazonaws.services.codedeploy.model.RegisterApplicationRevisionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.RegisterApplicationRevisionResult {
...
fun AmazonCodeDeployFunctions.registerOnPremisesInstance(init: (AmazonCodeDeployRegisterOnPremisesInstanceCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.RegisterOnPremisesInstanceResult {
	return this.block.declare(AmazonCodeDeployRegisterOnPremisesInstanceCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.RegisterOnPremisesInstanceResult
}
...
class AmazonCodeDeployRegisterOnPremisesInstanceCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.RegisterOnPremisesInstanceRequest, com.amazonaws.services.codedeploy.model.RegisterOnPremisesInstanceResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.RegisterOnPremisesInstanceResult {
...
fun AmazonCodeDeployFunctions.removeTagsFromOnPremisesInstances(init: (AmazonCodeDeployRemoveTagsFromOnPremisesInstancesCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.RemoveTagsFromOnPremisesInstancesResult {
	return this.block.declare(AmazonCodeDeployRemoveTagsFromOnPremisesInstancesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.RemoveTagsFromOnPremisesInstancesResult
}
...
class AmazonCodeDeployRemoveTagsFromOnPremisesInstancesCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.RemoveTagsFromOnPremisesInstancesRequest, com.amazonaws.services.codedeploy.model.RemoveTagsFromOnPremisesInstancesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.RemoveTagsFromOnPremisesInstancesResult {
...
fun AmazonCodeDeployFunctions.skipWaitTimeForInstanceTermination(init: (AmazonCodeDeploySkipWaitTimeForInstanceTerminationCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.SkipWaitTimeForInstanceTerminationResult {
	return this.block.declare(AmazonCodeDeploySkipWaitTimeForInstanceTerminationCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.SkipWaitTimeForInstanceTerminationResult
}
...
class AmazonCodeDeploySkipWaitTimeForInstanceTerminationCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.SkipWaitTimeForInstanceTerminationRequest, com.amazonaws.services.codedeploy.model.SkipWaitTimeForInstanceTerminationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.SkipWaitTimeForInstanceTerminationResult {
...
fun AmazonCodeDeployFunctions.stopDeployment(init: (AmazonCodeDeployStopDeploymentCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.StopDeploymentResult {
	return this.block.declare(AmazonCodeDeployStopDeploymentCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.StopDeploymentResult
}
...
class AmazonCodeDeployStopDeploymentCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.StopDeploymentRequest, com.amazonaws.services.codedeploy.model.StopDeploymentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.StopDeploymentResult {
...
fun AmazonCodeDeployFunctions.updateApplication(init: (AmazonCodeDeployUpdateApplicationCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.UpdateApplicationResult {
	return this.block.declare(AmazonCodeDeployUpdateApplicationCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.UpdateApplicationResult
}
...
class AmazonCodeDeployUpdateApplicationCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.UpdateApplicationRequest, com.amazonaws.services.codedeploy.model.UpdateApplicationResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.UpdateApplicationResult {
...
fun AmazonCodeDeployFunctions.updateDeploymentGroup(init: (AmazonCodeDeployUpdateDeploymentGroupCommand.() -> Unit)? = null): com.amazonaws.services.codedeploy.model.UpdateDeploymentGroupResult {
	return this.block.declare(AmazonCodeDeployUpdateDeploymentGroupCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codedeploy.model.UpdateDeploymentGroupResult
}
...
class AmazonCodeDeployUpdateDeploymentGroupCommand() : AmazonWebServiceCommand<com.amazonaws.services.codedeploy.model.UpdateDeploymentGroupRequest, com.amazonaws.services.codedeploy.model.UpdateDeploymentGroupResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codedeploy.model.UpdateDeploymentGroupResult {
