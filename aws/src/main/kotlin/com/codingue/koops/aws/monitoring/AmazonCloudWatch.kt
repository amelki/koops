...
package com.codingue.koops.aws.monitoring
...
var com.codingue.koops.core.Environment.monitoring: AmazonCloudWatch
	get() {
...
fun AmazonCloudWatchFunctions.deleteAlarms(alarmNames: List<String>, init: (AmazonCloudWatchDeleteAlarmsCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatch.model.DeleteAlarmsResult {
	return this.block.declare(AmazonCloudWatchDeleteAlarmsCommand(alarmNames).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatch.model.DeleteAlarmsResult
}
...
class AmazonCloudWatchDeleteAlarmsCommand(val alarmNames: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatch.model.DeleteAlarmsRequest, com.amazonaws.services.cloudwatch.model.DeleteAlarmsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatch.model.DeleteAlarmsResult {
...
fun AmazonCloudWatchFunctions.deleteDashboards(dashboardNames: List<String>, init: (AmazonCloudWatchDeleteDashboardsCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatch.model.DeleteDashboardsResult {
	return this.block.declare(AmazonCloudWatchDeleteDashboardsCommand(dashboardNames).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatch.model.DeleteDashboardsResult
}
...
class AmazonCloudWatchDeleteDashboardsCommand(val dashboardNames: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatch.model.DeleteDashboardsRequest, com.amazonaws.services.cloudwatch.model.DeleteDashboardsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatch.model.DeleteDashboardsResult {
...
fun AmazonCloudWatchFunctions.describeAlarmHistory(init: (AmazonCloudWatchDescribeAlarmHistoryCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatch.model.DescribeAlarmHistoryResult {
	return this.block.declare(AmazonCloudWatchDescribeAlarmHistoryCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatch.model.DescribeAlarmHistoryResult
}
...
class AmazonCloudWatchDescribeAlarmHistoryCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudwatch.model.DescribeAlarmHistoryRequest, com.amazonaws.services.cloudwatch.model.DescribeAlarmHistoryResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatch.model.DescribeAlarmHistoryResult {
...
fun AmazonCloudWatchFunctions.describeAlarms(init: (AmazonCloudWatchDescribeAlarmsCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatch.model.DescribeAlarmsResult {
	return this.block.declare(AmazonCloudWatchDescribeAlarmsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatch.model.DescribeAlarmsResult
}
...
class AmazonCloudWatchDescribeAlarmsCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudwatch.model.DescribeAlarmsRequest, com.amazonaws.services.cloudwatch.model.DescribeAlarmsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatch.model.DescribeAlarmsResult {
...
fun AmazonCloudWatchFunctions.describeAlarmsForMetric(metricName: String, namespace: String, init: (AmazonCloudWatchDescribeAlarmsForMetricCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatch.model.DescribeAlarmsForMetricResult {
	return this.block.declare(AmazonCloudWatchDescribeAlarmsForMetricCommand(metricName, namespace).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatch.model.DescribeAlarmsForMetricResult
}
...
class AmazonCloudWatchDescribeAlarmsForMetricCommand(val metricName: String, val namespace: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatch.model.DescribeAlarmsForMetricRequest, com.amazonaws.services.cloudwatch.model.DescribeAlarmsForMetricResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatch.model.DescribeAlarmsForMetricResult {
...
fun AmazonCloudWatchFunctions.disableAlarmActions(alarmNames: List<String>, init: (AmazonCloudWatchDisableAlarmActionsCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatch.model.DisableAlarmActionsResult {
	return this.block.declare(AmazonCloudWatchDisableAlarmActionsCommand(alarmNames).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatch.model.DisableAlarmActionsResult
}
...
class AmazonCloudWatchDisableAlarmActionsCommand(val alarmNames: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatch.model.DisableAlarmActionsRequest, com.amazonaws.services.cloudwatch.model.DisableAlarmActionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatch.model.DisableAlarmActionsResult {
...
fun AmazonCloudWatchFunctions.enableAlarmActions(alarmNames: List<String>, init: (AmazonCloudWatchEnableAlarmActionsCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatch.model.EnableAlarmActionsResult {
	return this.block.declare(AmazonCloudWatchEnableAlarmActionsCommand(alarmNames).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatch.model.EnableAlarmActionsResult
}
...
class AmazonCloudWatchEnableAlarmActionsCommand(val alarmNames: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatch.model.EnableAlarmActionsRequest, com.amazonaws.services.cloudwatch.model.EnableAlarmActionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatch.model.EnableAlarmActionsResult {
...
fun AmazonCloudWatchFunctions.getDashboard(dashboardName: String, init: (AmazonCloudWatchGetDashboardCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatch.model.GetDashboardResult {
	return this.block.declare(AmazonCloudWatchGetDashboardCommand(dashboardName).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatch.model.GetDashboardResult
}
...
class AmazonCloudWatchGetDashboardCommand(val dashboardName: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatch.model.GetDashboardRequest, com.amazonaws.services.cloudwatch.model.GetDashboardResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatch.model.GetDashboardResult {
...
fun AmazonCloudWatchFunctions.getMetricData(metricDataQueries: List<com.amazonaws.services.cloudwatch.model.MetricDataQuery>, startTime: java.util.Date, endTime: java.util.Date, init: (AmazonCloudWatchGetMetricDataCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatch.model.GetMetricDataResult {
	return this.block.declare(AmazonCloudWatchGetMetricDataCommand(metricDataQueries, startTime, endTime).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatch.model.GetMetricDataResult
}
...
class AmazonCloudWatchGetMetricDataCommand(val metricDataQueries: List<com.amazonaws.services.cloudwatch.model.MetricDataQuery>, val startTime: java.util.Date, val endTime: java.util.Date) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatch.model.GetMetricDataRequest, com.amazonaws.services.cloudwatch.model.GetMetricDataResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatch.model.GetMetricDataResult {
...
fun AmazonCloudWatchFunctions.getMetricStatistics(namespace: String, metricName: String, startTime: java.util.Date, endTime: java.util.Date, period: Int, init: (AmazonCloudWatchGetMetricStatisticsCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatch.model.GetMetricStatisticsResult {
	return this.block.declare(AmazonCloudWatchGetMetricStatisticsCommand(namespace, metricName, startTime, endTime, period).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatch.model.GetMetricStatisticsResult
}
...
class AmazonCloudWatchGetMetricStatisticsCommand(val namespace: String, val metricName: String, val startTime: java.util.Date, val endTime: java.util.Date, val period: Int) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatch.model.GetMetricStatisticsRequest, com.amazonaws.services.cloudwatch.model.GetMetricStatisticsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatch.model.GetMetricStatisticsResult {
...
fun AmazonCloudWatchFunctions.listDashboards(init: (AmazonCloudWatchListDashboardsCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatch.model.ListDashboardsResult {
	return this.block.declare(AmazonCloudWatchListDashboardsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatch.model.ListDashboardsResult
}
...
class AmazonCloudWatchListDashboardsCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudwatch.model.ListDashboardsRequest, com.amazonaws.services.cloudwatch.model.ListDashboardsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatch.model.ListDashboardsResult {
...
fun AmazonCloudWatchFunctions.listMetrics(init: (AmazonCloudWatchListMetricsCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatch.model.ListMetricsResult {
	return this.block.declare(AmazonCloudWatchListMetricsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatch.model.ListMetricsResult
}
...
class AmazonCloudWatchListMetricsCommand() : AmazonWebServiceCommand<com.amazonaws.services.cloudwatch.model.ListMetricsRequest, com.amazonaws.services.cloudwatch.model.ListMetricsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatch.model.ListMetricsResult {
...
fun AmazonCloudWatchFunctions.putDashboard(dashboardName: String, dashboardBody: String, init: (AmazonCloudWatchPutDashboardCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatch.model.PutDashboardResult {
	return this.block.declare(AmazonCloudWatchPutDashboardCommand(dashboardName, dashboardBody).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatch.model.PutDashboardResult
}
...
class AmazonCloudWatchPutDashboardCommand(val dashboardName: String, val dashboardBody: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatch.model.PutDashboardRequest, com.amazonaws.services.cloudwatch.model.PutDashboardResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatch.model.PutDashboardResult {
...
fun AmazonCloudWatchFunctions.putMetricAlarm(alarmName: String, metricName: String, namespace: String, period: Int, evaluationPeriods: Int, threshold: Double, comparisonOperator: ComparisonOperator, init: (AmazonCloudWatchPutMetricAlarmCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatch.model.PutMetricAlarmResult {
	return this.block.declare(AmazonCloudWatchPutMetricAlarmCommand(alarmName, metricName, namespace, period, evaluationPeriods, threshold, comparisonOperator).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatch.model.PutMetricAlarmResult
}
...
class AmazonCloudWatchPutMetricAlarmCommand(val alarmName: String, val metricName: String, val namespace: String, val period: Int, val evaluationPeriods: Int, val threshold: Double, val comparisonOperator: ComparisonOperator) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatch.model.PutMetricAlarmRequest, com.amazonaws.services.cloudwatch.model.PutMetricAlarmResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatch.model.PutMetricAlarmResult {
...
fun AmazonCloudWatchFunctions.putMetricData(namespace: String, metricData: List<com.amazonaws.services.cloudwatch.model.MetricDatum>, init: (AmazonCloudWatchPutMetricDataCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatch.model.PutMetricDataResult {
	return this.block.declare(AmazonCloudWatchPutMetricDataCommand(namespace, metricData).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatch.model.PutMetricDataResult
}
...
class AmazonCloudWatchPutMetricDataCommand(val namespace: String, val metricData: List<com.amazonaws.services.cloudwatch.model.MetricDatum>) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatch.model.PutMetricDataRequest, com.amazonaws.services.cloudwatch.model.PutMetricDataResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatch.model.PutMetricDataResult {
...
fun AmazonCloudWatchFunctions.setAlarmState(alarmName: String, stateValue: StateValue, stateReason: String, init: (AmazonCloudWatchSetAlarmStateCommand.() -> Unit)? = null): com.amazonaws.services.cloudwatch.model.SetAlarmStateResult {
	return this.block.declare(AmazonCloudWatchSetAlarmStateCommand(alarmName, stateValue, stateReason).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.cloudwatch.model.SetAlarmStateResult
}
...
class AmazonCloudWatchSetAlarmStateCommand(val alarmName: String, val stateValue: StateValue, val stateReason: String) : AmazonWebServiceCommand<com.amazonaws.services.cloudwatch.model.SetAlarmStateRequest, com.amazonaws.services.cloudwatch.model.SetAlarmStateResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.cloudwatch.model.SetAlarmStateResult {
