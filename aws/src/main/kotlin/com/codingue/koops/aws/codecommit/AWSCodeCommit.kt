...
package com.codingue.koops.aws.codecommit
...
var com.codingue.koops.core.Environment.codecommit: AWSCodeCommit
	get() {
		var service = this.capabilities["aws-codecommit"]
		if (service == null) {
			service = AWSCodeCommitClientBuilder.standard().build()
			this.capabilities["aws-codecommit"] = service
		}
		return service as AWSCodeCommit
	}
	set(codecommit) {
		this.capabilities["aws-codecommit"] = codecommit
	}
...
fun AWSCodeCommitFunctions.batchGetRepositories(init: (AWSCodeCommitBatchGetRepositoriesCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.BatchGetRepositoriesResult {
	return this.block.declare(AWSCodeCommitBatchGetRepositoriesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.BatchGetRepositoriesResult
}
...
class AWSCodeCommitBatchGetRepositoriesCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.BatchGetRepositoriesRequest, com.amazonaws.services.codecommit.model.BatchGetRepositoriesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.BatchGetRepositoriesResult {
...
fun AWSCodeCommitFunctions.createBranch(init: (AWSCodeCommitCreateBranchCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.CreateBranchResult {
	return this.block.declare(AWSCodeCommitCreateBranchCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.CreateBranchResult
}
...
class AWSCodeCommitCreateBranchCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.CreateBranchRequest, com.amazonaws.services.codecommit.model.CreateBranchResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.CreateBranchResult {
...
fun AWSCodeCommitFunctions.createPullRequest(init: (AWSCodeCommitCreatePullRequestCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.CreatePullRequestResult {
	return this.block.declare(AWSCodeCommitCreatePullRequestCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.CreatePullRequestResult
}
...
class AWSCodeCommitCreatePullRequestCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.CreatePullRequestRequest, com.amazonaws.services.codecommit.model.CreatePullRequestResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.CreatePullRequestResult {
...
fun AWSCodeCommitFunctions.createRepository(init: (AWSCodeCommitCreateRepositoryCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.CreateRepositoryResult {
	return this.block.declare(AWSCodeCommitCreateRepositoryCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.CreateRepositoryResult
}
...
class AWSCodeCommitCreateRepositoryCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.CreateRepositoryRequest, com.amazonaws.services.codecommit.model.CreateRepositoryResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.CreateRepositoryResult {
...
fun AWSCodeCommitFunctions.deleteBranch(init: (AWSCodeCommitDeleteBranchCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.DeleteBranchResult {
	return this.block.declare(AWSCodeCommitDeleteBranchCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.DeleteBranchResult
}
...
class AWSCodeCommitDeleteBranchCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.DeleteBranchRequest, com.amazonaws.services.codecommit.model.DeleteBranchResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.DeleteBranchResult {
...
fun AWSCodeCommitFunctions.deleteCommentContent(init: (AWSCodeCommitDeleteCommentContentCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.DeleteCommentContentResult {
	return this.block.declare(AWSCodeCommitDeleteCommentContentCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.DeleteCommentContentResult
}
...
class AWSCodeCommitDeleteCommentContentCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.DeleteCommentContentRequest, com.amazonaws.services.codecommit.model.DeleteCommentContentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.DeleteCommentContentResult {
...
fun AWSCodeCommitFunctions.deleteRepository(init: (AWSCodeCommitDeleteRepositoryCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.DeleteRepositoryResult {
	return this.block.declare(AWSCodeCommitDeleteRepositoryCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.DeleteRepositoryResult
}
...
class AWSCodeCommitDeleteRepositoryCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.DeleteRepositoryRequest, com.amazonaws.services.codecommit.model.DeleteRepositoryResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.DeleteRepositoryResult {
...
fun AWSCodeCommitFunctions.describePullRequestEvents(init: (AWSCodeCommitDescribePullRequestEventsCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.DescribePullRequestEventsResult {
	return this.block.declare(AWSCodeCommitDescribePullRequestEventsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.DescribePullRequestEventsResult
}
...
class AWSCodeCommitDescribePullRequestEventsCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.DescribePullRequestEventsRequest, com.amazonaws.services.codecommit.model.DescribePullRequestEventsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.DescribePullRequestEventsResult {
...
fun AWSCodeCommitFunctions.getBlob(init: (AWSCodeCommitGetBlobCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.GetBlobResult {
	return this.block.declare(AWSCodeCommitGetBlobCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.GetBlobResult
}
...
class AWSCodeCommitGetBlobCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.GetBlobRequest, com.amazonaws.services.codecommit.model.GetBlobResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.GetBlobResult {
...
fun AWSCodeCommitFunctions.getBranch(init: (AWSCodeCommitGetBranchCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.GetBranchResult {
	return this.block.declare(AWSCodeCommitGetBranchCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.GetBranchResult
}
...
class AWSCodeCommitGetBranchCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.GetBranchRequest, com.amazonaws.services.codecommit.model.GetBranchResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.GetBranchResult {
...
fun AWSCodeCommitFunctions.getComment(init: (AWSCodeCommitGetCommentCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.GetCommentResult {
	return this.block.declare(AWSCodeCommitGetCommentCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.GetCommentResult
}
...
class AWSCodeCommitGetCommentCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.GetCommentRequest, com.amazonaws.services.codecommit.model.GetCommentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.GetCommentResult {
...
fun AWSCodeCommitFunctions.getCommentsForComparedCommit(init: (AWSCodeCommitGetCommentsForComparedCommitCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.GetCommentsForComparedCommitResult {
	return this.block.declare(AWSCodeCommitGetCommentsForComparedCommitCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.GetCommentsForComparedCommitResult
}
...
class AWSCodeCommitGetCommentsForComparedCommitCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.GetCommentsForComparedCommitRequest, com.amazonaws.services.codecommit.model.GetCommentsForComparedCommitResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.GetCommentsForComparedCommitResult {
...
fun AWSCodeCommitFunctions.getCommentsForPullRequest(init: (AWSCodeCommitGetCommentsForPullRequestCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.GetCommentsForPullRequestResult {
	return this.block.declare(AWSCodeCommitGetCommentsForPullRequestCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.GetCommentsForPullRequestResult
}
...
class AWSCodeCommitGetCommentsForPullRequestCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.GetCommentsForPullRequestRequest, com.amazonaws.services.codecommit.model.GetCommentsForPullRequestResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.GetCommentsForPullRequestResult {
...
fun AWSCodeCommitFunctions.getCommit(init: (AWSCodeCommitGetCommitCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.GetCommitResult {
	return this.block.declare(AWSCodeCommitGetCommitCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.GetCommitResult
}
...
class AWSCodeCommitGetCommitCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.GetCommitRequest, com.amazonaws.services.codecommit.model.GetCommitResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.GetCommitResult {
...
fun AWSCodeCommitFunctions.getDifferences(init: (AWSCodeCommitGetDifferencesCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.GetDifferencesResult {
	return this.block.declare(AWSCodeCommitGetDifferencesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.GetDifferencesResult
}
...
class AWSCodeCommitGetDifferencesCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.GetDifferencesRequest, com.amazonaws.services.codecommit.model.GetDifferencesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.GetDifferencesResult {
...
fun AWSCodeCommitFunctions.getMergeConflicts(init: (AWSCodeCommitGetMergeConflictsCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.GetMergeConflictsResult {
	return this.block.declare(AWSCodeCommitGetMergeConflictsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.GetMergeConflictsResult
}
...
class AWSCodeCommitGetMergeConflictsCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.GetMergeConflictsRequest, com.amazonaws.services.codecommit.model.GetMergeConflictsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.GetMergeConflictsResult {
...
fun AWSCodeCommitFunctions.getPullRequest(init: (AWSCodeCommitGetPullRequestCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.GetPullRequestResult {
	return this.block.declare(AWSCodeCommitGetPullRequestCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.GetPullRequestResult
}
...
class AWSCodeCommitGetPullRequestCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.GetPullRequestRequest, com.amazonaws.services.codecommit.model.GetPullRequestResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.GetPullRequestResult {
...
fun AWSCodeCommitFunctions.getRepository(init: (AWSCodeCommitGetRepositoryCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.GetRepositoryResult {
	return this.block.declare(AWSCodeCommitGetRepositoryCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.GetRepositoryResult
}
...
class AWSCodeCommitGetRepositoryCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.GetRepositoryRequest, com.amazonaws.services.codecommit.model.GetRepositoryResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.GetRepositoryResult {
...
fun AWSCodeCommitFunctions.getRepositoryTriggers(init: (AWSCodeCommitGetRepositoryTriggersCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.GetRepositoryTriggersResult {
	return this.block.declare(AWSCodeCommitGetRepositoryTriggersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.GetRepositoryTriggersResult
}
...
class AWSCodeCommitGetRepositoryTriggersCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.GetRepositoryTriggersRequest, com.amazonaws.services.codecommit.model.GetRepositoryTriggersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.GetRepositoryTriggersResult {
...
fun AWSCodeCommitFunctions.listBranches(init: (AWSCodeCommitListBranchesCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.ListBranchesResult {
	return this.block.declare(AWSCodeCommitListBranchesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.ListBranchesResult
}
...
class AWSCodeCommitListBranchesCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.ListBranchesRequest, com.amazonaws.services.codecommit.model.ListBranchesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.ListBranchesResult {
...
fun AWSCodeCommitFunctions.listPullRequests(init: (AWSCodeCommitListPullRequestsCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.ListPullRequestsResult {
	return this.block.declare(AWSCodeCommitListPullRequestsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.ListPullRequestsResult
}
...
class AWSCodeCommitListPullRequestsCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.ListPullRequestsRequest, com.amazonaws.services.codecommit.model.ListPullRequestsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.ListPullRequestsResult {
...
fun AWSCodeCommitFunctions.listRepositories(init: (AWSCodeCommitListRepositoriesCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.ListRepositoriesResult {
	return this.block.declare(AWSCodeCommitListRepositoriesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.ListRepositoriesResult
}
...
class AWSCodeCommitListRepositoriesCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.ListRepositoriesRequest, com.amazonaws.services.codecommit.model.ListRepositoriesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.ListRepositoriesResult {
...
fun AWSCodeCommitFunctions.mergePullRequestByFastForward(init: (AWSCodeCommitMergePullRequestByFastForwardCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.MergePullRequestByFastForwardResult {
	return this.block.declare(AWSCodeCommitMergePullRequestByFastForwardCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.MergePullRequestByFastForwardResult
}
...
class AWSCodeCommitMergePullRequestByFastForwardCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.MergePullRequestByFastForwardRequest, com.amazonaws.services.codecommit.model.MergePullRequestByFastForwardResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.MergePullRequestByFastForwardResult {
...
fun AWSCodeCommitFunctions.postCommentForComparedCommit(init: (AWSCodeCommitPostCommentForComparedCommitCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.PostCommentForComparedCommitResult {
	return this.block.declare(AWSCodeCommitPostCommentForComparedCommitCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.PostCommentForComparedCommitResult
}
...
class AWSCodeCommitPostCommentForComparedCommitCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.PostCommentForComparedCommitRequest, com.amazonaws.services.codecommit.model.PostCommentForComparedCommitResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.PostCommentForComparedCommitResult {
...
fun AWSCodeCommitFunctions.postCommentForPullRequest(init: (AWSCodeCommitPostCommentForPullRequestCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.PostCommentForPullRequestResult {
	return this.block.declare(AWSCodeCommitPostCommentForPullRequestCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.PostCommentForPullRequestResult
}
...
class AWSCodeCommitPostCommentForPullRequestCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.PostCommentForPullRequestRequest, com.amazonaws.services.codecommit.model.PostCommentForPullRequestResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.PostCommentForPullRequestResult {
...
fun AWSCodeCommitFunctions.postCommentReply(init: (AWSCodeCommitPostCommentReplyCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.PostCommentReplyResult {
	return this.block.declare(AWSCodeCommitPostCommentReplyCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.PostCommentReplyResult
}
...
class AWSCodeCommitPostCommentReplyCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.PostCommentReplyRequest, com.amazonaws.services.codecommit.model.PostCommentReplyResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.PostCommentReplyResult {
...
fun AWSCodeCommitFunctions.putFile(init: (AWSCodeCommitPutFileCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.PutFileResult {
	return this.block.declare(AWSCodeCommitPutFileCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.PutFileResult
}
...
class AWSCodeCommitPutFileCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.PutFileRequest, com.amazonaws.services.codecommit.model.PutFileResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.PutFileResult {
...
fun AWSCodeCommitFunctions.putRepositoryTriggers(init: (AWSCodeCommitPutRepositoryTriggersCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.PutRepositoryTriggersResult {
	return this.block.declare(AWSCodeCommitPutRepositoryTriggersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.PutRepositoryTriggersResult
}
...
class AWSCodeCommitPutRepositoryTriggersCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.PutRepositoryTriggersRequest, com.amazonaws.services.codecommit.model.PutRepositoryTriggersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.PutRepositoryTriggersResult {
...
fun AWSCodeCommitFunctions.testRepositoryTriggers(init: (AWSCodeCommitTestRepositoryTriggersCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.TestRepositoryTriggersResult {
	return this.block.declare(AWSCodeCommitTestRepositoryTriggersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.TestRepositoryTriggersResult
}
...
class AWSCodeCommitTestRepositoryTriggersCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.TestRepositoryTriggersRequest, com.amazonaws.services.codecommit.model.TestRepositoryTriggersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.TestRepositoryTriggersResult {
...
fun AWSCodeCommitFunctions.updateComment(init: (AWSCodeCommitUpdateCommentCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.UpdateCommentResult {
	return this.block.declare(AWSCodeCommitUpdateCommentCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.UpdateCommentResult
}
...
class AWSCodeCommitUpdateCommentCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.UpdateCommentRequest, com.amazonaws.services.codecommit.model.UpdateCommentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.UpdateCommentResult {
...
fun AWSCodeCommitFunctions.updateDefaultBranch(init: (AWSCodeCommitUpdateDefaultBranchCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.UpdateDefaultBranchResult {
	return this.block.declare(AWSCodeCommitUpdateDefaultBranchCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.UpdateDefaultBranchResult
}
...
class AWSCodeCommitUpdateDefaultBranchCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.UpdateDefaultBranchRequest, com.amazonaws.services.codecommit.model.UpdateDefaultBranchResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.UpdateDefaultBranchResult {
...
fun AWSCodeCommitFunctions.updatePullRequestDescription(init: (AWSCodeCommitUpdatePullRequestDescriptionCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.UpdatePullRequestDescriptionResult {
	return this.block.declare(AWSCodeCommitUpdatePullRequestDescriptionCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.UpdatePullRequestDescriptionResult
}
...
class AWSCodeCommitUpdatePullRequestDescriptionCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.UpdatePullRequestDescriptionRequest, com.amazonaws.services.codecommit.model.UpdatePullRequestDescriptionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.UpdatePullRequestDescriptionResult {
...
fun AWSCodeCommitFunctions.updatePullRequestStatus(init: (AWSCodeCommitUpdatePullRequestStatusCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.UpdatePullRequestStatusResult {
	return this.block.declare(AWSCodeCommitUpdatePullRequestStatusCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.UpdatePullRequestStatusResult
}
...
class AWSCodeCommitUpdatePullRequestStatusCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.UpdatePullRequestStatusRequest, com.amazonaws.services.codecommit.model.UpdatePullRequestStatusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.UpdatePullRequestStatusResult {
...
fun AWSCodeCommitFunctions.updatePullRequestTitle(init: (AWSCodeCommitUpdatePullRequestTitleCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.UpdatePullRequestTitleResult {
	return this.block.declare(AWSCodeCommitUpdatePullRequestTitleCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.UpdatePullRequestTitleResult
}
...
class AWSCodeCommitUpdatePullRequestTitleCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.UpdatePullRequestTitleRequest, com.amazonaws.services.codecommit.model.UpdatePullRequestTitleResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.UpdatePullRequestTitleResult {
...
fun AWSCodeCommitFunctions.updateRepositoryDescription(init: (AWSCodeCommitUpdateRepositoryDescriptionCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.UpdateRepositoryDescriptionResult {
	return this.block.declare(AWSCodeCommitUpdateRepositoryDescriptionCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.UpdateRepositoryDescriptionResult
}
...
class AWSCodeCommitUpdateRepositoryDescriptionCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.UpdateRepositoryDescriptionRequest, com.amazonaws.services.codecommit.model.UpdateRepositoryDescriptionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.UpdateRepositoryDescriptionResult {
...
fun AWSCodeCommitFunctions.updateRepositoryName(init: (AWSCodeCommitUpdateRepositoryNameCommand.() -> Unit)? = null): com.amazonaws.services.codecommit.model.UpdateRepositoryNameResult {
	return this.block.declare(AWSCodeCommitUpdateRepositoryNameCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.codecommit.model.UpdateRepositoryNameResult
}
...
class AWSCodeCommitUpdateRepositoryNameCommand() : AmazonWebServiceCommand<com.amazonaws.services.codecommit.model.UpdateRepositoryNameRequest, com.amazonaws.services.codecommit.model.UpdateRepositoryNameResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.codecommit.model.UpdateRepositoryNameResult {
