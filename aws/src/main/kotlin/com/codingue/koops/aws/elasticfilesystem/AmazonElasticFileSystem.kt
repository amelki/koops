...
package com.codingue.koops.aws.elasticfilesystem
...
var com.codingue.koops.core.Environment.elasticfilesystem: AmazonElasticFileSystem
	get() {
...
fun AmazonElasticFileSystemFunctions.createFileSystem(creationToken: String, init: (AmazonElasticFileSystemCreateFileSystemCommand.() -> Unit)? = null): com.amazonaws.services.elasticfilesystem.model.CreateFileSystemResult {
	return this.block.declare(AmazonElasticFileSystemCreateFileSystemCommand(creationToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticfilesystem.model.CreateFileSystemResult
}
...
class AmazonElasticFileSystemCreateFileSystemCommand(val creationToken: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticfilesystem.model.CreateFileSystemRequest, com.amazonaws.services.elasticfilesystem.model.CreateFileSystemResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticfilesystem.model.CreateFileSystemResult {
...
fun AmazonElasticFileSystemFunctions.createMountTarget(fileSystemId: String, subnetId: String, init: (AmazonElasticFileSystemCreateMountTargetCommand.() -> Unit)? = null): com.amazonaws.services.elasticfilesystem.model.CreateMountTargetResult {
	return this.block.declare(AmazonElasticFileSystemCreateMountTargetCommand(fileSystemId, subnetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticfilesystem.model.CreateMountTargetResult
}
...
class AmazonElasticFileSystemCreateMountTargetCommand(val fileSystemId: String, val subnetId: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticfilesystem.model.CreateMountTargetRequest, com.amazonaws.services.elasticfilesystem.model.CreateMountTargetResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticfilesystem.model.CreateMountTargetResult {
...
fun AmazonElasticFileSystemFunctions.createTags(fileSystemId: String, tags: List<com.amazonaws.services.elasticfilesystem.model.Tag>, init: (AmazonElasticFileSystemCreateTagsCommand.() -> Unit)? = null): com.amazonaws.services.elasticfilesystem.model.CreateTagsResult {
	return this.block.declare(AmazonElasticFileSystemCreateTagsCommand(fileSystemId, tags).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticfilesystem.model.CreateTagsResult
}
...
class AmazonElasticFileSystemCreateTagsCommand(val fileSystemId: String, val tags: List<com.amazonaws.services.elasticfilesystem.model.Tag>) : AmazonWebServiceCommand<com.amazonaws.services.elasticfilesystem.model.CreateTagsRequest, com.amazonaws.services.elasticfilesystem.model.CreateTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticfilesystem.model.CreateTagsResult {
...
fun AmazonElasticFileSystemFunctions.deleteFileSystem(fileSystemId: String, init: (AmazonElasticFileSystemDeleteFileSystemCommand.() -> Unit)? = null): com.amazonaws.services.elasticfilesystem.model.DeleteFileSystemResult {
	return this.block.declare(AmazonElasticFileSystemDeleteFileSystemCommand(fileSystemId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticfilesystem.model.DeleteFileSystemResult
}
...
class AmazonElasticFileSystemDeleteFileSystemCommand(val fileSystemId: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticfilesystem.model.DeleteFileSystemRequest, com.amazonaws.services.elasticfilesystem.model.DeleteFileSystemResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticfilesystem.model.DeleteFileSystemResult {
...
fun AmazonElasticFileSystemFunctions.deleteMountTarget(mountTargetId: String, init: (AmazonElasticFileSystemDeleteMountTargetCommand.() -> Unit)? = null): com.amazonaws.services.elasticfilesystem.model.DeleteMountTargetResult {
	return this.block.declare(AmazonElasticFileSystemDeleteMountTargetCommand(mountTargetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticfilesystem.model.DeleteMountTargetResult
}
...
class AmazonElasticFileSystemDeleteMountTargetCommand(val mountTargetId: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticfilesystem.model.DeleteMountTargetRequest, com.amazonaws.services.elasticfilesystem.model.DeleteMountTargetResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticfilesystem.model.DeleteMountTargetResult {
...
fun AmazonElasticFileSystemFunctions.deleteTags(fileSystemId: String, tagKeys: List<String>, init: (AmazonElasticFileSystemDeleteTagsCommand.() -> Unit)? = null): com.amazonaws.services.elasticfilesystem.model.DeleteTagsResult {
	return this.block.declare(AmazonElasticFileSystemDeleteTagsCommand(fileSystemId, tagKeys).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticfilesystem.model.DeleteTagsResult
}
...
class AmazonElasticFileSystemDeleteTagsCommand(val fileSystemId: String, val tagKeys: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.elasticfilesystem.model.DeleteTagsRequest, com.amazonaws.services.elasticfilesystem.model.DeleteTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticfilesystem.model.DeleteTagsResult {
...
fun AmazonElasticFileSystemFunctions.describeFileSystems(init: (AmazonElasticFileSystemDescribeFileSystemsCommand.() -> Unit)? = null): com.amazonaws.services.elasticfilesystem.model.DescribeFileSystemsResult {
	return this.block.declare(AmazonElasticFileSystemDescribeFileSystemsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticfilesystem.model.DescribeFileSystemsResult
}
...
class AmazonElasticFileSystemDescribeFileSystemsCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticfilesystem.model.DescribeFileSystemsRequest, com.amazonaws.services.elasticfilesystem.model.DescribeFileSystemsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticfilesystem.model.DescribeFileSystemsResult {
...
fun AmazonElasticFileSystemFunctions.describeMountTargetSecurityGroups(mountTargetId: String, init: (AmazonElasticFileSystemDescribeMountTargetSecurityGroupsCommand.() -> Unit)? = null): com.amazonaws.services.elasticfilesystem.model.DescribeMountTargetSecurityGroupsResult {
	return this.block.declare(AmazonElasticFileSystemDescribeMountTargetSecurityGroupsCommand(mountTargetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticfilesystem.model.DescribeMountTargetSecurityGroupsResult
}
...
class AmazonElasticFileSystemDescribeMountTargetSecurityGroupsCommand(val mountTargetId: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticfilesystem.model.DescribeMountTargetSecurityGroupsRequest, com.amazonaws.services.elasticfilesystem.model.DescribeMountTargetSecurityGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticfilesystem.model.DescribeMountTargetSecurityGroupsResult {
...
fun AmazonElasticFileSystemFunctions.describeMountTargets(init: (AmazonElasticFileSystemDescribeMountTargetsCommand.() -> Unit)? = null): com.amazonaws.services.elasticfilesystem.model.DescribeMountTargetsResult {
	return this.block.declare(AmazonElasticFileSystemDescribeMountTargetsCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticfilesystem.model.DescribeMountTargetsResult
}
...
class AmazonElasticFileSystemDescribeMountTargetsCommand() : AmazonWebServiceCommand<com.amazonaws.services.elasticfilesystem.model.DescribeMountTargetsRequest, com.amazonaws.services.elasticfilesystem.model.DescribeMountTargetsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticfilesystem.model.DescribeMountTargetsResult {
...
fun AmazonElasticFileSystemFunctions.describeTags(fileSystemId: String, init: (AmazonElasticFileSystemDescribeTagsCommand.() -> Unit)? = null): com.amazonaws.services.elasticfilesystem.model.DescribeTagsResult {
	return this.block.declare(AmazonElasticFileSystemDescribeTagsCommand(fileSystemId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticfilesystem.model.DescribeTagsResult
}
...
class AmazonElasticFileSystemDescribeTagsCommand(val fileSystemId: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticfilesystem.model.DescribeTagsRequest, com.amazonaws.services.elasticfilesystem.model.DescribeTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticfilesystem.model.DescribeTagsResult {
...
fun AmazonElasticFileSystemFunctions.modifyMountTargetSecurityGroups(mountTargetId: String, init: (AmazonElasticFileSystemModifyMountTargetSecurityGroupsCommand.() -> Unit)? = null): com.amazonaws.services.elasticfilesystem.model.ModifyMountTargetSecurityGroupsResult {
	return this.block.declare(AmazonElasticFileSystemModifyMountTargetSecurityGroupsCommand(mountTargetId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.elasticfilesystem.model.ModifyMountTargetSecurityGroupsResult
}
...
class AmazonElasticFileSystemModifyMountTargetSecurityGroupsCommand(val mountTargetId: String) : AmazonWebServiceCommand<com.amazonaws.services.elasticfilesystem.model.ModifyMountTargetSecurityGroupsRequest, com.amazonaws.services.elasticfilesystem.model.ModifyMountTargetSecurityGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.elasticfilesystem.model.ModifyMountTargetSecurityGroupsResult {
