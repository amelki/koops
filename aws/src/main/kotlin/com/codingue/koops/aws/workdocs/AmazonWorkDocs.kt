...
package com.codingue.koops.aws.workdocs
...
var com.codingue.koops.core.Environment.workdocs: AmazonWorkDocs
	get() {
		var service = this.capabilities["aws-workdocs"]
		if (service == null) {
			service = AmazonWorkDocsClientBuilder.standard().build()
			this.capabilities["aws-workdocs"] = service
		}
		return service as AmazonWorkDocs
	}
	set(workdocs) {
		this.capabilities["aws-workdocs"] = workdocs
	}
...
fun AmazonWorkDocsFunctions.abortDocumentVersionUpload(documentId: String, versionId: String, init: (AmazonWorkDocsAbortDocumentVersionUploadCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.AbortDocumentVersionUploadResult {
	return this.block.declare(AmazonWorkDocsAbortDocumentVersionUploadCommand(documentId, versionId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.AbortDocumentVersionUploadResult
}
...
class AmazonWorkDocsAbortDocumentVersionUploadCommand(val documentId: String, val versionId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.AbortDocumentVersionUploadRequest, com.amazonaws.services.workdocs.model.AbortDocumentVersionUploadResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.AbortDocumentVersionUploadResult {
...
fun AmazonWorkDocsFunctions.activateUser(userId: String, init: (AmazonWorkDocsActivateUserCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.ActivateUserResult {
	return this.block.declare(AmazonWorkDocsActivateUserCommand(userId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.ActivateUserResult
}
...
class AmazonWorkDocsActivateUserCommand(val userId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.ActivateUserRequest, com.amazonaws.services.workdocs.model.ActivateUserResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.ActivateUserResult {
...
fun AmazonWorkDocsFunctions.addResourcePermissions(resourceId: String, principals: List<com.amazonaws.services.workdocs.model.SharePrincipal>, init: (AmazonWorkDocsAddResourcePermissionsCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.AddResourcePermissionsResult {
	return this.block.declare(AmazonWorkDocsAddResourcePermissionsCommand(resourceId, principals).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.AddResourcePermissionsResult
}
...
class AmazonWorkDocsAddResourcePermissionsCommand(val resourceId: String, val principals: List<com.amazonaws.services.workdocs.model.SharePrincipal>) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.AddResourcePermissionsRequest, com.amazonaws.services.workdocs.model.AddResourcePermissionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.AddResourcePermissionsResult {
...
fun AmazonWorkDocsFunctions.createComment(documentId: String, versionId: String, text: String, init: (AmazonWorkDocsCreateCommentCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.CreateCommentResult {
	return this.block.declare(AmazonWorkDocsCreateCommentCommand(documentId, versionId, text).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.CreateCommentResult
}
...
class AmazonWorkDocsCreateCommentCommand(val documentId: String, val versionId: String, val text: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.CreateCommentRequest, com.amazonaws.services.workdocs.model.CreateCommentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.CreateCommentResult {
...
fun AmazonWorkDocsFunctions.createCustomMetadata(resourceId: String, customMetadata: Map<String, String>, init: (AmazonWorkDocsCreateCustomMetadataCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.CreateCustomMetadataResult {
	return this.block.declare(AmazonWorkDocsCreateCustomMetadataCommand(resourceId, customMetadata).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.CreateCustomMetadataResult
}
...
class AmazonWorkDocsCreateCustomMetadataCommand(val resourceId: String, val customMetadata: Map<String, String>) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.CreateCustomMetadataRequest, com.amazonaws.services.workdocs.model.CreateCustomMetadataResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.CreateCustomMetadataResult {
...
fun AmazonWorkDocsFunctions.createFolder(parentFolderId: String, init: (AmazonWorkDocsCreateFolderCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.CreateFolderResult {
	return this.block.declare(AmazonWorkDocsCreateFolderCommand(parentFolderId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.CreateFolderResult
}
...
class AmazonWorkDocsCreateFolderCommand(val parentFolderId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.CreateFolderRequest, com.amazonaws.services.workdocs.model.CreateFolderResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.CreateFolderResult {
...
fun AmazonWorkDocsFunctions.createLabels(resourceId: String, labels: List<String>, init: (AmazonWorkDocsCreateLabelsCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.CreateLabelsResult {
	return this.block.declare(AmazonWorkDocsCreateLabelsCommand(resourceId, labels).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.CreateLabelsResult
}
...
class AmazonWorkDocsCreateLabelsCommand(val resourceId: String, val labels: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.CreateLabelsRequest, com.amazonaws.services.workdocs.model.CreateLabelsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.CreateLabelsResult {
...
fun AmazonWorkDocsFunctions.createNotificationSubscription(organizationId: String, endpoint: String, protocol: SubscriptionProtocolType, subscriptionType: SubscriptionType, init: (AmazonWorkDocsCreateNotificationSubscriptionCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.CreateNotificationSubscriptionResult {
	return this.block.declare(AmazonWorkDocsCreateNotificationSubscriptionCommand(organizationId, endpoint, protocol, subscriptionType).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.CreateNotificationSubscriptionResult
}
...
class AmazonWorkDocsCreateNotificationSubscriptionCommand(val organizationId: String, val endpoint: String, val protocol: SubscriptionProtocolType, val subscriptionType: SubscriptionType) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.CreateNotificationSubscriptionRequest, com.amazonaws.services.workdocs.model.CreateNotificationSubscriptionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.CreateNotificationSubscriptionResult {
...
fun AmazonWorkDocsFunctions.createUser(username: String, givenName: String, surname: String, password: String, init: (AmazonWorkDocsCreateUserCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.CreateUserResult {
	return this.block.declare(AmazonWorkDocsCreateUserCommand(username, givenName, surname, password).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.CreateUserResult
}
...
class AmazonWorkDocsCreateUserCommand(val username: String, val givenName: String, val surname: String, val password: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.CreateUserRequest, com.amazonaws.services.workdocs.model.CreateUserResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.CreateUserResult {
...
fun AmazonWorkDocsFunctions.deactivateUser(userId: String, init: (AmazonWorkDocsDeactivateUserCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.DeactivateUserResult {
	return this.block.declare(AmazonWorkDocsDeactivateUserCommand(userId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.DeactivateUserResult
}
...
class AmazonWorkDocsDeactivateUserCommand(val userId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.DeactivateUserRequest, com.amazonaws.services.workdocs.model.DeactivateUserResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.DeactivateUserResult {
...
fun AmazonWorkDocsFunctions.deleteComment(documentId: String, versionId: String, commentId: String, init: (AmazonWorkDocsDeleteCommentCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.DeleteCommentResult {
	return this.block.declare(AmazonWorkDocsDeleteCommentCommand(documentId, versionId, commentId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.DeleteCommentResult
}
...
class AmazonWorkDocsDeleteCommentCommand(val documentId: String, val versionId: String, val commentId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.DeleteCommentRequest, com.amazonaws.services.workdocs.model.DeleteCommentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.DeleteCommentResult {
...
fun AmazonWorkDocsFunctions.deleteCustomMetadata(resourceId: String, init: (AmazonWorkDocsDeleteCustomMetadataCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.DeleteCustomMetadataResult {
	return this.block.declare(AmazonWorkDocsDeleteCustomMetadataCommand(resourceId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.DeleteCustomMetadataResult
}
...
class AmazonWorkDocsDeleteCustomMetadataCommand(val resourceId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.DeleteCustomMetadataRequest, com.amazonaws.services.workdocs.model.DeleteCustomMetadataResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.DeleteCustomMetadataResult {
...
fun AmazonWorkDocsFunctions.deleteDocument(documentId: String, init: (AmazonWorkDocsDeleteDocumentCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.DeleteDocumentResult {
	return this.block.declare(AmazonWorkDocsDeleteDocumentCommand(documentId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.DeleteDocumentResult
}
...
class AmazonWorkDocsDeleteDocumentCommand(val documentId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.DeleteDocumentRequest, com.amazonaws.services.workdocs.model.DeleteDocumentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.DeleteDocumentResult {
...
fun AmazonWorkDocsFunctions.deleteFolder(folderId: String, init: (AmazonWorkDocsDeleteFolderCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.DeleteFolderResult {
	return this.block.declare(AmazonWorkDocsDeleteFolderCommand(folderId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.DeleteFolderResult
}
...
class AmazonWorkDocsDeleteFolderCommand(val folderId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.DeleteFolderRequest, com.amazonaws.services.workdocs.model.DeleteFolderResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.DeleteFolderResult {
...
fun AmazonWorkDocsFunctions.deleteFolderContents(folderId: String, init: (AmazonWorkDocsDeleteFolderContentsCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.DeleteFolderContentsResult {
	return this.block.declare(AmazonWorkDocsDeleteFolderContentsCommand(folderId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.DeleteFolderContentsResult
}
...
class AmazonWorkDocsDeleteFolderContentsCommand(val folderId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.DeleteFolderContentsRequest, com.amazonaws.services.workdocs.model.DeleteFolderContentsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.DeleteFolderContentsResult {
...
fun AmazonWorkDocsFunctions.deleteLabels(resourceId: String, init: (AmazonWorkDocsDeleteLabelsCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.DeleteLabelsResult {
	return this.block.declare(AmazonWorkDocsDeleteLabelsCommand(resourceId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.DeleteLabelsResult
}
...
class AmazonWorkDocsDeleteLabelsCommand(val resourceId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.DeleteLabelsRequest, com.amazonaws.services.workdocs.model.DeleteLabelsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.DeleteLabelsResult {
...
fun AmazonWorkDocsFunctions.deleteNotificationSubscription(subscriptionId: String, organizationId: String, init: (AmazonWorkDocsDeleteNotificationSubscriptionCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.DeleteNotificationSubscriptionResult {
	return this.block.declare(AmazonWorkDocsDeleteNotificationSubscriptionCommand(subscriptionId, organizationId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.DeleteNotificationSubscriptionResult
}
...
class AmazonWorkDocsDeleteNotificationSubscriptionCommand(val subscriptionId: String, val organizationId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.DeleteNotificationSubscriptionRequest, com.amazonaws.services.workdocs.model.DeleteNotificationSubscriptionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.DeleteNotificationSubscriptionResult {
...
fun AmazonWorkDocsFunctions.deleteUser(userId: String, init: (AmazonWorkDocsDeleteUserCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.DeleteUserResult {
	return this.block.declare(AmazonWorkDocsDeleteUserCommand(userId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.DeleteUserResult
}
...
class AmazonWorkDocsDeleteUserCommand(val userId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.DeleteUserRequest, com.amazonaws.services.workdocs.model.DeleteUserResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.DeleteUserResult {
...
fun AmazonWorkDocsFunctions.describeActivities(init: (AmazonWorkDocsDescribeActivitiesCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.DescribeActivitiesResult {
	return this.block.declare(AmazonWorkDocsDescribeActivitiesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.DescribeActivitiesResult
}
...
class AmazonWorkDocsDescribeActivitiesCommand() : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.DescribeActivitiesRequest, com.amazonaws.services.workdocs.model.DescribeActivitiesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.DescribeActivitiesResult {
...
fun AmazonWorkDocsFunctions.describeComments(documentId: String, versionId: String, init: (AmazonWorkDocsDescribeCommentsCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.DescribeCommentsResult {
	return this.block.declare(AmazonWorkDocsDescribeCommentsCommand(documentId, versionId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.DescribeCommentsResult
}
...
class AmazonWorkDocsDescribeCommentsCommand(val documentId: String, val versionId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.DescribeCommentsRequest, com.amazonaws.services.workdocs.model.DescribeCommentsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.DescribeCommentsResult {
...
fun AmazonWorkDocsFunctions.describeDocumentVersions(documentId: String, init: (AmazonWorkDocsDescribeDocumentVersionsCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.DescribeDocumentVersionsResult {
	return this.block.declare(AmazonWorkDocsDescribeDocumentVersionsCommand(documentId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.DescribeDocumentVersionsResult
}
...
class AmazonWorkDocsDescribeDocumentVersionsCommand(val documentId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.DescribeDocumentVersionsRequest, com.amazonaws.services.workdocs.model.DescribeDocumentVersionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.DescribeDocumentVersionsResult {
...
fun AmazonWorkDocsFunctions.describeFolderContents(folderId: String, init: (AmazonWorkDocsDescribeFolderContentsCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.DescribeFolderContentsResult {
	return this.block.declare(AmazonWorkDocsDescribeFolderContentsCommand(folderId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.DescribeFolderContentsResult
}
...
class AmazonWorkDocsDescribeFolderContentsCommand(val folderId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.DescribeFolderContentsRequest, com.amazonaws.services.workdocs.model.DescribeFolderContentsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.DescribeFolderContentsResult {
...
fun AmazonWorkDocsFunctions.describeGroups(searchQuery: String, init: (AmazonWorkDocsDescribeGroupsCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.DescribeGroupsResult {
	return this.block.declare(AmazonWorkDocsDescribeGroupsCommand(searchQuery).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.DescribeGroupsResult
}
...
class AmazonWorkDocsDescribeGroupsCommand(val searchQuery: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.DescribeGroupsRequest, com.amazonaws.services.workdocs.model.DescribeGroupsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.DescribeGroupsResult {
...
fun AmazonWorkDocsFunctions.describeNotificationSubscriptions(organizationId: String, init: (AmazonWorkDocsDescribeNotificationSubscriptionsCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.DescribeNotificationSubscriptionsResult {
	return this.block.declare(AmazonWorkDocsDescribeNotificationSubscriptionsCommand(organizationId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.DescribeNotificationSubscriptionsResult
}
...
class AmazonWorkDocsDescribeNotificationSubscriptionsCommand(val organizationId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.DescribeNotificationSubscriptionsRequest, com.amazonaws.services.workdocs.model.DescribeNotificationSubscriptionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.DescribeNotificationSubscriptionsResult {
...
fun AmazonWorkDocsFunctions.describeResourcePermissions(resourceId: String, init: (AmazonWorkDocsDescribeResourcePermissionsCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.DescribeResourcePermissionsResult {
	return this.block.declare(AmazonWorkDocsDescribeResourcePermissionsCommand(resourceId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.DescribeResourcePermissionsResult
}
...
class AmazonWorkDocsDescribeResourcePermissionsCommand(val resourceId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.DescribeResourcePermissionsRequest, com.amazonaws.services.workdocs.model.DescribeResourcePermissionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.DescribeResourcePermissionsResult {
...
fun AmazonWorkDocsFunctions.describeRootFolders(authenticationToken: String, init: (AmazonWorkDocsDescribeRootFoldersCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.DescribeRootFoldersResult {
	return this.block.declare(AmazonWorkDocsDescribeRootFoldersCommand(authenticationToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.DescribeRootFoldersResult
}
...
class AmazonWorkDocsDescribeRootFoldersCommand(val authenticationToken: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.DescribeRootFoldersRequest, com.amazonaws.services.workdocs.model.DescribeRootFoldersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.DescribeRootFoldersResult {
...
fun AmazonWorkDocsFunctions.describeUsers(init: (AmazonWorkDocsDescribeUsersCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.DescribeUsersResult {
	return this.block.declare(AmazonWorkDocsDescribeUsersCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.DescribeUsersResult
}
...
class AmazonWorkDocsDescribeUsersCommand() : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.DescribeUsersRequest, com.amazonaws.services.workdocs.model.DescribeUsersResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.DescribeUsersResult {
...
fun AmazonWorkDocsFunctions.getCurrentUser(authenticationToken: String, init: (AmazonWorkDocsGetCurrentUserCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.GetCurrentUserResult {
	return this.block.declare(AmazonWorkDocsGetCurrentUserCommand(authenticationToken).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.GetCurrentUserResult
}
...
class AmazonWorkDocsGetCurrentUserCommand(val authenticationToken: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.GetCurrentUserRequest, com.amazonaws.services.workdocs.model.GetCurrentUserResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.GetCurrentUserResult {
...
fun AmazonWorkDocsFunctions.getDocument(documentId: String, init: (AmazonWorkDocsGetDocumentCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.GetDocumentResult {
	return this.block.declare(AmazonWorkDocsGetDocumentCommand(documentId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.GetDocumentResult
}
...
class AmazonWorkDocsGetDocumentCommand(val documentId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.GetDocumentRequest, com.amazonaws.services.workdocs.model.GetDocumentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.GetDocumentResult {
...
fun AmazonWorkDocsFunctions.getDocumentPath(documentId: String, init: (AmazonWorkDocsGetDocumentPathCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.GetDocumentPathResult {
	return this.block.declare(AmazonWorkDocsGetDocumentPathCommand(documentId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.GetDocumentPathResult
}
...
class AmazonWorkDocsGetDocumentPathCommand(val documentId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.GetDocumentPathRequest, com.amazonaws.services.workdocs.model.GetDocumentPathResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.GetDocumentPathResult {
...
fun AmazonWorkDocsFunctions.getDocumentVersion(documentId: String, versionId: String, init: (AmazonWorkDocsGetDocumentVersionCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.GetDocumentVersionResult {
	return this.block.declare(AmazonWorkDocsGetDocumentVersionCommand(documentId, versionId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.GetDocumentVersionResult
}
...
class AmazonWorkDocsGetDocumentVersionCommand(val documentId: String, val versionId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.GetDocumentVersionRequest, com.amazonaws.services.workdocs.model.GetDocumentVersionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.GetDocumentVersionResult {
...
fun AmazonWorkDocsFunctions.getFolder(folderId: String, init: (AmazonWorkDocsGetFolderCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.GetFolderResult {
	return this.block.declare(AmazonWorkDocsGetFolderCommand(folderId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.GetFolderResult
}
...
class AmazonWorkDocsGetFolderCommand(val folderId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.GetFolderRequest, com.amazonaws.services.workdocs.model.GetFolderResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.GetFolderResult {
...
fun AmazonWorkDocsFunctions.getFolderPath(folderId: String, init: (AmazonWorkDocsGetFolderPathCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.GetFolderPathResult {
	return this.block.declare(AmazonWorkDocsGetFolderPathCommand(folderId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.GetFolderPathResult
}
...
class AmazonWorkDocsGetFolderPathCommand(val folderId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.GetFolderPathRequest, com.amazonaws.services.workdocs.model.GetFolderPathResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.GetFolderPathResult {
...
fun AmazonWorkDocsFunctions.initiateDocumentVersionUpload(parentFolderId: String, init: (AmazonWorkDocsInitiateDocumentVersionUploadCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.InitiateDocumentVersionUploadResult {
	return this.block.declare(AmazonWorkDocsInitiateDocumentVersionUploadCommand(parentFolderId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.InitiateDocumentVersionUploadResult
}
...
class AmazonWorkDocsInitiateDocumentVersionUploadCommand(val parentFolderId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.InitiateDocumentVersionUploadRequest, com.amazonaws.services.workdocs.model.InitiateDocumentVersionUploadResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.InitiateDocumentVersionUploadResult {
...
fun AmazonWorkDocsFunctions.removeAllResourcePermissions(resourceId: String, init: (AmazonWorkDocsRemoveAllResourcePermissionsCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.RemoveAllResourcePermissionsResult {
	return this.block.declare(AmazonWorkDocsRemoveAllResourcePermissionsCommand(resourceId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.RemoveAllResourcePermissionsResult
}
...
class AmazonWorkDocsRemoveAllResourcePermissionsCommand(val resourceId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.RemoveAllResourcePermissionsRequest, com.amazonaws.services.workdocs.model.RemoveAllResourcePermissionsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.RemoveAllResourcePermissionsResult {
...
fun AmazonWorkDocsFunctions.removeResourcePermission(resourceId: String, principalId: String, init: (AmazonWorkDocsRemoveResourcePermissionCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.RemoveResourcePermissionResult {
	return this.block.declare(AmazonWorkDocsRemoveResourcePermissionCommand(resourceId, principalId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.RemoveResourcePermissionResult
}
...
class AmazonWorkDocsRemoveResourcePermissionCommand(val resourceId: String, val principalId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.RemoveResourcePermissionRequest, com.amazonaws.services.workdocs.model.RemoveResourcePermissionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.RemoveResourcePermissionResult {
...
fun AmazonWorkDocsFunctions.updateDocument(documentId: String, init: (AmazonWorkDocsUpdateDocumentCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.UpdateDocumentResult {
	return this.block.declare(AmazonWorkDocsUpdateDocumentCommand(documentId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.UpdateDocumentResult
}
...
class AmazonWorkDocsUpdateDocumentCommand(val documentId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.UpdateDocumentRequest, com.amazonaws.services.workdocs.model.UpdateDocumentResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.UpdateDocumentResult {
...
fun AmazonWorkDocsFunctions.updateDocumentVersion(documentId: String, versionId: String, init: (AmazonWorkDocsUpdateDocumentVersionCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.UpdateDocumentVersionResult {
	return this.block.declare(AmazonWorkDocsUpdateDocumentVersionCommand(documentId, versionId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.UpdateDocumentVersionResult
}
...
class AmazonWorkDocsUpdateDocumentVersionCommand(val documentId: String, val versionId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.UpdateDocumentVersionRequest, com.amazonaws.services.workdocs.model.UpdateDocumentVersionResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.UpdateDocumentVersionResult {
...
fun AmazonWorkDocsFunctions.updateFolder(folderId: String, init: (AmazonWorkDocsUpdateFolderCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.UpdateFolderResult {
	return this.block.declare(AmazonWorkDocsUpdateFolderCommand(folderId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.UpdateFolderResult
}
...
class AmazonWorkDocsUpdateFolderCommand(val folderId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.UpdateFolderRequest, com.amazonaws.services.workdocs.model.UpdateFolderResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.UpdateFolderResult {
...
fun AmazonWorkDocsFunctions.updateUser(userId: String, init: (AmazonWorkDocsUpdateUserCommand.() -> Unit)? = null): com.amazonaws.services.workdocs.model.UpdateUserResult {
	return this.block.declare(AmazonWorkDocsUpdateUserCommand(userId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workdocs.model.UpdateUserResult
}
...
class AmazonWorkDocsUpdateUserCommand(val userId: String) : AmazonWebServiceCommand<com.amazonaws.services.workdocs.model.UpdateUserRequest, com.amazonaws.services.workdocs.model.UpdateUserResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workdocs.model.UpdateUserResult {
