...
package com.codingue.koops.aws.workspaces
...
fun AmazonWorkspacesFunctions.createTags(resourceId: String, tags: List<com.amazonaws.services.workspaces.model.Tag>, init: (AmazonWorkspacesCreateTagsCommand.() -> Unit)? = null): com.amazonaws.services.workspaces.model.CreateTagsResult {
	return this.block.declare(AmazonWorkspacesCreateTagsCommand(resourceId, tags).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workspaces.model.CreateTagsResult
}
...
class AmazonWorkspacesCreateTagsCommand(val resourceId: String, val tags: List<com.amazonaws.services.workspaces.model.Tag>) : AmazonWebServiceCommand<com.amazonaws.services.workspaces.model.CreateTagsRequest, com.amazonaws.services.workspaces.model.CreateTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workspaces.model.CreateTagsResult {
...
fun AmazonWorkspacesFunctions.createWorkspaces(workspaces: List<com.amazonaws.services.workspaces.model.WorkspaceRequest>, init: (AmazonWorkspacesCreateWorkspacesCommand.() -> Unit)? = null): com.amazonaws.services.workspaces.model.CreateWorkspacesResult {
	return this.block.declare(AmazonWorkspacesCreateWorkspacesCommand(workspaces).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workspaces.model.CreateWorkspacesResult
}
...
class AmazonWorkspacesCreateWorkspacesCommand(val workspaces: List<com.amazonaws.services.workspaces.model.WorkspaceRequest>) : AmazonWebServiceCommand<com.amazonaws.services.workspaces.model.CreateWorkspacesRequest, com.amazonaws.services.workspaces.model.CreateWorkspacesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workspaces.model.CreateWorkspacesResult {
...
fun AmazonWorkspacesFunctions.deleteTags(resourceId: String, tagKeys: List<String>, init: (AmazonWorkspacesDeleteTagsCommand.() -> Unit)? = null): com.amazonaws.services.workspaces.model.DeleteTagsResult {
	return this.block.declare(AmazonWorkspacesDeleteTagsCommand(resourceId, tagKeys).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workspaces.model.DeleteTagsResult
}
...
class AmazonWorkspacesDeleteTagsCommand(val resourceId: String, val tagKeys: List<String>) : AmazonWebServiceCommand<com.amazonaws.services.workspaces.model.DeleteTagsRequest, com.amazonaws.services.workspaces.model.DeleteTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workspaces.model.DeleteTagsResult {
...
fun AmazonWorkspacesFunctions.describeTags(resourceId: String, init: (AmazonWorkspacesDescribeTagsCommand.() -> Unit)? = null): com.amazonaws.services.workspaces.model.DescribeTagsResult {
	return this.block.declare(AmazonWorkspacesDescribeTagsCommand(resourceId).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workspaces.model.DescribeTagsResult
}
...
class AmazonWorkspacesDescribeTagsCommand(val resourceId: String) : AmazonWebServiceCommand<com.amazonaws.services.workspaces.model.DescribeTagsRequest, com.amazonaws.services.workspaces.model.DescribeTagsResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workspaces.model.DescribeTagsResult {
...
fun AmazonWorkspacesFunctions.describeWorkspaceBundles(init: (AmazonWorkspacesDescribeWorkspaceBundlesCommand.() -> Unit)? = null): com.amazonaws.services.workspaces.model.DescribeWorkspaceBundlesResult {
	return this.block.declare(AmazonWorkspacesDescribeWorkspaceBundlesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workspaces.model.DescribeWorkspaceBundlesResult
}
...
class AmazonWorkspacesDescribeWorkspaceBundlesCommand() : AmazonWebServiceCommand<com.amazonaws.services.workspaces.model.DescribeWorkspaceBundlesRequest, com.amazonaws.services.workspaces.model.DescribeWorkspaceBundlesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workspaces.model.DescribeWorkspaceBundlesResult {
...
fun AmazonWorkspacesFunctions.describeWorkspaceDirectories(init: (AmazonWorkspacesDescribeWorkspaceDirectoriesCommand.() -> Unit)? = null): com.amazonaws.services.workspaces.model.DescribeWorkspaceDirectoriesResult {
	return this.block.declare(AmazonWorkspacesDescribeWorkspaceDirectoriesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workspaces.model.DescribeWorkspaceDirectoriesResult
}
...
class AmazonWorkspacesDescribeWorkspaceDirectoriesCommand() : AmazonWebServiceCommand<com.amazonaws.services.workspaces.model.DescribeWorkspaceDirectoriesRequest, com.amazonaws.services.workspaces.model.DescribeWorkspaceDirectoriesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workspaces.model.DescribeWorkspaceDirectoriesResult {
...
fun AmazonWorkspacesFunctions.describeWorkspaces(init: (AmazonWorkspacesDescribeWorkspacesCommand.() -> Unit)? = null): com.amazonaws.services.workspaces.model.DescribeWorkspacesResult {
	return this.block.declare(AmazonWorkspacesDescribeWorkspacesCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workspaces.model.DescribeWorkspacesResult
}
...
class AmazonWorkspacesDescribeWorkspacesCommand() : AmazonWebServiceCommand<com.amazonaws.services.workspaces.model.DescribeWorkspacesRequest, com.amazonaws.services.workspaces.model.DescribeWorkspacesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workspaces.model.DescribeWorkspacesResult {
...
fun AmazonWorkspacesFunctions.describeWorkspacesConnectionStatus(init: (AmazonWorkspacesDescribeWorkspacesConnectionStatusCommand.() -> Unit)? = null): com.amazonaws.services.workspaces.model.DescribeWorkspacesConnectionStatusResult {
	return this.block.declare(AmazonWorkspacesDescribeWorkspacesConnectionStatusCommand().applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workspaces.model.DescribeWorkspacesConnectionStatusResult
}
...
class AmazonWorkspacesDescribeWorkspacesConnectionStatusCommand() : AmazonWebServiceCommand<com.amazonaws.services.workspaces.model.DescribeWorkspacesConnectionStatusRequest, com.amazonaws.services.workspaces.model.DescribeWorkspacesConnectionStatusResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workspaces.model.DescribeWorkspacesConnectionStatusResult {
...
fun AmazonWorkspacesFunctions.modifyWorkspaceProperties(workspaceId: String, workspaceProperties: com.amazonaws.services.workspaces.model.WorkspaceProperties, init: (AmazonWorkspacesModifyWorkspacePropertiesCommand.() -> Unit)? = null): com.amazonaws.services.workspaces.model.ModifyWorkspacePropertiesResult {
	return this.block.declare(AmazonWorkspacesModifyWorkspacePropertiesCommand(workspaceId, workspaceProperties).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workspaces.model.ModifyWorkspacePropertiesResult
}
...
class AmazonWorkspacesModifyWorkspacePropertiesCommand(val workspaceId: String, val workspaceProperties: com.amazonaws.services.workspaces.model.WorkspaceProperties) : AmazonWebServiceCommand<com.amazonaws.services.workspaces.model.ModifyWorkspacePropertiesRequest, com.amazonaws.services.workspaces.model.ModifyWorkspacePropertiesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workspaces.model.ModifyWorkspacePropertiesResult {
...
fun AmazonWorkspacesFunctions.rebootWorkspaces(rebootWorkspaceRequests: List<com.amazonaws.services.workspaces.model.RebootRequest>, init: (AmazonWorkspacesRebootWorkspacesCommand.() -> Unit)? = null): com.amazonaws.services.workspaces.model.RebootWorkspacesResult {
	return this.block.declare(AmazonWorkspacesRebootWorkspacesCommand(rebootWorkspaceRequests).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workspaces.model.RebootWorkspacesResult
}
...
class AmazonWorkspacesRebootWorkspacesCommand(val rebootWorkspaceRequests: List<com.amazonaws.services.workspaces.model.RebootRequest>) : AmazonWebServiceCommand<com.amazonaws.services.workspaces.model.RebootWorkspacesRequest, com.amazonaws.services.workspaces.model.RebootWorkspacesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workspaces.model.RebootWorkspacesResult {
...
fun AmazonWorkspacesFunctions.rebuildWorkspaces(rebuildWorkspaceRequests: List<com.amazonaws.services.workspaces.model.RebuildRequest>, init: (AmazonWorkspacesRebuildWorkspacesCommand.() -> Unit)? = null): com.amazonaws.services.workspaces.model.RebuildWorkspacesResult {
	return this.block.declare(AmazonWorkspacesRebuildWorkspacesCommand(rebuildWorkspaceRequests).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workspaces.model.RebuildWorkspacesResult
}
...
class AmazonWorkspacesRebuildWorkspacesCommand(val rebuildWorkspaceRequests: List<com.amazonaws.services.workspaces.model.RebuildRequest>) : AmazonWebServiceCommand<com.amazonaws.services.workspaces.model.RebuildWorkspacesRequest, com.amazonaws.services.workspaces.model.RebuildWorkspacesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workspaces.model.RebuildWorkspacesResult {
...
fun AmazonWorkspacesFunctions.startWorkspaces(startWorkspaceRequests: List<com.amazonaws.services.workspaces.model.StartRequest>, init: (AmazonWorkspacesStartWorkspacesCommand.() -> Unit)? = null): com.amazonaws.services.workspaces.model.StartWorkspacesResult {
	return this.block.declare(AmazonWorkspacesStartWorkspacesCommand(startWorkspaceRequests).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workspaces.model.StartWorkspacesResult
}
...
class AmazonWorkspacesStartWorkspacesCommand(val startWorkspaceRequests: List<com.amazonaws.services.workspaces.model.StartRequest>) : AmazonWebServiceCommand<com.amazonaws.services.workspaces.model.StartWorkspacesRequest, com.amazonaws.services.workspaces.model.StartWorkspacesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workspaces.model.StartWorkspacesResult {
...
fun AmazonWorkspacesFunctions.stopWorkspaces(stopWorkspaceRequests: List<com.amazonaws.services.workspaces.model.StopRequest>, init: (AmazonWorkspacesStopWorkspacesCommand.() -> Unit)? = null): com.amazonaws.services.workspaces.model.StopWorkspacesResult {
	return this.block.declare(AmazonWorkspacesStopWorkspacesCommand(stopWorkspaceRequests).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workspaces.model.StopWorkspacesResult
}
...
class AmazonWorkspacesStopWorkspacesCommand(val stopWorkspaceRequests: List<com.amazonaws.services.workspaces.model.StopRequest>) : AmazonWebServiceCommand<com.amazonaws.services.workspaces.model.StopWorkspacesRequest, com.amazonaws.services.workspaces.model.StopWorkspacesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workspaces.model.StopWorkspacesResult {
...
fun AmazonWorkspacesFunctions.terminateWorkspaces(terminateWorkspaceRequests: List<com.amazonaws.services.workspaces.model.TerminateRequest>, init: (AmazonWorkspacesTerminateWorkspacesCommand.() -> Unit)? = null): com.amazonaws.services.workspaces.model.TerminateWorkspacesResult {
	return this.block.declare(AmazonWorkspacesTerminateWorkspacesCommand(terminateWorkspaceRequests).applyIfNotNull(init, { init!!() })) as com.amazonaws.services.workspaces.model.TerminateWorkspacesResult
}
...
class AmazonWorkspacesTerminateWorkspacesCommand(val terminateWorkspaceRequests: List<com.amazonaws.services.workspaces.model.TerminateRequest>) : AmazonWebServiceCommand<com.amazonaws.services.workspaces.model.TerminateWorkspacesRequest, com.amazonaws.services.workspaces.model.TerminateWorkspacesResult> {
	...
	override fun eval(environment: com.codingue.koops.core.Environment): com.amazonaws.services.workspaces.model.TerminateWorkspacesResult {
